...
Total relevant papers: 173

Paper selection prompt and criteria at the bottom

Table of contents with paper titles:

0. [CELEUS: Certifiable and Efficient LLM Evaluation via E-Processes](#link0)
**Authors:** Zhijian Zhou, Zesheng Ye, Zhaorun Chen, Bo Li, Feng Liu

1. [A Markov Chain Approach to Preference Alignment](#link1)
**Authors:** Takuya Koriyama, Tengyuan Liang

2. [Scheduling Thoughts: Learning the Order of Thought in Diffusion Language Models](#link2)
**Authors:** Jiawei Xu, Minghui Liu, Aakriti Agrawal, Yifan Chen, Furong Huang

3. [When to Plan, When to Polish: Noise Level as a Granularity Axis for Diffusion Language Models](#link3)
**Authors:** Peihong Li, Yuanjie Shi, Yan Yan

4. [EvoRubrics: Dynamic Rubrics as Rewards via Adversarial Co-Evolution for LLM Reinforcement Learning](#link4)
**Authors:** Hongxin Ding, Baixiang Huang, Yue Fang, Weibin Liao, Zheng Li, Jinyang Zhang, Zhijing Wu, Junfeng Zhao, Yasha Wang

5. [Evaluation Awareness Is Not One Capability: Evidence from Open Language Models](#link5)
...
6. [Discretizing Reward Models](#link6)
**Authors:** Vijay Viswanathan, Shiqi Wang, Devamanyu Hazarika, Chirag Nagpal, Tongshuang Wu, Graham Neubig, Yuning Mao

7. [SPIRAL: Learning to Search and Aggregate](#link7)
**Authors:** Jubayer Ibn Hamid, Ifdita Hasan Orney, Michael Y. Li, Omar Shaikh, Yoonho Lee, Dorsa Sadigh, Chelsea Finn, Noah Goodman

8. [Prefix-Guided On-Policy Distillation: Mining Golden Trajectories from Rollouts](#link8)
**Authors:** Qingfei Zhao, Huan Song, Shuyu Tian, Jiawei Shao, Xuelong Li

9. [Learning through Internalization](#link9)
**Authors:** Nikolaos Tsilivis, Nirmit Joshi, Marko Medvedev, Julia Kempe, Nati Srebro

10. [GIF: Locally Sound Geometric Information Flow Control for LLMs](#link10)
**Authors:** Adam Storek, Nikolaus Holzer, Zhuo Zhang, Suman Jana

11. [A Formula-Driven Survey and Research Agenda for On-Policy Distillation](#link11)
**Authors:** Bowen Zhang

12. [What are Key Factors for Updates in RL for LLM Reasoning?](#link12)
**Authors:** Peidong Wang, Demi Wang, Xufang Luo, Jiahang Xu, Xiaocui Yang, Shi Feng, Yuqing Yang, Dongsheng Li

13. [Provable Benefits of RLVR over SFT for Reasoning Models: Learning to Backtrack Efficiently](#link13)
**Authors:** Stanley Wei, Juno Kim

14. [Local Causal Attribution of Chain-of-Thought Reasoning](#link14)
**Authors:** Dennis Wei, Yannis Belkhiter, Erik Miehling, Radu Marinescu

15. [ARCO: Adaptive Rubric with Co-Evolution for Multi-Step LLM-Based Agents](#link15)
**Authors:** Zihang Tian, Jingsen Zhang, Rui Li, Xiaohe Bo, Yuanzi Li, Xu Chen

16. [ReNIO: Reweighting Negative Trajectory Importance for LLM On-Policy Distillation](#link16)
**Authors:** Chen Lin, Kedi Chen, Wei Zhang

17. [ForEx: A Formal Verification Framework for Explainable Reasoning in Logical Fallacy Detection and Annotation](#link17)
**Authors:** Pei-Cing Huang, Chienyu Liu, Chan Hsu, Ci-Siang Chen, Pei-Ju Lee, Yihuang Kang

18. [VeriEvol: Scaling Multimodal Mathematical Reasoning via Verifiable Evol-Instruct](#link18)
**Authors:** Haoling Li, Kai Zheng, Jie Wu, Can Xu, Qingfeng Sun, Han Hu, Yujiu Yang

19. [Curriculum Reinforcement Learning Can Incentivize Reasoning Capacity in LLMs Beyond the Base Model](#link19)
**Authors:** Pengxiang Cai, Tianchen Fang, Xiaohan Li, Qingyuan Zeng, Guocong Li, Jintai Chen

20. [When Is Emergent Consensus Real? A Measured Coupling Gain and a Validity Diagnostic for LLM Agent Societies](#link20)
**Authors:** Dongxu Yang

21. [ORBIT: Training-Free Multi-Attribute Behavioral Steering via Orthogonal Subspace Rotation](#link21)
**Authors:** Narges Ghasemi, Amir Ziashahabi, Salman Avestimehr, Jonathan May

22. [PRIME: Evaluating Prompt Resolution Under Incompatible Instructions in LLMs](#link22)
**Authors:** Tehreem Javed, Shumaim Fatimah, Masooma Bakhtiari, Gibrail Islam, Mehwish Fatima

23. [Skin-Deep: A Geometric Diagnostic for Alignment Fragility in Large Language Model Representations](#link23)
**Authors:** Dongyub Jude Lee, Jungseob Lee, Seungyoon Lee, Seongtae Hong, Suhyune Son, Sugyeong Eo, Jaehyung Seo, Heuiseok Lim

24. [Denoising Iterative Self-Correction: Structured Verification Loops for Reliable LLM Reasoning](#link24)
**Authors:** Shen Yin, David Ken, Joel Stremmel

25. [Does the Same Token Mean the Same State? MoE Routing as Signal for Reasoning Control](#link25)
**Authors:** Kang Chen, Minshen Yu, Junjie Nian, Yaoning Wang, Yixin Cao, Yugang Jiang

26. [StatABench: Dataset and Framework for Evaluating Statistical Analysis Capabilities of LLMs](#link26)
**Authors:** Youxin Zhu, Yixuan Ding, Peng Lai, Longyue Wang, Bingyi Jing, Guanhua Chen

27. [Understanding Parallel Samplers in Masked Diffusion via Random Walks on Graphs](#link27)
**Authors:** Vansh Bansal, Cho Cholyeon, Syamantak Kumar, Sujay Sanghavi, Purnamrita Sarkar

28. [ReasoningLens: Hierarchical Visualization and Diagnostic Auditing for Large Reasoning Models](#link28)
**Authors:** Jun Zhang, Jiasheng Zheng, Boxi Cao, Yaojie Lu, Hongyu Lin, Jia Zheng, Xianpei Han, Le Sun

29. [Scalable Maximum Entropy Reinforcement Learning for Diffusion Policies via Adjoint Matching](#link29)
**Authors:** Serge Thilges, Onur Celik, Denis Blessing, Emiliyan Gospodinov, Gerhard Neumann

30. [A-Evolve-Training: Autonomous Post-Training of a 30B Model](#link30)
**Authors:** Zhan Shi, Bing He, Yisi Sang, Hanqing Lu

31. [HERALD: High-Throughput Block Diffusion LLM Serving via CPU-GPU Cooperative KV Cache Retrieval](#link31)
**Authors:** Omin Kwon, Doyeon Kim, Jongseok Park, Seung Yul Lee, Ion Stoica, Jae W. Lee

32. [Factual Retrieval in LLMs Is a Redundant, Distributed and Non-Contiguous Process](#link32)
**Authors:** Hail Hochman, Natalie Shapira, Yoav Goldberg

33. [PeLAP-A: Adaptive Latent Pruning for Lightweight Latent Diffusion Models](#link33)
**Authors:** Kissa Zahra, Zaib Un Nisa

34. [Calibration Is Not Control: Why LLM-Agent Oversight Needs Intervention](#link34)
**Authors:** Chubin Zhang, Zhenglin Wan, Xingrui Yu, Jingxuan Wu, Qi Wen, Pengfei Zhou, Wangbo Zhao, Ivor Tsang

35. [LIG: Layer-wise Integrated Gradients for Within-Layer Flow Analysis in Transformers](#link35)
**Authors:** Eight Suzuki, Hideitsu Hino, Noboru Murata

36. [TriggerBench: Investigating Prospective Memory for Large Language Models](#link36)
**Authors:** Tianhua Zhang, Xinjiang Wang, Qianxi Zhang, Qi Chen, Kun Li, Yaoqi Chen, Dingdong Wang, Helen Meng, Yan Lu

37. [Breaking the Likelihood Trap: Variance-Calibrated Modulation for Large Language Model Decoding](#link37)
**Authors:** Yuanhao Ding, Meimingwei Li, Esteban Garces Arias, Matthias A{\ss}enmacher, Christian Heumann, Chongsheng Zhang

38. [Beyond Penalizing Mistakes: Stabilizing Efficiency Training in Large Reasoning Models via Adaptive Correct-Only Rewards](#link38)
**Authors:** Jungseob Lee, Seungyoon Lee, Seongtae Hong, Minhyuk Kim, Chanjun Park, Heuiseok Lim

39. [Distribution-Aware Diffusion-LLM for Robust Ultra-Long-Term Time Series Forecasting](#link39)
**Authors:** Falguni Ghosh, Vahid Hashemi, Bernhard Kainz

40. [AgentLens: Interpretable Safety Steering via Mechanistic Subspaces for Multi-Turn Coding Agent](#link40)
**Authors:** Weidi Luo, Qiming Zhang, Yihao Quan, Mingyu Jin, Jie Cai, Chaowei Xiao, Jingcheng Niu, Zhen Xiang

41. [CLI-Universe: Towards Verifiable Task Synthesis Engine for Terminal Agents](#link41)
...
42. [Quantifying the Agreement Between Data-Influence and Data-Similarity to Understand LLM Behavior](#link42)
**Authors:** Christopher J. Anders, Henrique Da Silva Gameiro, Nico Daheim, Mohammad Emtiyaz Khan

43. [AI Alignment From Social Choice Perspectives](#link43)
**Authors:** Daniel Halpern, Evi Micha, Ariel D. Procaccia, Benjamin Schiffer, Itai Shapira, Shirley Zhang

44. [Understanding Knowledge Distillation in Post-Training: When It Helps and When It Fails](#link44)
**Authors:** Xin Liu, Simin Ma, Shujian Liu, Song Wang, Sathish Reddy Indurthi, Haoyun Deng, Lu Wang, Kaiqiang Song

45. [Test-Time Training with Next-Token Prediction](#link45)
**Authors:** Xuan Ouyang, Zefan Cai, Junjie Hu

46. [Simulated Customers Never Walk Away: Decision Fidelity of LLM User Simulators Measured Against Real Purchase Outcomes](#link46)
**Authors:** Liang Chen

47. [Deeper is Not Always Better: Mitigating the Alignment Tax via Confident Layer Decoding](#link47)
...
48. [GRAG: Generic Response-Augmented Generation Framework for Personalized Conversational Systems](#link48)
**Authors:** Junfeng Liu, Christopher T. Symons, Ranga Raju Vatsavai

49. [Abstract representational geometry supports inference in large language models](#link49)
**Authors:** Yunan Zeng, Yuwang Wang

50. [Asymptotic Signal Subspace Recovery in Softmax Attention Models](#link50)
**Authors:** Lan V. Truong

51. [Learning at the Right Pace: Adaptive Data Scheduling Improves LLM Reinforcement Learning](#link51)
...
52. [Scaling LLM Knowledge Boundaries via Distribution-Optimized Synthesis](#link52)
...
53. [In LLM Reasoning, there is Irrationality on top of Value Misalignment](#link53)
**Authors:** Kejiang Qian, Fengxiang He

54. [Right Knowledge, Wrong Answer: Test-Time Steering for Temporal Fact Conflicts in Open-Weight Language Models](#link54)
**Authors:** Elias Hossain, Sourav Saha, Umesh Chandra Biswas, Sanjeda Sara Jennifer

55. [Escaping the Variance Trap: Jacobian-Free Dynamics for Root-Finding Bilevel Optimization](#link55)
**Authors:** Zhiyu Li, Xi Xuan, Davide Carbone

56. [The Origins of Stochasticity: Comprehensive Investigations on Uncertainty Quantification for Large Language Models](#link56)
**Authors:** Xiang-Jun Ou, Shuang Liang, Xin-Yu Hu, Rong-Hao Huang, Jing Wang, Shao-Qun Zhang

57. [Modularized Reinforcement Learning on LLMs: From MDP Creation to Exploration and Learning](#link57)
**Authors:** Zhao Yang, Yuxuan Jiang, Ting-Chih Chen, Lincen Yang, Annie Wong, Chao Gao, Jacob E. Kooi, Zhong Li, Jiayang Shi, Kevin Qiu, Qi Huang, Xinrui Zu, Shiping Yang, Hengyuan Zhang, Ngai Wong, Filip Ilievski, Shujian Yu, Aske Plaat, Zhaochun Ren, Mark Hoogendoorn, Vincent Fran\c{c}ois-Lavet

58. [SCRUB-FL: Sanitizing and Cleansing Representations via Unlearning of Backdoors](#link58)
**Authors:** Osama Wehbi, Sarhad Arisdakessian, Omar Abdel Wahab, Azzam Mourad, Hadi Otrok

59. [SkillAudit: From Fixed-Suite Benchmarking to Skill-Centered Assessment](#link59)
...
60. [Tmax: A simple recipe for terminal agents](#link60)
**Authors:** Hamish Ivison, Junjie Oscar Yin, Rulin Shao, Teng Xiao, Nathan Lambert, Hannaneh Hajishirzi

61. [When Do Intrinsic Rewards Work for Code Reasoning? A Comprehensive Study](#link61)
**Authors:** Xiaolong Jin, Xuandong Zhao, Wenbo Guo, Xiangyu Zhang, Dawn Song

62. [PrivacyAlign: Contextual Privacy Alignment for LLM Agents](#link62)
**Authors:** Manveer Singh Tamber, Abhay Puri, Marc-Etienne Brunet, Perouz Taslakian, Jimmy Lin, Spandana Gella

63. [Measuring & Mitigating Over-Alignment for LLMs in Multilingual Criminal Law Courts](#link63)
**Authors:** Arthur Wuhrmann, Gaetan Stein, Daniel Brunner, Andrei Kucharavy

64. [MuPPET: A Benchmark for Contextual Privacy of LLM Assistants in Multi-Party Conversations](#link64)
**Authors:** Elena Sofia Ruzzetti, Cornelius Emde, Sangdoo Yun, Seong Joon Oh, Martin Gubri

65. [L20-Edu-135M: An Auditable Single-GPU Study of Data-Efficient Small Language Modeling](#link65)
**Authors:** Yin Li

66. [On the Position Bias of On-Policy Distillation](#link66)
**Authors:** Yan Xie, Sijie Zhu, Tiansheng Wen, Bo Chen, Yifei Wang

67. [Beyond Fixed Budgets: Characterizing the Inelasticity and Limitations of Tree-of-Thought Reasoning Strategies](#link67)
**Authors:** Atkia Mahila, Avinash Maurya, M. Mustafa Rafique, Bogdan Nicolae

68. [Behavioral and Representational Evidence of Binomial Ordering Preferences in Large Language Models](#link68)
**Authors:** Zhiqing Yang, Yilun Liu, Yunpu Ma, Volker Tresp, Hinrich Sch\"utze

69. [Priority-Aware Learning-Unlearning Correction for Dynamic Decentralized LoRA Fine-Tuning](#link69)
**Authors:** Nuocheng Yang, Yechen He, Sihua Wang, Zihan Chen, Tony Q. S. Quek, Changchuan Yin

70. [Look Light, Think Heavy: What Multimodal Chain-of-Thought Reasoning Can and Cannot Do](#link70)
**Authors:** Zhuoran Jin, Kejian Zhu, Hongbang Yuan, Yupu Hao, Pengfei Cao, Yubo Chen, Kang Liu, Jun Zhao

71. [Do Sparse Autoencoders Learn Meaningful Concept Hierarchies?](#link71)
**Authors:** Nils Grandien, David Steinmann, Felix Friedrich, Kristian Kersting

72. [When Context Misleads: Surprisal, Energy and Attention Entropy as Metrics of Coherence Illusions in LLMs](#link72)
**Authors:** Ece Takmaz, Nitin Kumar, Li Kloostra, Jakub Dotlacil

73. [When AUC 0.998 Is Not Enough: A Candidate Evaluation Protocol for Hidden-State Probes of Indirect Prompt Injection in Multimodal Computer-Use Agents](#link73)
**Authors:** Yanhang Li, Zhichao Fan, Zexin Zhuang

74. [Peeking Inside LLMs: Leveraging Internal Artifacts of LLMs for Enhancing Reliability in Legal Classification](#link74)
**Authors:** Sudipta Santra, Debtanu Datta, Saptarshi Ghosh

75. [Answer Engineering: Local Trajectory Editing for Protocol-Constrained Decision Making in Large Language Models](#link75)
**Authors:** Victor Lavrenko, Anastasiia Molodnitskaia

76. [The Score Granularity Gap in Black-Box LLM Classification: A Comparative Study of Confidence Constructions](#link76)
**Authors:** Ao Sun, Tian Sun, Jiaxing Geng

77. [Minimax Quantile Lower Bounds for Interactive Statistical Decision Making with Privacy](#link77)
**Authors:** Raghav Bongole, Amirreza Zamani, Tobias J. Oechtering, Mikael Skoglund

78. [Tapered Language Models](#link78)
**Authors:** Reza Bayat, Ali Behrouz, Aaron Courville

79. [Inverting the Bellman Equation: From $Q$-Values to World Models](#link79)
**Authors:** Alistair Letcher, Mattie Fellows, Alexander D. Goldie, Jonathan Richens, Jakob N. Foerster, Oliver Richardson

80. [DiT-Reward: Generative Representations for Text-to-Image Reward Modeling](#link80)
**Authors:** Yuanming Yang, Guoqing Ma, Bo Wang, Yuan Zhang, Wei Tang, Chenyi Li, Haoyang Huang, Nan Duan

81. [What Shapes Emergent Misalignment? Insights from Training Dynamics, Model Priors, and Data](#link81)
**Authors:** Yuchen Zhang, Anietta Weckauff, Diego Garcia-Olano, Maksym Andriushchenko

82. [When Does Intrinsic Self-Correction Help? A Task-Sensitive Analysis](#link82)
**Authors:** Elroy Stav, Dvir Berlowitz, Maayan Orner, Sarit Kraus

83. [The AI Evaluability Gap: The Missing Layer for Managing Risk and Sustaining Value](#link83)
**Authors:** Vishal Srivastava, Tanmay Sah

84. [On the Limits of Prompt-Conditioned Language Models as General-Purpose Learners](#link84)
**Authors:** David Mguni, Julian Ma, Jun Wang

85. [Muown Implicitly Performs Angular Step-size Decay](#link85)
**Authors:** Florian H\"ubler, Kai Lion, Antonio Orvieto, Niao He

86. [Gradient-Descent Steps to Success over Mean Accuracy: A Paradigm Shift for ML](#link86)
**Authors:** Riccardo Poli, Ahmet Yilmaz

87. [Group-Graph Policy Optimization for Long-Horizon Agentic Reinforcement Learning](#link87)
**Authors:** Yunan Wang, Minghui Song, Zihan Zhang, Shaohan Huang, Haizhen Huang, Furu Wei, Weiwei Deng, Feng Sun, Qi Zhang

88. [HOLMES: Evaluating Higher-Order Logical Reasoning in LLMs](#link88)
**Authors:** Yucheng Wu, Jundong Xu, Mingzhen Ju, Yue Yu, Chenpeng Wang, Haoxuan Li, Liangming Pan

89. [CuratorKIT : Data Curation and Synthetic Data Generation for LLM Post-Training](#link89)
**Authors:** Soham Bhattacharjee, Karun Sharma, Vinay Kumar Sankarapu, Pratinav Seth

90. [Enhancing Differentially Private Mechanisms via Empirical Bayes](#link90)
**Authors:** Minwoo Kim, Junyong Park, Sungkyu Jung

91. [Inverse Turing Bench: Evaluating Language Models as Judges of Human vs. AI Dialogue](#link91)
**Authors:** William Hager, Ishika Rathi, Masum Hasan, Cameron Jones

92. [Can Reasoning Models Detect Changes to their Chains of Thought?](#link92)
**Authors:** Sathvik Napa, Utkarsh Singh, Chengyuan Xue, Miriam Wanner, William Walden

93. [RIZZ: Routing Interactions to Near Zero-Interference Zones for Continual Adaptation of Black-Box Agents](#link93)
**Authors:** Sonali Goel, Pranav Vaidhyanathan, Lucas Schorling, Natalia Ares, Maike Osborne

94. [The Topology of Ill-Posed Questions: Persistent Homology for Detection and Steering in LLMs](#link94)
**Authors:** Guangyu Jiang, Sizhe Tang, Mahdi Imani, Tian Lan

95. [PeerCheck: Enhancing LLM-Generated Academic Reviews Towards Human-Level Quality](#link95)
**Authors:** Zeyuan Chen, Ziqing Yang, Yihan Ma, Michael Backes, Yang Zhang

96. [When Compression Helps and When It Hurts: Condition-Aware Analysis of Chain-of-Thought Distillation](#link96)
**Authors:** Siyang Lyu, Zhijing Sun, Xinghao Chen, Tong Liu, Dawei Zhu, Xiaoyu Shen

97. [FirstPass: Grounding AI Scientific Judgment in Multi-Round Editorial Outcomes](#link97)
**Authors:** Prabhjot Singh, Somnath Luitel, Manmeet Singh, Josh Durkee

98. [Reward-free Pretraining for Reinforcement Learning via Occupancy Coverage Maximization](#link98)
**Authors:** Marco Prattic\`o, Pietro Novelli, Massimiliano Pontil, Carlo Ciliberto

99. [Formalizing Task-Space Complexity for Zero-Shot Generalization](#link99)
**Authors:** Jung-Hoon Cho, Heling Zhang, Siqi Du, Roy Dong, Cathy Wu

100. [Intrinsic Flow Matching on Quantum Pure-State Manifolds with Phase-Aligned Transport](#link100)
**Authors:** Jian Xu, Delu Zeng, John Paisley, Qibin Zhao

101. [Grouped Query Experts: Mixture-of-Experts on GQA Self-Attention](#link101)
**Authors:** Vishesh Tripathi, Abhay Kumar

102. [DART: Draft-Agreement Routing for Training-Free Adaptive Thinking Budgets in Hybrid Reasoning Models](#link102)
...
103. [FORGE: Fused On-Register Gradient Elimination for Memory-Efficient LLM Training](#link103)
...
104. [NL2Scratch: An Executable Benchmark and Evaluation for Block-Based Programming](#link104)
**Authors:** Heejin Do, Alexandre Ballenghien, Yang Wu, April Yi Wang

105. [Expressivity Saturation: Reduced Affine Region Usage Under Increasing Task Complexity](#link105)
**Authors:** Xuan Qi, Yi Wei, Fanqi Yu, Manuel Lecha

106. [Breaking chains with trees: Deep learning with $\mathcal{O}(\log N)$ parallel time complexity](#link106)
...
107. [Interleaved Speech Language Models Latently Work In Text](#link107)
**Authors:** Talia Sternberg, Gallil Maimon, Yossi Adi

108. [Beyond Hooking Onto the World: Referential Profiles and the Numerical Structure of LLM Grounding](#link108)
**Authors:** Joo Yull Rhee

109. [CalVerT: Augmenting Agents with Calibrated Verifier Telemetry Improves Action and Learning in Knowledge-Intensive Tasks](#link109)
**Authors:** Ashwin Vinod, Ying Ding, Elias Stengel-Eskin

110. [Measuring Behavior Portability in Large Language Models](#link110)
**Authors:** Tianjia Dong, Nadav Kunievsky, James A. Evans

111. [NASDAQ: Normalized Observation Space Dynamics-Augmented Q-Learning](#link111)
**Authors:** Xinwei Liu (Sun Yat-sen University, China), Junyuan Liang (Sun Yat-sen University, China), Zicong Hong (EPFL, Switzerland), Jianting Zhang (Purdue University, USA), Wuhui Chen (Sun Yat-sen University, China)

112. [Learning the ARTS of Search for Automated Discovery](#link112)
**Authors:** Gurusha Juneja, Arnav Kumar Jain, Deepak Nathani, William Yang Wang, Xin Eric Wang

113. [Sakana Fugu Technical Report](#link113)
...
114. [Randomized YaRN Improves Length Generalization for Long-Context Reasoning](#link114)
**Authors:** Manas Mehta, Fangcong Yin, Greg Durrett

115. [AdaPrivate-TS: Private Thompson Sampling for Contextual Bandits with Privacy Amplification](#link115)
**Authors:** Mohammadreza Riyazat, Eranga Ukwatta

116. [All Routes Lead to Collapse](#link116)
**Authors:** K. R. Balasubramanian

117. [Dead-Direction Signatures: A Cheap Spectral Reading of Singular Complexity](#link117)
**Authors:** Tejas Pradeep Shirodkar, P. J. Narayanan

118. [DynamicMem: A Long-Horizon Memory Benchmark in Real-World Settings](#link118)
...
119. [Demystifying Numerical Instability in LLM Inference: Achieving Reproducible Inference for Mission-Critical Tasks with HEAL](#link119)
**Authors:** Zhenting Zhu, Lucas Thai, Shan Yu, Yicheng Liu, Yifan Qiao, Chenxi Wang, Harry Xu, Junyi Shu

120. [Beyond Value Benchmarks: Measuring Value-Structure Alignment in Large Language Models via Symmetric Q-Sorts](#link120)
**Authors:** Jingting Zheng (TJUNLP Lab, School of Computer Science, Technology, Tianjin University, Tianjin, China), Yuqi Ren (TJUNLP Lab, School of Computer Science, Technology, Tianjin University, Tianjin, China), Linhao Yu (TJUNLP Lab, School of Computer Science, Technology, Tianjin University, Tianjin, China), Yongqi Leng (TJUNLP Lab, School of Computer Science, Technology, Tianjin University, Tianjin, China), Deyi Xiong (TJUNLP Lab, School of Computer Science, Technology, Tianjin University, Tianjin, China)

121. [TALAS: Teacher-Anchored Layer Alignment with Adaptive Sharpness-Aware Minimization for Embedding Distillation](#link121)
**Authors:** Quoc Phong Dao, Hoang Son Nguyen, Pham Khanh Chi, Linh Ngo Van, Nguyen Thi Ngoc Diep, Thien Huu Nguyen, Trung Le

122. [Phonemes to the Rescue: Multilingual Tokenization Based on International Phonetic Alphabet](#link122)
**Authors:** Milan Mileti\'c, Julie Kallini, Ekaterina Shutova

123. [Agentic Time Machine as an Infrastructure for Future-Event Forecasting](#link123)
**Authors:** Jingyi Chai, Bingyang Zheng, Xiangrui Liu, Hao Lu, Zihang Zhou, Tianchen Wang, Kemeng Zhang, Siheng Chen

124. [GRADE: Graph Representation of LLM Agent Dependency and Execution](#link124)
**Authors:** Yue Zhao

125. [Alternate loss functions and regression models that achieve robustness to outliers by modulating the learning rate](#link125)
**Authors:** Mathew Mithra Noel, Arindam Banerjee, Yug D. Oswal, Geraldine Bessie Amali D, Venkataraman Muthiah-Nakarajan

126. [Only Ask What You Don't Know: Grounded Delta Planning for Efficient Multi-step RAG](#link126)
**Authors:** Wei-Chieh Chou, Xuanjun Chen, Jian-Ren Lin, Claire Lin, Hung-yi Lee, Jyh-Shing Roger Jang

127. [Are Multilingual Models Actually Improving? Isolating True Cross-Lingual Transfer](#link127)
**Authors:** Prasoon Bajpai, Eleftheria Briakou, Colin Cherry, Preethi Jyothi, Vihari Piratla

128. [Open Problem: Is AdamW Effective Under Heavy-Tailed Noise?](#link128)
**Authors:** Dingzhi Yu, Hongyi Tao, Yuanyu Wan, Luo Luo, Lijun Zhang

129. [On the Effect of Segmentation Width and Cluster Size on Speech Resynthesis and Continuation in Generative Spoken Language Models](#link129)
**Authors:** Shunsuke Kando, Wataru Nakata, Shinnosuke Takamichi, Yusuke Miyao

130. [VADAOrchestra: Neurosymbolic Orchestration of Adaptive Reasoning Workflows](#link130)
...
131. [AlphaMemo: Structured Search-Process Memory for Self-Evolving Alpha Mining Agents](#link131)
**Authors:** Hang Yu, Zifan Zheng, Jeff Z. Pan, Tongliang Liu, Zhiyong Wang, Fengxiang He

132. [PlanBench-XL: Evaluating Long-Horizon Planning of LLM Tool-Use Agents in Large-Scale Tool Ecosystems](#link132)
**Authors:** Jiayu Liu, Qihan Lin, Cheng Qian, Rui Wang, Emre Can Acikgoz, Xiaocheng Yang, Jiateng Liu, Zhenhailong Wang, Xiusi Chen, Heng Ji, Dilek Hakkani-T\"ur

133. [Managing Procedural Memory in LLM Agents: Control, Adaptation, and Evaluation](#link133)
**Authors:** Julia Belikova, Rauf Parchiev, Evgeny Egorov, Grigorii Davydenko, Gleb Gusev, Andrey Savchenko, Maksim Makarenko

134. [Gradient-Free Warm-Start Library Recovery: an Amortized-Regret Separation](#link134)
**Authors:** Jianwei Lou (RailMind Systems, Neuss, Germany)

135. [Beyond the Next Step: Variable-Length Latent World Models for Long-Horizon Planning](#link135)
**Authors:** Tianqi Du, Qi Zhang, Yifei Wang, Yisen Wang

136. [Select-to-Act: Hierarchical Reinforcement Learning via Adaptive Language Guidance](#link136)
**Authors:** Hanping Zhang, Adam Koziak, Yuhong Guo

137. [Keyless Attention: Value-Space Routing and Value-Only Caching for Efficient Transformers](#link137)
**Authors:** Xin Gao

138. [Words as Difference Makers: How Large Language Models Determine Causal Structure in Text](#link138)
**Authors:** Wolfgang Pietsch

139. [FiLM-Coordinated Dual-Branch Transformer for Global-Local Dependency Modeling in Language Modeling](#link139)
**Authors:** Zhiqiang Zhou, Xu Ling, Junliang Dai

140. [Plans Don't Persist: Why Context Management Is Load Bearing for LLM Agents](#link140)
**Authors:** Aman Mehta, Anupam Datta

141. [Finetuning with Scientific Data Increases Hallucinations: A Multi-domain Factuality Evaluation of LLMs](#link141)
**Authors:** Raia Abu Ahmad, Nikolas Rauscher, Ekaterina Borisova, Fabio Barth, Georg Rehm, Sebastian M\"oller

142. [Geometric and Information Compression of Representations in Deep Learning](#link142)
**Authors:** Linara Adilova, Henning Petzka, Asja Fischer, Bernhard C. Geiger

143. [RaMem: Contextual Reinstatement for Long-term Agentic Memory](#link143)
**Authors:** Wei Yang, Bryce Kan, Shixuan Li, Li Li, Yuehan Qin, Jiate Li, Paul Bogdan, Jesse Thomason

144. [Agent-as-a-Router: Agentic Model Routing for Coding Tasks](#link144)
...
145. [Bayesian Adaptation Gym: A Benchmark for the Bayesian Low-Rank Adaptation of Multi-Modal Language Models](#link145)
**Authors:** Colin Samplawski, Ramneet Kaur, Manoj Acharya, Anirban Roy, Adam D. Cobb

146. [The Two-Hump Problem: Bridging the Difficulty Gap in Mathematical Reinforcement Learning](#link146)
...
147. [AdaMem: Learning What to Remember for Personalized Long-Horizon LLM Agents](#link147)
**Authors:** Xingyu Chen, Rui Wang, Zhaopeng Tu, Liefeng Bo

148. [Scaling Performance and Low-Resource Annotation with Many-Shot In-Context Learning for Named Entity Recognition](#link148)
**Authors:** Qi Zhang, Fangping Lan, Cornelia Caragea, Longin Jan Latecki, Eduard Dragut

149. [EvoEmbedding: Evolvable Representations for Long-Context Retrieval and Agentic Memory](#link149)
**Authors:** Chang Nie, Chaoyou Fu, Junlan Feng, Caifeng Shan

150. [Nous: A Predictive World Model for Long-Term Agent Memory](#link150)
**Authors:** Pranav Singh

151. [A Stackelberg Framework for Resource-Aware LLM Agents: Learning, Repair, and Conditional Guarantees](#link151)
**Authors:** Baoxun Wang

152. [The Language-Energy Divide: Measuring Energy Costs of Multilingual LLM Inference](#link152)
**Authors:** Naihao Deng, Alissa Shen, Yiming Feng, Joan Nwatu, Jae-Won Chung, Mosharaf Chowdhury, Yulong Chen, Rada Mihalcea

153. [UniRank: Unified Rank Allocation for Low-Rank LLM Compression](#link153)
**Authors:** Chao Han, Haozhe Hu, Fei Ma, Wei Zhang, Xiaoyu Shen

154. [Is Our Benchmark Enough? An Analysis of Continual Learning for MLLMs](#link154)
**Authors:** Van-Tuan Tran, Shruthi Gowda, Merim Dzaferagic, Marco Ruffini

155. [Towards Root Memories: Benchmarking and Enhancing Implicit Logical Memory Retrieval for Personalized LLMs](#link155)
**Authors:** Hongxun Ding, Xiang Yu, Chengbing Wang, Jianfei Xiao, Keqin Bao, Wenjie Wang, Xiangnan He

156. [Factored Gossip DiLoCo: Reducing Blocking Communication in DiLoCo](#link156)
...
157. [Orthogonal Representation Editing: Decoupling Semantic Entanglement in Batch Knowledge Editing of LLMs](#link157)
**Authors:** Wenhao Yu, Zhicong Lu, Bo Lv, Fangyin Ma, Kaiwen Wei, Shihao Yang, Nayu Liu

158. [LangMAP: A Language-Adaptive Approach to Tokenization](#link158)
**Authors:** Clara Meister, Suchir Salhan, Andrzej Szablewski, Pietro Lesci, Paula Buttery, Tiago Pimentel

159. [Closed-loop Auto Research for Molecular Property Prediction: Discovering and Certifying Generalizable Improvements](#link159)
**Authors:** Jingjie Ning, Xiaochuan Li, Ji Zeng, Chenyan Xiong, Guolin Ke

160. [Encoder-Decoder Manifold Alignment for Idempotent Generation](#link160)
**Authors:** Dareen Alharthi, Abdul Waheed, Bhiksha Raj

161. [RLM-Cascade: Response-Level Speculative Decoding for Cost-Efficient LLM API Serving](#link161)
**Authors:** Haifeng Wu, Srinivasan Manoharan, Fangbo Tu, Junhua Zhao, Jian Wan

162. [Don't Blindly Trust It: How Unreliable Feedback Breaks Tool-Using LLM Agents](#link162)
**Authors:** Chubin Zhang, Zhenglin Wan, Xingrui Yu, Pengfei Zhou, Wangbo Zhao, Jingxuan Wu, Yaxin Zhou, Ivor Tsang

163. [Agent Behavior Mining: Generative AI Agent Governance in Business Processes](#link163)
**Authors:** Hoang Vu, Maximilian K\"orner, Adrian Rebmann, Gabriel Kevorkian, Michael Perscheid, Gregor Berg, Timotheus Kampik

164. [Post-Training Recipe, More Than Model Family, Shapes Multi-Agent LLM Conversational Behavior](#link164)
**Authors:** Luyang Zhang, Jialu Wang, Fei Xue, Yi-Yun Chu

165. [Causal Discovery in the Era of Agents](#link165)
**Authors:** Yujia Zheng, Vishal Verma, Mantej Gill, Haoyue Dai, Peter Spirtes, Kun Zhang

166. [Confident but Conflicted: Internal Uncertainty and Cognitive Dissonance Resolution in LLMs](#link166)
**Authors:** Weihong Qi, Kristina Lerman

167. [How Should Agents Read Demonstrations? Hierarchical Structure Beats Flat Action Logs](#link167)
**Authors:** Honjar Xing, Jefferson Lin, Henry Lieberman

168. [Learning Process Rewards via Success Visitation Matching for Efficient RL](#link168)
**Authors:** Raymond Tsao, Andrew Wagenmaker, Sergey Levine

169. [From Question Answering to Task Completion: A Survey on Agent System and Harness Design](#link169)
...
170. [Fara-1.5: Scalable Learning Environments for Computer Use Agents](#link170)
