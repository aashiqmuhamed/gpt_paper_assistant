...
Total relevant papers: 116

Paper selection prompt and criteria at the bottom

Table of contents with paper titles:

0. [On the Relationship Between Activation Outliers and Feature Death in Sparse Autoencoders](#link0)
**Authors:** Elana Simon, Etowah Adams, James Zou

1. [Toward Identifiable Sparse Autoencoders](#link1)
**Authors:** Walter Nelson, Theofanis Karaletsos, Francesco Locatello

2. [Spectral Reach: Understanding Neural Scaling as Progress into the Spectral Tail](#link2)
**Authors:** Konstantin Nikolaou, Jonas Scheunemann, Sven Krippendorf, Samuel Tovey, Christian Holm

3. [De-attribute to Forget for LLM Unlearning](#link3)
**Authors:** Xinyang Lu, Jiabao Pan, Rachael Hwee Ling Sim, See-Kiong Ng, Anthony Kum Hoe Tung, Bryan Kian Hsiang Low

4. [MAAT: Multi-phase Adapter-Aware Targeted Unlearning](#link4)
**Authors:** Suryash Yagnik, Shubham Gaur, Saksham Thakur, Vinija Jain, Aman Chadha, Amitava Das

5. [Discovering a Zeta Map Algorithm on Dyck Paths via Mechanistic Interpretability](#link5)
**Authors:** Xiaoyu Huang, Blake Jackson, Kyu-Hwan Lee

6. [Emergent Languages in Populations of Language Model Agents: From Token Efficiency to Oversight Evasion](#link6)
**Authors:** Stine Lyngs{\o} Beltoft, William Brach, Federico Torrielli, Jacob Nielsen, Annemette Brok Pirchert, Filippo Tonini, Peter Schneider-Kamp, Lukas Galke Poech

7. [Assign and Add: A Mechanistic Study of Compositional Arithmetic](#link7)
**Authors:** Brady Exoo, Alberto Bietti, John Sous

8. [DRIFT: Decoupled Rollouts and Importance-Weighted Fine-Tuning for Efficient Multi-Turn Optimization](#link8)
**Authors:** Jian Mu, Tianyi Lin, Chengwei Qin, Zhongxiang Dai, Yao Shu

9. [PReMISE: Policy Rubrics as Measurement Specifications for LLM Judges](#link9)
...
10. [The Flip Side of RLHF: On-Policy Feedback for Reward Model Self-Supervised Improvement](#link10)
**Authors:** Xiaobo Wang, Tong Wu, Min Tang, Jiaqi Li, Qi Liu, Zilong Zheng

11. [Efficient Diffusion LLMs via Temporal-Spatial Parallel Decoding and Confidence Extrapolation](#link11)
**Authors:** Zekai Li, Ji Liu, Yiqing Huang, Ziqiong Liu, Dong Li, Emad Barsoum

12. [Auditing LLM Benchmarks with Item Response Theory](#link12)
**Authors:** Sander Land, Daniel M. Bikel

13. [Cognitive Fatigue in Autoregressive Transformers: Formalization and Measurement](#link13)
**Authors:** Riju Marwah, Ritvik Garimella, Vishal Pallagani, Atishay Jain, Michael Stewart, Amit Sheth

14. [Smaller Models are Natural Explorers for Policy-Level Diversity in GRPO](#link14)
...
15. [Federated Variational Preference Alignment with Gumbel-Softmax Prior for Personalized User Preferences](#link15)
**Authors:** Jabin Koo, Hoyoung Kim, Minwoo Jang, Jungseul Ok

16. [Forgetting Has Neighbors: Localized Collateral Forgetting in Machine Unlearning](#link16)
**Authors:** Polina Dolgova, Sebastian U. Stich

17. [LongTraceRL: Learning Long-Context Reasoning from Search Agent Trajectories with Rubric Rewards](#link17)
**Authors:** Nianyi Lin, Jiajie Zhang, Lei Hou, Juanzi Li

18. [Measuring, Localizing, and Ablating Alignment Signatures in LLMs](#link18)
**Authors:** Aniket Anand, Janvijay Singh, Zhewei Sun, Dilek Hakkani-T\"ur, Nick Feamster

19. [Steering LLMs? Actually, Sparse Autoencoders can outperform simple baselines](#link19)
**Authors:** Mikkel Godsk J{\o}rgensen, Lars Kai Hansen

20. [LinTree: Improving LLM Reasoning with Explicitly Structured Search Histories](#link20)
**Authors:** Liwei Kang, Yee Whye Teh, Wee Sun Lee

21. [What Gets Unmasked First? Trajectory Analysis of Diffusion Models for Graph-to-Text Generation](#link21)
**Authors:** Qing Wang, Jacob Devasier, Chengkai Li

22. [AMNESIA: A Large Scale Medical Unlearning Benchmark Suite with Disease-Informed Analysis](#link22)
**Authors:** Saeedeh Davoudi, Reihaneh Iranmanesh, Ophir Frieder, Nazli Goharian

23. [idSCD: Identifying Training Datasets through Semantic Correlation Descriptors](#link23)
**Authors:** Andrada Gobeaja, Ionut Hodoroaga, Elena Burceanu, Marius Leordeanu

24. [Positional versus Symbolic Attention Heads: Learning Dynamics, RoPE Geometry, and Length Generalization](#link24)
**Authors:** Felipe Urrutia, Juan Jos\'e Alegr\'ia, Cinthia Sanchez Macias, Jorge Salas, Cristian B. Calderon, Cristobal Rojas

25. [SLAT: Segment-Level Adaptive Trimming for Efficient CoT Reasoning](#link25)
**Authors:** Jian Yao, Xiongcai Luo, Ran Cheng, Kay Chen Tan

26. [Not All Synthetic Data Is Yours to Learn From](#link26)
**Authors:** Sina Alemohammad, Li Chen, Richard G. Baraniuk, Zhangyang Wang

27. [ConsisGuard: Aligning Safety Deliberation with Policy Enforcement in LLM Guardrails](#link27)
...
28. [Evaluating using Mock Tool Calls to Quarantine Untrusted Prompt Inputs](#link28)
**Authors:** David Gros, Adam Gleave

29. [Generating and Refining Dynamic Evaluation Rubrics for LLM-as-a-Judge](#link29)
**Authors:** Zijie Wang, Eduardo Blanco

30. [MADS: Model-Aware Diverse Core Set Selection for Instruction Tuning](#link30)
**Authors:** Yi Bai, Wenhao Zhang, Yao Chen, Jiao Xue, Zhumin Chen, Pengjie Ren

31. [AdaptR1: Reinforcement Learning Based Adaptive Interleaved Thinking in Multi-hop Question Answering](#link31)
**Authors:** Yuxin Wang, Jiahao Lu, Qifeng Wu, Shicheng Fang, Chuanyuan Tan, Yining Zheng, Xuanjing Huang, Xipeng Qiu

32. [SCOPE: Self-Play via Co-Evolving Policies for Open-Ended Tasks](#link32)
**Authors:** Wai-Chung Kwan, Aryo Pradipta Gema, Joshua Ong Jun Leang, Pasquale Minervini

33. [Welfare, Improvability, and Variance: A Principal-Agent Approach to Optimal Benchmark Item Aggregation](#link33)
**Authors:** Andreas Haupt, Justin Hartenstein, Anka Reuel, Mykel Kochenderfer, Sanmi Koyejo

34. [Eigenvectors of Experts are Training-free Non-collapsing Routers](#link34)
**Authors:** Giang Do, Hung Le, Truyen Tran

35. [VeriGate: Verifier-Gated Step-Level Supervision for GRPO](#link35)
**Authors:** Aakriti Agrawal, Minghui Liu, Furong Huang

36. [Representation Collapse in Sequential Post-Training of Large Language Models](#link36)
**Authors:** Yichen Liu, Mingyu Chen, Hao Wang, Xiaoran Xu, Chenxi Lin, Rui Zhang, Yutong Zhou, Yuxin Yang, Jiarui Wu, Wei Sun

37. [Consolidating Rewarded Perturbations for LLM Post-Training](#link37)
**Authors:** Zheyu Zhang, Shuo Yang, Gjergji Kasneci

38. [Configurable Reward Model for Balanced Safety Alignment](#link38)
...
39. [The Latin Substrate: How Language Models Represent and Mediate Script Choice](#link39)
**Authors:** Daniil Gurgurov, Alan Saji, Katharina Trinley, Josef van Genabith, Simon Ostermann

40. [Interpretability Without Tradeoffs: Disentangling Polysemanticity At Equal Predictive Performance](#link40)
**Authors:** Do\u{g}ukan Ba\u{g}c{\i}, Bernt Schiele, Simone Schaub-Meyer, Jonas Fischer, Robin Hesse

41. [Towards Efficient LLMs Annealing with Principled Sample Selection](#link41)
**Authors:** Yuanjian Xu, Jianing Hao, Wanbo Zhang, Zhong Li, Guang Zhang

42. [dMoE: dLLMs with Learnable Block Experts](#link42)
**Authors:** Sicheng Feng, Zigeng Chen, Gongfan Fang, Xinyin Ma, Xinchao Wang

43. [Neuron-Level Interventions for Gendered and Gender-Neutral Generation in Language Models](#link43)
**Authors:** Zhiwen You, Nafiseh Nikeghbal, Jana Diesner

44. [Unlocking Fine-Grained Translation Quality Estimation in LRMs through Synergistically Evolving Implicit and Explicit Reasoning](#link44)
**Authors:** Renfei Dang, Xinye Wang, Zhejian Lai, Weilu Xu, Shimin Tao, Daimeng Wei, Min Zhang, Shujian Huang

45. [D$^3$: Dynamic Directional Graph-Constrained Data Scheduling for LLM Training](#link45)
**Authors:** Yuanjian Xu, Jianing Hao, Guang Zhang, Zhong Li

46. [Scaling Multi-Hop Training Data via Graph-Constrained Path Selection](#link46)
**Authors:** Pengyu Chen, Yonggang Zhang, Mingming Chen, Jun Song, Wei Xue, Yike Guo

47. [Counterfactual Evaluation Reveals Hidden Capability Profiles in Clinical LLMs and Agents](#link47)
**Authors:** Matt Turk

48. [Your Teacher Can't Help You Here: Combating Supervision Fidelity Decay in On-Policy Distillation](#link48)
**Authors:** Yanjiang Liu, Jie Lou, Xinyan Guan, Yuqiu Ji, Hongyu Lin, Ben He, Xianpei Han, Le Sun, Xing Yu, Yaojie Lu

49. [Are Full Rollouts Necessary for On-Policy Distillation?](#link49)
...
50. [Preference-Aware Rubric Learning for Personalized Evaluation](#link50)
...
51. [Human-Alignment, Calibration, and Activation Patterns in Large Language Model Uncertainty](#link51)
**Authors:** Kyle Moore, Jesse Roberts, Daryl Watson, William Ward, Grayson Heyboer

52. [Fine-Tuning Improves Information Conveyance in Language Models](#link52)
**Authors:** Yuwei Cheng, Weiyi Tian, Haifeng Xu

53. [EchoRL: Reinforcement Learning via Rollout Echoing](#link53)
...
54. [EUDAIMONIA: Evaluating Undesirable Dynamics in AI](#link54)
**Authors:** Jun Rui Huang, Wang Bill Zhu, Ziyi Liu, Nathanael Fast, Ravi Iyer, Robin Jia

55. [MosaicLeaks:Privacy Risks in Querying-in-the-Open for Deep Research Agents](#link55)
**Authors:** Alexander Gurung, Spandana Gella, Alexandre Drouin, Issam H. Laradji, Perouz Taslakian, Rafael Pardinas

56. [Conformal Reliability: A New Evaluation Metric for Conditional Generation](#link56)
**Authors:** Yachen Gao, Xinwei Sun, Yikai Wang, Ye Shi, Jingya Wang, Jianfeng Feng, Yanwei Fu

57. [COMPASS: Cognitive MCTS-Guided Process Alignment for Safe Search Agents](#link57)
**Authors:** Wenkai Shen, Pengyang Zhou, Jiahe Xu, Jiaming Qian, Haozhe He, Zhihao Huang, Chaochao Chen, Xiaolin Zheng

58. [Toxic HallucinAItions: Perturbing Prompts and Tracing LLM Circuits](#link58)
...
59. [Combinatorial Synthesis: Scaling Code RLVR via Atomic Decomposition and Recombination](#link59)
**Authors:** Jiasheng Zheng, Boxi Cao, Boxi Yu, Yuzhong Zhang, Jialun Cao, Yaojie Lu, Hongyu Lin, Xianpei Han, Le Sun

60. [DARTS: Distribution-Aware Active Rollout Trajectory Shaping for Accelerating LLM Reinforcement Learning](#link60)
**Authors:** Yujie Wang, Siwei Chen, Longzan Luo, Xinyi Liu, Xupeng Miao, Fangcheng Fu, Bin Cui

61. [Fixed-Point Masked Generative Modeling](#link61)
**Authors:** Andrea Miele, Yiming Qin, Alba Carballo-Castro, Justin Deschenaux, Pascal Frossard

62. [Calibrated Preference Learning: The Case of Label Ranking](#link62)
**Authors:** Santo M. A. R. Thies, Viktor Bengs, Timo Kaufmann, Sebastian J. Vollmer, Eyke H\"ullermeier

63. [Diffusion Models Preferentially Memorize Prototypical Examples or: Why Does My Diffusion Model Love Slop?](#link63)
**Authors:** Marta Aparicio Rodriguez, Anastasia Borovykh, Grigorios A. Pavliotis, Daniel J. Korchinski

64. [COFT: Counterfactual-Conformal Decoding for Fair Chain-of-Thought Reasoning in Large Language Models](#link64)
**Authors:** Arya Fayyazi, Mehdi Kamal, Massoud Pedram

65. [Exploring Autonomous Agentic Data Engineering for Model Specialization](#link65)
...
66. [LLM Judges Inconsistently Disagree Across Safety Criteria and Harm Categories](#link66)
**Authors:** Krishnapriya Vishnubhotla, Soumya Vajjala, Akriti Vij, Isar Nejadgholi

67. [Diversity Matters: Revisiting Test-Time Compute in Vision-Language Models](#link67)
**Authors:** Yijie Tong, Yifan Hou, Shaobo Cui, Antoine Bosselut, Mrinmaya Sachan

68. [Planner-Centric Reinforcement Learning for Deep Research with Structure-Aware Reward](#link68)
**Authors:** Mustafa Anis Hussain, Xinle Wu, Yao Lu

69. [Learning Agent-Compatible Context Management for Long-Horizon Tasks](#link69)
**Authors:** Lu Yi, Runlin Lei, Liuyi Yao, Yuexiang Xie, Yuyang Li, Wenhao Zhang, Zhewei Wei, Yaliang Li, Jian-Yun Nie

70. [Harness Updating Is Not Harness Benefit: Disentangling Evolution Capabilities in Self-Evolving LLM Agents](#link70)
...
71. [Unlearning in Diffusion Models: A Unified Framework with KL Divergence and Likelihood Constraints](#link71)
**Authors:** Shervin Khalafi, Alejandro Ribeiro, Dongsheng Ding

72. [Fixed Universal Transformers](#link72)
**Authors:** Jingwen Liu, Alexandr Andoni, Daniel Hsu

73. [Counterfactual Graph for Multi-Agent LLM Calibration](#link73)
**Authors:** Jiatan Huang, Mingchen Li, Ziming Li, Sunjae Kwon, Hong Yu, Chuxu Zhang

74. [KnowledgeGain: Evaluating and Optimizing Science News Generation for Reader Learning](#link74)
**Authors:** Dominik So\'os, Meng Jiang, Jian Wu

75. [TraceGraph: Shared Decision Landscapes for Diagnosing and Improving Agent Trajectories](#link75)
**Authors:** Junjie Nian, Kang Chen, Ge Zhang, Yixin Cao, Yugang Jiang

76. [ExpGraph: Model-Agnostic Experience Learning with Graph-Structured Memory for LLM Agents](#link76)
...
77. [Self-Certifying Transport MCMC via Dual Spectral-Gap Certificates](#link77)
**Authors:** Jun Hu

78. [Skill is Not One-Size-Fits-All: Model-Aware Skill Alignment for LLM Agents](#link78)
**Authors:** Jianxiang Yu, Jiapeng Zhu, Bochen Lin, Qier Cui, Zichen Ding, Xiang Li

79. [UniScale: Adaptive Unified Inference Scaling via Online Joint Optimization of Model Routing and Test-Time Scaling](#link79)
**Authors:** Kaiyu Huang, Xingyu Wang, Mingze Kong, Zhubo Shi, Yuqian Hou, Hong Xu, Zhongxiang Dai, Minchen Yu, Qingjiang Shi

80. [The Sword, Shield, and Achilles' Heel: Characterizing the Linguistic Inductive Bias of Large Language Models for Spatial Reasoning in Navigation Planning](#link80)
**Authors:** Xudong Zhang, Jian Yang, Shengkai Wang, Jiangpeng Tian, Shaowen Chen, Xian Wei, Ke Li, Xiong You

81. [ElasticMem: Latent Memory as a Learnable Resource for LLM Agents](#link81)
**Authors:** Tao Feng, Chongrui Ye, Tianyang Luo, Jingjun Xu, Xueqiang Xu, Haozhen Zhang, Ge Liu, Jiaxuan You

82. [Value Functions as Supermartingale Certificates](#link82)
**Authors:** Alessandro Abate, Daniel Contro, Mirco Giacobbe, Agust\'in Mart\'inez-Su\~n\'e, Diptarko Roy

83. [Trust-Region Behavior Blending for On-Policy Distillation](#link83)
...
84. [Incremental BPE Tokenization](#link84)
**Authors:** Shenghu Jiang, Ruihao Gong

85. [When are LLMs Sufficient Policy Optimizers for Sequential RL Tasks?](#link85)
**Authors:** Stephane Hatgis-Kessell, Emma Brunskill

86. [TSM-Bench: Detecting LLM-Generated Text in Real-World Wikipedia Editing Practices](#link86)
**Authors:** Gerrit Quaremba, Elizabeth Black, Denny Vrande\v{c}i\'c, Elena Simperl

87. [Convergence of Steepest Descent and Adam under Non-Uniform Smoothness](#link87)
**Authors:** Sharan Vaswani, Yifan Sun, Reza Babanezhad

88. [Speculative Pipeline Decoding: Higher-Accruacy and Zero-Bubble Speculation via Pipeline Parallelism](#link88)
**Authors:** Yijiong Yu, Huazheng Wang, Shuai Yuan, Ruilong Ren, Ji Pei

89. [Revisiting Padded Transformer Expressivity: Which Architectural Choices Matter and Which Don't](#link89)
**Authors:** Anej Svete, William Merrill, Ryan Cotterell, Ashish Sabharwal

90. [Improving Selective Classification with Pairwise Queries for Binary Classification](#link90)
**Authors:** Harsh Vardhan, Sunav Choudhary, Natwar Modani, Arya Mazumdar

91. [A Unified Framework for Gradient Aggregation in Multi-Objective Optimization](#link91)
**Authors:** Zeou Hu, Kelvin Ho, Yaoliang Yu

92. [Language Models Learn Constructional Semantics, Not To Mention Syntax: Investigating LM Understanding of Paired-Focus Constructions](#link92)
**Authors:** Wesley Scivetti, Ethan Wilcox, Nathan Schneider, Kanishka Misra, Leonie Weissweiler

93. [Trading Complexity for Expressivity Through Structured Generalized Linear Token Mixing](#link93)
**Authors:** Erwan Fagnou, Paul Caillon, Blaise Delattre, Alexandre Allauzen

94. [Revisiting Zeroth-Order Hessian Approximation: A Single-Step Policy Optimization Lens](#link94)
**Authors:** Junbin Qiu, Zhaowei Hong, Renzhe Xu, Yao Shu

95. [TRACE: Discovering Task-Specific Parameter via Adaptation-Aware Probing for Continual Fine-Tuning](#link95)
...
96. [A Visually Impaired Assistance Benchmark for VLM-as-a-Judge Evaluation](#link96)
**Authors:** Yi Zhao, Siqi Wang, Zhe Hu, Yushi Li, Jing Li

97. [Disagreeing Rationales: Rethinking Classification and Explainability Evaluation in Hate Speech Detection](#link97)
**Authors:** Benedetta Muscato, Beiduo Chen, Gizem Gezici, Barbara Plank, Fosca Giannotti

98. [Do Large Language Models Encode Institutional Experience? Evidence from Cross-Linguistic Moral Reasoning Under Ambiguity](#link98)
**Authors:** Nattavudh Powdthavee

99. [On the Robustness of Multilingual Text Embedding Rankings Across Learning Tasks, Languages, and Benchmark Datasets](#link99)
**Authors:** Ana Gjorgjevikj, Barbara Korou\v{s}i\'c Seljak, Tome Eftimov

100. [Retriever Portfolios: A Principled Approach to Adaptive RAG](#link100)
**Authors:** Miltiadis Stouras, Vincent Cohen-Addad, Silvio Lattanzi, Ola Svensson

101. [SAGE: A Novelty Gate for Efficient Memory Evolution in Agentic LLMs](#link101)
**Authors:** Sijia Wang, Dhanajit Brahma, Ricardo Henao

102. [BilliardPhys-Bench: Benchmarking Physical Reasoning and Visual Dynamics of Multimodal LLMs](#link102)
**Authors:** Ben Wang, Xiaogang Li, Ruochen Gao, Peiyao Xiao, Chengliang Xu, Zeyu Wang, Zichao Chen, Bing Zhao, Hu Wei

103. [GRKV: Global Regression for Training-Free KV Cache Compression in Long-Context LLMs](#link103)
**Authors:** Junjie Peng, You Wu, Haoyi Wu, Jialong Han, Xiaohua Xie, Kewei Tu, Jianhuang Lai

104. [Algorithmic Recourse of In-Context Learning for Tabular Data](#link104)
**Authors:** Wenshuo Dong, Jiaming Zhang, Shaopneg Fu, Hongbin Lin, Di Wang, Lijie Hu

105. [Skill Availability and Presentation Granularity in Large-Language-Model Agents: A Controlled SkillsBench Study](#link105)
**Authors:** Xiaonan Xu, Wenjing Wu

106. [CoMem: Context Management with A Decoupled Long-Context Model](#link106)
