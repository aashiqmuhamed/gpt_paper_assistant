...
0. [Weak-to-Strong Generalization via Direct On-Policy Distillation](#link0)
...
1. [What Does a Discrete Diffusion Model Learn?](#link1)
**Authors:** Rodrigo Casado Noguerales, Bernhard Sch\"olkopf, Thomas Hofmann, Aran Raoufi

2. [Unbiased Alignment for Large Language Models with Noisy Preferences](#link2)
**Authors:** Jialiang Wang, Xianming Liu, Xiong Zhou, Hui Liu, Haoliang Li

3. [Turning Off-Policy Tokens On-Policy: A Plug-in Approach for Improving LLM Alignment](#link3)
**Authors:** Yu Li, Xiuyu Li, Mingyang Yi, Jiaxing Wang, zhangliangxu, Zhaolong Xing, Zhen Chen

4. [Spectral Rewiring for Exploration, Purification, and Model Merging](#link4)
**Authors:** Zhilong Zhang, Hongli Yu, Huan-ang Gao, Hanlin Wu, Yuxuan Song, Wei-Ying Ma, Ya-Qin Zhang, Hao Zhou

5. [One Framework for All: Cross-Modal Membership Inference for Generative Models](#link5)
**Authors:** Dayong Ye, Tainqing Zhu, Kun Gao, Junhao Liu, Yichuan Chen, Shuai Zhou, Hengzhu Liu, Bo Liu, Wanlei Zhou

6. [LLM-as-a-Verifier: A General-Purpose Verification Framework](#link6)
...
7. [Mixture-of-Gaussians-Guided Schedule Design for Brownian Bridge Diffusion Models](#link7)
**Authors:** Ron Levi, Michael Elad

8. [Oyster-II: Reinforcement Learning for Constructive Safety Alignment in Large Language Models](#link8)
**Authors:** Jiyang Guan, Yong Xie, Jun Chen, Jiexi Liu, Zipeng Ye, Defeng Li, Jiayu Shen, Jialing Tao, Hui Xue

9. [Governed Individuation: Cryptographically Decoupling an Agent's Learning from Its Authority](#link9)
**Authors:** Xue Qin, Simin Luan, Cong Yang, Zhijun Li

10. [Asymptotic-Preserving A Posteriori Analysis of Diffusion and Flow-Matching Samplers](#link10)
**Authors:** Shiheng Zhang

11. [Best-of-Better-$N$: Generating Pre-Aligned Responses with In-Context Learning](#link11)
**Authors:** Eric Lei, Hsiang Hsu, Chun-Fu Chen

12. [Improving LLMs via Validator-to-Generator Alignment](#link12)
**Authors:** Juan Diego Rodriguez, Jocelyn Zhang, Katrin Erk, Greg Durrett

13. [LP-SFT: Local-Preserving Supervised Fine-Tuning via Multimodal Entropy Structure](#link13)
**Authors:** Yueyang Wang, Baolong Bi, Shuo Lu, Jingyuan Zhang

14. [Legible-by-Construction: Attention and End-to-End Transformers](#link14)
**Authors:** Mark Oskin

15. [Reward-Gated On-Policy Distillation](#link15)
**Authors:** Mohammad Sadegh Akhondzadeh, Vijay Lingam, Atula Tejaswi, Chanakya Ekbote, Sujay Sanghavi, Aleksandar Bojchevski

16. [TACG: Trajectory-Aware Commit Gating for Diffusion Language Model Decoding](#link16)
**Authors:** Chengcheng Wang, Tingzhang Luo, Wenhao Li, Jianyuan Guo, Chang Xu

17. [Rethinking On-Policy Self-Distillation for Thinking Models](#link17)
**Authors:** Simran Kaur, Narutatsu Ri, Yinghui He, Liam Fowl, Sanjeev Arora

18. [Agent Reinforcement Learning via Pivotal-Aware Self-Feedback Retry](#link18)
**Authors:** Weiyang Guo, Zesheng Shi, Longhui Zhang, Zeen Zhu, Min Zhang, Jing Li

19. [Induction Heads Interpolate N-Grams](#link19)
**Authors:** Francesco D'Angelo, Oguz Kaan Yuksel, Swathi Shree Narashiman, Nicolas Flammarion

20. [Tensor-Train Joint Modeling for Few-Step Discrete Diffusion](#link20)
**Authors:** Byoungkwon Kim, Minhyuk Sung

21. [AgentGym2: Benchmarking Large Language Model Agents in De-Idealized Real-World Environments](#link21)
...
22. [Knowledge Knows, Verbalization Tells: Disentangling Latent Directions for Mathematical Solvability in LLMs](#link22)
**Authors:** Nikolaos Xiros, Maria-Eleni Zoumpoulidi, Georgios Paraskevopoulos

23. [LLM-as-a-Tutor: Policy-Aware Prompt Adaptation for Non-Verifiable RL](#link23)
...
24. [ACPO: Adaptive Credit Policy Optimization via Fine-Grained Surrogate Entropy](#link24)
**Authors:** Zijun Xie, Yuyang You, Yongzhi Li, Enlei Gong, Zeyu Chen, Quan Chen, Yanhua Cheng, Peng Jiang, Yadong Mu

25. [On the effectiveness of reward functions in reinforcement learning for confidence calibration of large language models](#link25)
**Authors:** Chee Heng Tan, Zhuoyi Lin, Mehul Motani, Wee Sun Lee

26. [No Time Like the Present: Agentic Test-Time Training for LLM Agents](#link26)
**Authors:** Yanbo Wang, Jinhua Hao, Yuze Shi, Kun Yuan, Ming Sun

27. [MechMath Agent Team: LLM Driven Agents for Mathematical Research](#link27)
**Authors:** Yichuan Cao, Ruichen Qiu, Junqi Liu, Jiaqi Wang, Dakai Guo, Ruyong Feng, Lihong Zhi, Xiao-Shan Gao

28. [Evaluating LLM Uncertainty in Long-Form Generation Using Deterministic Ground Truth](#link28)
**Authors:** Ido Amit, Ido Galil, Ran El-Yaniv

29. [CollabEval: Statistically Efficient Collaborative Model Evaluation via Matrix Completion](#link29)
...
30. [CARL: Constraint-Aware Reinforcement Learning for Planning with LLMs](#link30)
...
31. [Reason, Reward, Refine: Step-Level Errors Corrections with Structured Feedback for Physics Reasoning in Small Language Models](#link31)
**Authors:** Raj Jaiswal, Dhruv Jain, Rishabh Dhawan, Sree Krishna Uppalapati, Shin'ichi Satoh, Tanuja Ganu, Rajiv Ratn Shah

32. [CompactionRL: Reinforcement Learning with Context Compaction for Long-Horizon Agents](#link32)
**Authors:** Yujiang Li, Zhenyu Hou, Yi Jing, Jie Tang, Yuxiao Dong

33. [Detecting Answer-Driven Reasoning in LLM-Based Educational Tutors via Truncated Chain-of-Thought Auditing](#link33)
**Authors:** Bonan Shen, Dingyan Shang, Youting Wang, Tao Ning

34. [STAPO: Selective Trajectory-Aware Policy Optimization for LLM Agent Training](#link34)
...
35. [Unsupervised Features Mining via Activation Geometry](#link35)
**Authors:** Amit LeVi, Elad David, Max Fomin

36. [Wrong Before Right: Late Rescue and Interface Failure in Aligned Language Models](#link36)
**Authors:** Jiaqi Deng

37. [Noisy-Channel Minimum Bayes Risk Decoding](#link37)
**Authors:** Yusuke Sakai, Hidetaka Kamigaito, Taro Watanabe

38. [Spinning Straw into Gold: Relabeling LLM Agent Trajectories in Hindsight for Successful Demonstrations](#link38)
**Authors:** Zichao Li, Gang Wu, Zichao Wang, Ruiyi Zhang, Wanrong Zhu, Ryan A. Rossi, Vlad I Morariu, Jihyung Kil

39. [MANCE: Manifold Aware Concept Erasure](#link39)
**Authors:** Matan Avitan, Yoav Goldberg, Yanai Elazar

40. [NormWorlds-CF: Solver-Verified Counterfactual Normative Reasoning with Metamorphic-Relation GRPO](#link40)
**Authors:** Xinqi Zhang

41. [Statistically Meaningful Geometry (SMG) Beyond the Euclidean Paradigm, with Application to Generative AI](#link41)
**Authors:** Bing Cheng, Yi-Shuai Niu, Howell Tong, Shing-Tung Yau

42. [TREK: Distill to Explore, Reinforce to Refine](#link42)
...
43. [SHiPPO: Recurrent Memory with Transported Polynomial Projections](#link43)
**Authors:** Tomoya Mizuguchi, Bum Jun Kim

44. [EdgeBench: Unveiling Scaling Laws of Learning from Real-World Environments](#link44)
...
45. [Teacher Supervision over Representation Equivalence Classes](#link45)
**Authors:** Sang Il Han

46. [Hierarchical Sparse Attention Done Right: Toward Infinite Context Modeling](#link46)
...
47. [Multi-Turn On-Policy Distillation with Prefix Replay](#link47)
**Authors:** Baohao Liao, Hanze Dong, Christof Monz, Xinxing Xu, Li Dong, Furu Wei

48. [Aligning Language Models with Selective Prediction](#link48)
**Authors:** Gaoxiang Luo, Yifan Wu, Sinian Zhang, Aryan Deshwal, Ju Sun

49. [Localized LoRA-MoE: Block-wise Low-Rank Experts With Adaptive Routing](#link49)
**Authors:** Babak Barazandeh, Subhabrata Majumdar, Vinay Prithyani, George Michailidis

50. [Shortcut Learning in Legal Judgment Prediction: Empirical Evidence from the UK Employment Tribunal](#link50)
**Authors:** Joe Watson, Joana Ribeiro de Faria, Marcus Tomalin, M{\aa}ns Magnusson, Huiyuan Xie, Hao Tian Yeung, Felix Steffek

51. [Safe Inference-Time Alignment via Lagrangian Reward Augmentation](#link51)
**Authors:** Yaswanth Chittepu, Ativ Joshi, Sohini Chintala, Scott Niekum

52. [RSPO: Reward-Swap Policy Optimization for Multi-Turn LLM Agents](#link52)
**Authors:** Qiang Liu, Taian Guo, Ruizhi Qiao, Xing Sun

53. [Distill Where the Student Goes: Teacher-Regularized RL for English-Evidence Cross-Lingual RAG](#link53)
**Authors:** Haotian Zhou, Weiran Huang, Siqi Liu, Xiting Wang, Xin Zhang, Zhihao Wen

54. [Pretraining Curricula Enable Selective Fine-tuning](#link54)
**Authors:** Sebastian A. Bruijns, Jirko Rubruck, Mia H. Whitefield, Kai J. Sandbrink, Fazl Barez, Christopher Summerfield

55. [How to Avoid Debate: Scalable AI Safety via Doubly-Efficient Interactive Proofs](#link55)
**Authors:** Liyan Chen, Yael Tauman Kalai, Zoe Xi

56. [Fidelity-Diversity Metrics for Text](#link56)
**Authors:** Amanda Wang, Tudor Manole, Florentina Bunea, John Thickstun

57. [Out-of-Distribution Generalization of Risk Aversion in Language Models](#link57)
**Authors:** Kristina Zhang, Junior Chinomso Okoroafor, Benjamin Maltbie, Andrew Lin, Abhitej Bokka, Elliott Thornley

58. [RL Forgets! Towards Continual Policy Optimization](#link58)
**Authors:** Mao-Lin Luo, Zhe-Xu Wang, Zi-Hao Zhou, Bo Ye, Jian Zhao, Min-Ling Zhang, Tong Wei

59. [Latent Programming Horizons in Coding Agents](#link59)
**Authors:** Andr\'e Silva, Han Tu, Martin Monperrus

60. [Rethinking Neural Nonlinearity as Gating](#link60)
**Authors:** Muhammad Sabih, Frank Hannig, J\"urgen Teich

61. [Auditing the Audit: Five Failure Modes in Benchmark-Validity Audits](#link61)
**Authors:** Yanhang Li, Zhichao Fan, Zexin Zhuang

62. [MPSelectTune: Prompt-type Selection for Fine-tuning improves Concept Unlearning in LLMs](#link62)
...
63. [Rethinking AI-Generated Text Detection: A Strong Baseline and the Distribution-Shift Problem That Remains](#link63)
**Authors:** Zhuoer Shen, Mingyi Wang, Shaofeng Zou, Yuheng Bu

64. [Demonstrating Generalization Failures via Mixtures of Conditional Policies](#link64)
**Authors:** Jou Barzdukas, Jack Peck, Julian Schulz, Paulius Rauba, Steven Basart, Lennie Wells

65. [How Much is Left? LLMs Linearly Encode Their Remaining Output Length](#link65)
**Authors:** Mohamed Amine Merzouk, Dmitri Carpov, Mirko Bronzi, Damiano Fornasiere, Adam Oberman

66. [When Geometry Aligns: Dihedral Hidden-State Transformations in UNet, ViT, and DiT Architectures](#link66)
**Authors:** Mojtaba Faramarzi, Alex Lamb, Irina Rish

67. [Mechanism-level routing failure in LLMs over Lean-verified algebraic structures](#link67)
**Authors:** Manuel Israel C\'azares, Wenlin Zhang, Haobo Ma

68. [The Role of Rigor in Artificial Intelligence](#link68)
**Authors:** Timothy Nguyen

69. [Separating Representation from Reconstruction Enables Scalable Text Encoders](#link69)
**Authors:** Megi Dervishi, Mathurin Videau, Yann LeCun

70. [A Unified Framework for In-Context Learning with Causal and Masked Language Models](#link70)
**Authors:** Chenrui Liu, Chuanlong Xie, Falong Tan, Yicheng Zeng, Lixing Zhu

71. [Diffusion-Guided Uncertainty-Aware Delayed Policy Optimization](#link71)
**Authors:** Junqi Tu, Zejiao Liu, Fangfei Li, Yang Tang

72. [LACE-SVD: Loss-Aware SVD with Cumulative Error Correction for LLM Compression](#link72)
**Authors:** Zhuowen Liu, Longkun Hao, Shiyu Feng, Xiaowen Chang, Ruiqun Li, Changqun Li

73. [Less Tokens, Better Forecasts: Sparse Residual Routing for Efficient Weather Prediction](#link73)
**Authors:** Janet Wang, Yunbei Zhang, Lin Zhao, Xi Xiao, Jihun Hamm, Xiao Wang

74. [Train Smarter, Not Longer: Memorization-Guided Data Reuse for Efficient LLM Training](#link74)
...
75. [Mask-based Predictive Representations for Reinforcement Learning](#link75)
**Authors:** Kai Zhao

76. [Optimizing Large Language Models for Causality Assessment in Pharmacovigilance: Developing a Performance Metric as Objective for Bayesian Hyperparameter Optimization](#link76)
**Authors:** Nicole Sonne Heckmann, Arnault-Quentin Vermillet, S{\o}ren Norlin M{\o}lgaard, Manuela Del Castillo Suero, Lars Melskens, Gerard Ompad, Maurizio Sessa

77. [Failures and Successes to Learn a Core Conceptual Distinction from the Statistics of Language](#link77)
**Authors:** Zhimin Hu, Jeroen van Paridon, Gary Lupyan

78. [The Remarkable Effectiveness of Providing AI Agents with Natural Language Tools: A Replication Study Validating NLT Performance Across 14 Models](#link78)
**Authors:** Alexander Somma, Isabelle Plante, Fred Premji

79. [Can Model Merging Improve Aggregation in DiLoCo?](#link79)
**Authors:** Stefan Horoi, Benjamin Th\'erien, Guy Wolf, Eugene Belilovsky

80. [DSpark: Confidence-Scheduled Speculative Decoding with Semi-Autoregressive Generation](#link80)
...
81. [Rating the Pitch, Not the Product: User Evaluations of LLMs Reflect Expectations More Than Performance](#link81)
**Authors:** Robert Morabito, Tyler McDonald, Charitra Viswanath, Angel Hsing-Chi Hwang, Susanne Gaube, Jad Kabbara, Ali Emami

82. [Efficient Decentralized Multi-task Dataset Valuation via Model Merging](#link82)
**Authors:** Mohammadsajad Alipour, Mohammad Mohammadi Amiri

83. [Bridging Interleaved Multi-Modal Reasoning as a Unified Decision Process](#link83)
...
84. [Amortising Bayesian Experimental Design for Sequential Information Gathering in LLMs](#link84)
...
85. [ASK in the Dark: Uncertainty-Gated LLM Assistance under Partial Observability](#link85)
**Authors:** Juarez Monteiro, Nathan Gavenski, Guilherme Lima, Francisco Galuppo, Odinaldo Rodrigues, Adriano Veloso

86. [NKI-Agent: Domain-Specific Fine-Tuning and Agentic Tool Use for Neuron Kernel Generation](#link86)
**Authors:** Junjie Tang, Jun Huan, Hao Zhou, Yuhao Zhang, Lin Wang

87. [Hyperparameter Transfer in Graph Neural Networks](#link87)
**Authors:** Gage DeZoort, Boris Hanin

88. [Full-Stack FP4: Stable LLM Pretraining with Quantized Projections, Optimizers, and Attention](#link88)
**Authors:** Siyu Ding, Mingchuan Ma, Jiabo Tong, Xingrun Xing, Ziming Wang, Guoqi Li

89. [Spectral Signatures of Large Language Models](#link89)
**Authors:** Zhuoying Zhang, Ishan V. Prasad, Yuanzhe Hu, Zihang Liu, Hengrui Luo, Pu Ren, Yaoqing Yang

90. [FORGE: Research-Trajectory Hijacking Attacks on Deep Research Agents](#link90)
**Authors:** Yue Pan, Ziheng Zhang, Junxiang Lei, Changhao Jia, Qingyi Si, Hongcheng Guo

91. [Language Models Represent and Transform Concepts with Shared Geometry](#link91)
**Authors:** Zhimin Hu, Lanhao Niu, Sashank Varma

92. [Why Pure Reasoning is Not Enough: Nature as the Source of Mathematical Innovation](#link92)
**Authors:** Charanjit S. Jutla, Vimal Sharma

93. [Consistent but Miscalibrated: Evaluating LLM Limitations for Risk Communication in Natural Language](#link93)
**Authors:** Diego Cerda-Mardini, Sarath Chandar, Sreenath Madathil

94. [Decentralized Aggregation of LLM Predictions via Wagering Mechanisms](#link94)
**Authors:** Yuhong Luo, David M. Pennock, Xintong Wang

95. [The Map Behind the Flow: Finite-Step Gradient Descent as a Dynamical System](#link95)
**Authors:** Thomas Hofmann

96. [KVpop -- Key-Value Cache Compression with Predictive Online Pruning](#link96)
...
97. [Formal Disco: Scalable Open-Ended Generation of Formally Verified Programs](#link97)
**Authors:** Gabriel Poesia, Simon Henniger, Tzu-Han Hsu, Yilun Du, Nada Amin

98. [CausalGame: Benchmarking Causal Thinking of LLM Agents in Games](#link98)
**Authors:** Zhenhao Chen, Yongqiang Chen, Chenxi Liu, Junchi Yu, Xiangchen Song, Zijian Li, Jialin Li, Philip Torr, Bo Han, Kun Zhang

99. [SelfMem: Self-Optimizing Memory for AI Agents](#link99)
**Authors:** Shu Yang, Junchao Wu, Derek F. Wong, Di Wang

100. [PraMem: Practice-derived Experiential Memory for Long-horizon Behavior Prediction](#link100)
...
101. [Bootstrap Flow-Map Tree Sampling Enables Online Feedback Driven Search](#link101)
**Authors:** Binglin Ji, Anindya Sarkar, Hengchang Lu, Jens Sj\"olund, Yevgeniy Vorobeychik

102. [Reinforcement Learning for Evidence-Seeking Diagnostic Reasoning with Large Language Models](#link102)
**Authors:** Shengyi Hua, Kangzhe Hu, Conghui He, Xiaofan Zhang, Shaoting Zhang

103. [Can Dialects Be Steered Like Languages? Sparse Neurons and Distributed Directions in Arabic LLMs](#link103)
**Authors:** Kareem Elozeiri, Mervat Abassy, Omar Kallas, Fahim Dalvi, Preslav Nakov, Kentaro Inui, Nadir Durrani

104. [MentalThink: Shaping Thoughts in Mental SVG World](#link104)
...
105. [Punching Above Their Weight: Classification-Head Fine-Tuning of Tiny Language Models (TLMs) for Verifiable Multiple-Choice Tasks](#link105)
**Authors:** Bhavesh Sood, Jaromir Savelka

106. [FormalRx: Rectify and eXamine Semantic Failures in Autoformalization](#link106)
**Authors:** Haocheng Wang, Baiyu Huang, Yingjia Wan, Xiao Zhu, Xiaoyang Liu, Yinya Huang, Zhijiang Guo

107. [Validation-Induced Shapley Shifts: How Validation Structure Distorts Data Valuation](#link107)
**Authors:** Yinan Shen, Ziao Yang, Hongfu Liu

108. [Towards Diverse and Comprehensive Benchmarks for Mutual Information Estimation](#link108)
**Authors:** Alberto Foresti, Ivan Butakov, Alexander Tolmachev, Giulio Franzese, Alexey Frolov, Pietro Michiardi

109. [APeB: Benchmarking Personalization Ability of Large Language Model Agents](#link109)
...
110. [Regime-Conditional Stabilisation of LLM-Augmented Cooperative Multi-Agent Reinforcement Learning](#link110)
**Authors:** Faid Keddouri, Sohaib Houhou, Aissa Boulmerka, Nadir Farhi

111. [Nemotron-Labs-3-Puzzle-75B-A9B: Compressing Hybrid MoE LLMs](#link111)
...
112. [A Bayesian Framework for Evaluating Scenario Compatibility in Generative Population Synthesis](#link112)
**Authors:** Zhenlin Qin, Leizhen Wang, Yancheng Ling, Zhenliang Ma

113. [MetaSkill-Evolve: Recursive Self-Improvement of LLM Agents via Two-Timescale Meta-Skill Evolution](#link113)
**Authors:** Zefeng Wang, Minxi Yan, Jinhe Bi, Sikuan Yan, Volker Tresp, Yunpu Ma

114. [Co-Adaptive Multi-Task LoRA: Transfer-Aware, Label-Free Control of Domain Participation](#link114)
**Authors:** Wei Zhang, Lin Tang, Ming Zhao, Yuxuan Wang

115. [Don't Wait to Reply: Towards Responsive yet Thoughtful Dialogue through Proactive Thinking](#link115)
**Authors:** Ante Wang, Jiaqi Fu, Xuanyi Chen, Ruotian Ma, Zhaopeng Tu, Weizhi Ma, Yang Liu

116. [Where do LLMs Fall Short in CBT-Guided Affective Reasoning?](#link116)
...
117. [HAS-Bench: Evaluating LLM-Based Human-Agent Systems under Configurable Human Participation](#link117)
