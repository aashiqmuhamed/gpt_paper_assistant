...
Total relevant papers: 134

Paper selection prompt and criteria at the bottom

Table of contents with paper titles:

0. [LangFlow: Continuous Diffusion Rivals Discrete in Language Modeling](#link0)
**Authors:** Yuxin Chen, Chumeng Liang, Hangke Sui, Ruihan Guo, Chaoran Cheng, Jiaxuan You, Ge Liu

1. [Introspective Diffusion Language Models](#link1)
...
2. [Layerwise Dynamics for In-Context Classification in Transformers](#link2)
**Authors:** Patrick Lutz, Themistoklis Haris, Arjun Chandra, Aditya Gangrade, Venkatesh Saligrama

3. [A Mechanistic Analysis of Looped Reasoning Language Models](#link3)
...
4. [Latent Instruction Representation Alignment: defending against jailbreaks, backdoors and undesired knowledge in LLMs](#link4)
**Authors:** Eric Easley, Sebastian Farquhar

5. [A Tale of Two Temperatures: Simple, Efficient, and Diverse Sampling from Diffusion Language Models](#link5)
**Authors:** Theo X. Olausson, Metod Jazbec, Xi Wang, Armando Solar-Lezama, Christian A. Naesseth, Stephan Mandt, Eric Nalisnick

6. [Pando: Do Interpretability Methods Work When Models Won't Explain Themselves?](#link6)
**Authors:** Ziqian Zhong, Aashiq Muhamed, Mona T. Diab, Virginia Smith, Aditi Raghunathan

7. [Steered LLM Activations are Non-Surjective](#link7)
**Authors:** Aayush Mishra, Daniel Khashabi, Anqi Liu

8. [Tracing the Thought of a Grandmaster-level Chess-Playing Transformer](#link8)
...
9. [Tracing the Roots: A Multi-Agent Framework for Uncovering Data Lineage in Post-Training LLMs](#link9)
...
10. [FACT-E: Causality-Inspired Evaluation for Trustworthy Chain-of-Thought Reasoning](#link10)
**Authors:** Yuxi Sun, Aoqi Zuo, Haotian Xie, Wei Gao, Mingming Gong, Jing Ma

11. [Rethinking Token-Level Credit Assignment in RLVR: A Polarity-Entropy Analysis](#link11)
**Authors:** Yuhang He, Haodong Wu, Siyi Liu, Hongyu Ge, Hange Zhou, Keyi Wu, Zhuo Zheng, Qihong Lin, Zixin Zhong, Yongqi Zhang

12. [Early Decisions Matter: Proximity Bias and Initial Trajectory Shaping in Non-Autoregressive Diffusion Language Models](#link12)
**Authors:** Jiyeon Kim, Sungik Choi, Yongrae Jo, Moontae Lee, Minjoon Seo

13. [Hodoscope: Unsupervised Monitoring for AI Misbehaviors](#link13)
**Authors:** Ziqian Zhong, Shashwat Saxena, Aditi Raghunathan

14. [Lost in Diffusion: Uncovering Hallucination Patterns and Failure Modes in Diffusion Large Language Models](#link14)
**Authors:** Zhengnan Guo, Fei Tan

15. [Mitigating Privacy Risk via Forget Set-Free Unlearning](#link15)
**Authors:** Aviraj Newatia, Michael Cooper, Viet Nguyen, Rahul G. Krishnan

16. [Bringing Value Models Back: Generative Critics for Value Modeling in LLM Reinforcement Learning](#link16)
**Authors:** Zikang Shan, Han Zhong, Liwei Wang, Li Zhao

17. [Transformers Learn Latent Mixture Models In-Context via Mirror Descent](#link17)
**Authors:** Francesco D'Angelo, Nicolas Flammarion

18. [Human-like Working Memory Interference in Large Language Models](#link18)
...
19. [Utilizing and Calibrating Hindsight Process Rewards via Reinforcement with Mutual Information Self-Evaluation](#link19)
**Authors:** Jiashu Yao, Heyan Huang, Zeming Liu, Yuhang Guo

20. [Detecting Safety Violations Across Many Agent Traces](#link20)
**Authors:** Adam Stein, Davis Brown, Hamed Hassani, Mayur Naik, Eric Wong

21. [The Myth of Expert Specialization in MoEs: Why Routing Reflects Geometry, Not Necessarily Domain Expertise](#link21)
**Authors:** Xi Wang, Soufiane Hayou, Eric Nalisnick

22. [Measuring the Authority Stack of AI Systems: Empirical Analysis of 366,120 Forced-Choice Responses Across 8 AI Models](#link22)
**Authors:** Seulki Lee

23. [MEMENTO: Teaching LLMs to Manage Their Own Context](#link23)
...
24. [Spoiler Alert: Narrative Forecasting as a Metric for Tension in LLM Storytelling](#link24)
**Authors:** Peiqi Sui, Yutong Zhu, Tianyi Cheng, Peter West, Richard Jean So, Hoyt Long, Ari Holtzman

25. [Cognitive Pivot Points and Visual Anchoring: Unveiling and Rectifying Hallucinations in Multimodal Reasoning Models](#link25)
**Authors:** Zhe Qian, Yanbiao Ma, Zhuohan Ouyang, Zhonghua Wang, Zhongxing Xu, Fei Luo, Xinyu Liu, Zongyuan Ge, Yike Guo, Jungong Han

26. [Playing Along: Learning a Double-Agent Defender for Belief Steering via Theory of Mind](#link26)
**Authors:** Hanqi Xiao, Vaidehi Patil, Zaid Khan, Hyunji Lee, Elias Stengel-Eskin, Mohit Bansal

27. [FAITH: Factuality Alignment through Integrating Trustworthiness and Honestness](#link27)
**Authors:** Xiaoning Dong, Chengyan Wu, Yajie Wen, Yu Chen, Yun Xue, Jing Zhang, Wei Xu, Bolei Ma

28. [Weird Generalization is Weirdly Brittle](#link28)
**Authors:** Miriam Wanner, Hannah Collison, William Jurayj, Benjamin Van Durme, Mark Dredze, William Walden

29. [Efficient Process Reward Modeling via Contrastive Mutual Information](#link29)
**Authors:** Nakyung Lee, Sangwoo Hong, Jungwoo Lee

30. [Do LLMs Know Tool Irrelevance? Demystifying Structural Alignment Bias in Tool Invocations](#link30)
**Authors:** Yilong Liu, Xixun Lin, Pengfei Cao, Ge Zhang, Fang Fang, Yanan Cao

31. [Low-rank Optimization Trajectories Modeling for LLM RLVR Acceleration](#link31)
**Authors:** Zhipeng Chen, Tao Qian, Wayne Xin Zhao, Ji-Rong Wen

32. [Deliberative Alignment is Deep, but Uncertainty Remains: Inference time safety improvement in reasoning via attribution of unsafe behavior to base model](#link32)
**Authors:** Pankayaraj Pathmanathan, Furong Huang

33. [Thinking Fast, Thinking Wrong: Intuitiveness Modulates LLM Counterfactual Reasoning in Policy Evaluation](#link33)
**Authors:** Yanjie He

34. [Learning from Contrasts: Synthesizing Reasoning Paths from Diverse Search Trajectories](#link34)
**Authors:** Peiyang Liu, Zhirui Chen, Xi Wang, Di Liang, Youru Li, Zhi Cai, Wei Ye

35. [Attention Sinks as Internal Signals for Hallucination Detection in Large Language Models](#link35)
**Authors:** Jakub Binkowski, Kamil Adamczewski, Tomasz Kajdanowicz

36. [Instruction Data Selection via Answer Divergence](#link36)
**Authors:** Bo Li, Mingda Wang, Shikun Zhang, Wei Ye

37. [STARS: Skill-Triggered Audit for Request-Conditioned Invocation Safety in Agent Systems](#link37)
**Authors:** Guijia Zhang, Shu Yang, Xilin Gong, Di Wang

38. [Reason Only When Needed: Efficient Generative Reward Modeling via Model-Internal Uncertainty](#link38)
...
39. [OOM-RL: Out-of-Money Reinforcement Learning Market-Driven Alignment for LLM-Based Multi-Agent Systems](#link39)
**Authors:** Kun Liu, Liqun Chen

40. [Controllable and Verifiable Tool-Use Data Synthesis for Agentic Reinforcement Learning](#link40)
...
41. [Triviality Corrected Endogenous Reward](#link41)
**Authors:** Xinda Wang, Zhengxu Hou, Yangshijie Zhang, Bingren Yan, Jialin Liu, Chenzhuo Zhao, Zhibo Yang, Bin-Bin Yang, Feng Xiao

42. [Policy Split: Incentivizing Dual-Mode Exploration in LLM Reinforcement with Dual-Mode Entropy Regularization](#link42)
**Authors:** Jiashu Yao, Heyan Huang, Chuwei Luo, Daiqing Wu, Zeming Liu, Yuhang Guo, Yangyang Kang

43. [Your Model Diversity, Not Method, Determines Reasoning Strategy](#link43)
...
44. [Decomposing and Reducing Hidden Measurement Error in LLM Evaluation Pipelines](#link44)
**Authors:** Solomon Messing

45. [CoSToM:Causal-oriented Steering for Intrinsic Theory-of-Mind Alignment in Large Language Models](#link45)
**Authors:** Mengfan Li, Xuanhua Shi, Yang Deng

46. [Governed Reasoning for Institutional AI](#link46)
**Authors:** Mamadou Seck

47. [HiEdit: Lifelong Model Editing with Hierarchical Reinforcement Learning](#link47)
**Authors:** Yangfan Wang, Tianyang Sun, Chen Tang, Jie Liu, Wei Cai, Jingchi Jiang

48. [PRISM Risk Signal Framework: Hierarchy-Based Red Lines for AI Behavioral Risk](#link48)
**Authors:** Seulki Lee

49. [AI Organizations are More Effective but Less Aligned than Individual Agents](#link49)
...
50. [A Comparative Theoretical Analysis of Entropy Control Methods in Reinforcement Learning](#link50)
**Authors:** Ming Lei, Christophe Baehr

51. [The Past Is Not Past: Memory-Enhanced Dynamic Reward Shaping](#link51)
**Authors:** Yang Liu, Enxi Wang, Yufei Gao, Weixin Zhang, Bo Wang, Zhiyuan Zeng, Yikai Zhang, Yining Zheng, Xipeng Qiu

52. [When Can You Poison Rewards? A Tight Characterization of Reward Poisoning in Linear MDPs](#link52)
**Authors:** Jose Efraim Aguilar Escamilla, Haoyang Hong, Jiawei Li, Haoyu Zhao, Xuezhou Zhang, Sanghyun Hong, Huazheng Wang

53. [Persona Non Grata: Single-Method Safety Evaluation Is Incomplete for Persona-Imbued LLMs](#link53)
**Authors:** Wenkai Li, Fan Yang, Shaunak A. Mehta, Koichi Onoue

54. [Escaping the Context Bottleneck: Active Context Curation for LLM Agents via Reinforcement Learning](#link54)
**Authors:** Xiaozhe Li, Tianyi Lyu, Yizhao Yang, Liang Shan, Siyi Yang, Ligao Zhang, Zhuoyi Huang, Qingwen Liu, Yang Li

55. [Exploring Knowledge Conflicts for Faithful LLM Reasoning: Benchmark and Method](#link55)
**Authors:** Tianzhe Zhao, Jiaoyan Chen, Shuxiu Zhang, Haiping Zhu, Qika Lin, Jun Liu

56. [ZoomR: Memory Efficient Reasoning through Multi-Granularity Key Value Retrieval](#link56)
...
57. [MathAgent: Adversarial Evolution of Constraint Graphs for Mathematical Reasoning Data Synthesis](#link57)
**Authors:** Zixiong Yu, Jun Rao, Guhan Chen, Songtao Tian, Bohan Li, Jiansheng Wei, Min Zhang, Xiaojun Meng

58. [RTMC: Step-Level Credit Assignment via Rollout Trees](#link58)
**Authors:** Tao Wang, Suhang Zheng, Xiaoxiao Xu

59. [Instructing LLMs to Negotiate using Reinforcement Learning with Verifiable Rewards](#link59)
**Authors:** Shuze Daniel Liu, Claire Chen, Jiabao Sean Xiao, Lei Lei, Yuheng Zhang, Yisong Yue, David Simchi-Levi

60. [SVSR: A Self-Verification and Self-Rectification Paradigm for Multimodal Reasoning](#link60)
**Authors:** Zhe Qian, Nianbing Su, Zhonghua Wang, Hebei Li, Zhongxing Xu, Yueying Li, Fei Luo, Zhuohan Ouyang, Yanbiao Ma

61. [What do your logits know? (The answer may surprise you!)](#link61)
**Authors:** Masha Fedzechkina, Eleonora Gualdoni, Rita Ramos, Sinead Williamson

62. [CausalGaze: Unveiling Hallucinations via Counterfactual Graph Intervention in Large Language Models](#link62)
**Authors:** Linggang Kong, Lei Wu, Yunlong Zhang, Xiaofeng Zhong, Zhen Wang, Yongjie Wang, Yao Pan

63. [Self-Correcting RAG: Enhancing Faithfulness via MMKP Context Selection and NLI-Guided MCTS](#link63)
**Authors:** Shijia Xu, Zhou Wu, Xiaolong Jia, Yu Wang, Kai Liu, April Xiaowen Dong

64. [METER: Evaluating Multi-Level Contextual Causal Reasoning in Large Language Models](#link64)
**Authors:** Pengfeng Li, Chen Huang, Chaoqun Hao, Hongyao Chen, Xiao-Yong Wei, Wenqiang Lei, See-Kiong Ng

65. [Why Supervised Fine-Tuning Fails to Learn: A Systematic Study of Incomplete Learning in Large Language Models](#link65)
**Authors:** Chao Xue, Yao Wang, Mengqiao Liu, Di Liang, Xingsheng Han, Peiyang Liu, Xianjie Wu, Chenyao Lu, Lei Jiang, Yu Lu, Haibo Shi, Shuang Liang, Minlong Peng, Flora D. Salim

66. [Learning to Adapt: In-Context Learning Beyond Stationarity](#link66)
**Authors:** Zhen Qin, Jiachen Jiang, Zhihui Zhu

67. [Polyglot Teachers: Evaluating Language Models for Multilingual Synthetic Data Generation](#link67)
**Authors:** Lester James V. Miranda, Ivan Vuli\'c, Anna Korhonen

68. [Self-Calibrating Language Models via Test-Time Discriminative Distillation](#link68)
**Authors:** Mohamed Rissal Hedna, Jan Strich, Martin Semmann, Chris Biemann

69. [TInR: Exploring Tool-Internalized Reasoning in Large Language Models](#link69)
**Authors:** Qiancheng Xu, Yongqi Li, Fan Liu, Hongru Wang, Min Yang, Wenjie Li

70. [Agentic Aggregation for Parallel Scaling of Long-Horizon Agentic Tasks](#link70)
**Authors:** Yoonsang Lee, Howard Yen, Xi Ye, Danqi Chen

71. [Evaluating Cooperation in LLM Social Groups through Elected Leadership](#link71)
**Authors:** Ryan Faulkner, Anushka Deshpande, David Guzman Piedrahita, Joel Z. Leibo, Zhijing Jin

72. [Nationality encoding in language model hidden states: Probing culturally differentiated representations in persona-conditioned academic text](#link72)
**Authors:** Paul Jackson (Language Centre, School of Language, Literature, Music and Visual Culture, University of Aberdeen, United Kingdom), Ruizhe Li (School of Natural and Computing Sciences, University of Aberdeen, United Kingdom), Elspeth Edelstein (School of Language, Literature, Music and Visual Culture, University of Aberdeen, United Kingdom)

73. [New Hybrid Fine-Tuning Paradigm for LLMs: Algorithm Design and Convergence Analysis Framework](#link73)
**Authors:** Shaocong Ma, Peiran Yu, Heng Huang

74. [Why Don't You Know? Evaluating the Impact of Uncertainty Sources on Uncertainty Quantification in LLMs](#link74)
**Authors:** Maiya Goloburda, Roman Vashurin, Fedor Chernogorsky, Nurkhan Laiyk, Daniil Orel, Preslav Nakov, Maxim Panov

75. [Hidden Failures in Robustness: Why Supervised Uncertainty Quantification Needs Better Evaluation](#link75)
**Authors:** Joe Stacey, Hadas Orgad, Kentaro Inui, Benjamin Heinzerling, Nafise Sadat Moosavi

76. [Query Lower Bounds for Diffusion Sampling](#link76)
**Authors:** Zhiyang Xun, Eric Price

77. [Exact Finite-Sample Variance Decomposition of Subagging: A Spectral Filtering Perspective](#link77)
**Authors:** Ye Su, Mingrui Ye, Yining Wang, Jipeng Guo, Yong Liu

78. [Adaptive Multi-Expert Reasoning via Difficulty-Aware Routing and Uncertainty-Guided Aggregation](#link78)
**Authors:** Mohamed Ehab, Ali Hamdi

79. [AI Integrity: A New Paradigm for Verifiable AI Governance](#link79)
**Authors:** Seulki Lee

80. [Learning and Enforcing Context-Sensitive Control for LLMs](#link80)
**Authors:** Mohammad Albinhassan, Pranava Madhyastha, Mark Law, Alessandra Russo

81. [General365: Benchmarking General Reasoning in Large Language Models Across Diverse and Challenging Tasks](#link81)
...
82. [RationalRewards: Reasoning Rewards Scale Visual Generation Both Training and Test Time](#link82)
**Authors:** Haozhe Wang, Cong Wei, Weiming Ren, Jiaming Liu, Fangzhen Lin, Wenhu Chen

83. [INCRT: An Incremental Transformer That Determines Its Own Architecture](#link83)
**Authors:** Giansalvo Cirrincione

84. [Do Agent Rules Shape or Distort? Guardrails Beat Guidance in Coding Agents](#link84)
**Authors:** Xing Zhang, Guanghui Wang, Yanwei Cui, Wei Qiu, Ziyuan Li, Bing Zhu, Peiyang He

85. [Attention Sink in Transformers: A Survey on Utilization, Interpretation, and Mitigation](#link85)
...
86. [LLMs Should Incorporate Explicit Mechanisms for Human Empathy](#link86)
**Authors:** Xiaoxing You, Qiang Huang, Jun Yu

87. [Relax: An Asynchronous Reinforcement Learning Engine for Omni-Modal Post-Training at Scale](#link87)
...
88. [Agent^2 RL-Bench: Can LLM Agents Engineer Agentic RL Post-Training?](#link88)
**Authors:** Wanyi Chen, Xiao Yang, Xu Yang, Tianming Sha, Qizheng Li, Zhuo Wang, Bowen Xian, Fang Kong, Weiqing Liu, Jiang Bian

89. [Learning Discrete Diffusion of Graphs via Free-Energy Gradient Flows](#link89)
**Authors:** Dario Rancati, Jan Maas, Francesco Locatello

90. [From Attribution to Action: A Human-Centered Application of Activation Steering](#link90)
**Authors:** Tobias Labarta, Maximilian Dreyer, Katharina Weitz, Wojciech Samek, Sebastian Lapuschkin

91. [Pioneer Agent: Continual Improvement of Small Language Models in Production](#link91)
...
92. [Deep-Reporter: Deep Research for Grounded Multimodal Long-Form Generation](#link92)
**Authors:** Fangda Ye, Zhifei Xie, Yuxin Hu, Yihang Yin, Shurui Huang, Shikai Dong, Jianzhu Bao, Shuicheng Yan

93. [Beyond Compliance: A Resistance-Informed Motivation Reasoning Framework for Challenging Psychological Client Simulation](#link93)
**Authors:** Danni Liu, Bo Liu, Yuxin Hu, Hantao Zhao, Yan Liu, Ding Ding, Jiahui Jin, Jiuxin Cao

94. [Learning from Emptiness: De-biasing Listwise Rerankers with Content-Agnostic Probability Calibration](#link94)
**Authors:** Hang Lv, Hongchao Gu, Ruiqing Yang, Liangyue Li, Zulong Chen, Defu Lian, Hao Wang, Enhong Chen

95. [Optimal Stability of KL Divergence under Gaussian Perturbations](#link95)
**Authors:** Jialu Pan, Yufeng Zhang, Nan Hu, Keqin Li

96. [Retrieval as Generation: A Unified Framework with Self-Triggered Information Planning](#link96)
**Authors:** Bo Li, Mingda Wang, Gexiang Fang, Shikun Zhang, Wei Ye

97. [MIXAR: Scaling Autoregressive Pixel-based Language Models to Multiple Languages and Scripts](#link97)
**Authors:** Chen Hu, Yintao Tai, Antonio Vergari, Frank Keller, Alessandro Suglia

98. [Do LLMs Build Spatial World Models? Evidence from Grid-World Maze Tasks](#link98)
**Authors:** Weijiang Li, Yilin Zhu, Rajarshi Das, Parijat Dube

99. [Select Smarter, Not More: Prompt-Aware Evaluation Scheduling with Submodular Guarantees](#link99)
**Authors:** Xiaoyu Ma, Yiwen Li, Haoyue Liu, Zhichao Wang, Ye Chen, Yongxin Guo, Xiaoying Tang

100. [Judge Like Human Examiners: A Weighted Importance Multi-Point Evaluation Framework for Generative Tasks with Long-form Answers](#link100)
**Authors:** Guoxin Yu, Chulun Zhou, Lemao Liu, Qi Wang, Mo Yu, Jialong Tang, Baosong Yang, Xiang Ao, Wao Lam, Yue Yu

101. [Muon$^2$: Boosting Muon via Adaptive Second-Moment Preconditioning](#link101)
**Authors:** Ziyue Liu, Ruijie Zhang, Zhengyang Wang, Yequan Zhao, Yupeng Su, Zi Yang, Zheng Zhang

102. [Reducing Hallucination in Enterprise AI Workflows via Hybrid Utility Minimum Bayes Risk (HUMBR)](#link102)
...
103. [ReFEree: Reference-Free and Fine-Grained Method for Evaluating Factual Consistency in Real-World Code Summarization](#link103)
**Authors:** Suyoung Bae, CheolWon Na, Jaehoon Lee, Yumin Lee, YunSeok Choi, Jee-Hyong Lee

104. [ShapShift: Explaining Model Prediction Shifts with Subgroup Conditional Shapley Values](#link104)
**Authors:** Tom Bewley, Salim I. Amoukou, Emanuele Albini, Saumitra Mishra, Manuela Veloso

105. [When Verification Fails: How Compositionally Infeasible Claims Escape Rejection](#link105)
**Authors:** Muxin Liu, Delip Rao, Grace Kim, Chris Callison-Burch

106. [SWE-AGILE: A Software Agent Framework for Efficiently Managing Dynamic Reasoning Context](#link106)
**Authors:** Shuquan Lian, Juncheng Liu, Yazhe Chen, Yuhong Chen, Hui Li

107. [Min-$k$ Sampling: Decoupling Truncation from Temperature Scaling via Relative Logit Dynamics](#link107)
**Authors:** Yuanhao Ding, Meimingwei Li, Esteban Garces Arias, Matthias A{\ss}enmacher, Christian Heumann, Chongsheng Zhang

108. [Online Covariance Estimation in Averaged SGD: Improved Batch-Mean Rates and Minimax Optimality via Trajectory Regression](#link108)
**Authors:** Yijin Ni, Xiaoming Huo

109. [Closed-Form Concept Erasure via Double Projections](#link109)
**Authors:** Chi Zhang, Jingpu Cheng, Zhixian Wang, Ping Liu

110. [SpectralLoRA: Is Low-Frequency Structure Sufficient for LoRA Adaptation? A Spectral Analysis of Weight Updates](#link110)
**Authors:** Rajveer Singh

111. [Inter-Layer Hessian Analysis of Neural Networks with DAG Architectures](#link111)
...
112. [Who Wrote This Line? Evaluating the Detection of LLM-Generated Classical Chinese Poetry](#link112)
**Authors:** Jiang Li, Tian Lan, Shanshan Wang, Dongxing Zhang, Dianqing Lin, Guanglai Gao, Derek F. Wong, Xiangdong Su

113. [Teaching Language Models How to Code Like Learners: Conversational Serialization for Student Simulation](#link113)
**Authors:** Charles Koutcheme, Arto Hellas, Juho Leinonen

114. [TimeSeriesExamAgent: Creating Time Series Reasoning Benchmarks at Scale](#link114)
**Authors:** Malgorzata Gwiazda, Yifu Cai, Mononito Goswami, Arjun Choudhry, Artur Dubrawski

115. [CodeQuant: Unified Clustering and Quantization for Enhanced Outlier Smoothing in Low-Precision Mixture-of-Experts](#link115)
...
116. [UniToolCall: Unifying Tool-Use Representation, Data, and Evaluation for LLM Agents](#link116)
**Authors:** Yijuan Liang, Xinghao Chen, Yifan Ge, Ziyi Wu, Hao Wu, Changyu Zeng, Wei Xing, Xiaoyu Shen

117. [CAGenMol: Condition-Aware Diffusion Language Model for Goal-Directed Molecular Generation](#link117)
**Authors:** Yanting Li, Zhuoyang Jiang, Enyan Dai, Lei Wang, Wen-Cai Ye, Li Liu

118. [CLSGen: A Dual-Head Fine-Tuning Framework for Joint Probabilistic Classification and Verbalized Explanation](#link118)
**Authors:** WonJin Yoon, Kangyu Zhu, Ian Bulovic, Autumn Sehy, Yanjun Gao, Dmitriy Dligach, Majid Afshar, Timothy A. Miller

119. [Expect the Unexpected? Testing the Surprisal of Salient Entities](#link119)
**Authors:** Jessica Lin, Amir Zeldes

120. [CSPO: Alleviating Reward Ambiguity for Structured Table-to-LaTeX Generation](#link120)
**Authors:** Yunfan Yang, Cuiling Lan, Jitao Sang, Yan Lu

121. [CHAIRO: Contextual Hierarchical Analogical Induction and Reasoning Optimization for LLMs](#link121)
**Authors:** Haotian Lu, Yuchen Mou, Bingzhe Wu

122. [NovBench: Evaluating Large Language Models on Academic Paper Novelty Assessment](#link122)
**Authors:** Wenqing Wu, Yi Zhao, Yuzhuo Wang, Siyou Li, Juexi Shao, Yunfei Long, Chengzhi Zhang

123. [Flow-Controlled Scheduling for LLM Inference with Provable Stability Guarantees](#link123)
**Authors:** Zhuolun Dong, Junyu Cao

124. [CocoaBench: Evaluating Unified Digital Agents in the Wild](#link124)
...
125. [How Robust Are Large Language Models for Clinical Numeracy? An Empirical Study on Numerical Reasoning Abilities in Clinical Contexts](#link125)
**Authors:** Minh-Vuong Nguyen, Fatemeh Shiri, Zhuang Li, Karin Verspoor

126. [Self-Evolving LLM Memory Extraction Across Heterogeneous Tasks](#link126)
**Authors:** Yuqing Yang, Tengxiao Liu, Wang Bill Zhu, Taiwei Shi, Linxin Song, Robin Jia

127. [LoopGuard: Breaking Self-Reinforcing Attention Loops via Dynamic KV Cache Intervention](#link127)
**Authors:** Dongjie Xu, Hao Wu, Weijie Shi, Yue Cui, Yuanjun Liu, Jiawei Li, Haolun Ma, An Liu, Jia Zhu, Jiajie Xu

128. [Do BERT Embeddings Encode Narrative Dimensions? A Token-Level Probing Analysis of Time, Space, Causality, and Character in Fiction](#link128)
**Authors:** Beicheng Bei, Hannah Hyesun Chun, Chen Guo, Arwa Saghiri

129. [Efficient Matrix Implementation for Rotary Position Embedding](#link129)
**Authors:** Chen Minqi, Zhongqi Yue, Shihao Zhang, Yun Xu, Peng Wu, kaixiang Xu, Zeyi Huang, Hanwang Zhang

130. [STaR-DRO: Stateful Tsallis Reweighting for Group-Robust Structured Prediction](#link130)
