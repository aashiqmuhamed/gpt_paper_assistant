...
Total relevant papers: 132

Paper selection prompt and criteria at the bottom

Table of contents with paper titles:

0. [GVPO++: Group Variance Policy Optimization for LLM Post-Training and On-Policy Distillation](#link0)
**Authors:** Kaichen Zhang, Yuzhong Hong, Junwei Bao, Hongfei Jiang, Yang Song, Dingqian Hong, Hui Xiong

1. [Weak Ties, Strong Signals: Efficient Training Data Detection in Diffusion LLMs via Independent Token Sampling](#link1)
**Authors:** Hongyao Yu, Tianqu Zhuang, Ziyuan Xu, Hao Fang, Jiaxin Hong, Bin Chen, Shu-Tao Xia

2. [Knowing, and Saying It Only When Asked: LLM Endognostics and the Schizognosis of Minerva-7B](#link2)
**Authors:** Fabrizio Davide, Francesco Collova

3. [GUARD: Natural Forgetting in Large Reasoning Models via Guided Answer-Reasoning Distillation](#link3)
**Authors:** Zeyu Yan, Guanghao Zhou, Minghui Qiu, Ming Gao, Cen Chen

4. [Optimizers for Diffusion Models: A Controlled Benchmark](#link4)
**Authors:** Arman Bolatov, Egor Shulgin, David Li, Abduragim Shtanchaev, Sebastian U. Stich, Maxim Panov, Eric Moulines, Peter Richt\'arik, Martin Tak\'a\v{c}

5. [FLARE: A Full-Lifecycle Dense Supervision Paradigm for Long-Horizon Coding Agents via Generative Reward Model](#link5)
...
6. [From Concept Alignment to Causal Grounding: An Intervention Test of Chain-of-Thought Faithfulness](#link6)
**Authors:** Qianli Wang, Yilong Wang, Dennis Wei, Jingyi Sun, Simon Ostermann, Pepa Atanasova, Nils Feldhus

7. [Rare Event Estimation via Iterative Unalignment](#link7)
**Authors:** Hanming Yang, Daksh Mittal, Jing Dong, Hongseok Namkoong

8. [Human-LLM Deliberation as Interactive Proof: Conditions for Verifiability Without Transparency](#link8)
**Authors:** Baotong Zhang, Dean Foster, Jo\~ao Sedoc

9. [Towards Full Pipeline FP8 Reinforcement Learning for LLMs](#link9)
**Authors:** Fanchao Chen, Ziheng Jiang, Ziyun Wei, Zheng Zhong, Du Li, Chi Zhang, Haibin Lin, Shivaram Venkataraman

10. [Is Imagination Derived from Hallucination? A Cross-Taxonomy Evaluation of Imagination and Hallucination in Large Language Models](#link10)
**Authors:** Zixuan Tang, Hongzong Li, Shuxin Zhuang, Dapeng Wu, Zi Liang

11. [Teacher Should Think Ahead: Adaptive Continuations for Reliable On-Policy Distillation](#link11)
**Authors:** Jingang Zhou, Yuyi Zhou, Haiyang Guo, Xukai Wang, Shuai Feng, Sirui Gao, Jian Xu, Qingpei Guo, Xu-Yao Zhang

12. [LogicTrack: Auditing Reasoning Trajectories of Large Language Models with Formal Logic Solvers](#link12)
**Authors:** Jingyu Hu, Shu Yang, Weiru Liu, Di Wang

13. [RLVR$^{2}$: Reinforcement Learning with Verifiable Rubric-based Ranking](#link13)
**Authors:** Hao Li, Zhengkun Zhang, Gangqiang Hu, Zhen Zhang, Yude Gao, Dai Dai, Jing Liu

14. [Information-Gain Rewards over Diversity-Pruned Tests: GT-Anchored Verifier Co-Training for Reliable Code Generation](#link14)
**Authors:** Ana Nunez, Peyman Najafirad

15. [Judging a Review by its Cover: A Reliability Analysis of LLM-based Peer Review Evaluation Metrics](#link15)
**Authors:** Shakiba Amirshahi, Sajad Ebrahimi, Hai Son Le, Negar Arabzadeh, Ebrahim Bagheri

16. [On Mitigation of Subliminal Learning in Large Language Models](#link16)
**Authors:** Atsushi Yanagisawa, Brendan Gho, Rajendran Ramesh Babu Manoj Narender, Kevin Zhu, Madhur Panwar, Antonio Mari

17. [Calibrating Teacher--Student Discrepancy for On-Policy Distillation](#link17)
**Authors:** Qiangqiang He, Jin Li, MingCai Chen

18. [Dissecting Training-Free Uncertainty Estimation in Multimodal Large Language Models](#link18)
**Authors:** Soroush Seifi, Vaggelis Dorovatas, Lin Li, Yarin Gal, Rahaf Aljundi

19. [Detecting Hallucination in LLMs: Tracing the Topological Signatures of Impaired Context Sharing](#link19)
**Authors:** Amir Jalilifard, Anderson Rocha, Eric Wong, Marcos Medeiros Raimundo

20. [CAMFT: Conflict-Aware Mergeable Fine-Tuning for Large Language Models](#link20)
**Authors:** Jingang Zhou, Haiyang Guo, Yuan Ma, Han Zhu, Xu-Yao Zhang

21. [Information-Time Proximal Policy Optimization](#link21)
...
22. [Strategy Accumulation and Guided Execution for Automated LLM Fine-Tuning](#link22)
**Authors:** Haoran Zhao, Wei Du, Dingwen Yang, Jixuan Huang, Junlin Shang, Lingyong Fang, Ya Guo, Tao Gui, Qi Zhang, Xuanjing Huang

23. [A Pinch of SFT, A Dash of RL: When Reinforcement Learning Helps Long-Horizon Advertising Agents](#link23)
...
24. [Evaluation Awareness Shifts from Format to Context with Model Scale](#link24)
**Authors:** Navraj Singh, Maheep Chaudhary

25. [Leveraging Inference-Time Compute for Diffusion Models via Global Scheduling of Denoising Trajectories](#link25)
**Authors:** Yuan Cao, Yifu Tang, Hangqi Li, Zeyu Zheng

26. [Swiss-Knife: A Framework for Reconfigurable Externalised Multi-Objective Alignment at Decode Time](#link26)
**Authors:** Agnibh Karmakar, Mayur Parvatikar, Shreyash Dhoot, Amit Dhanda, Aman Chadha, Kapil Wanaskar, Vinija Jain, Amitava Das

27. [MechaTerp-TRACE: A Novel Approach for Component Ablation Analysis in Language Models](#link27)
**Authors:** Brandon Colelough, Davis Bartels, Madeline Bittner, Dina Demner-Fushman

28. [CaLR: Causal Latent Revision for Robust Diffusion Reasoning](#link28)
**Authors:** Wei Cai, Jian Zhao, Yuchen Yuan, Xuelong Li

29. [iSDFT: Information-Proximal Self-Distillation for Continual Learning in LLMs](#link29)
**Authors:** Ahmed Khaled Khamis, Xiaotong Ji, Hassan Jaber, Rasul Tutunov, Matthieu Zimmer, Jun Wang, Haitham Bou-Ammar

30. [Directing large language models to follow the letter or spirit of the law](#link30)
**Authors:** Peng Qian, Andrew Li, Sam Chen, Sonia K. Murthy, Yonatan Belinkov, Tomer D. Ullman

31. [LLaDA-PRM: A Bidirectional Step-Level Reasoning Evaluator](#link31)
**Authors:** Yiming Feng, Naihao Deng, Yulong Chen, Rada Mihalcea

32. [MemCalib: Benchmarking and Optimizing Memory Use in LLM Agents](#link32)
**Authors:** Ruike Cao, Fanyu Zhao, Fugen Yao, Liang Dong, Jian Xu, Guanjun Jiang, Yifei Zhao, Han Zhang, Li Xiao

33. [onPanda: Efficient Annotation of On-Policy Alignment Data for LLMs and Agents via Token-Level Correction](#link33)
...
34. [Read-Best Is Not Steer-Best: A Probing--Steering Layer Dissociation in Omni-Modal Large Language Models](#link34)
**Authors:** Yibo Wang, Jisheng Dang, Bimei Wang, Yitao Wu, Wencan Zhang, Hong Peng, Jizhao Liu, Bin Hu, Qi Tian, Tat-Seng Chua

35. [On the Efficiency-Safety Dilemma in Large Reasoning Models](#link35)
**Authors:** Yifei Yang, Zouying Cao, Xingrui Wang, Xiao Zhou, Yuexian Li, Dongjie Yang, Hai Zhao

36. [LoopCD: Loop-wise Contrastive Decoding for Improving Reasoning in Looped Language Models](#link36)
**Authors:** Byeongho Yu, Junhyuk So, Eunhyeok Park

37. [Attention-Aware Routing: Coupling Routing and Attention in MoEs](#link37)
...
38. [GRRR: The Geometry of Reshaping, Rotation, and Routing in Decoder LLM post-training](#link38)
**Authors:** Jianing Qi, Hao Tang, Zhigang Zhu

39. [Triggers and Diagnostics for LLM-Based Interpretability Failures in Active Inference Agents](#link39)
**Authors:** Param Raval, Rohit Shenoy, Archana Vaidheeswaran

40. [Multiple latent orderings better predict language model preferences](#link40)
**Authors:** Aviral Chawla, William H. W. Thompson, Jean-Gabriel Young

41. [Assessing Adversarial Robustness of Latent Reasoning Models](#link41)
**Authors:** Shaolong Chen, Ang Li, Mingjie Li, Yisen Wang

42. [Resist, Update, Reject: Preference Optimization Installs a Prior-Dependent Reliability Switch](#link42)
**Authors:** Sen Yang, Yuen-Hei Yeung

43. [Time-Incremental Continued Pretraining of LLMs: Knowledge Updates Without Catastrophic Forgetting](#link43)
**Authors:** F{\i}rat \"Oncel, Salman Hussain Ali, Mirco Ravanelli, Cem Subakan, \c{C}a\u{g}atay Y{\i}ld{\i}z

44. [Chronologic: Measuring Language Models' Ability to Represent the Past](#link44)
**Authors:** Ted Underwood, Ziliang Qiu, Sarah Griebel, Laura K. Nelson, Edwin Roland, Wenyi Shang, Matthew Wilkens

45. [CLOOPD: Closing the Learner Loop in On-Policy Distillation](#link45)
**Authors:** Keye Zheng, Hanyu Li, Zhan Cheng, Yuan Gao

46. [Measuring Behavioural Signatures of Large Language Models through Psychometric Profiling](#link46)
...
47. [Decoupling Internal Representational Changes and Causal Importance in Fine-Tuned Large Language Models](#link47)
**Authors:** Lingfang Li, Procheta Sen, Shubham Das, Danushka Bollegala

48. [CodeMidas: Scaling Agentic Coding RL Environments from Code Itself](#link48)
...
49. [DIPLOMAT: Dialogue-Span-Aware Direct Preference Optimization for Polite Persuasive Workplace Negotiation Dialogues](#link49)
**Authors:** Bibhuti Jha, Rishikant Chigrupaatii, Priyanshu Priya, Asif Ekbal

50. [Distill What You Trust: Reliability-Aware Multi-Teacher On-Policy Distillation](#link50)
...
51. [Efficient Reasoning Exploration via State-Conditioned Latent Steering with Progress Guidance](#link51)
...
52. [Implicit Rule Induction with Test-Time Task Embeddings in ARC-like Tasks](#link52)
**Authors:** Adrien Deli\`ege, Claas Beger, Marc Van Droogenbroeck, Melanie Mitchell

53. [The Answer-Basin Representation Hypothesis: We Are Not Probing or Steering Concepts](#link53)
**Authors:** Manjiang Yu, Hongji Li, Zihan Wang, Junwei Chen, Xue Li, Priyanka Singh, Yang Cao, Lijie Hu

54. [To Consolidate or not to Consolidate? Evaluating the Impact of Consolidation in Multi-Reference Training using Peer Reviews](#link54)
...
55. [Beyond the Text: Verifying That Agent-Written Papers Are Backed by Their Artifacts](#link55)
**Authors:** Qiuhong Shen, Benlong Wu, Hanjin Liu, Yuang Qi, Kejiang Chen

56. [Efficient Mixture-of-Experts with Speculative Decoding via Expert Coactivation](#link56)
...
57. [Acceptance-Aware Draft Model Training for Speculative Decoding](#link57)
**Authors:** Tianhua Xia, Mugilan Ganesan, Yifei Feng, Haiyu Wang, Maximilian Egger, Sai Qian Zhang

58. [H-Spec: Parallel Speculative Decoding Without a Drafter-Side KV Cache](#link58)
...
59. [LoRA-generating hypernetworks for efficient on-device LLM generative personalization](#link59)
**Authors:** Sean Augenstein, Li Ding, Jihwan Lee, Keith Rush, Andrey Zhmoginov

60. [Euston: Training Away Mathematical Sycophancy Without Losing the Mathematics](#link60)
**Authors:** Zehua Cheng, Wei Dai, Jiahao Sun

61. [Complex KDA: Understanding and Enhancing the Expressivity of Kimi Delta Attention](#link61)
**Authors:** Julien Siems, Riccardo Grazzi, Korbinian P\"oppel, Jaisidh Singh, Arber Zela, Timur Carstensen, Jenia Jitsev, Frank Hutter, Volkan Cevher, Antonio Orvieto, Aaron Klein

62. [STEVE: Stabilizing Textual Gradient-Based Prompt Optimization via Error-Driven Refinement and Regularized Verification](#link62)
**Authors:** Yifan Xu, Yixuan Li, Xinzhuo Li, Yixin Gu, Yifan Shen, Lijun Yu, Haohan Wang

63. [1% of Tokens Can Be Enough: On Gradient Estimation in On-Policy Distillation](#link63)
**Authors:** Huanxin Sheng, Zhiling Ye, Haonan Wang, Jian Wang, Jinjie Gu, Jian Kang

64. [TreeSpark: Calibrated, Load-Adaptive Draft Trees for Semi-Autoregressive Speculative Decoding](#link64)
**Authors:** Huapeng Zhou, Huayu Wang, Xinyu Wang

65. [When Quantization Preserves Accuracy but Not Evidence: Explanation-Aware Post-Training Quantization for Medical LLMs](#link65)
**Authors:** Yeji Kim, Mi-Young Kim, Randy Goebel

66. [Augmented Hypothesis Testing with Persona-Based LLM Simulations](#link66)
**Authors:** Ziyad Benomar, Aymen Al Marjani, Paul Missault, Saab Mansour

67. [StepKV: Step-Aware KV Cache Compression for LLM Agents](#link67)
**Authors:** Boyu Feng, Jiahong Liu, Yifan Li, Wenhao Yu, Zexuan Qiu, Yuliang Sun, Ming Shen, Xiang Li, Quanyu Dai, Irwin King

68. [The Communication Bottleneck: A Round-Trip Study of Tree-Structured Expression Serialization in Language Models](#link68)
**Authors:** Xavier Suau, Alex Ferrando de las Morenas, Luca Zappella, Samy Bengio

69. [Memory vs. Context? Influential Factors of Factual Recall in Language Models](#link69)
**Authors:** Guilhem Fouilh\'e, Nicholas Asher, Philippe Muller

70. [ARM: Attention with Routed-Memory for Learnable Sparse Control](#link70)
**Authors:** Qiuhao Zeng, Jerry Huang, Peng Lu, Ruiyi Fang, Gezheng Xu, Zihao Jing, Yufei Cui, Charles Ling, Gang Niu, Boyu Wang

71. [Assessing Readability with LLMs: The Role of Reasoning and Few-Shot Prompting](#link71)
**Authors:** Rapha\"el Thieffry, Matej Martinc

72. [Context Poisoning as Extreme-Value Attention Interference in Long-Context Language Models](#link72)
**Authors:** Meysam Ghaffari, Nina Fatehi, Bhaskar Sen, Nasim Sabetpour, Carlos Morato

73. [Exactness at Inference: A Representational Criterion for Out-of-Distribution Generalization](#link73)
**Authors:** Filipe Marinho Rocha, In\^es Dutra, V\'itor Santos Costa, Lu\'is Paulo Reis

74. [Adapting Tree-Structured Speculative Decoding to DeepSeek-V4 for Efficient Inference](#link74)
**Authors:** Changxu Liu, Zhaogeng Li

75. [The Ups and Downs of Backprop Weights](#link75)
**Authors:** Giuseppe Chindemi, Benjamin F. Grewe

76. [Checkpoints Are Not Enough: Trust Calibration in CoSLR, a Human-AI System for Systematic Literature Reviews](#link76)
...
77. [Why Ghost Outputs Teach: A Kernel-Based Understanding of Subliminal Learning](#link77)
**Authors:** Zhe Li, Bicheng Ying, Chaosheng Dong, Haibo Yang

78. [SupportCal: Label-Free Calibration of Post-Trained LLMs via Reference Support and Corroboration](#link78)
**Authors:** Linhan Luo, Lequan Lin, Dai Shi, Feng Chen, Jos\'e Miguel Hern\'andez-Lobato, Junbin Gao

79. [Iterative Atom Refinement: A Monotonicity Principle for Dictionary Learning](#link79)
**Authors:** Alexander Christie, Miguel Moscoso, Alexei Novikov, George Papanicolaou, Chrysoula Tsogka

80. [Luck Is Not Skill: When Do Paired Rollouts Help Group-Relative RL of LLM Agents?](#link80)
**Authors:** Nazmus Sakib

81. [WaveFront Decoding: Parallelized Self-Speculative Decoding for Looped Language Models](#link81)
**Authors:** Hyeongju Ha, Jae-Joon Kim

82. [XYEval: Agents say yes to bad advice](#link82)
**Authors:** Zhengxuan Wu, Yuxuan Li, Oyvind Tafjord, Been Kim

83. [Improving Parameter Utilization by Sharing Neural Experts Across Layers in Transformers](#link83)
**Authors:** Dian Jiao, Jiaxin Duan, Shuai Zhao, Jiabing Leng, Yiran Zhang, Feng Huang

84. [RRSI: Regularized Recursive Self-Improvement of Agent Harnesses](#link84)
...
85. [Multi-Armed Bernoulli Bandits via Minimax Single-Arm Stopping](#link85)
**Authors:** Huikang Liu, Zhengchao Wang, Daniel Kuhn, Wolfram Wiesemann

86. [Using Composition Operators to Linearize LLM Semantic Transformations](#link86)
**Authors:** Afjal Chowdhury, James Chen, Alan Edelman

87. [Causal Inference with Unobserved Confounding: A Mixture Learning Perspective](#link87)
**Authors:** Mansi Sood, Devavrat Shah

88. [Opinion Leader Dynamics: How Sparse Attention Shapes Token Clustering](#link88)
**Authors:** Jingkun Liu, Yue Song

89. [Multilingual Safety Signals Are Multi-Layered: Filtering Safety-Degrading Data for Safer LLMs](#link89)
**Authors:** Jiakun Li, Guowei Song, Sijia Li, Xingwei He, Hongzheng Chai, Yuan Yuan

90. [TTSE: A Two-Track Online Self-Evolution Framework](#link90)
**Authors:** Ruimin Pei, Yongkang Wu, Shangyi Zheng, Yaqing Zhang, Deyang Li, Jianjun Tao, Xinyu Zhang, Xiang Zhang

91. [Predicting Out-of-Distribution Generalization of Neural Operators via Observable Spectral Error Decomposition](#link91)
**Authors:** Hang-Cheng Dong, Pengcheng Cheng

92. [Block-Sparse Attention with Semantic-Geometric Decoupled Routing](#link92)
**Authors:** Xinwei Long, Weigao Sun, Weibo Gao, Pengkun Jiao, Biqing Qi, Feida Zhu, Yiran Zhong, Steven Hoi, Bowen Zhou

93. [Provably Efficient Reinforcement Learning in Continuous-Time Episodic MDPs with Poisson Decision Epochs](#link93)
**Authors:** Kenny Guo, Valentio Iverson, Sahan Wijetunga, William Chang

94. [OSWorld-Pro: Process-based Evaluation for Computer Use Agents](#link94)
...
95. [Accelerating Dense LLMs via L0-regularized Mixture-of-Experts](#link95)
**Authors:** Zhenyu Zhang, Jiudong Yang, Zhaowen Tao, Meng Chen

96. [EvalMem: An Operation-Level Diagnostic Framework for Long-Term Memory Systems](#link96)
...
97. [Whitening Inverts the Hierarchy: What the Norm of a Whitened Embedding Measures](#link97)
**Authors:** Mohammed Ahnouch, Lotfi Elaachak

98. [Muon Can Outperform Dedicated Continual Learning Methods](#link98)
**Authors:** Sebastian George Sincari (Faculty of Mathematics and Computer Science, University of Bucharest, Bucharest, Romania), Bogdan Alexandru Gheorghe (Faculty of Mathematics and Computer Science, University of Bucharest, Bucharest, Romania), Antonio Barbalau (Bitdefender, Bucharest, Romania)

99. [PAGE: Partition-Aware Gated KV-Cache Eviction](#link99)
**Authors:** Pankaj Kumar, Subhankar Mishra

100. [A Distributional Optimisation Perspective on Combining Models in Deep Learning](#link100)
**Authors:** Congye Wang, Yan Lin, Zheyang Shen, Matthew A. Fisher, Chris. J. Oates

101. [Do LLMs Choose Like Humans? Using Cognitive Theory to Evaluate LLM Decision-Making](#link101)
**Authors:** Johnathan Sun, Andrei Shleifer, Yonatan Belinkov

102. [Prescriptive SVD-Inspired Attention via Spectral Energy Retention](#link102)
**Authors:** Vasileios Arampatzakis, Vasileios Sevetlidis, George Pavlidis

103. [Merge++: Universal Merge Refinement Through Data-Free Checkpoint Inversion](#link103)
**Authors:** Aditya Pola, Vineeth N. Balasubramanian

104. [Vox-Infinity: Benchmarking the Limits of Long-Context Spoken Language Models](#link104)
**Authors:** Xize Cheng, Wenxu Jia, Chenyuhao Wen, Dongjie Fu, Zehan Wang, Xinyu Zhang, Tao Jin

105. [Global Ranks Survive, Selected Heads Shift: BOS-Sink Topology under 4-bit Weight-Only Quantization](#link105)
**Authors:** Kuanlin Chen, Chen-Wei Kuo, Cheng-En Ou

106. [Enhancing Transformer Representations of Symbolic ODE Expressions](#link106)
**Authors:** Xiyue Fan, Adam Prugel-Bennett, Stuart E. Middleton

107. [AdaMem: Adaptive Memory Token Allocation for Soft Compression in Retrieval-Augmented Generation](#link107)
**Authors:** Artem Sakhno, Grigorii Davydenko, Omar Zoloev, Julia Belikova, Andrey Savchenko, Maksim Makarenko

108. [D-IMPL: A Diffusion-based Solver for Parameterized BBOs](#link108)
**Authors:** Yang Hu, Na Li

109. [List Counting Failures Are Not One Phenomenon](#link109)
**Authors:** Iyad Ait Hou, Saad Mankarious, Aya Zirikly, Rebecca Hwa

110. [DeepInstructor: An Agentic AI Instructor for Experience-Driven Idea Evaluation](#link110)
**Authors:** Rongcan Pei, Fang Guo, Qinglin Qi, Qi Zhu, Yun Luo, Jianhao Yan, Minjun Zhu, Qiujie Xie, Dehong Zheng, Yue Zhang

111. [Tool-Augmented On-Policy Distillation for LLM Domain Adaptation in Sequence-Based Omics Tasks](#link111)
...
112. [Critical-State RL: Diagnosing Trainable States for Multi-Turn Tool Use](#link112)
...
113. [Success Leaves Detours: Learning Executable Walkthroughs for Long-Horizon Agents](#link113)
**Authors:** Kaijie Chen, Chenyu Fang, Liang Yan, Bo Li, Bo Zhang, Peng Ye

114. [A Fully Differentiable Neuro-Soft-Symbolic Framework for Perceptual Task Planning](#link114)
**Authors:** Hongyan Wei, Wael AbdAlmageed

115. [Learning-to-Optimize as the Missing Architectural Layer of AI-Native Networks](#link115)
**Authors:** Giambattista Amati, Federica Mangiatordi, Pierpaolo Salvo, Emiliano Pallotti, Simone Angelini

116. [GDN Tree-Scan: Served Tree Verification for Recurrent-Hybrid Language Models](#link116)
**Authors:** Zhiyuan Ma

117. [TinyCeNN-LM: Quality-Gated Conversion of Pretrained Attention with CeNN-Inspired Cellular-Recurrent Layers](#link117)
**Authors:** Kabeh Mohsenzadegan, Vahid Tavakkoli, Kyandoghere Kyamakya

118. [Token Signatures of Code: Comparing Coding Behaviors Across Large Language Models](#link118)
**Authors:** Junpeng Wang, Yuzhong Chen, Menghai Pan, Uday Singh Saini, Yiwei Cai

119. [When Cosine Similarity Fails to Reflect Linearly Accessible Structure in Dialogue Models](#link119)
**Authors:** Yu Sun, Mengyin Lu, Cong Feng, Guangming Lu, Huimin Han

120. [KV-COBRA: KV Cache Compression via Co-Optimized Bit-Rank Allocation](#link120)
**Authors:** Sihyeon Ha, Jaeho Lee, Yo-Seb Jeon

121. [Pretrained Persona Mixture Models and Tandem Models for Human Simulation](#link121)
**Authors:** Minwoo Kang, T\'ea Wright, Seun Eisape, Ayush Raj, Suhong Moon, Joseph Suh, Alane Suhr, David M. Chan, John Canny

122. [COT-TTS: Audio Context-Aware Text-to-Speech with Chain-of-Thought Reasoning](#link122)
...
123. [Observational Equivalence of LLM and Human Annotation](#link123)
**Authors:** Kentaro Nakamura, Jing Ling Tan, George Yean

124. [RPMem: Learning Long-Term Recurrent Parametric Memory Across Sessions for LLM Agents](#link124)
**Authors:** Fanyu Zhao, Ruike Cao, Liang Dong, Fugen Yao, Jian Xu, Guanjun Jiang, Han Zhang, Yifei Zhao, Yinsheng Li

125. [Toollery: Scaling LLM Agents to Thousands of Skills and Tools](#link125)
**Authors:** Xiangxi Tian, Ran Guan

126. [An Empirical Cost Attribution of Context-Compression Gateways in Multi-Turn Coding Agents](#link126)
**Authors:** Luzhuo Chen, Jiayu Shi

127. [PRQuant: Permutation Residual Quantization for Low-Overhead Inference](#link127)
...
128. [Correlation-Aware Structured Pruning for Large Language Models](#link128)
**Authors:** Sicheng Xu, Hao Shi, Wei Zhang, Haoran Pang, Zhenyu Ming, Hao Wu, Zhongyi Huang, Xin Yao, Gong Zhang

129. [A Tutorial on Prompt Engineering: From Messy Thoughts to AI Workflows](#link129)
**Authors:** Erfan Loweimi, Hadi Daneshvar, Samira Loveymi, Samir Ouelha, Zhengjun Yue, Hajar Mozaffar, Saturnino Luz

130. [Misaligned Clinical Risk Classification and Cost Asymmetry in Open-Weight Large Language Models](#link130)
**Authors:** Star S. D. Liu, Xiyu Ding, Robert B. Barrett, Alberto Santamaria-Pang, Nic Dobbins, Harold P. Lehmann

131. [AutoViewMem: Self-Configuring Orthogonal Views for Conversational Long-Term Memory](#link131)
