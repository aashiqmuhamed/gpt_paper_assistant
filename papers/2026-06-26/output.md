...
0. [When Does Combining Language Models Help? A Co-Failure Ceiling on Routing, Voting, and Mixture-of-Agents Across 67 Frontier Models](#link0)
**Authors:** Josef Chen

1. [Nemotron-TwoTower: Diffusion Language Modeling with Pretrained Autoregressive Context](#link1)
**Authors:** Fitsum Reda, John Kamalu, Roger Waleffe, Mostofa Patwary, Mohammad Shoeybi, Bryan Catanzaro

2. [DualEval: Joint Model-Item Calibration for Unified LLM Evaluation](#link2)
**Authors:** Aaron J. Li, Hao Huang, Youngmin Park, Yitong Ma, Wei-Lin Chiang, Li Chen, Cho-Jui Hsieh, Bin Yu, Ion Stoica

3. [Dataset Usage Inference without Shadow Models or Held-out Data](#link3)
**Authors:** Wojciech {\L}apacz, Stanis{\l}aw Pawlak, Jan Dubi\'nski, Franziska Boenisch, Adam Dziedzic

4. [The Red Queen G\"odel Machine: Co-Evolving Agents and Their Evaluators](#link4)
...
5. [Know2Guess: A Contamination-Aware Multi-Zone Benchmark for Knowledge-Boundary Evaluation in Large Language Models](#link5)
**Authors:** Renwei Meng, Bowen Zhang, Jian Wang, Xican Wang, Haoyi Wu, Xuanyan Qiu, Shengan Yang

6. [NebulaExp-8B: An Empirical Post-Training Pipeline via Full-Scale Ablation Research](#link6)
**Authors:** Qiaobo Hao, Yangqian Wu, Shunyi Wang, Zhongjian Zhang, Ziqun Li, Yayin He, Muqing Li, Chen Zhong

7. [Discovering Millions of Interpretable Features with Sparse Autoencoders](#link7)
**Authors:** XinYang He, Wei Wang, Bing Zhao, Xuan Ren, WenBo Li, WeiXu Qiao, Hu Wei, Lin Qu

8. [Dynamic-dLLM: Dynamic Cache-Budget and Adaptive Parallel Decoding for Training-Free Acceleration of Diffusion LLM](#link8)
**Authors:** Tianyi Wu, Xiaoxi Sun, Yanhua Jiao, Yulin Li, Yixin Chen, YunHao Cao, YiQi Hu, Zhuotao Tian

9. [At the Edge of Understanding: Sparse Autoencoders Trace The Limits of Transformer Generalization](#link9)
**Authors:** Praneet Suresh, Jack Stanley, Sonia Joseph, Luca Scimeca, Danilo Bzdok

10. [Ask, Don't Judge: Binary Questions for Interpretable LLM Evaluation and Self-Improvement](#link10)
**Authors:** Sangwoo Cho, Kushal Chawla, Pengshan Cai, Zefang Liu, Chenyang Zhu, Shi-Xiong Zhang, Sambit Sahu

11. [Reinforcement Learning without Ground-Truth Solutions can Improve LLMs](#link11)
**Authors:** Yingyu Lin, Qiyue Gao, Nikki Lijing Kuang, Xunpeng Huang, Kun Zhou, Tongtong Liang, Zhewei Yao, Yi-An Ma, Yuxiong He

12. [Reasoning Quality Emerges Early: Data Curation for Reasoning Models](#link12)
**Authors:** Hongyi Henry Jin, Wenhan Yang, Meysam Ghaffari, Carlos Morato, Baharan Mirzasoleiman

13. [Decision-Aligned Evaluation of Uncertainty Quantification](#link13)
**Authors:** Annika Schneider, Tommy Rochussen, Joshua Stiller, Vincent Fortuin

14. [Where Larger Models Excel: The Primacy of Constraint-Guided Reasoning](#link14)
**Authors:** Guan-Yi Lin, Hen-Hsen Huang

15. [Paved with True Intents: Intent-Aware Training Improves LLM Safety Classification Across Training Regimes](#link15)
**Authors:** Jeremias Ferrao, Niclas M\"uller-Hof, Iustin S\^irbu, Traian Rebedea, Yftah Ziser

16. [The Riddle Riddle: Testing Flexible Reasoning in Large Language Models and Humans](#link16)
**Authors:** Bella Fascendini, Kathryn McGregor, Max D. Gupta, Thomas L. Griffiths

17. [From Weights to Features: SAE-Guided Activation Regularization for LLM Continual Learning](#link17)
**Authors:** Evan Ning, Wei Xue, Dong Lou, Yike Guo

18. [Life After Benchmark Saturation: A Case Study of CORE-Bench](#link18)
...
19. [The Capability Frontier: Benchmarks Miss 82% of Model Performance](#link19)
**Authors:** Bradley Fowler, Ryan Smith, Daniel Thi Graviet, William Myers, Joshua Greaves, Narmeen Fatimah Oozeer, Ant\'ia Garc\'ia, Philip Quirke, Amirali Abdullah, Fazl Barez, Shriyash Kaustubh Upadhyay

20. [Where Do CoT Training Gains Land in LLM based Agents?](#link20)
**Authors:** Jingyu Liu, Zhiwen Wang, Yuxin Jing, Huanyu Zhou, Yong Liu

21. [Einstein World Models](#link21)
**Authors:** Munachiso Samuel Nwadike, Zangir Iklassov, Ali Mekky, Zayd M. Kawakibi Zuhri, Kentaro Inui

22. [Autoregressive Boltzmann Generators](#link22)
**Authors:** Danyal Rehman, Charlie B. Tan, Yoshua Bengio, Avishek Joey Bose, Alexander Tong

23. [OPID: On-Policy Skill Distillation for Agentic Reinforcement Learning](#link23)
...
24. [Sketched Linear Contrastive Learning: Approximation, Optimization, and Statistical Scaling](#link24)
**Authors:** Ziyan Chen, Zhongzhu Zhou, Ding-Xuan Zhou

25. [Humans Disengage, Reasoning Models Persist: Separating Difficulty Registration from Deliberation Allocation](#link25)
**Authors:** Han-yu Wang

26. [LMs as Task-Specific Knowledge Bases: An Interpretability Analysis](#link26)
**Authors:** Amit Elhelo, Amir Globerson, Mor Geva

27. [Localizing RL-Induced Tool Use to a Single Crosscoder Feature](#link27)
**Authors:** Andrii Shportko, Shubham Bhokare, Ahmed Zeyad A Alzahrani, Bowen Cheng, Gustavo Mercier, Jessica Hullman

28. [\textsc{DiARC}: Distinguishing Positive and Negative Samples Helps Improving ARC-like Reasoning Ability of Large Language Models](#link28)
**Authors:** Yuxuan Yang, Feiyang Li, Yile Wang

29. [Reproducibility Study of "AlphaEdit: Null-Space Constrained Knowledge Editing for Language Models"](#link29)
**Authors:** Ananth K S, Arya Hariharan

30. [RedVox: Safety and Fairness Gaps in Speech Models Across Languages](#link30)
**Authors:** Beatrice Savoldi, Sara Papi, Wafa Aissa, Matteo Negri, Luisa Bentivogli

31. [Can Large Language Models Reliably Code Qualitative Humanitarian Data? A Benchmark Study Against Human Expert Adjudication](#link31)
**Authors:** Jerome Marston, Tino Kreutzer, Salom\'e Garnier, Ella Boone, Phuong N Pham, Patrick Vinck

32. [ProfileFoundry: A Synthetic Person-Object Substrate for Privacy, Memory, and Tool-Use Evaluation in LLM Agent](#link32)
**Authors:** Sriram Selvam, Anneswa Ghosh

33. [Data-driven Machine Learning Cannot Reach Symbolic-level Logical Reasoning -- The Limit of the Scaling Law](#link33)
**Authors:** Tiansi Dong, Mateja Jamnik, Pietro Li\`o

34. [The Inattentional Gap: Task-Conditioned Language and Vision Models Omit the Safety-Critical Signals They Can Otherwise Report](#link34)
**Authors:** Kwan Soo Shin

35. [ConflictScore: Identifying and Measuring How Language Models Handle Conflicting Evidence](#link35)
**Authors:** Siyi Liu, Aaron Halfaker, Dan Roth, Patrick Xia

36. [Soft Token Alignment for Cross-Lingual Reasoning](#link36)
**Authors:** Jiayi He, Jungsoo Park, Wei Xu, Alan Ritter

37. [Governing Actions, Not Agents: Institutional Attestation as a Governance Model for Autonomous AI Systems](#link37)
**Authors:** Jakob Salfeld-Nebgen

38. [The Verification Horizon: No Silver Bullet for Coding Agent Rewards](#link38)
...
39. [Erase-then-Delta Attention: Decoupling Erase and Write Addresses in Delta-Rule Linear Attention](#link39)
...
40. [Beyond the Hard Budget: Sparsity Regularizers for More Interpretable Top-k Sparse Autoencoders](#link40)
**Authors:** Nathana\"el Jacquier, Maria Vakalopoulou, Mahdi S. Hosseini

41. [HyperDFlash: MHC-Aligned Block Speculative Decoding with Gated Residual Reduction](#link41)
**Authors:** Luxi Lin, Shuang Peng, Rui Ma, Junhao Hua, Shuwei Fan, Zhengda Qin, Qiang Wang, Hongjian Sun, Fangmin Chen, Songwei Liu

42. [Automating Potential-based Reward Shaping with Vision Language Model Guidance](#link42)
**Authors:** Henrik M\"uller, Daniel Kudenko

43. [Investigating LLM's Problem Solving Capability -- a Study on Statics Questions](#link43)
**Authors:** Tanner Culleton, Hung-Fu Chang

44. [What Survives When You Compress a Recursive Reasoner for the Edge?](#link44)
**Authors:** Pearse Jim, Steven Kolawole, Opegbemi Matthias Busoye, Glory Bagai, Virginia Smith

45. [Effective Covariance Dynamics in Solvable High-Dimensional GANs](#link45)
**Authors:** Andrew Bond, Zafer Do\u{g}an

46. [Structure Before Collapse: Transient semantic geometry in next-token prediction](#link46)
**Authors:** Yize Zhao, Isabel Papadimitriou, Christos Thrampoulidis

47. [Temporal Validity in Retrieval Memory: Eliminating Stale-Fact Errors for AI Agents over Evolving Knowledge](#link47)
**Authors:** Neeraj Yadav

48. [Algorithmic Foundations of Deep Learning: Complexity-Theoretic Rates and a Characterization of Universal Approximation](#link48)
**Authors:** Anastasis Kratsios, Simone Brugiapaglia, Bum Jun Kim, Gregory Cousins, Haitz S\'aez de Oc\'ariz Borde

49. [Just how sure are you? Improving Verbalized Uncertainty Calibration in Medical VQA](#link49)
**Authors:** Eren Senoglu, Federico Toschi, Nicolo Brunello, Andrea Sassella, Mark James Carman

50. [Information-Aware KV Cache Compression for Long Reasoning](#link50)
**Authors:** Jushi Kai, Zhuiri Xiao, Alexandra Birch, Zhouhan Lin

51. [The Geometry of Updates: Fisher Alignment at Vocabulary Scale](#link51)
**Authors:** John Sweeney

52. [Escaping Iterative Parameter-Space Noise: Differentially Private Learning with a Hypernetwork](#link52)
**Authors:** Naoki Nishikawa, Shokichi Takakura, Satoshi Hasegawa

53. [Scientific discovery as meta-optimization: a combinatorial optimization case study](#link53)
**Authors:** Yuan-Hang Zhang, Chesson Sipling, Massimiliano Di Ventra

54. [TOPS: First-Principles Visual Token Pruning via Constructing Token Optimal Preservation Sets for Efficient MLLM Inference](#link54)
...
55. [Instruction Bleed: Cross-Module Interference in Prompt-Composed Agentic Systems](#link55)
**Authors:** Ching-Yu Lin, Yifan Liu

56. [SharQ: Bridging Activation Sparsity and FP4 Quantization for LLM Inference](#link56)
**Authors:** Haoqian Meng, Yilun Luo, Yafei Zhao, Wenyuan Liu, Huaqing Zheng, Xindian Ma, Peng Zhang

57. [Generative Retrieval via Diffusion Transformer with Metric-Ordered Sequence Training and Hybrid-Policy Preference Optimization](#link57)
