# Personalized Daily Arxiv Papers 07/20/2026
...
0. [Verbalizable Representations Form a Global Workspace in Language Models](#link0)
...
1. [ASK-NN: An Asymmetric Nearest-Neighbor Test that detects Distribution Drifts in Natural Language](#link1)
**Authors:** Sergey Zakharov, Rodion Oblovatny, Alexey Zaytsev

2. [BayesPO: Bayesian Prompt Optimization via Parallel-Tempered Gradient-Guided Discrete MCMC](#link2)
**Authors:** Junjie Zhou, Zhijian Ou

3. [Relevant and Irrelevant: A Renormalization Group Analysis of Transformer Attention](#link3)
**Authors:** Parviz Haggi-Mani, Irina Rish

4. [Recursive Harness Self-Improvement](#link4)
**Authors:** Hyunin Lee, Jinglue Xu, Jeffrey Seely, Donghyun Lee, Matei Zaharia, Yujin Tang

5. [Adaptive Multi-Step Lookahead Decoding for Diffusion Language Models](#link5)
**Authors:** Yingqian Cui, Wei Deng, Lantao Mei, Hang Li, Charu C. Aggarwal, Hui Liu, Yue Xing

6. [Understanding Reasoning from Pretraining to Post-Training](#link6)
**Authors:** Jingyan Shen, Ang Li, Salman Rahman, Yifan Sun, Micah Goldblum, Matus Telgarsky, Pavel Izmailov

7. [CRAFT: Clustering Rubrics to Diagnose Weak LLM Capabilities and Generate Targeted Fine-Tuning Data](#link7)
**Authors:** Vipul Gupta, Zihao Wang, Razvan-Gabriel Dumitru, MohammadHossein Rezaei, Aakash Sabharwal, Yunzhong He

8. [Better Starts, Better Ends: Bootstrapped Iterative Self-Reasoning Distillation for Compressed Reasoning](#link8)
**Authors:** Leichao Dong, Dongxu Zhang, Yiding Sun, Qirui Wang, Yuhan Wang, Lin Chen, Jihua Zhu

9. [ToolVerse: Unlocking Massive Environments and Long-Horizon Tasks for Agentic Reinforcement Learning](#link9)
**Authors:** Shuaiyu Zhou, Fengpeng Yue, Zengjie Hu, Yuanzhe Shen, Chenyang Zhang, feng hong, Cao Liu, Ke Zeng

10. [Diffusion models recover accurate mixture weights despite score function insensitivity](#link10)
**Authors:** Andrew Dennehy, Ramchandran Muthukumar, Rebecca Willett, Nisha Chandramoorthy

11. [Frontier Language Models Struggle to Copy: Text Can Be Better Viewed in 2D](#link11)
**Authors:** Haodong Wen, Yiran Zhang, Yingfa Chen, Kaifeng Lyu

12. [Causal-Audit: Explicit and Auditable Graph-based Reasoning via Target-Aware Causal Chain Construction](#link12)
**Authors:** Su Lan, Xuefei Yin, Yanming Zhu, Alan Wee-Chung Liew

13. [ContinuityBench: A Benchmark and Systems Study of Stateful Failover in Multi-Provider LLM Routing](#link13)
**Authors:** Vishal Pandey, Gopal Singh

14. [Process Reward Informed Tree Rollout for Effective Multi-Turn RL](#link14)
...
15. [Publicly-Verifiable Certificates for Statistical Algorithms](#link15)
**Authors:** Michael Ngo, Michael P. Kim

16. [Knowledge-Centric Agents for Workflow Generation](#link16)
**Authors:** Zhendong Li, Lei Sun, Ruibo Ming, He Zhang, Danda Pani Paudel, Luc Van Gool, Jinjin Gu

17. [Cura 1T: Specialized Model for Agentic Healthcare](#link17)
...
18. [Position: Quantum Program Generation Must Prioritize Validity Over Probabilistic Scaling](#link18)
**Authors:** Junhao Song, Yu Zhou, William Knottenbelt, Yudong Cao

19. [Loop the Loopies!](#link19)
**Authors:** Zitian Gao, Yilong Chen, Yihao Xiao, Xinyu Yang, Ran Tao, Joey Zhou, Bryan Dai

20. [When Does Muon Help Agentic Reinforcement Learning?](#link20)
**Authors:** Kai Ruan, Jinghao Lin, Zihe Huang, Ziqi Zhou, Qianshan Wei, Xuan Wang, Hao Sun

21. [Frontier AI performance across the business disciplines: a case-grounded benchmark of knowledge work and analytical reasoning](#link21)
**Authors:** Ajay Patel, Kartik Hosanagar, Ramayya Krishnan, Chris Callison-Burch, Karim Lakhani, Mitch Weiss

22. [VarRate: Training-Free Variable-Rate KV Cache Compression for Long-Context LLMs](#link22)
**Authors:** Shahrzad Esmat, Dhawal Shah, Ali Jannesari

23. [PagedWeight: Efficient MoE LLM Serving with Dynamic Quality-Aware Weight Quantization](#link23)
**Authors:** Yuchen Yang, Yifan Zhao, Anisha Dasgupta, Sasa Misailovic

24. [Before the Action: Benchmarking LLMs on Prospective Hypothesis Discovery](#link24)
...
25. [Rethinking Transfer in Continual Learning: A Replay-Based Realisation](#link25)
**Authors:** Yang Meng, Zhenya Liu, Zhuokai Zhao, Yuxin Chen

26. [QUADS: Stabilizing NVFP4 Reinforcement Learning for MoE via QUantization-error Alignment across Dual Sides](#link26)
**Authors:** Zhengyang Zhuge, Hao Yu, Xin Wang, Zheng Li, Yizhong Cao, Dayiheng Liu, Jianwei Zhang

27. [When Do Multi-Agent Systems Help? An Information Bottleneck Perspective](#link27)
...
28. [From Plausible to Actionable: A Position on LLM Self-Explanations](#link28)
**Authors:** Elize Herrewijnen, Benedetta Muscato, Gizem Gezici, Fosca Giannotti

29. [SkillCorpus: Consolidating and Evaluating the Open Skill Ecosystem for Real-World LLM Agents](#link29)
**Authors:** Yanze Wang, Pengfei Yao, Tianyi Sun, Chuanrui Hu, Yan Xiao, Yunyun Han, Jun Sun, Yafeng Deng

30. [Rate-Utility Frontiers for Language Encodings: Comparing Tokens, Bytes, and Pixels Under Controlled Linguistic Content](#link30)
**Authors:** Ingo Ziegler, Martin Krebs, Desmond Elliott

31. [Logic, Optimization, and Artificial Intelligence](#link31)
**Authors:** J. N. Hooker

32. [An MLIR-Based Compilation Method for Large Language Models](#link32)
**Authors:** Pengchao Hu, Zhibin Xin, Yifan Chen, Yangyang Zhou, Liang Wang

33. [S1-Omni: A Unified Multimodal Reasoning Model for Scientific Understanding, Prediction, and Generation](#link33)
