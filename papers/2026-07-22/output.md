...
0. [Measuring Reward-Seeking via Contrastive Belief Updates](#link0)
...
1. [S2T-RLHF: Hierarchical Credit Assignment for Stable Preference-Based RLHF](#link1)
**Authors:** Wei Chen, Guanghui Zhu, Yafei Li, Limin Wang, Yihua Huang

2. [Two-Level Meta-Rubrics for Evaluating Open-Ended Generation: GAMUT, a Benchmark for Factual Completeness](#link2)
**Authors:** Xilun Chen, Zhaleh Feizollahi, Ross Goodwin, Seungwhan Moon, Scott Yih, Pinar Donmez, Babak Damavandi, Luna Dong

3. [ISO: An RLVR-Native Optimization Stack](#link3)
...
4. [Reasoning Fine-Tuning Induces Persistent Latent Policy States](#link4)
**Authors:** Abir Harrasse, Michael Lan, Hunar Batra, Fateme Hashemi Chaleshtori, Chaithanya Bandi

5. [Off-Context GRPO: Learning to Reason on Hard Problems using Privileged Information](#link5)
**Authors:** Priyank Agrawal, Ankur Samanta, Shervin Ghasemlou, Jalaj Bhandari, Kavosh Asadi, Daniel Jiang, Aditya Modi

6. [Reasoning Error from Known Fact: Step-Level Self-Consistency Group Relative Policy Optimization for LLM](#link6)
**Authors:** Xiaomeng Hu, Jiaqi Hu, Hao Chen, Qi Zhang, Zhanming Shen, Wentao Ye, Junbo Zhao

7. [Structured Output Collapses Answer Diversity Across 44 Language Models](#link7)
**Authors:** Tapan Parikh

8. [Mark, Don't Erase: Token Inoculation for Dual-Use Knowledge in LLMs](#link8)
**Authors:** Seunghyun Lee, Dongyoon Han, Sangdoo Yun

9. [MUX: Continuous Reasoning via Multiplexed Tokens](#link9)
**Authors:** Ayhan Suleymanzade, Halil Alperen Gozeten, Michael Bronstein, \.Ismail \.Ilkan Ceylan, Jinwoo Kim

10. [Stochastic Meta-Unlearning: Bridging Language Backbone and Multimodal Unlearning](#link10)
**Authors:** Zijie Liu, Jinhao Duan, Gaowen Liu, Sijia Liu, Tianlong Chen

11. [Elicitation without Backpropagation: Steering Model Behavior by Optimizing the Latent Posterior](#link11)
**Authors:** Garrett Baker, Vinayak Pathak, Daniel Murfet, Susan Wei

12. [AdaFlash: Adaptive Speculative Decoding via On-Policy Distilled Diffusion Drafters](#link12)
**Authors:** Yu-Yang Qian, Hao-Cong Wu, Chen Chen, Jiacheng Sun, Zhenhua Dong, Peng Zhao, Zhi-Hua Zhou

13. [H$^2$SD: Hybrid Hindsight Self-Distillation](#link13)
**Authors:** Qiye Cai, Yichuan Ma, Linyang Li, Peiji Li, Yongkang Chen, Qipeng Guo, Yicheng Zou, Tao Gui, Xiaocheng Feng, Bing Qin

14. [ResearchArena: Evaluating Sabotage and Monitoring in Automated AI R&D](#link14)
**Authors:** Lena Libon, Ben Rank, Jehyeok Yeon, David Schmotz, Jeremy Qin, Daniel Donnelly, Derck Prinzhorn, Maksym Andriushchenko

15. [On the Limits of Support-Preserving Alignment and Bounded Filtering](#link15)
**Authors:** Aryan Dutt, Rui Mao, Anupam Chattopadhyay

16. [On the Diverse Dynamical Behaviors Arising in Deep Linear Transformers](#link16)
**Authors:** Sixu Li, Thomas Jacob Maranzatto, Jan Peszek, Trevor Teolis, Semih Akkoc, Konstantin Riedl, Sennur Ulukus, Nicol\'as Garc\'ia Trillos

17. [PEARL: Solver-in-the-Loop Interactive Optimization Modeling from Natural Language](#link17)
**Authors:** Hongliang Lu, Zhong Li, Yuxuan Chen, Yuan Lan, Fan Zhang, Zaiwen Wen

18. [One Student, Many Teachers: Multi-Task On-Policy Distillation via Soft-Prompt Privileged Context](#link18)
**Authors:** Yingzi Ma, Zichen Zhu, Ming Jiang, Chaowei Xiao

19. [Wisdom of LLM Crowds: Aggregation and Contamination in Language Model Ensembles](#link19)
**Authors:** Igor Douven

20. [Signed Rectified Flow: Negativity-Controlled Generation](#link20)
**Authors:** Runlong Liao, Baiyu Su, Lizhang Chen, Qiang Liu

21. [LatentMT: Machine Translation with Latent Reasoning](#link21)
**Authors:** Wei-Rui Chen, Samar M. Magdy, Chiyu Zhang, Wenhui Zhu, Zhipeng Wang, Muhammad Abdul-Mageed

22. [RRPO: Reference-Relative Policy Optimization with Stratified Conditional Rollouts](#link22)
...
23. [Verifiable Self-Evolution for Open-Ended Dialogue Skills via Future-Feedback Prediction](#link23)
**Authors:** ChaoJin Zhao, Xuan Jiang

24. [Circuit Claims Depend on What Is Extracted and How It Is Compared](#link24)
**Authors:** Yang Sheng, Jie Fu

25. [Provable diffusion-based posterior sampling for linear inverse problems via DDIM](#link25)
**Authors:** Yuchen Jiao, Na Li, Changxiao Cai, Yuxin Chen, Gen Li

26. [TD-DPO: Difference-Aware Preference Optimization for Mitigating Sycophancy in Clinical Autism Intervention Dialogue](#link26)
**Authors:** Shuzhong Lai, Junhong Lai, Chenxi Li, Qing Zhou, Haifeng Li, Gang Pan, Lin Yao, Yueming Wang

27. [Adopting Reinforcement Learning with Verifiable Rewards for Molecular Generation](#link27)
**Authors:** Mingxuan Ouyang, Hao Lan, Wanyu Lin

28. [LLM Detection as an Intervention: Downstream Impact under Strategic User Behavior](#link28)
**Authors:** Meena Jagadeesan, Tatsunori Hashimoto, Jon Kleinberg

29. [Find Before You Fine-Tune: A Diagnostic Study of Small LLMs for Cybersecurity QA](#link29)
**Authors:** Shaswata Mitra, Subash Neupane, Trisha Chakraborty, Himanshu Tripathi, Sudip Mittal, Aritran Piplai, Shahram Rahimi

30. [Selective State-Space Adaptation and Retrieval for Language Model Reasoning](#link30)
**Authors:** Atahan Dokme, Larry Heck

31. [Fishing Out Free Riders: Shapley-Based Reward Attribution for Parallel Reasoning via Reinforcement Learning](#link31)
**Authors:** Wentao Zhang, Haoyu Zhang, Xinke Jiang, Yuxuan Cheng, Yuhan Pan, Miao Li, Zhipeng Qiao, Tao Feng, Zhen Tao, Dengji Zhao

32. [DAIS: Dependency-Aware Intermediate QA Supervision for Complex Reasoning](#link32)
**Authors:** Yu Wang, Ming Fan, Xicheng Zhang, Zhiyong Li, Zhihu Wang, Caiyue Xu, Dahai Hu, Ting Liu

33. [SciHazard: A Benchmark for Measuring Scientific Safety Risks with Decomposed Harm Scoring](#link33)
**Authors:** Chunxiao Li, Yuan Xiong, Lijun Li, Tianyi Du, Wenlong Zhang, Lei Bai, Jing Shao

34. [Beyond Score Prediction: LLM-Based Essay Scoring and Feedback Generation via Reinforcement Learning with Rubric Rewards](#link34)
**Authors:** Xuefeng Jin, Jiashuo Zhang, Teng Cao, Bin Yang

35. [Semantic Cooperative Games for Contribution Attribution in LLM-Based Multi-Agent Systems](#link35)
**Authors:** Pengyi Jiang, Xiaoguang Zhu, Quanyan Zhu

36. [Convolution for Large Language Models](#link36)
**Authors:** Yuchuan Tian, Yingte Shu, Wei He, Shuo Zhang, Tianchen Zhao, Chao Xu, Xinghao Chen, Yunhe Wang, Hanting Chen, Yu Wang

37. [Reasoning Before Translation: Enhancing Legal Machine Translation with Structured Reasoning](#link37)
**Authors:** Aixiu An, Michael Jungo, Eloi Eynard, Mark Drenhaus, Andreas Fischer, Jean Hennebert, S\'ebastien Rumley

38. [Relative Positions Generalize, Absolute Positions Memorize: An Implicit-Bias Account of Length Generalization in Attention](#link38)
**Authors:** Subham Singh, Ashutosh Mishra, Subha Raut

39. [Intelligence from Learnable Novelty](#link39)
**Authors:** Yanbo Zhang, Michael Levin

40. [Conservative Query and Adaptive Regularization for Offline RL Under Uncertainty Estimation](#link40)
**Authors:** Li-Rong Zhou, Qin-Wen Luo, Sheng-Jun Huang

41. [Spectral Higher-Order Neural Networks Have Sharp Expressivity Bounds](#link41)
**Authors:** Gianluca Peri, Diego Febbe, Duccio Fanelli

42. [Weak-to-Strong Learning in Decision Making](#link42)
**Authors:** Jingwei Ji, Renyuan Xu

43. [From Dependency to Compositionality: A Neurosymbolic Lifting of LLM Outputs via Combinatory Categorial Grammar](#link43)
**Authors:** Remo Pareschi

44. [Search-on-Graph-R1: Training Large Language Models to Search Knowledge Graphs with Reinforcement Learning](#link44)
**Authors:** Jia Ao Sun, Hao Yu, Fengran Mo, Zhan Su, Yuchen Hui, Bang Liu, Jian-Yun Nie

45. [Beyond Accuracy and Cost: Latency-Aware LLM Query Routing for Dynamic Workloads](#link45)
**Authors:** Shivam Patel, Akaash R. Parthasarathy, Ankur Mallick, Gauri Joshi

46. [Beyond Single-Dimensional Compression: The Compound Sparsity Frontier of Large Language Models](#link46)
**Authors:** Chao Han, Haozhe Hu, Xiaoyu Shen

47. [Interactive Training 2: Auditable Control Plane for Live Model Training](#link47)
**Authors:** Wentao Zhang, Xuanhe Pan, Han Zhou, Yang Lu, Yuntian Deng

48. [The Story Shapes the Agent: Narrative Priors in LLM Behavior](#link48)
**Authors:** Yixuan Wang, James Lester, Shashank Srivastava

49. [Exposure-Based Reinforcement Learning to Rank](#link49)
**Authors:** Harrie Oosterhuis, Rolf Jagerman, Zhen Qin, Xuanhui Wang

50. [Probabilistic Concept-Aware Steering for Trustworthy LLM Inference](#link50)
**Authors:** Brian Becker, Rui Chu, Yingjie Lao

51. [AgentDebugX: An Open-Source Toolkit for Failure Observability, Attribution, and Recovery in LLM Agents](#link51)
