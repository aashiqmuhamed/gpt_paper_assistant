# Personalized Daily Arxiv Papers 06/09/2026
Total relevant papers: 143

Paper selection prompt and criteria at the bottom

Table of contents with paper titles:

0. [When Behavioral Safety Evaluation Fails: A Representation-Level Perspective](#link0)
**Authors:** Enyi Jiang, Anders Gj{\o}lbye, Yibo Jacky Zhang, Sanmi Koyejo

1. [Data-Efficient Autoregressive-to-Diffusion Language Models via On-Policy Distillation](#link1)
...
2. [Reasoning Arena: Trace Tournaments When Verifiable Rewards Fall Short](#link2)
**Authors:** Han Zhou, Adam X. Yang, Laurence Aitchison, Anna Korhonen, Albert Q. Jiang

3. [Diffuse AI Control on Fuzzy Tasks](#link3)
**Authors:** Mikhail Terekhov, Caglar Gulcehre, Vivek Hebbar, Joe Benton

4. [A Unifying Framework for Concept-Based Representational Similarity](#link4)
**Authors:** Gr\'egoire Dhimo\"ila, Victor Boutin, Agustin Martin Picard, Thomas Fel, Thomas Serre

5. [ComplexConstraints and Beyond: Expert Rubrics for RLVR](#link5)
**Authors:** Sushant Mehta, Liudas Panavas, Edwin Chen

6. [Item Response Scaling Laws: A Measurement Theory Approach for Efficient and Generalizable Neural Scaling Estimation](#link6)
**Authors:** Sang Truong, Yuheng Tu, Rylan Schaeffer, Sanmi Koyejo

7. [INFUSER: Influence-Guided Self-Evolution Improves Reasoning](#link7)
...
8. [Trajectory-Refined Distillation](#link8)
**Authors:** Li Jiang, Haoran Xu, Yichuan Ding, Amy Zhang

9. [LEAF: Growing Trees Without Branching for Speech-Aware Large Language Model Post-Training](#link9)
**Authors:** Argyrios Gerogiannis, Yekaterina Yegorova, Mark Hasegawa-Johnson, Venugopal V. Veeravalli

10. [Sequential statistical inference for Large Language Models: Representation, validity, and monitoring](#link10)
**Authors:** Yao Xie

11. [Proxy Reward Internalization and Mechanistic Exploitation: A Learned Precursor to Reward Hacking and Its Generalization](#link11)
**Authors:** Mohammad Beigi, Ming Jin, Lifu Huang

12. [The Easy, the Hard, and the Learnable: Confidence and Difficulty-Adaptive Policy Optimization for LLM Reasoning](#link12)
**Authors:** Zhanke Zhou, Xiangyu Lu, Chentao Cao, Brando Miranda, Tongliang Liu, Bo Han, Sanmi Koyejo

13. [Shared Latent Structures Enable Unified Backdoor Detection and Mitigation in LLMs](#link13)
...
14. [Benchmarking Empirical Privacy Protection for Adaptations of Large Language Models](#link14)
**Authors:** Bart{\l}omiej Marek, Lorenzo Rossi, Vincent Hanke, Xun Wang, Michael Backes, Franziska Boenisch, Adam Dziedzic

15. [Rethinking the Divergence Regularization in LLM RL](#link15)
**Authors:** Jiarui Yao, Xiangxin Zhou, Penghui Qi, Wee Sun Lee, Liefeng Bo, Tianyu Pang

16. [From Shortcuts to Reasoning: Robust Post-Training of Theory of Mind with Reinforcement Learning](#link16)
**Authors:** Jike Zhong, Yuxiang Lai, Ming Li, Yuheng Li, Wuao Liu, Behzad Dariush, Konstantinos Psounis, Shao-Yuan Lo

17. [On Choosing the $\mu$ Parameter in Gaussian Differential Privacy](#link17)
**Authors:** Bogdan Kulynych, Antti Honkela

18. [WhiFlash: Accelerating Speculative Decoding with Token-Level Cross-Paradigm Routing](#link18)
**Authors:** Young D. Kwon, Miles Williams, Rui Li, Alexandros Kouris, Stylianos I. Venieris

19. [Auditing Training Data in Domain-adapted LLMs: LoRA-MINT](#link19)
**Authors:** Gonzalo Mancera, Daniel DeAlcala, Aythami Morales, Julian Fierrez, Ruben Tolosana, Francisco Jurado

20. [Where Instruction Hierarchy Breaks: Diagnosing and Repairing Failures in Reasoning Language Models](#link20)
**Authors:** Sanjay Kariyappa, G. Edward Suh

21. [The Piggyback Hypothesis of Generalization: Explaining and Mitigating Emergent Misalignment](#link21)
**Authors:** Jiachen Zhao, Zhengxuan Wu, Aryaman Arora, Yiyou Sun, David Bau, Weiyan Shi

22. [A Regret Minimization Framework on Preference Learning in Large Language Models](#link22)
**Authors:** Suhwan Kim, Taehyun Cho, Geon-Hyeong Kim, Yu Jin Kim, Youngsoo Jang, Moontae Lee, Jungwoo Lee

23. [ConSteer-RL: Steering Reasoning Capabilities in Large Language Models via Confidence-Aware Reinforcement Learning](#link23)
**Authors:** Qing Miao, Yiming Zhao, Jing Yang, Chenxi Liu, Yuehai Chen, Yuewen Liu, Shaoyi Du, Badong Chen

24. [Inference-Time Conformal Reasoning with Valid Factuality Control for Large Language Models](#link24)
**Authors:** Ting Wang, Yuanjie Shi, Yan Yan, Huan Zhang

25. [UnpredictaBench: A Benchmark for Evaluating Distributional Randomness in LLMs](#link25)
...
26. [Sparrow: Sparse Rollout for Stable and Efficient Long-context RL of Large Language Models](#link26)
...
27. [Reformulate LLM Reinforcement Learning for Efficient Training under Black-box Discrepancy](#link27)
**Authors:** Jiashun Liu, Runze Liu, Xu Wan, Jing Liang, Hongyao Tang, Ling Pan

28. [Correct Looks Better: Pairwise Comparisons Reveal Accuracy Rankings](#link28)
**Authors:** Mina Remeli, Moritz Hardt

29. [MADE: Beyond Scoring via a Multilingual Agentic Diagnosing Engine for Fine-Grained Evaluation Insights](#link29)
...
30. [Explaining Data Mixing Scaling Laws](#link30)
**Authors:** Rui Dai, Shuran Zheng

31. [What Do People Actually Want From AI? Mapping Preference Plurality](#link31)
**Authors:** Julia Sep\'ulveda Coelho, Scott A. Hale

32. [Momentum for Reasoning: Dense Intrinsic Signals in Policy Optimization](#link32)
...
33. [Improving Cross-Lingual Factual Recall via Consistency-Driven Reinforcement Learning](#link33)
...
34. [PRISM: Recovering Instruction Sets from Language Model Activations](#link34)
**Authors:** Gilad Gressel, Rahul Pankajakshan, Julia Diament, Efim Hudis, Krishnashree Achuthan, Yisroel Mirsky

35. [SAW: Stage-Aware Dynamic Weighting for Multi-Objective Reinforcement Learning in Large Language Models](#link35)
**Authors:** Yuchen He, Baolong Bi, Shenghua Liu, Huaming Liao, Yuyao Ge, Bolin Wan, Siqian Tong, Juan Chen, Jiafeng Guo, Xueqi Cheng

36. [Beyond Goodhart's Law: A Dynamic Benchmark for Evaluating Compliance in Multi-Agent Systems](#link36)
**Authors:** Yiyang Zhao, Zhuo Zhang, Qingxuan Le, Lizhen Qu, Zenglin Xu

37. [Beyond Rubrics: Exploration-Guided Evaluation Skills for Reward Modeling](#link37)
**Authors:** Xing Yue, Linjuan Wu, Daoxin Zhang, Yongliang Shen, Weiming Lu

38. [sGPO: Trading Inference FLOPs for Training Efficiency in RLVR](#link38)
**Authors:** Shivchander Sudalairaj, Kai Xu, Akash Srivastava, Giorgio Giannone

39. [Reliable to Expressive: A Curriculum for Rubric-Following Safety Judges](#link39)
**Authors:** Yongtaek Lim, Hyeji Choi, Minwoo Kim

40. [DOG-DPO:Dynamic Optimization in Geometry for Safety Alignment](#link40)
**Authors:** Yi Nian, Tiankai Yang, Yudi Zhang, Qi Pan, Zelong Xu, Shenzhe Zhu, Qingqing Luan, Yue Huang, Xiangliang Zhang, Yue Zhao

41. [Where the Score Lives: A Wavelet View of Diffusion](#link41)
**Authors:** Emma Finn, Binxu Wang, T. Anderson Keller, Demba E. Ba

42. [The Hidden Bias of Process Reward Models:PRISM for Rewarding the Right Reasoning](#link42)
...
43. [OpenHalDet: A Unified Benchmark for Hallucination Detection across Diverse Generation Scenarios](#link43)
...
44. [Trajectory Geometry of Transformer Representations Across Layers](#link44)
**Authors:** Vishal Pandey, Gopal Singh

45. [Ablation-Reversible Heads Don't Transfer: A Stress Test for Mechanistic Role Claims in Transformers](#link45)
**Authors:** Philip Quirke

46. [PAEC: Position-Aware Entropy Calibration for LLM Reasoning in RLVR](#link46)
**Authors:** Shumeng Yang, Yisu Liu, Jiayi Zheng, Zhaohui Yang, Linjing Li

47. [Breaking the Tokenizer Barrier: On-Policy Distillation across Model Families](#link47)
**Authors:** Yifan Niu, Han Xiao, Dongyi Liu, Zelong Wang, Dihong Gong, Yasheng Wang, Jia Li

48. [DiffoR: A Unified Continuous Generative Framework for Universal Ordinal Regression](#link48)
**Authors:** Hongxu Ma, Lin Wang, Chenghou Jin, Han Zhou, Jie Zhang, Xiaoyu Yang, Chunjie Chen, Jihong Guan, Shuigeng Zhou

49. [Characterize Then Distill: Mechanistic Reasoning in Large Output Spaces](#link49)
**Authors:** Debjyoti Saha Roy, Byron C. Wallace, Javed A. Aslam

50. [Evaluating the Representation Space of Diffusion Models via Self-Supervised Principles](#link50)
**Authors:** Xiao Li, Yixuan Jia, Zekai Zhang, Xiang Li, Lianghe Shi, Jinxin Zhou, Zhihui Zhu, Liyue Shen, Qing Qu

51. [Stabilizing On-Policy Distillation for MLLM Reasoning with Global Normalization](#link51)
**Authors:** Dongze Hao, Zhiwei Jin, Chen Chen, Haonan Lu

52. [Trait-space Monitoring for Emergent Misalignment During Supervised Finetuning](#link52)
**Authors:** Huy Nghiem, Sy-Tuyen Ho, Sarah Wiegreffe, Hal Daum\'e III

53. [Multi-Turn Evaluation of Deep Research Agents Under Process-Level Feedback](#link53)
**Authors:** Rishabh Sabharwal, Hongru Wang, Amos Storkey, Jeff Z. Pan

54. [Tight Sample Complexity of Transformers](#link54)
**Authors:** Chenxiao Yang, Nathan Srebro, Zhiyuan Li

55. [Escaping the KL Agreement Trap in On-Policy Distillation](#link55)
**Authors:** Haoran Xin, Anhao Zhao, Ying Sun, Jin Li, Xiaoyu Shen, Hui Xiong

56. [Mitigating the Contractivity Trap in Diffusion ODEs via Stein Stabilization](#link56)
**Authors:** Shigui Li, Delu Zeng

57. [TRACE: Trajectory Reasoning through Adaptive Cross-Step Evidence Aggregation for LLM Agents](#link57)
...
58. [Finite Certificates for In-Context Determinacy and a Threshold Theory of Emergence in Language Models](#link58)
**Authors:** Faruk Alpay, Hamdi Alakkad

59. [PBSD: Privileged Bayesian Self-Distillation for Long-Horizon Credit Assignment](#link59)
**Authors:** Yang Tian, Rui Wang, Xumeng Wen, Junjie Li, Shizhao Sun, Lei Song, Jiang Bian, Bo Zhao

60. [DICE: Entropy-Regularized Equilibrium Selection for Stable Multi-Agent LLM Coordination](#link60)
**Authors:** Yi Xie, Zhanke Zhou, Chentao Cao, Bo Liu, Bo Han

61. [Evaluation Cards: An Interpretive Layer for AI Evaluation Reporting](#link61)
...
62. [Reinforcement Learning for Flow-Matching Policies with Density Transport](#link62)
**Authors:** Boshu Lei, Kostas Daniilidis, Antonio Loquercio

63. [How Many Counterfactuals Does It Take? Probing VLM Hallucinations Through Circuits and Causal Effects](#link63)
**Authors:** Abhivansh Gupta, Simardeep Singh, Advika Sinha, Shreyansh Modi, Akshat Tomar

64. [A Theoretical Analysis of Memory and Overfitting Phenomena in Stochastic Interpolation Models](#link64)
**Authors:** Yunchen Li, Shaohui Lin, Zhou Yu

65. [Adversarial Robustness of Activation Steering in Large Language Models](#link65)
**Authors:** Kien Le, Thai Le

66. [Explain Like I'm 5 or Whatever I Choose: Evaluating the Interactive Potential of Language Model Responses](#link66)
**Authors:** Indu Panigrahi, Tal August

67. [Distilling Safe LLM Systems via Soft Prompts for On Device Settings](#link67)
**Authors:** Motasem Alfarra, Cristina Pinneri, Dana Kianfar, Mohammed Almousa, Christos Louizos

68. [Decoy-Calibrated Failure Audits for Language Models](#link68)
**Authors:** Vyzantinos Repantis, Ameya Gawde, Harshvardhan Singh

69. [PAFO: Pareto Fairness Optimization for Personalized Reward Modeling](#link69)
**Authors:** Xiaoyan Zhao, Haoting Ni, Yang Zhang, Chunyuan Zheng, Haoxuan Li, Fuli Feng

70. [Cutting LLM Evaluation Costs with SySRs: A Bandit Algorithm that Provably Exploits Model Similarity](#link70)
**Authors:** Zifan Lyu, Chahine Nejma, Tobias Wegel, Fanny Yang, Florian E. Dorner

71. [Oversight Has a Capacity: Calibrating Agent Guards to a Subjective, Fatiguing Human](#link71)
**Authors:** Emre Turan

72. [Enabling KV Caching of Shared Prefix for Diffusion Language Models](#link72)
**Authors:** Younghun Go, Jaehoon Han, Changyong Shin, Chuk Yoo, Gyeongsik Yang

73. [Cross-LLM Consistency in Inference: Evidence from Shared Interactions](#link73)
**Authors:** Siyu Lou, Yao Yan, Yuntian Chen, Quanshi Zhang

74. [RiskNet: A large-scale dataset of AI risk incidents from news with alignment and multi-dimensional annotations](#link74)
**Authors:** Leihan Zhang, Wecheng Ye, Xianlong Ma, Haochuan Liu, Yang Li, Qianyu Zhang, Jinliang Chen, Qiang Yan

75. [DynaCF: Mitigating Shortcut Learning in Reward Models via Dynamic Counterfactual Sensitivity](#link75)
**Authors:** Fengyuan Liu, Yongliang Miao, Zirui He, Yanguang Liu, Fei Sun, Mengnan Du

76. [Sycophantic Praise: Evaluating Excessive Praise in Language Models](#link76)
**Authors:** Daniel Vennemeyer, Phan Anh Duong, Meryl Ye, Ruihong Huang, Tianyu Jiang

77. [Reachability and asymptotics of Gaussian Transformer dynamics](#link77)
**Authors:** Albert Alcalde, Zhengping Ji, Enrique Zuazua

78. [Activation Steering Induces Emergent Misalignment: A More Comprehensive Evaluation](#link78)
**Authors:** Qi Cao, Jian Lou, Meiting Liu, Wenjie Feng, Dan Li, See-Kiong Ng, Anh Tuan Luu

79. [REFLECT: Intervention-Supported Error Attribution for Silent Failures in LLM Agent Traces](#link79)
**Authors:** Xiaofeng Lin, Yingxu Wang, Tung Sum Thomas Kwok, Daniel Guo, Sahil Arun Nale, Charles Fleming, Guang Cheng

80. [SearchSwarm: Towards Delegation Intelligence in Agentic LLMs for Long-Horizon Deep Research](#link80)
**Authors:** Pu Ning, Quan Chen, Kun Tao, Xinyu Tang, Tianshu Wang, Qianggang Cao, Xinyu Kong, Zujie Wen, Zhiqiang Zhang, Jun Zhou

81. [How Language Models Fail: Token-Level Signatures of Committed and Persistent Reasoning Failures](#link81)
**Authors:** Tanvi Thoria, Kiana Jafari, Marc R. Schlichting, Mykel J. Kochenderfer

82. [Personalization Meets Safety:Mechanisms,Risks,and Mitigations in Personalized LLMs](#link82)
...
83. [Diverse Thinking Schemata Elicit Better Reasoning in Large Language Models](#link83)
**Authors:** Xinyue Liang, Yizhe Yang, Yu Bai, Bin Xu, Jiawei Li, Yang Gao

84. [When Does Delegation Beat Majority? A Delegation-Based Aggregator for Multi-Sample LLM Inference](#link84)
**Authors:** Yasushi Sakai, Allen Song, Kent Larson

85. [Intrinsic Selection and Particle Resampling for Inference-Time Scaling Beyond Domain Verifiability](#link85)
...
86. [HARP: Efficient Data Selection for Finetuning Large Language Models](#link86)
**Authors:** Ning Wang, Zhengxin Zhang, Maosen Tang, Yitang Gao, Claire Cardie, Sainyam Galhotra

87. [SciTrace: Trajectory-Aware Safety Reasoning for Scientific Discovery Agents](#link87)
**Authors:** Tanush Swaminathan, Runmin Jiang, Letian Zhang, Min Xu

88. [InA-Probe: Instruction-Aware Active Probing for Time Series Forecasting with LLMs](#link88)
...
89. [MetaEvo: A Meta-Optimization Framework for Experience-Driven Agent Evolution](#link89)
**Authors:** Bowen Ren, Heyan Huang, Yinghao Li, Yang Gao

90. [Understanding the Parameter Space Geometry of Transformers Encoding Boolean Functions](#link90)
**Authors:** Blanka K\"over, Alexandra Butoi, Anej Svete, Michael Hahn, Ryan Cotterell

91. [ThinkBooster: A Unified Framework for Seamless Test-Time Scaling of LLM Reasoning](#link91)
...
92. [Stage-1 Controls the Entropy Regime, Not the Outcome](#link92)
**Authors:** Jianxiong Shen

93. [Training-Inference Kernel Contracts: Bounding Divergence in Post-Training and Deployment](#link93)
**Authors:** Bruce Changlong Xu, Lan Wu

94. [Assessing Sample Quality in Conditional Generation under Compositional Shift](#link94)
**Authors:** Berker Demirel, Valentino Maiorca, Marco Fumero, Theofanis Karaletsos, Francesco Locatello

95. [From Rigid to Dynamic: Entropy-Guided Adaptive Inference for Long-Context LLMs](#link95)
**Authors:** Zhanchao Xu, Haoyang Li, Qingfa Xiao, Fei Teng, Chen Jason Zhang, Lei Chen, Qing Li

96. [Artificial Intelligence for Mathematical Reasoning: An Integrated Survey of Language Models, Neuro-symbolic Systems, and Verified Discovery](#link96)
**Authors:** Syed Rifat Raiyan, Mohsinul Kabir, Hasan Mahmud, Md Kamrul Hasan

97. [SKILL.nb: Selective Formalization and Gated Execution for Durable Agent Workflows](#link97)
**Authors:** Amine El Hattami, Nicolas Chapados, Christopher Pal

98. [Beyond Linear Activation Steering: Invertible Latent Transformations for Controlling LLM Behavior](#link98)
**Authors:** Tuc Nguyen, Thai Le

99. [Minibatch Selection via Partition Matroid Constrained Gradient Matching](#link99)
**Authors:** Prayas Agrawal, Prateek Chanda, Ishita Khatri, Ganesh Ramakrishnan, Bamdev Mishra, Pratik Jawanpuria

100. [How Deep Are Deep GPs, Really? A Sharp Threshold and a Non-Gaussian Limit for Compositional GPs](#link100)
**Authors:** Mark Kozdoba, Shie Mannor

101. [Claw-R1: A Step-Level Data Middleware System for Agentic Reinforcement Learning](#link101)
**Authors:** Daoyu Wang, Mingyue Cheng, Qingchuan Li, Shuo Yu, Jie Ouyang, Qi Liu

102. [Contract2Tool: Learning Preconditions and Effects for Reliable Tool-Augmented LLM Agents](#link102)
**Authors:** Rahul Suresh Babu, Laxmipriya Ganesh Iyer

103. [FlashMemory-DeepSeek-V4: Lightning Index Ultra-Long Context via Lookahead Sparse Attention](#link103)
...
104. [Your UnEmbedding Matrix is Secretly a Feature Lens for Text Embeddings](#link104)
**Authors:** Songhao Wu, Zhongxin Chen, Yuxuan Liu, Heng Cui, Cong Li, Rui Yan

105. [Repetition Mismatch: Why Data Mixture Experiments Don't Scale and How to Fix Them](#link105)
**Authors:** Kevin Zhou, Lisa Alazraki, Kris Cao, Marek Rei

106. [Scaling Participation in Modular AI Systems](#link106)
**Authors:** Shangbin Feng, Yike Wang, Weijia Shi, Luke Zettlemoyer, Yejin Choi, Yulia Tsvetkov

107. [Understanding Quantization-Aware Training: Gradients at Quantized Weights Bias to the Low-Loss Basin](#link107)
**Authors:** Hanyang Li, Jianhao Ma, Ying Cui

108. [SIFT: Selective-Index For Fast Compute of RAG Prefill by Exploiting Attention Invariance](#link108)
**Authors:** Rya Sanovar, Srikant Bharadwaj, Hritvik Taneja, Moinuddin Qureshi

109. [BrainSurgery: Reproducible and Reliable Declarative Weight Manipulations for Model Editing and Upcycling](#link109)
**Authors:** Gianluca Barmina, Annemette Broch Pirchert, Andrea Blasi N\'u\~nez, Lukas Galke Poech, Peter Schneider-Kamp

110. [STAR: Rethinking MoE Routing as Structure-Aware Subspace Learning](#link110)
**Authors:** Sumin Park, Noseong Park

111. [Lost in the Non-convex Loss Landscape: How to Fine-tune the Large Time Series Model?](#link111)
**Authors:** Xu Zhang, Peang Wang, Wei Wang

112. [BUDDY: BUdget-Driven DYnamic Depth Routing for Adaptive Large Language Model Inference](#link112)
**Authors:** Yuhua Zhou, Shaoqi Yu, Shichao Weng, Changhai Zhou, Mingze Yin, Fei Yang, Aimin Pan

113. [Modular Monolingual Adaptation using Pretrained Language Models](#link113)
**Authors:** Nalin Kumar, Ond\v{r}ej Du\v{s}ek

114. [ScaleSweep: Accurate NVFP4 Post-Training Quantization of LLMs via Block Scale Initialization](#link114)
**Authors:** Li Lin, Xiaojun Wan

115. [TheoremBench: Evaluating LLMs on Theorem Proving in Formal Mathematics](#link115)
**Authors:** QuocViet Pham, Elvir Karimov, Andrey Galichin, Ivan Oseledets

116. [Principles of Concept Representation in Sentence Encoders](#link116)
**Authors:** Isabelle Mohr, John Dujany, Jonathan Souquet, Andre Freitas

117. [A Unifying View of Attention Sinks: Two Algorithms, Two Solutions](#link117)
**Authors:** Lukas Fesser, Mozes Jacobs, Thomas Fel, Andy Keller, Sham Kakade

118. [A Geometric Measure of Linear Separability for Neural Representations](#link118)
**Authors:** Yi Wei, Xuan Qi, Furao Shen

119. [CRAFT: A Unified Counterfactual Reasoning Framework for Tabular Question Answering and Fact Verification](#link119)
...
120. [How Much Dense Attention is Necessary? Oracle-Guided Sparse Prefill for Full/GQA Layers in Hybrid Long-Context Models](#link120)
**Authors:** Hongxing Wang, Harenome Razanajato, Zhen Zhang, Yujie Yuan, Hongsheng Liu

121. [Tree-of-Experience: A Structured Experience-Management Solution for Self-Evolving Agents under Low-Repetition and Implicit-Reward Environments](#link121)
**Authors:** Zihao Deng, Yining Zhu, Leiming Wang, Jingfei Lu, Junbo Wang, Chuncheng Ran, Yu Yang, Dixuan Yang, Jikun Shen

122. [Anything2Skill: Compiling External Knowledge into Reusable Skills for Agents](#link122)
**Authors:** Qianjun Pan, Yutao Yang, Junsong Li, Jie Zhou, Kai Chen, Xin Li, Qin Chen, Liang He

123. [Deep Active Re-Labeling: Toward Noise-Resilient Annotation Efficiency](#link123)
**Authors:** Md Abdullah Al Forhad, Weishi Shi

124. [ResearchClawBench: A Benchmark for End-to-End Autonomous Scientific Research](#link124)
...
125. [Correlation Is Not Enough: Embedding Human Metadata for Individual Causal Discovery](#link125)
**Authors:** Suraj Biswas, Saurabh Gupta, Pritam Mukherjee

126. [IMUG-Bench: Benchmarking Unified Multimodal Models on Interleaved Understanding and Generation](#link126)
...
127. [Next-Token Prediction Learns Generalisable Representations of Sleep Physiology](#link127)
**Authors:** Jonathan F. Carter, Lionel Tarassenko

128. [STAR-KV: Low-Rank KV Cache Compression via Soft Thresholding for Adaptive Rank Control](#link128)
**Authors:** Priyansh Bhatnagar, Ashkan Moradifirouzabadi, Se-Hyun Yang, SeungJae Lee, Jungwook Choi, Mingu Kang

129. [Joint Structural Pruning and Mixed-Precision Quantization for LLM Compression](#link129)
**Authors:** Hoang-Loc La, Truong-Thanh Le, Amir Taherkordi, Phuong Hoai Ha

130. [Progress-SQL: Improving Reinforcement Learning for Text-to-SQL via Progressive Rewards](#link130)
**Authors:** Shihao Zhang, Xiaoman Wang, Yuan Liu, Yunshi Lan, Weining Qian

131. [Beyond FLOPs: Benchmarking Real Inference Acceleration of LLM Pruning under a GEMM-Centric Taxonomy](#link131)
**Authors:** Haozhe Hu, Hao Wu, Anhao Zhao, Longwei Ding, Peiran Yin, Yunpu Ma, Xiaoyu Shen

132. [Collaborative Human-Agent Protocol (CHAP)](#link132)
**Authors:** Arsalan Shahid, Gordon Suttie, Philip Black

133. [EASE-TTT: Evidence-Aligned Selective Test-Time Training for Long-Context Question Answering](#link133)
**Authors:** Xiaopeng Yuan, Zebin Wang, Suwen Wang, Zongxin Yang, Haohan Wang, Yushun Dong

134. [Decision-Aware Memory Cards: Counterfactual-Inspired Context Selection and Compression for Tool-Using LLM Agents](#link134)
**Authors:** Xinyu Guan, Qianyang Zhao, Yuming Deng

135. [The Masked Advantage: Uncovering Local-Language Access to Cultural Knowledge in LLMs](#link135)
