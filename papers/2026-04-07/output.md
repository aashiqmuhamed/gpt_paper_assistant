...
0. [Beyond Semantic Manipulation: Token-Space Attacks on Reward Models](#link0)
**Authors:** Yuheng Zhang, Mingyue Huo, Minghao Zhu, Mengxue Zhang, Nan Jiang

1. [Finding Belief Geometries with Sparse Autoencoders](#link1)
**Authors:** Matthew Levinson

2. [Selective Forgetting for Large Reasoning Models](#link2)
**Authors:** Tuan Le, Wei Qian, Mengdi Huai

3. [Generative Frontiers: Why Evaluation Matters for Diffusion Language Models](#link3)
**Authors:** Patrick Pynadath, Jiaxin Shi, Ruqi Zhang

4. [DARE: Diffusion Large Language Models Alignment and Reinforcement Executor](#link4)
**Authors:** Jingyi Yang, Yuxian Jiang, Xuhao Hu, Shuang Cheng, Biqing Qi, Jing Shao

5. [Mitigating Reward Hacking in RLHF via Advantage Sign Robustness](#link5)
**Authors:** Shinnosuke Ono, Johannes Ackermann, Soichiro Nishimori, Takashi Ishida, Masashi Sugiyama

6. [ShieldNet: Network-Level Guardrails against Emerging Supply-Chain Injections in Agentic Systems](#link6)
**Authors:** Zhuowen Yuan, Zhaorun Chen, Zhen Xiang, Nathaniel D. Bastian, Seyyed Hadi Hashemi, Chaowei Xiao, Wenbo Guo, Bo Li

7. [Rethinking Token Prediction: Tree-Structured Diffusion Language Model](#link7)
**Authors:** Zihao Wu, Haoming Yang, Juncheng Dong, Vahid Tarokh

8. [Co-Evolution of Policy and Internal Reward for Language Agents](#link8)
...
9. [Implementing surrogate goals for safer bargaining in LLM-based agents](#link9)
**Authors:** Caspar Oesterheld, Maxime Rich\'e, Filip Sondej, Jesse Clifton, Vincent Conitzer

10. [Random Is Hard to Beat: Active Selection in online DPO with Modern LLMs](#link10)
**Authors:** Giyeong Oh, Junghyun Lee, Jaehyun Park, Youngjae Yu, Wonho Bae, Junhyug Noh

11. [Unlocking Prompt Infilling Capability for Diffusion Language Models](#link11)
**Authors:** Yoshinari Fujinuma, Keisuke Sakaguchi

12. [Understanding the Role of Hallucination in Reinforcement Post-Training of Multimodal Reasoning Models](#link12)
...
13. [Structured Multi-Criteria Evaluation of Large Language Models with Fuzzy Analytic Hierarchy Process and DualJudge](#link13)
**Authors:** Yulong He, Ivan Smirnov, Dmitry Fedrushkov, Sergey Kovalchuk, Ilya Revin

14. [Self-Distilled RLVR](#link14)
**Authors:** Chenxu Yang, Chuanyu Qin, Qingyi Si, Minghui Chen, Naibin Gu, Dingyu Yao, Zheng Lin, Weiping Wang, Jiaqi Wang, Nan Duan

15. [Many Preferences, Few Policies: Towards Scalable Language Model Personalization](#link15)
**Authors:** Cheol Woo Kum, Jai Moondra, Roozbeh Nahavandi, Andrew Perrault, Milind Tambe, Swati Gupta

16. [Not All Denoising Steps Are Equal: Model Scheduling for Faster Masked Diffusion Language Models](#link16)
**Authors:** Ivan Sedykh, Nikita Sorokin, Valentin Malykh

17. [QED-Nano: Teaching a Tiny Model to Prove Hard Theorems](#link17)
**Authors:** LM-Provers, Yuxiao Qu, Amrith Setlur, Jasper Dekoninck, Edward Beeching, Jia Li, Ian Wu, Lewis Tunstall, Aviral Kumar

18. [Self-Execution Simulation Improves Coding Models](#link18)
**Authors:** Gallil Maimon, Ori Yoran, Felix Kreuk, Michael Hassid, Gal Cohen, Pierre Chambon, Yossi Adi

19. [Testing the Limits of Truth Directions in LLMs](#link19)
**Authors:** Angelos Poulis, Mark Crovella, Evimaria Terzi

20. [When Do Hallucinations Arise? A Graph Perspective on the Evolution of Path Reuse and Path Compression](#link20)
**Authors:** Xinnan Dai, Kai Yang, Cheng Luo, Shenglai Zeng, Kai Guo, Jiliang Tang

21. [Your Agent is More Brittle Than You Think: Uncovering Indirect Injection Vulnerabilities in Agentic LLMs](#link21)
**Authors:** Wenhui Zhu, Xuanzhao Dong, Xiwen Chen, Rui Cai, Peijie Qiu, Zhipeng Wang, Oana Frunza, Shao Tang, Jindong Gu, Yalin Wang

22. [LLM Reasoning with Process Rewards for Outcome-Guided Steps](#link22)
**Authors:** Mohammad Rezaei, Jens Lehmann, Sahar Vahdati

23. [Rethinking Exploration in RLVR: From Entropy Regularization to Refinement via Bidirectional Entropy Modulation](#link23)
**Authors:** Hengrui Gu, Xiaotian Han, Yujing Bian, Kaixiong Zhou

24. [TriAttention: Efficient Long Reasoning with Trigonometric KV Compression](#link24)
**Authors:** Weian Mao, Xi Lin, Wei Huang, Yuxin Xie, Tianfu Fu, Bohan Zhuang, Song Han, Yukang Chen

25. [Hallucination Basins: A Dynamic Framework for Understanding and Controlling LLM Hallucinations](#link25)
**Authors:** Kalyan Cherukuri, Lav R. Varshney

26. [Predict, Don't React: Value-Based Safety Forecasting for LLM Streaming](#link26)
**Authors:** Pride Kavumba, Koki Wataoka, Huy H. Nguyen, Jiaxuan Li, Masaya Ohagi

27. [LightThinker++: From Reasoning Compression to Memory Management](#link27)
...
28. [OPRIDE: Offline Preference-based Reinforcement Learning via In-Dataset Exploration](#link28)
...
29. [SIEVE: Sample-Efficient Parametric Learning from Natural Language](#link29)
**Authors:** Parth Asawa, Alexandros G. Dimakis, Matei Zaharia

30. [Reflective Context Learning: Studying the Optimization Primitives of Context Space](#link30)
**Authors:** Nikita Vassilyev, William Berrios, Ruowang Zhang, Bo Han, Douwe Kiela, Shikib Mehri

31. [Entropy and Attention Dynamics in Small Language Models: A Trace-Level Structural Analysis on the TruthfulQA Benchmark](#link31)
**Authors:** Adeyemi Adeseye, Aisvarya Adeseye, Hannu Tenhunen, Jouni Isoaho

32. [Do No Harm: Exposing Hidden Vulnerabilities of LLMs via Persona-based Client Simulation Attack in Psychological Counseling](#link32)
...
33. [POEMetric: The Last Stanza of Humanity](#link33)
**Authors:** Bingru Li, Han Wang, Hazel Wilkinson

34. [What Makes Good Multilingual Reasoning? Disentangling Reasoning Traces with Measurable Features](#link34)
**Authors:** Dayeon Ki, Kevin Duh, Marine Carpuat

35. [Early Stopping for Large Reasoning Models via Confidence Dynamics](#link35)
**Authors:** Parsa Hosseini, Sumit Nawathe, Mahdi Salmani, Meisam Razaviyayn, Soheil Feizi

36. [Shorter, but Still Trustworthy? An Empirical Study of Chain-of-Thought Compression](#link36)
**Authors:** Lingjie Zeng, Xiaofan Chen, Yanbo Wang, Xiuying Chen

37. [The Format Tax](#link37)
**Authors:** Ivan Yee Lee, Loris D'Antoni, Taylor Berg-Kirkpatrick

38. [Evolutionary Search for Automated Design of Uncertainty Quantification Methods](#link38)
**Authors:** Mikhail Seleznyov, Daniil Korbut, Viktor Moskvoretskii, Oleg Somov, Alexander Panchenko, Elena Tutubalina

39. [DeonticBench: A Benchmark for Reasoning over Rules](#link39)
**Authors:** Guangyao Dou, Luis Brena, Akhil Deo, William Jurayj, Jingyu Zhang, Nils Holzenberger, Benjamin Van Durme

40. [Responses Fall Short of Understanding: Revealing the Gap between Internal Representations and Responses in Visual Document Understanding](#link40)
**Authors:** Haruka Kawasaki, Ryota Tanaka, Kyosuke Nishida

41. [Vocabulary Dropout for Curriculum Diversity in LLM Co-Evolution](#link41)
**Authors:** Jacob Dineen, Aswin RRV, Zhikun Xu, Ben Zhou

42. [Position: Science of AI Evaluation Requires Item-level Benchmark Data](#link42)
**Authors:** Han Jiang, Susu Zhang, Xiaoyuan Yi, Xing Xie, Ziang Xiao

43. [TimeSeek: Temporal Reliability of Agentic Forecasters](#link43)
**Authors:** Hamza Mostafa, Om Shastri, Dennis Lee

44. [Cultural Authenticity: Comparing LLM Cultural Representations to Native Human Expectations](#link44)
**Authors:** Erin MacMurray van Liemt, Aida Davani, Sinchana Kumbale, Neha Dixit, Sunipa Dev

45. [I-CALM: Incentivizing Confidence-Aware Abstention for LLM Hallucination Mitigation](#link45)
**Authors:** Haotian Zong, Binze Li, Yufei Long, Sinyin Chang, Jialong Wu, Gillian K. Hadfield

46. [Why Attend to Everything? Focus is the Key](#link46)
...
47. [AdaptFuse: Training-Free Sequential Preference Learning via Externalized Bayesian Inference](#link47)
...
48. [Combee: Scaling Prompt Learning for Self-Improving Language Model Agents](#link48)
...
49. [Unveiling Language Routing Isolation in Multilingual MoE Models for Interpretable Subnetwork Adaptation](#link49)
...
50. [Which English Do LLMs Prefer? Triangulating Structural Bias Towards American English in Foundation Models](#link50)
**Authors:** Mir Tafseer Nayeem, Davood Rafiei

51. [Robust LLM Performance Certification via Constrained Maximum Likelihood Estimation](#link51)
**Authors:** Minghe Shen, Ananth Balashankar, Adam Fisch, David Madras, Miguel Rodrigues

52. [Understanding Latent Diffusability via Fisher Geometry](#link52)
**Authors:** Jing Gu, Morteza Mardani, Wonjun Lee, Dongmian Zou, Gilad Lerman

53. [Haiku to Opus in Just 10 bits: LLMs Unlock Massive Compression Gains](#link53)
**Authors:** Roy Rinberg, Annabelle Michael Carrell, Simon Henniger, Nicholas Carlini, Keri Warr

54. [BioAlchemy: Distilling Biological Literature into Reasoning-Ready Reinforcement Learning Training Data](#link54)
**Authors:** Brian Hsu, Ozan G\"okdemir, Carlo Siebenschuh, Bruce Parrello, Neil Getty, Thomas S. Brettin, Rick L. Stevens, Ian T. Foster, Nicholas Chia, Arvind Ramanathan

55. [How Far Are We? Systematic Evaluation of LLMs vs. Human Experts in Mathematical Contest in Modeling](#link55)
**Authors:** Yuhang Liu, Heyan Huang, Yizhe Yang, Hongyan Zhao, Zhizhuo Zeng, Yang Gao

56. [Lighting Up or Dimming Down? Exploring Dark Patterns of LLMs in Co-Creativity](#link56)
**Authors:** Zhu Li, Jiaming Qu, Yuan Chang

57. [PRAISE: Prefix-Based Rollout Reuse in Agentic Search Training](#link57)
**Authors:** Erhan Zhang, Yiqun Chen, Zechun Niu, Wei Yang, Xiaochi Wei, Yan Gao, Yi Wu, Yao Hu, Jiaxin Mao

58. [InferenceEvolve: Towards Automated Causal Effect Estimators through Self-Evolving AI](#link58)
**Authors:** Can Wang, Hongyu Zhao, Yiqun Chen

59. [Automatically Generating Hard Math Problems from Hypothesis-Driven Error Analysis](#link59)
**Authors:** Jiayu Fu, Mourad Heddaya, Chenhao Tan

60. [CresOWLve: Benchmarking Creative Problem-Solving Over Real-World Knowledge](#link60)
**Authors:** Mete Ismayilzada, Renqing Cuomao, Daniil Yurshevich, Anna Sotnikova, Lonneke van der Plas, Antoine Bosselut

61. [GUIDE: Interpretable GUI Agent Evaluation via Hierarchical Diagnosis](#link61)
**Authors:** Yuwen Zhai, Runze Li, Liang Wang, Nian Shi, Liwu Xu, Wei Zhang, Ran Lin, Bo Xu, Benlei Cui

62. [Quantifying Trust: Financial Risk Management for Trustworthy AI Agents](#link62)
**Authors:** Wenyue Hua, Tianyi Peng, Chi Wang, Ian Kaufman, Bryan Lim, Chandler Fang

63. [SEDGE: Structural Extrapolated Data Generation](#link63)
**Authors:** Kun Zhang, Jiaqi Sun, Yiqing Li, Ignavier Ng, Namrata Deka, Shaoan Xie

64. [LPC-SM: Local Predictive Coding and Sparse Memory for Long-Context Language Modeling](#link64)
**Authors:** Keqin Xie

65. [Efficient Logistic Regression with Mixture of Sigmoids](#link65)
**Authors:** Federico Di Gennaro, Saptarshi Chakraborty, Nikita Zhivotovskiy

66. [Beyond the Final Actor: Modeling the Dual Roles of Creator and Editor for Fine-Grained LLM-Generated Text Detection](#link66)
**Authors:** Yang Li, Qiang Sheng, Zhengjia Wang, Yehan Yang, Danding Wang, Juan Cao

67. [Uncertainty as a Planning Signal: Multi-Turn Decision Making for Goal-Oriented Conversation](#link67)
**Authors:** Xinyi Ling, Ye Liu, Reza Averly, Xia Ning

68. [RUQuant: Towards Refining Uniform Quantization for Large Language Models](#link68)
**Authors:** Han Liu, Haotian Gao, Changya Li, Feng Zhang, Xiaotong Zhang, Wei Wang, Hong Yu

69. [How Well Do Agentic Skills Work in the Wild: Benchmarking LLM Skill Usage in Realistic Settings](#link69)
**Authors:** Yujian Liu, Jiabao Ji, Li An, Tommi Jaakkola, Yang Zhang, Shiyu Chang

70. [Dynamical structure of vanishing gradient and overfitting in multi-layer perceptrons](#link70)
**Authors:** Alex Al\`i Maleknia, Yuzuru Sato

71. [Do We Need Frontier Models to Verify Mathematical Proofs?](#link71)
**Authors:** Aaditya Naik, Guruprerana Shabadi, Rajeev Alur, Mayur Naik

72. [SKILLFOUNDRY: Building Self-Evolving Agent Skill Libraries from Heterogeneous Scientific Resources](#link72)
**Authors:** Shuaike Shen, Wenduo Cheng, Mingqian Ma, Alistair Turcan, Martin Jinye Zhang, Jian Ma

73. [Position: Logical Soundness is not a Reliable Criterion for Neurosymbolic Fact-Checking with LLMs](#link73)
**Authors:** Jason Chan, Robert Gaizauskas, Zhixue Zhao

74. [Empirical Characterization of Rationale Stability Under Controlled Perturbations for Explainable Pattern Recognition](#link74)
**Authors:** Abu Noman Md Sakib, Zhensen Wang, Merjulah Roby, Zijie Zhang

75. [FeynmanBench: Benchmarking Multimodal LLMs on Diagrammatic Physics Reasoning](#link75)
**Authors:** Zeyu Wang, Xiaogang Li, Peiyao Xiao, Qinhao Kong, Ben Wang, Chengliang Xu, Zichao Chen, Bing Zhao, Hu Wei

76. [SoLA: Leveraging Soft Activation Sparsity and Low-Rank Decomposition for Large Language Model Compression](#link76)
**Authors:** Xinhao Huang, You-Liang Huang, Zeyi Wen

77. [Metaphors We Compute By: A Computational Audit of Cultural Translation vs. Thinking in LLMs](#link77)
**Authors:** Yuan Chang, Jiaming Qu, Zhu Li

78. [TableVision: A Large-Scale Benchmark for Spatially Grounded Reasoning over Complex Hierarchical Tables](#link78)
**Authors:** Xiaoyu Chen, Lu Dai, Hanqing Wang, Zhuoyu Li, Wenbin Dai, Yanzong Zheng, Zhenggang Xia, Junyong Lin, Hui Xiong

79. [REAM: Merging Improves Pruning of Experts in LLMs](#link79)
**Authors:** Saurav Jha, Maryam Hashemzadeh, Ali Saheb Pasand, Ali Parviz, Min-Joong Lee, Boris Knyazev

80. [Explainable Model Routing for Agentic Workflows](#link80)
**Authors:** Mika Okamoto, Ansel Kaplan Erol, Mark Riedl

81. [Comparative reversal learning reveals rigid adaptation in LLMs under non-stationary uncertainty](#link81)
**Authors:** Haomiaomiao Wang, Tom\'as E Ward, Lili Zhang

82. [Conversational Control with Ontologies for Large Language Models: A Lightweight Framework for Constrained Generation](#link82)
**Authors:** Barbara Gendron, Ga\"el Guibon, Mathieu d'Aquin

83. [A Model of Understanding in Deep Learning Systems](#link83)
**Authors:** David Peter Wallis Freeborn

84. [Researchers waste 80% of LLM annotation costs by classifying one text at a time](#link84)
**Authors:** Christian Pipal, Eva-Maria Vogel, Morgan Wack, Frank Esser

85. [Decocted Experience Improves Test-Time Inference in LLM Agents](#link85)
...
86. [AXELRAM: Quantize Once, Never Dequantize](#link86)
**Authors:** Yasushi Nishida

87. [The Tool Illusion: Rethinking Tool Use in Web Agents](#link87)
**Authors:** Renze Lou, Baolin Peng, Wenlin Yao, Qianhui Wu, Hao Cheng, Suman Nath, Wenpeng Yin, Jianfeng Gao

88. [Are Arabic Benchmarks Reliable? QIMMA's Quality-First Approach to LLM Evaluation](#link88)
