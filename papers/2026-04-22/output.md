...
0. [Cell-Based Representation of Relational Binding in Language Models](#link0)
**Authors:** Qin Dai, Benjamin Heinzerling, Kentaro Inui

1. [EVPO: Explained Variance Policy Optimization for Adaptive Critic Utilization in LLM Post-Training](#link1)
...
2. [Policy Gradient Primal-Dual Method for Safe Reinforcement Learning from Human Feedback](#link2)
**Authors:** Qiang Liu, Adrienne Kline, Ermin Wei

3. [$R^2$-dLLM: Accelerating Diffusion Large Language Models via Spatio-Temporal Redundancy Reduction](#link3)
...
4. [ARES: Adaptive Red-Teaming and End-to-End Repair of Policy-Reward System](#link4)
**Authors:** Jiacheng Liang, Yao Ma, Tharindu Kumarage, Satyapriya Krishna, Rahul Gupta, Kai-Wei Chang, Aram Galstyan, Charith Peris

5. [Towards Understanding the Robustness of Sparse Autoencoders](#link5)
**Authors:** Ahson Saiyed, Sabrina Sadiekh, Chirag Agarwal

6. [Robust Continual Unlearning against Knowledge Erosion and Forgetting Reversal](#link6)
**Authors:** Eun-Ju Park, Youjin Shin, Simon S. Woo

7. [Pause or Fabricate? Training Language Models for Grounded Reasoning](#link7)
...
8. [When Safety Fails Before the Answer: Benchmarking Harmful Behavior Detection in Reasoning Chains](#link8)
**Authors:** Ishita Kakkar, Enze Zhang, Rheeya Uppaal, Junjie Hu

9. [Where Fake Citations Are Made: Tracing Field-Level Hallucination to Specific Neurons in LLMs](#link9)
**Authors:** Yuefei Chen, Yihao Quan, Xiaodong Lin, Ruixiang Tang

10. [Do LLMs Game Formalization? Evaluating Faithfulness in Logical Reasoning](#link10)
**Authors:** Kyuhee Kim, Auguste Poiroux, Antoine Bosselut

11. [Mechanistic Anomaly Detection via Functional Attribution](#link11)
**Authors:** Hugo Lyons Keenan, Christopher Leckie, Sarah Erfani

12. [TEMPO: Scaling Test-time Training for Large Reasoning Models](#link12)
...
13. [How Do Answer Tokens Read Reasoning Traces? Self-Reading Patterns in Thinking LLMs for Quantitative Reasoning](#link13)
**Authors:** Haoyang Chen, Yi Liu, Jianzhi Shao, Tao Zhang, Chengfu Huo, Wei Hu

14. [Personalized Benchmarking: Evaluating LLMs by Individual Preferences](#link14)
**Authors:** Cristina Garbacea, Heran Wang, Chenhao Tan

15. [Reasoning Structure Matters for Safety Alignment of Reasoning Models](#link15)
**Authors:** Yeonjun In, Wonjoong Kim, Sangwu Park, Chanyoung Park

16. [SAVOIR: Learning Social Savoir-Faire via Shapley-based Reward Attribution](#link16)
...
17. [Discovering a Shared Logical Subspace: Steering LLM Logical Reasoning via Alignment of Natural-Language and Symbolic Views](#link17)
**Authors:** Feihao Fang, My T. Thai, Yuanyuan Lei

18. [One Step Forward and K Steps Back: Better Reasoning with Denoising Recursion Models](#link18)
**Authors:** Chris Cameron, Wangzheng Wang, Nikita Ivanov, Ashmita Bhattacharyya, Didier Ch\'etelat, Yingxue Zhang

19. [DT2IT-MRM: Debiased Preference Construction and Iterative Training for Multimodal Reward Modeling](#link19)
**Authors:** Zhihong Zhang, Jie Zhao, Xiaojian Huang, Jin Xu, Zhuodong Luo, Xin Liu, Jiansheng Wei, Xuejin Chen

20. [Human-Guided Harm Recovery for Computer Use Agents](#link20)
**Authors:** Christy Li, Sky CH-Wang, Andi Peng, Andreea Bobu

21. [Detecting Data Contamination in Large Language Models](#link21)
**Authors:** Juliusz Janicki, Savvas Chamezopoulos, Evangelos Kanoulas, Georgios Tsatsaronis

22. [The Rise of Verbal Tics in Large Language Models: A Systematic Analysis Across Frontier Models](#link22)
**Authors:** Shuai Wu, Xue Li, Yanna Feng, Yufang Li, Zhijun Wang, Ran Wang

23. [Unsupervised Confidence Calibration for Reasoning LLMs from a Single Generation](#link23)
**Authors:** Thomas Zollo, Jimmy Wang, Richard Zemel

24. [How Adversarial Environments Mislead Agentic AI?](#link24)
**Authors:** Zhonghao Zhan, Huichi Zhou, Zhenhao Li, Peiyuan Jing, Krinos Li, Hamed Haddadi

25. [Compile to Compress: Boosting Formal Theorem Provers by Compiler Outputs](#link25)
**Authors:** Guchan Li, Rui Tian, Hongning Wang

26. [AI scientists produce results without reasoning scientifically](#link26)
**Authors:** Marti\~no R\'ios-Garc\'ia, Nawaf Alampara, Chandan Gupta, Indrajeet Mandal, Sajid Mannan, Ali Asghar Aghajani, N. M. Anoop Krishnan, Kevin Maik Jablonka

27. [Nexusformer: Nonlinear Attention Expansion for Stable and Inheritable Transformer Scaling](#link27)
**Authors:** Weijie Zhao, Mingquan Liu, Bolun Wang, Simo Wu, Nuobei Xie, Rui-Jie Zhu, Peng Zhou

28. [Impact of large language models on peer review opinions from a fine-grained perspective: Evidence from top conference proceedings in AI](#link28)
**Authors:** Wenqing Wu, Chengzhi Zhang, Yi Zhao, Tong Bao

29. [OLLM: Options-based Large Language Models](#link29)
**Authors:** Shashank Sharma, Janina Hoffmann, Vinay Namboodiri

30. [Taming Actor-Observer Asymmetry in Agents via Dialectical Alignment](#link30)
**Authors:** Bobo Li, Rui Wu, Zibo Ji, Meishan Zhang, Hao Fei, Min Zhang, Mong-Li Lee, Wynne Hsu

31. [Prioritizing the Best: Incentivizing Reliable Multimodal Reasoning by Rewarding Beyond Answer Correctness](#link31)
**Authors:** Mengzhao Jia, Zhihan Zhang, Meng Jiang

32. [Easy Samples Are All You Need: Self-Evolving LLMs via Data-Efficient Reinforcement Learning](#link32)
**Authors:** Zhiyin Yu, Bo Zhang, Qibin Hou, Zhonghai Wu, Xiao Luo, Lei Bai

33. [Beyond One Output: Visualizing and Comparing Distributions of Language Model Generations](#link33)
**Authors:** Emily Reif, Claire Yang, Jared Hwang, Deniz Nazar, Noah Smith, Jeff Heer

34. [STAR-Teaming: A Strategy-Response Multiplex Network Approach to Automated LLM Red Teaming](#link34)
**Authors:** MinJae Jung, YongTaek Lim, Chaeyun Kim, Junghwan Kim, Kihyun Kim, Minwoo Kim

35. [Generalization at the Edge of Stability](#link35)
**Authors:** Mario Tuci, Caner Korkmaz, Umut \c{S}im\c{s}ekli, Tolga Birdal

36. [Detoxification for LLM: From Dataset Itself](#link36)
**Authors:** Wei Shao, Yihang Wang, Gaoyu Zhu, Ziqiang Cheng, Lei Yu, Jiafeng Guo, Xueqi Cheng

37. [HoWToBench: Holistic Evaluation for LLM's Capability in Human-level Writing using Tree of Writing](#link37)
...
38. [Beyond Rating: A Comprehensive Evaluation and Benchmark for AI Reviews](#link38)
**Authors:** Bowen Li, Haochen Ma, Yuxin Wang, Jie Yang, Xinchi Chen, Xuanjing Huang, Yining Zheng, Xipeng Qiu

39. [AlignCultura: Towards Culturally Aligned Large Language Models?](#link39)
**Authors:** Gautam Siddharth Kashyap, Mark Dras, Usman Naseem

40. [Lost in Translation: Do LVLM Judges Generalize Across Languages?](#link40)
...
41. [Towards Scalable Lifelong Knowledge Editing with Selective Knowledge Suppression](#link41)
**Authors:** Dahyun Jung, Jaewook Lee, Heuiseok Lim

42. [Large Language Models Exhibit Normative Conformity](#link42)
**Authors:** Mikako Bito, Keita Nishimoto, Kimitaka Asatani, Ichiro Sakata

43. [Distillation Traps and Guards: A Calibration Knob for LLM Distillability](#link43)
**Authors:** Weixiao Zhan, Yongcheng Jing, Leszek Rutkowski, Dacheng Tao

44. [What Makes an LLM a Good Optimizer? A Trajectory Analysis of LLM-Guided Evolutionary Search](#link44)
**Authors:** Xinhao Zhang, Xi Chen, Fran\c{c}ois Portet, Maxime Peyrard

45. [Separating Geometry from Probability in the Analysis of Generalization](#link45)
**Authors:** Maxim Raginsky, Benjamin Recht

46. [TRN-R1-Zero: Text-rich Network Reasoning via LLMs with Reinforcement Learning Only](#link46)
**Authors:** Yilun Liu, Ruihong Qiu, Zi Huang

47. [From Natural Language to Executable Narsese: A Neuro-Symbolic Benchmark and Pipeline for Reasoning with NARS](#link47)
**Authors:** Mina Gabriel, Pei Wang

48. [Gradient-Based Program Synthesis with Neurally Interpreted Languages](#link48)
**Authors:** Matthew V. Macfarlane, Cl\'ement Bonnet, Herke van Hoof, Levi H. S. Lelis

49. [Exploring Language-Agnosticity in Function Vectors: A Case Study in Machine Translation](#link49)
**Authors:** Nurkhan Laiyk, Gerard I. G\'allego, Javier Ferrando, Fajri Koto

50. [Location Not Found: Exposing Implicit Local and Global Biases in Multilingual LLMs](#link50)
...
51. [Self-Improving Tabular Language Models via Iterative Group Alignment](#link51)
**Authors:** Yunbo Long, Tejumade Afonja, Alexandra Brintrup, Mario Fritz

52. [Reasoning-Aware AIGC Detection via Alignment and Reinforcement](#link52)
**Authors:** Zhao Wang, Max Xiong, Jianxun Lian, Zhicheng Dou

53. [Micro Language Models Enable Instant Responses](#link53)
**Authors:** Wen Cheng, Tuochao Chen, Karim Helwani, Sriram Srinivasan, Luke Zettlemoyer, Shyamnath Gollakota

54. [LBLLM: Lightweight Binarization of Large Language Models via Three-Stage Distillation](#link54)
**Authors:** Siqing Song, Chuang Wang, Yong Lang, Yi Yang, Xu-Yao Zhang

55. [Evaluation-driven Scaling for Scientific Discovery](#link55)
...
56. [CoDA: Towards Effective Cross-domain Knowledge Transfer via CoT-guided Domain Adaptation](#link56)
**Authors:** Jianzhi Yan, Le Liu, Buzhou Tang, Yang Xiang, Dongning Sun, Zhiming Li

57. [RARE: Redundancy-Aware Retrieval Evaluation Framework for High-Similarity Corpora](#link57)
**Authors:** Hanjun Cho, Jay-Yoon Lee

58. [Experiments or Outcomes? Probing Scientific Feasibility in Large Language Models](#link58)
**Authors:** Seyedali Mohammadi, Manas Gaur, Francis Ferraro

59. [Benign Overfitting in Adversarial Training for Vision Transformers](#link59)
**Authors:** Jiaming Zhang, Meng Ding, Shaopeng Fu, Jingfeng Zhang, Di Wang

60. [ShadowPEFT: Shadow Network for Parameter-Efficient Fine-Tuning](#link60)
**Authors:** Xianming Li, Zongxi Li, Tsz-fung Andrew Lee, Jing Li, Haoran Xie, Qing Li

61. [FedProxy: Federated Fine-Tuning of LLMs via Proxy SLMs and Heterogeneity-Aware Fusion](#link61)
**Authors:** Tao Fan, Guoqiang Ma, Yuanfeng Song, Lixin Fan, Kai Chen, Qiang Yang

62. [Decompose, Structure, and Repair: A Neuro-Symbolic Framework for Autoformalization via Operator Trees](#link62)
**Authors:** Xiaoyang Liu, Zineng Dong, Yifan Bai, Yantao Li, Yuntian Liu, Tao Luo

63. [DASH-KV: Accelerating Long-Context LLM Inference via Asymmetric KV Cache Hashing](#link63)
...
64. [Rethinking Dataset Distillation: Hard Truths about Soft Labels](#link64)
**Authors:** Priyam Dey, Aditya Sahdev, Sunny Bhati, Konda Reddy Mopuri, R. Venkatesh Babu

65. [Debating the Unspoken: Role-Anchored Multi-Agent Reasoning for Half-Truth Detection](#link65)
**Authors:** Yixuan Tang, Yirui Zhang, Hang Feng, Anthony K. H. Tung

66. [Rethinking Scale: Deployment Trade-offs of Small Language Models under Agent Paradigms](#link66)
**Authors:** Xinlin Wang, Mats Brorsson

67. [Assessing Capabilities of Large Language Models in Social Media Analytics: A Multi-task Quest](#link67)
**Authors:** Ramtin Davoudi, Kartik Thakkar, Nazanin Donyapour, Tyler Derr, Hamid Karimi

68. [ReflectMT: Internalizing Reflection for Efficient and High-Quality Machine Translation](#link68)
**Authors:** Kunquan Li, Yingxue Zhang, Fandong Meng, Jinsong Su

69. [A Self-Evolving Framework for Efficient Terminal Agents via Observational Context Compression](#link69)
...
70. [Probing for Reading Times](#link70)
...
71. [FG$^2$-GDN: Enhancing Long-Context Gated Delta Networks with Doubly Fine-Grained Control](#link71)
**Authors:** Pingwei Sun, Yuxuan Hu, Jianchao Tan, Xue Wang, Jiaqi Zhang, Yifan Lu, Yerui Sun, Yuchen Xie, Xunliang Cai

72. [Investigating Counterfactual Unfairness in LLMs towards Identities through Humor](#link72)
**Authors:** Shubin Kim, Yejin Son, Junyeong Park, Keummin Ka, Seungbeen Lee, Jaeyoung Lee, Hyeju Jang, Alice Oh, Youngjae Yu

73. [From Experience to Skill: Multi-Agent Generative Engine Optimization via Reusable Strategy Learning](#link73)
**Authors:** Beining Wu, Fuyou Mao, Jiong Lin, Cheng Yang, Jiaxuan Lu, Yifu Guo, Siyu Zhang, Yifan Wu, Ying Huang, Fu Li

74. [Are Large Language Models Economically Viable for Industry Deployment?](#link74)
