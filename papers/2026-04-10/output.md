# Personalized Daily Arxiv Papers 04/10/2026
...
0. [DMax: Aggressive Parallel Decoding for dLLMs](#link0)
**Authors:** Zigeng Chen, Gongfan Fang, Xinyin Ma, Ruonan Yu, Xinchao Wang

1. [Rethinking Generalization in Reasoning SFT: A Conditional Analysis on Optimization, Data, and Model Capability](#link1)
**Authors:** Qihan Ren, Peng Wang, Ruikun Cai, Shuai Shao, Dadi Guo, Yuejin Xie, Yafu Li, Quanshi Zhang, Xia Hu, Jing Shao, Dongrui Liu

2. [What Drives Representation Steering? A Mechanistic Case Study on Steering Refusal](#link2)
**Authors:** Stephen Cheng, Sarah Wiegreffe, Dinesh Manocha

3. [An Illusion of Unlearning? Assessing Machine Unlearning Through Internal Representations](#link3)
**Authors:** Yichen Gao, Altay Unal, Akshay Rangamani, Zhihui Zhu

4. [Large Language Model Post-Training: A Unified View of Off-Policy and On-Policy Learning](#link4)
...
5. [Cram Less to Fit More: Training Data Pruning Improves Memorization of Facts](#link5)
**Authors:** Jiayuan Ye, Vitaly Feldman, Kunal Talwar

6. [Blind Refusal: Language Models Refuse to Help Users Evade Unjust, Absurd, and Illegitimate Rules](#link6)
**Authors:** Cameron Pattison, Lorenzo Manuali, Seth Lazar

7. [What do Language Models Learn and When? The Implicit Curriculum Hypothesis](#link7)
**Authors:** Emmy Liu, Kaiser Sun, Millicent Li, Isabelle Lee, Lindia Tjuatja, Jen-tse Huang, Graham Neubig

8. [Loop, Think, & Generalize: Implicit Reasoning in Recurrent-Depth Transformers](#link8)
**Authors:** Harsh Kohli, Srinivasan Parthasarathy, Huan Sun, Yuekun Yao

9. [Synthetic Data for any Differentiable Target](#link9)
...
10. [Distributed Multi-Layer Editing for Rule-Level Knowledge in Large Language Models](#link10)
**Authors:** Yating Wang, Wenting Zhao, Yaqi Zhao, Yongshun Gong, Yilong Yin, Haoliang Sun

11. [Is your algorithm unlearning or untraining?](#link11)
**Authors:** Eleni Triantafillou, Ahmed Imtiaz Humayun, Monica Ribero, Alexander Matt Turner, Michael C. Mozer, Georgios Kaissis

12. [Self-Debias: Self-correcting for Debiasing Large Language Models](#link12)
**Authors:** Xuan Feng, Shuai Zhao, Luwei Xiao, Tianlong Gu, Bo An

13. [Reason in Chains, Learn in Trees: Self-Rectification and Grafting for Multi-turn Agent Policy Optimization](#link13)
**Authors:** Yu Li, Sizhe Tang, Tian Lan

14. [Less Approximates More: Harmonizing Performance and Confidence Faithfulness via Hybrid Post-Training for High-Stakes Tasks](#link14)
**Authors:** Haokai Ma, Lee Yan Zhen, Gang Yang, Yunshan Ma, Ee-Chien Chang, Tat-Seng Chua

15. [Linear Representations of Hierarchical Concepts in Language Models](#link15)
**Authors:** Masaki Sakata, Benjamin Heinzerling, Takumi Ito, Sho Yokoi, Kentaro Inui

16. [Latent Structure of Affective Representations in Large Language Models](#link16)
**Authors:** Benjamin J. Choi, Melanie Weber

17. [Multimodal Latent Reasoning via Predictive Embeddings](#link17)
**Authors:** Ashutosh Adhikari, Mirella Lapata

18. [Decompose, Look, and Reason: Reinforced Latent Reasoning for VLMs](#link18)
**Authors:** Mengdan Zhu, Senhao Cheng, Liang Zhao

19. [A Decomposition Perspective to Long-context Reasoning for LLMs](#link19)
...
20. [TTVS: Boosting Self-Exploring Reinforcement Learning via Test-time Variational Synthesis](#link20)
**Authors:** Sikai Bai, Haoxi Li, Jie Zhang, Yongjiang Liu, Song Guo

21. [Demystifying OPD: Length Inflation and Stabilization Strategies for Large Language Models](#link21)
**Authors:** Feng Luo, Yu-Neng Chuang, Guanchu Wang, Zicheng Xu, Xiaotian Han, Tianyi Zhang, Vladimir Braverman

22. [PolicyLong: Towards On-Policy Context Extension](#link22)
**Authors:** Junlong Jia, Ziyang Chen, Xing Wu, Chaochen Gao, TingHao Yu, Feng Zhang, Songlin Hu

23. [Guardian-as-an-Advisor: Advancing Next-Generation Guardian Models for Trustworthy LLMs](#link23)
**Authors:** Yue Huang, Haomin Zhuang, Jiayi Ye, Han Bao, Yanbo Wang, Hang Hua, Siyuan Wu, Pin-Yu Chen, Xiangliang Zhang

24. [Data Selection for Multi-turn Dialogue Instruction Tuning](#link24)
**Authors:** Bo Li, Shikun Zhang, Wei Ye

25. [Rethinking Data Mixing from the Perspective of Large Language Models](#link25)
**Authors:** Yuanjian Xu, Tianze Sun, Changwei Xu, XinLong Zhao, Jianing Hao, Ran Chen, Yang Liu, Ruijie Xu, Stephen Chen, Guang Zhang

26. [SepSeq: A Training-Free Framework for Long Numerical Sequence Processing in LLMs](#link26)
...
27. [Learning is Forgetting: LLM Training As Lossy Compression](#link27)
...
28. [Beyond Surface Judgments: Human-Grounded Risk Evaluation of LLM-Generated Disinformation](#link28)
**Authors:** Zonghuan Xu, Xiang Zheng, Yutao Wu, Xingjun Ma

29. [Preference Redirection via Attention Concentration: An Attack on Computer Use Agents](#link29)
**Authors:** Dominik Seip, Matthias Hein

30. [TEMPER: Testing Emotional Perturbation in Quantitative Reasoning](#link30)
**Authors:** Atahan Dokme, Benjamin Reichman, Larry Heck

31. [Optimal Decay Spectra for Linear Recurrences](#link31)
**Authors:** Yang Cao

32. [How Much LLM Does a Self-Revising Agent Actually Need?](#link32)
**Authors:** Sungwoo Jung, Seonil Son

33. [Benchmark Shadows: Data Alignment, Parameter Footprints, and Generalization in Large Language Models](#link33)
**Authors:** Hongjian Zou, Yidan Wang, Qi Ding, Yixuan Liao, Xiaoxin Chen

34. [Steering the Verifiability of Multimodal AI Hallucinations](#link34)
**Authors:** Jianhong Pang, Ruoxi Cheng, Ziyi Ye, Xingjun Ma, Zuxuan Wu, Xuanjing Huang, Yu-Gang Jiang

35. [Dead Weights, Live Signals: Feedforward Graphs of Frozen Language Models](#link35)
**Authors:** Marcus Armstrong, Navid Ayoobi, Arjun Mukherjee

36. [Riemann-Bench: A Benchmark for Moonshot Mathematics](#link36)
**Authors:** Suhaas Garre, Erik Knutsen, Sushant Mehta, Edwin Chen

37. [Data Warmup: Complexity-Aware Curricula for Efficient Diffusion Training](#link37)
**Authors:** Jinhong Lin, Pan Wang, Zitong Zhan, Lin Zhang, Pedro Morgado

38. [QaRL: Rollout-Aligned Quantization-Aware RL for Fast and Stable Training under Training--Inference Mismatch](#link38)
...
39. [Bias Redistribution in Visual Machine Unlearning: Does Forgetting One Group Harm Another?](#link39)
...
40. [Sinkhorn doubly stochastic attention rank decay analysis](#link40)
**Authors:** Michela Lapenna, Rita Fioresi, Bahman Gharesifard

41. [Information-Theoretic Requirements for Gradient-Based Task Affinity Estimation in Multi-Task Learning](#link41)
**Authors:** Jasper Zhang, Bryan Cheng

42. [Guaranteeing Knowledge Integration with Joint Decoding for Retrieval-Augmented Generation](#link42)
...
43. [On Emotion-Sensitive Decision Making of Small Language Model Agents](#link43)
**Authors:** Jiaju Lin, Xingjian Du, Qingyun Wu, Ellen Wenting Zou, Jindong Wang

44. [Inside-Out: Measuring Generalization in Vision Transformers Through Inner Workings](#link44)
**Authors:** Yunxiang Peng, Mengmeng Ma, Ziyu Yao, Xi Peng

45. [When to Trust Tools? Adaptive Tool Trust Calibration For Tool-Integrated Math Reasoning](#link45)
**Authors:** Ruotao Xu, Yixin Ji, Yu Luo, Jinpeng Li, Dong Li, Peifeng Li, Juntao Li, Min Zhang

46. [Scaling-Aware Data Selection for End-to-End Autonomous Driving Systems](#link46)
**Authors:** Tolga Dimlioglu, Nadine Chang, Maying Shen, Rafid Mahmood, Jose M. Alvarez

47. [Provably Adaptive Linear Approximation for the Shapley Value and Beyond](#link47)
**Authors:** Weida Li, Yaoliang Yu, Bryan Kian Hsiang Low

48. [Robust Length Prediction: A Perspective from Heavy-Tailed Prompt-Conditioned Distributions](#link48)
**Authors:** Jing Wang, Yu-Yang Qian, Ke Xue, Chao Qian, Peng Zhao, Zhi-Hua Zhou

49. [SAGE: Sign-Adaptive Gradient for Memory-Efficient LLM Optimization](#link49)
**Authors:** Wooin Lee, Hyun-Tae Kim

50. [AI generates well-liked but templatic empathic responses](#link50)
**Authors:** Emma Gueorguieva, Hongli Zhan, Jina Suh, Javier Hernandez, Tatiana Lau, Junyi Jessy Li, Desmond C. Ong

51. [Cross-Tokenizer LLM Distillation through a Byte-Level Interface](#link51)
**Authors:** Avyav Kumar Singh, Yen-Chen Wu, Alexandru Cioba, Alberto Bernacchia, Davide Buffelli

52. [Tree-of-Evidence: Efficient "System 2" Search for Faithful Multimodal Grounding](#link52)
**Authors:** Micky C. Nnamdi, Benoit L. Marteau, Yishan Zhong, J. Ben Tamo, May D. Wang

53. [AsyncTLS: Efficient Generative LLM Inference with Asynchronous Two-level Sparse Attention](#link53)
**Authors:** Yuxuan Hu, Jianchao Tan, Jiaqi Zhang, Wen Zan, Pingwei Sun, Yifan Lu, Yerui Sun, Yuchen Xie, Xunliang Cai, Jing Zhang

54. [An Empirical Analysis of Static Analysis Methods for Detection and Mitigation of Code Library Hallucinations](#link54)
**Authors:** Clarissa Miranda-Pena, Andrew Reeson, C\'ecile Paris, Josiah Poon, Jonathan K. Kummerfeld

55. [Alloc-MoE: Budget-Aware Expert Activation Allocation for Efficient Mixture-of-Experts Inference](#link55)
**Authors:** Baihui Liu, Kaiyuan Tian, Wei Wang, Zhaoning Zhang, Linbo Qiao, Dongsheng Li

56. [SOLAR: Communication-Efficient Model Adaptation via Subspace-Oriented Latent Adapter Reparametrization](#link56)
**Authors:** Seyed Mahmoud Sajjadi Mohammadabadi, Xiaolong Ma, Lei Yang, Feng Yan, Junshan Zhang

57. [TSUBASA: Improving Long-Horizon Personalization via Evolving Memory and Self-Learning with Context Distillation](#link57)
**Authors:** Xinliang Frederick Zhang, Lu Wang

58. [DIVERSED: Relaxed Speculative Decoding via Dynamic Ensemble Verification](#link58)
**Authors:** Ziyi Wang, Siva Rajesh Kasa, Ankith M S, Santhosh Kumar Kasa, Jiaru Zou, Sumit Negi, Ruqi Zhang, Nan Jiang, Qifan Song

59. [AtomEval: Atomic Evaluation of Adversarial Claims in Fact Verification](#link59)
**Authors:** Hongyi Cen, Mingxin Wang, Yule Liu, Jingyi Zheng, Hanze Jia, Tan Tang, Yingcai Wu

60. [The Role of Emotional Stimuli and Intensity in Shaping Large Language Model Behavior](#link60)
**Authors:** Ameen Patel, Felix Lee, Kyle Liang, Joseph Thomas

61. [Initialisation Determines the Basin: Efficient Codebook Optimisation for Extreme LLM Quantization](#link61)
**Authors:** Ian W. Kennedy, Nafise Sadat Moosavi

62. [GRASS: Gradient-based Adaptive Layer-wise Importance Sampling for Memory-efficient Large Language Model Fine-tuning](#link62)
**Authors:** Kaiyuan Tian, Yu Tang, Gongqingjian Jiang, Baihui Liu, Yifu Gao, Xialin Su, Linbo Qiao, Dongsheng Li

63. [Flux Attention: Context-Aware Hybrid Attention for Efficient LLMs Inference](#link63)
**Authors:** Quantong Qiu, Zhiyi Hong, Yi Yang, Haitian Wang, Kebin Liu, Qingqing Dang, Juntao Li, Min Zhang

64. [Bit-by-Bit: Progressive QAT Strategy with Outlier Channel Splitting for Stable Low-Bit LLMs](#link64)
**Authors:** Binxing Xu, Hao Gu, Lujun Li, Hao Wang, Bei Liu, Jiacheng Liu, Qiyuan Zhu, Xintong Yang, Chao Li, Sirui Han, Yike Guo

65. [CAMO: A Class-Aware Minority-Optimized Ensemble for Robust Language Model Evaluation on Imbalanced Data](#link65)
**Authors:** Mohamed Ehab (Faculty of Computer Science, October University for Modern Science & Arts, Giza, Egypt), Ali Hamdi (Faculty of Computer Science, October University for Modern Science & Arts, Giza, Egypt), Khaled Shaban (Department of Computer Science and Engineering, Qatar University, Doha, Qatar)

66. [Fast Heterogeneous Serving: Scalable Mixed-Scale LLM Allocation for SLO-Constrained Inference](#link66)
**Authors:** Jiaming Cheng, Duong Tung Nguyen

---
## 0. [DMax: Aggressive Parallel Decoding for dLLMs](https://arxiv.org/abs/2604.08302) <a id="link0"></a>
**ArXiv ID:** 2604.08302
**Authors:** Zigeng Chen, Gongfan Fang, Xinyin Ma, Ruonan Yu, Xinchao Wang

**Abstract:** arXiv:2604.08302v1 Announce Type: new  Abstract: We present DMax, a new paradigm for efficient diffusion language models (dLLMs). It mitigates error accumulation in parallel decoding, enabling aggressive decoding parallelism while preserving generation quality. Unlike conventional masked dLLMs that decode through a binary mask-to-token transition, DMax reformulates decoding as a progressive self-refinement from mask embeddings to token embeddings. At the core of our approach is On-Policy Uniform Training, a novel training strategy that efficiently unifies masked and uniform dLLMs, equipping the model to recover clean tokens from both masked inputs and its own erroneous predictions. Building on this foundation, we further propose Soft Parallel Decoding. We represent each intermediate decoding state as an interpolation between the predicted token embedding and the mask embedding, enabling iterative self-revising in embedding space. Extensive experiments across a variety of benchmarks demonstrate the effectiveness of DMax. Compared with the original LLaDA-2.0-mini, our method improves TPF on GSM8K from 2.04 to 5.47 while preserving accuracy. On MBPP, it increases TPF from 2.71 to 5.86 while maintaining comparable performance. On two H200 GPUs, our model achieves an average of 1,338 TPS at batch size 1. Code is available at: https://github.com/czg1225/DMax

**Comment:** Directly matches criterion 3 (diffusion language models). DMax presents a new paradigm for efficient dLLMs with novel training strategy (On-Policy Uniform Training) and Soft Parallel Decoding. Shows significant improvements in tokens per forward pass while maintaining quality. This is a significant advance in diffusion language models.
**Relevance:** 9
**Novelty:** 7

---

## 1. [Rethinking Generalization in Reasoning SFT: A Conditional Analysis on Optimization, Data, and Model Capability](https://arxiv.org/abs/2604.06628) <a id="link1"></a>
**ArXiv ID:** 2604.06628
**Authors:** Qihan Ren, Peng Wang, Ruikun Cai, Shuai Shao, Dadi Guo, Yuejin Xie, Yafu Li, Quanshi Zhang, Xia Hu, Jing Shao, Dongrui Liu
