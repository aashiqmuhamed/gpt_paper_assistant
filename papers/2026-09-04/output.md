...
0. [Unlocking Lossless Speedups in LLMs via Discrete Diffusion](#link0)
...
1. [The Geometry of Ignorance: LLMs Know When to Temper Bayesian Priors](#link1)
**Authors:** Toni J. B. Liu, Jiajun Bao, Yizhou Liu, Gurbir Arora, Nicolas Boull\'e, Rapha\"el Sarfati, Christopher J. Earls

2. [Sequential Beats Joint: On the Interplay between On-Policy Distillation and RLVR](#link2)
**Authors:** Boyan Li, Bingsen Chen, Chenghao Yang, Ping Nie, Chen Zhao, Xi Ye

3. [LLMs Learn Better In-Context from Rules than from Examples](#link3)
**Authors:** Xiang Fu, Seungmin Cho, Yukyung Lee, Najoung Kim

4. [A Circuit for Plural Reference: How LLMs Represent and Retrieve Singular and Plural Entities](#link4)
**Authors:** Anh Danh, Rick Nouwen, Massimo Poesio

5. [Beyond Shallow Alignment: How Post-Training Methods Determine Refusal Circuits And Steering Robustness](#link5)
**Authors:** Hoang Cuong Nguyen, Mark Dras, Usman Naseem

6. [Verify Before You Distill: Prompt-Level Teacher Gating for On-Policy Distillation](#link6)
**Authors:** Zhiwei Zhang, Zechen Sun, Fei Zhao, Kang Peng, Bin Liang, Huayu Deng, Yao Hu, Kam-Fai Wong, Mu Chuan

7. [Instruction Duplication as an Inference-Time Control Primitive](#link7)
**Authors:** Victor Lavrenko (PeaceTech VC, Israel)

8. [Coupled Scaling: A Representational Accessibility Framework for Neural Scaling Laws](#link8)
**Authors:** Jie Wang

9. [Rethinking On-Policy Distillation of Large Language Models II: One Training Example](#link9)
...
17. [Judging LLM-as-a-Judge: Concerning Rubric Artifacts in LLM-based Automated Text Generation Evaluation](#link17)
**Authors:** Anshul Bagaria, Sowmya S Sundaram, Gokul S Krishnan, Balaraman Ravindran

18. [DE-Venus: A Data-Efficient RLVR Framework for Large Language Models](#link18)
...
19. [Accountable AI with Grounded, Faithful, Consistent, Actionable Rationales: A Case Study in Clinical Trial Matching with VERDICT](#link19)
**Authors:** Zikai Zhou, Yufei Jin, Yilin Xu, Yu-Chiang Wang, Chieh-Ju Chao, Monica S. Lam

20. [Efficient Test-Time Adaptation through Human-AI Interaction](#link20)
...
21. [High-Dimensional Learning Dynamics of Attention-Indexed Models](#link21)
**Authors:** Yizhou Xu, Margarita Sagitova, Lenka Zdeborov\'a, Florent Krzakala

22. [Knowledge Acquisition During Pre-training? Large Language Models Learn Better With Auxiliary Views](#link22)
**Authors:** Joseph Lee, Yidi Huang, Dokyoon Kim, Shu Yang, Li Shen

23. [From Deceptive Outputs to Deceptive Mechanisms: A Causal Framework for Language-Model Deception Research](#link23)
**Authors:** Yakov Pyotr Shkolnikov

24. [FLY-EVAL++: An Evidence-Driven Evaluation Protocol for Safety-Constrained Flight Prediction with Large Language Models](#link24)
**Authors:** Yalun Wu, Junfeng Fang, Jiawei Wang, Haotian Liu, Qijun Yang, Minghan Yang, Hongcheng Guo, Zhoujun Li, Boyang Wang

25. [RecurTrace: Adaptive Latent Reasoning with Loop-Time Memory](#link25)
**Authors:** Yuxiang Wang, Kunyu Feng, Yingda Shen, Haoning Xu, Junyu Wang, Zhizheng Wu

26. [The Dually Flat Geometry of Planning as Inference](#link26)
**Authors:** Nikola Milosevic, Asaki Kataoka, Nicolas Hinrichs, Kenji Doya, Nico Scherf

27. [Spurious Advantage Hidden in GRPO](#link27)
**Authors:** Jiamian Wang, Samyadeep Basu, Koustava Goswami, Tong Yu, Zhiqiang Tao

28. [Random Attention: Rethinking KV Cache Eviction for Efficient Reasoning](#link28)
...
29. [Unifying Conformal Language Tasks with In-Context Ensembles](#link29)
**Authors:** Xiao Shi Huang, Chen-Yuan Lin, Bruce Kuwahara, Kin Kwan Leung, Jesse C. Cresswell

30. [Beyond "Made with AI": Visualizing Provenance Density to Mitigate the Transparency Penalty](#link30)
**Authors:** Qing Zhang, Yifei Huang, Juyoung Lee, Thad Starner, Jun Rekimoto

31. [Two-Stage Reinforcement Learning for Sound and Adversarial Test Generation in Code LLMs](#link31)
**Authors:** Jiacheng Xu, Wentao Zhang, Zhiyi Lyu, Fuxiang Zhang, Chaojie Wang, Yang Liu, Bo An

32. [Beyond BLEU: A Case for Redefining Sign Language Translation Benchmarks](#link32)
**Authors:** Oline Ranum, Edward Fish, Simon Hadfield, Richard Bowden

33. [Beyond Straightness: Non-Crossing Flow Matching via Quantile AlignTree Coupling](#link33)
**Authors:** Junyi Lin, Mengyu Li, Jingxuan Hu, Kejun He, Cheng Meng

34. [Routing Is Not Enough: Diagnosing Intra-Adapter Subspace Contention in MoE+LoRA Fine-Tuning](#link34)
...
35. [IndicSafeEval: Safety Robustness of Large Language Models under Multilingual Persuasive Jailbreak Attacks](#link35)
**Authors:** Saikat Mondal, Mamta, Deeksha Varshney, Oana Cocarascu, Asif Ekbal

36. [Scaling Laws, Tabular Data and Actuarial Ratemaking Models](#link36)
**Authors:** Ronald Richman

37. [ObserverBench: Testing Mechanistic Estimates for Intervention and Control](#link37)
**Authors:** Vijay Erramilli

38. [LeanGRPO: Eliminating Redundant Recomputation in Diffusion RL](#link38)
**Authors:** Sijie Wang, Zhiqiang Tan, Xinrui Yang, Shaohuai Shi

39. [</think> Doesn't Stop Reasoning: Analysis of Spurious CoT Termination](#link39)
**Authors:** Seunghee Koh, Sungjae Choi, Minchan Kwon, Sunghyun Baek, Junmo Kim

40. [Lost in Reordering: Structural Sensitivity of Multilingual LLMs under Semantics-Preserving Perturbations](#link40)
...
41. [Modern Transformers Are Implicit Hybrids: From Functional Differentiation to Principled Hybrid Architecture Design](#link41)
**Authors:** Runlin Shi, Bojian Yin, Guoqi Li

42. [Free Pause Tokens](#link42)
**Authors:** John Langford, Nathan Godey, Giovanni Monea, Yoav Artzi, Harry Dong, Ying Fan, Gustavo de Rosa, Zheng Zhan

43. [SGD-KV: Summarization Guided KV Cache Compression](#link43)
...
44. [DRACO: Fine-Grained Credit Assignment with Dynamic Rubrics for Long-Horizon Agent Training](#link44)
**Authors:** Shubham Gandhi, Saurabh Goyal, Kiran Kate, Yara Rizk

45. [Proactive Service Agents: A Unified Decision Framework, Methods, and Evaluation](#link45)
**Authors:** Yan Tang, Tingyu Cao, Yuanbo Tang, Huaze Tang, Keer Hu

46. [GrowPage: On-Demand KV Budgeting for Efficient LLM Reasoning Serving](#link46)
**Authors:** Qiankun Ma, Yanjiang Zhou, Zinan Xiong, Haofei Wang, Zhen Song, Yang Xiang, Ziyao Zhang, Hairong Zheng

47. [Frontier LLMs are effective batch optimizers: Assessing reasoning models in continuous and discrete settings](#link47)
**Authors:** Frank Hu, Shriram Chennakesavalu, David Graff

48. [Jina-OCR-v1: Efficient Document Parsing with Speculative Decoding and Dense Verifiable Rewards](#link48)
**Authors:** Alejandro Bar\'on Garc\'ia, Feng Wang, Emilia Garcia Casademont, Han Xiao

49. [FrameBench:A Language Understanding Benchmark Based on Frame Semantics](#link49)
**Authors:** Chihiro Yano, Ryohei Sasano

50. [Evaluating Criterion-Conditioned Behaviour of Large Language Models in Content Moderation](#link50)
**Authors:** Danting Zhang, Bei Peng, Robert Loftin

51. [CulturalMenuBench: Probing the Knowledge-Application Gap in Multimodal Culinary Reasoning](#link51)
...
52. [Remember and Reweight: Enhancing Multi-Agent Debate with Experience Memory and Confidence Estimation](#link52)
**Authors:** Xuanfa Jin, Zhijian Ma, Yongcheng Zeng, Xinyu Cui, Haifeng Zhang, Jun Wang

53. [To What Extent Do Large Language Models Understand Bangla Idioms?](#link53)
**Authors:** Mousumi Akter, Md. Faiyaz Abdullah Sayeedi, Nurul Labib Sayeedi, Swakkhar Shatabda

54. [Causal Foundation Models](#link54)
**Authors:** Christopher Stith, Hossein Rahmani, Jesse C. Cresswell

55. [Headroom-Drift Replay: A Primitive for Principled Replay Control in GRPO](#link55)
**Authors:** Hyun Bin Park, Du-Seong Chang

56. [Local Updates, Global Learning (LUGL): Playing Games with non-incremental Learners](#link56)
**Authors:** David Milec, Spyridon Samothrakis, Michael Fairbank, Dennis J. N. J. Soemers

57. [Govern the Model, Not Only the Data: Storage, Circulation, and Learning in Creative AI](#link57)
...
58. [Margins, Not Windows: Training-Free Per-Step Lossy Speculative Decoding](#link58)
**Authors:** Oszk\'ar Urb\'an, Young D. Kwon, Stylianos I. Venieris, Cecilia Mascolo

59. [Lngram v2: Latent N-Gram Memory with Interpretable Discrete Representations](#link59)
**Authors:** Yunao Zheng, Bin Wen, Xiaojie Wang

60. [Speak for Me: Giving LLMs the Situational Awareness to Participate in a Meeting](#link60)
**Authors:** Muneeb Khan, Frederic Kirstein, Terry Ruas, Bela Gipp

61. [LeanStream: A Speculate-and-Refine Streaming Framework for Efficient on-Device LLM Inference](#link61)
