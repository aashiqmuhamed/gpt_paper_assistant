...
0. [Improving Few-Step Language Flows with Untied Self-Conditioning](#link0)
**Authors:** Bocheng Li, Linli Xu

1. [Provably adaptive sampling with uniform and remasking discrete diffusion models](#link1)
**Authors:** Daniil Dmitriev, Zhihan Huang, Yuting Wei

2. [Can LLMs Truly Forget? Revealing Unlearning Gaps Through Adversarial Evaluation](#link2)
...
3. [ExecRubrics: Executable Tool-Augmented Rubrics for Verifiable and Efficient Long-Form Evaluation](#link3)
**Authors:** Kaustubh D. Dhole, Charles L. A. Clarke, Eugene Y. Agichtein

4. [Semantic Reasoning Denoising: Correcting Language Model Reasoning with Semantic Operators](#link4)
**Authors:** Yujiao Yang

5. [Thinking at the Right Size: Amortized Distillation Across Post-Trained LLMs](#link5)
**Authors:** Yan Zhou, Sara Kangaslahti, Jonathan Geuter, Nihal V. Nayak, Marco Fumero, Francesco Locatello, David Alvarez-Melis

6. [SRPO: Self-Reflective Policy Optimization for Long-Horizon Reasoning](#link6)
**Authors:** Jialong Liu, Yuling Shi, Ning Yang, Xiaodong Gu, Zuchao Li

7. [ConvergeFlow: Language Flow with Provable Convergence to Token Embeddings](#link7)
**Authors:** Na Li, Yuchen Jiao, Changxiao Cai, Gen Li

8. [BLADE: Bilevel Low-rank Augmented-Lagrangian Erasure for LLM Unlearning](#link8)
**Authors:** Md Toufikuzzaman, Ahmad Mousavi, Dongwon Lee

9. [Unlearning Is Not Just Erasing: Temporal Decoupling via Generation Inequality](#link9)
**Authors:** Xunlei Chen, Qirui Ye, Yuang Li, Yi Gong, Zhaokun Wang, Wenyi Li, Shiyao Guo, Jinyu Guo

10. [Let Credit Follow Computation: Architecture-Aware Credit Transport for Large Language Model Reinforcement Learning](#link10)
**Authors:** Qifan Shi, Zhaolu Kang, Chenghua Zhu

11. [SelFusion: Self-distillation for Diffusion Language Models](#link11)
**Authors:** Hyeongsoo Lim, Jinyoung Kim, Eunseo Seo, Minho Jang, Jiwon Yoon

12. [Context-Aware Cluster Decoding: Semantic Anchor-Driven Coherence in dMLLMs](#link12)
**Authors:** Yikai Zhao, Qiyan Zhao, Jiaquan Zhang, Xiaofeng Zhang, Xiaosong Yuan, Pengzhou Cheng

13. [Accelerating Diffusion Language Models via Structured Suffix Modeling](#link13)
**Authors:** Zifeng Cheng, Keda Li, Zhiwei Jiang, Cong Wang, Fei Shen, Qing Gu

14. [Safety Hacking in Constrained Best-of-$N$ Inference-time Scaling](#link14)
**Authors:** Akifumi Wachi, Takumi Tanabe, Youhei Akimoto

15. [What Proves You Wrong: Benchmarking Language Models on Falsifiable Research Ideation](#link15)
...
16. [Buried in Textual Debt: Context Pruning with Visual Evidence Preservation for MLLM Agents](#link16)
**Authors:** Yuchen Huang, Sijia Li, Jun Zhang, Yi R. Fung

17. [Is Next-Chunk Reasoning RL Really Better than SFT? Revisiting Training Strategies under no-CoT Data](#link17)
...
18. [PsychJail: Exploring Psychological Jailbreaks via Multi-Turn Persuasion of LLM Policies](#link18)
**Authors:** Zeyu Feng, Qingyu Wu, Yuzhe Luo, Hua Cheng

19. [Forgotten in Weights, Recovered by Tools: Agentic Tool Unlearning for LLM Agents](#link19)
**Authors:** Baicheng Chen, Zheyuan Liu, Jingyu Zhang, Kaize Ding, Ningshan Ma, Yue Huang, Meng Jiang

20. [ToSCA: Leveraging Hierarchical Reinforcement Learning on Temporal and Strategic Abstractions of Conversational Agents](#link20)
**Authors:** Xiaoyu Wang, Qingqing Gu, Yue Zhao, Teng Chen, Yuqi Cao, Xiaokai Chen, Hongyan Li, Luo Ji

21. [Proxy reliance in large language model decisions is uncalibrated to predictive evidence](#link21)
**Authors:** Zengqing Wu, Chuan Xiao

22. [Beyond the Stability-Exploration Dilemma: Environmental Regularization for LLM Policy Optimization](#link22)
**Authors:** Xianlei Zhou, Xiangdi Meng, Yu He, Tianyu Qi, Shuyan Guan, Xianli Zhang, Jian Zhang, Xin Li, Qika Lin, Jun Liu

23. [Reinforcement Learning on Benign Facts Amplifies Leakage of Memorized Private Data](#link23)
**Authors:** Renfei Zhang, Niloofar Mireshghallah

24. [StrategyBench: Evaluating Explicit Strategy Induction in Large Language Models](#link24)
**Authors:** Jinghan Tan, Yuanzheng Wang, Lu Chen, Zijun Chen, Yuqian Wang, Maosong Sun

25. [The Laws of Context Allocation: Causal Measurement and Closed-Loop Orchestration in Generative Search](#link25)
**Authors:** Peiyang Liu, Xi Wang, Di Liang, Wei Ye

26. [ST$^2$U: Stateful Test-Time Unlearning via Restricted Knowledge Boundary Control](#link26)
**Authors:** Xunlei Chen, Qinghui Gong, Ruini Xue, Yaodong Hu, Tian Lan, Wenhong Tian

27. [Stochastic Separability of Embedding Manifolds](#link27)
**Authors:** Liqing Zhang

28. [Anchoring Bias: A Persistent Fairness Backdoor Attack against MLLMs under Continual Learning](#link28)
**Authors:** Yuyang Luo, Kai Shu

29. [From Association to Causation: Improving Retrieval Precision of Retrieval-Augmented Generation via Causal Relations and an Attention Mechanism](#link29)
**Authors:** Jing Liu, Yongxing Qi, Muchen Jiang, Chengnan Hu, Qingqing Peng, Haoming Wang, Yuqing Wang, Yang Yu, Xu Zhang, Ting Wu

30. [Adaptive Multilevel Twisted Sequential Monte Carlo for Rare Events Estimation in Language Models](#link30)
**Authors:** Zixuan Liu, Fangzheng Wu, Brian Summa, Zizhan Zheng

31. [Disagree to Explore, Agree to Commit: Routing-Guided Test-Time Scaling for Software Agents](#link31)
**Authors:** Kang Chen, Junjie Nian, Yixin Cao, Yugang Jiang

32. [CAI-DLLM: Convergence Aware Inference for Diffusion Language Models](#link32)
**Authors:** Farhana Amin, Sabiha Afroz, Dimitrios S. Nikolopoulos

33. [Mitigating Reasoning-Induced Misalignment via Safety-Direction Penalty](#link33)
**Authors:** Yipeng Zhao, Qishun Yang, Shenzhe Zhu, Shu Yang, Di Wang

34. [Credal Large Language Models for Semantic Commitment under Uncertainty](#link34)
**Authors:** Shireen Kudukkil Manchingal, Sofiia Nikolenko, Fabio Cuzzolin

35. [Model of Models: When Does Emitting a Specialist Beat Attending, Adapting, or Tuning?](#link35)
**Authors:** John C. Howell

36. [MCP-Universe RL: A Framework for Training MCP Tool-Use Agents via Reinforcement Learning](#link36)
**Authors:** Ziyang Luo, Yan Yang, Xiangru Jian, Ziji Shi, Xiaoqiang Lin, Jun Hao Liew, Silvio Savarese, Junnan Li

37. [MemGuard: Persisting Verifier Signals for LLM-Agent Memory Governance](#link37)
**Authors:** Haoyu Wang, Guangyuan Dong, He Liang, Zijing Zhang, Jiachen Luo, Chuang Liu, Chao Xue, Hao Tang

38. [MCite-RL: Towards Reliable Multimodal RAG via Citation-enhanced Agentic Reinforcement Learning](#link38)
**Authors:** Suifeng Zhao, Zida Liu, Xinyu Lei, Lei Sun, Jun Gao, Sujian Li

39. [Beyond Success and Failure: Length-Aware Contrastive Learning for GUI Agents](#link39)
**Authors:** Chengyang Gu, Le Zhang, Jingbo Zhou, Yize Chen, Yu Shi, Siqi Bao, Zheng-Fan Wu, Hua Wu, Hui Xiong

40. [Don't Repeat Yourself: Stopping Verbatim Loops at Sampling Time](#link40)
**Authors:** Philipp Emanuel Weidmann, Allen Roush, Judah Goldfeder, Sanjay Basu, Ravid Shwartz-Ziv

41. [Mitigating Database Leakage in RAG Systems with Keyword-Grounded Fact Substitution](#link41)
**Authors:** Ziliang Zhang, Yubo Zhu, Wei Tong, Jingyu Hua, Zijian Wang, Yuan Zhang, Sheng Zhong

42. [HiDiffTIR: Hierarchical Difficulty-Aware Policy Optimization for Multi-Turn Tool-Integrated Reasoning](#link42)
...
43. [ChainPrune: Evaluating and Reducing Redundancy in Long Chain-of-Thought Reasoning](#link43)
**Authors:** Weihang Pan, Zhengxu Yu, Yuxiang Zhang, Wenzhi Li, Zhongming Jin, Binbin Lin, Xiaofei He, Jieping Ye

44. [LLM-based Agents for Forecasting and Prediction: Methods, Training, Evaluation, and Applications](#link44)
...
45. [Language Chain in Alignment: Cross-Lingual Ranking Preference Optimization](#link45)
**Authors:** Seungyoon Lee, Minhyuk Kim, Jungseob Lee, Heuiseok Lim

46. [Claim-Level Confidence Calibration for Reliable Decision Making with Large Language Models](#link46)
**Authors:** Toghrul Abbasli, Kentaroh Toyoda, Yuan Wang, Li Chen

47. [TailSieve: Partial-Rollout-Guided Tail Routing for LLM Rollouts](#link47)
...
48. [Stress Testing Unlearning Algorithms](#link48)
**Authors:** Noam Diamant, Ethan Fetaya, Neta Glazer

49. [On the Role of Citations in Preference Data](#link49)
**Authors:** Yu Hou, Hal Daum\'e III, Rachel Rudinger, William Walden

50. [MEMORY Wins All: Indirect Bias Injection Attacks via Social Media Feeds](#link50)
...
51. [Redteaming Leading Arabic LLMs with ASAS](#link51)
**Authors:** Fidaa Abed, Haidar Khan, M Saiful Bari, Babar Khan, Abdalghani Abujabal

52. [XTC: Head-Aware Sampling by Excluding Top Choices](#link52)
**Authors:** Philipp Emanuel Weidmann, Allen Roush, Judah Goldfeder, Sanjay Basu, Ravid Shwartz-Ziv

53. [Text-Anchored Semantic Perturbations for Transferable Jailbreak Attacks on Multimodal Large Language Models](#link53)
**Authors:** Wenyun Li, Guiping Cao, Xiangyuan Lan, Zheng Zhang

54. [SAEM: Stage-Aware Expert Management for Memory-Efficient MoE Inference in Chain-of-Thought Reasoning](#link54)
**Authors:** Yujie Zhang, Bin Gao, Tulika Mitra

55. [CD-LoRA: Consistency-Driven Low-Rank Adaptation for Multi-Task Fine-Tuning](#link55)
**Authors:** Qian Zha, Jinda Liu, Yuan Wu, Yi Chang

56. [EDGE: Experience-Distillation for Guided Exploration in Agentic Reinforcement Learning](#link56)
**Authors:** Can Xie, Yuyi Zhou, Wen Yang, Ziyi zhang, Siyao Song, Yingzhuo Deng, Shuo Ren, Jiajun Zhang

57. [GuardianBench: A Same-Scene Instruction-Contrastive Benchmark for Latent Contextual Risk in Embodied AI](#link57)
...
58. [Hidden in the Request: Explaining Unethical LLM Compliance through Token Relevance](#link58)
**Authors:** Or Biton, Tomer Krichli, Itai Allouche, Joseph Keshet

59. [FCPRAG: Fusion-Controller Parametric Retrieval-Augmented Generation for Stable Multi-Passage LoRA Injection](#link59)
**Authors:** Jinchang Zhu, Jindong Li, Yi Ding, Xiaojian Nie, Rong Fu, Shuangyong Song, Haowei He, Menglin Yang

60. [Industrial-Instruction: An End-to-End Framework for Building Instruction-Tuning and Benchmark Datasets from Industrial Technical Reports](#link60)
**Authors:** Parsa Bakhtiari, Hassan Bashiri, Alireza Khalilipour, Masoud Nasiripour, Moharram Challenger

61. [Walking on the DARKSIDE](#link61)
**Authors:** Aldo Gangemi, Emanuele Bottazzi

62. [TRACE: A Self-Evolving Skill Bank for Consistent, Limit-Aware LLM Agents](#link62)
**Authors:** Wenhao Wu, Menghao Zhang, Xin Wang, Zhi Wang, Kun Shao, Jian Luan

63. [On the Threat Model of Weird Generalization and Emergent Misalignment](#link63)
**Authors:** Miriam Wanner, Mark Dredze, William Walden

64. [From Detrimental to Beneficial: Dynamic Influence-based Valuation and Editing](#link64)
**Authors:** Adrian Nyakairu, Hongfu Liu

65. [Lexical Perturbations Disrupt LLM Reasoning: An Empirical Study of Attention Diversion](#link65)
**Authors:** Jiaqian Zhu, Yang Zhang, Junhua Ding, Xiaowei Yu

66. [Decoupled Physical Modeling and Execution for Physics Reasoning](#link66)
**Authors:** Ye Zhang, Xuehang Guo, Rui Pan, Pengfei Yu, Denghui Zhang, Manling Li, Qingyun Wang

67. [DynaContext: Self-Improving Dynamic Contextualization of Optimized Prompts for Heterogeneous Parameter Extraction](#link67)
**Authors:** Joe Yu, Shibin Thomas Stanley Paul, Sven Mayer

68. [Beyond Dense Adam States: Adaptive Log-Space Quantization for Memory-Efficient Optimizers](#link68)
**Authors:** Yan Wang

69. [Cognitive Profiling of LRMs' Reasoning Traces Using Bloom's Taxonomy](#link69)
**Authors:** Maria-Eleni Zoumpoulidi, Georgios Paraskevopoulos, Alexandros Potamianos

70. [Benchmarking Composable Compression Techniques in Mixture-of-Experts LLMs](#link70)
**Authors:** Afsara Benazir, Chen Chen, Rongxiao Qu, Jiabo Huang, Jingtao Li, Lingjuan Lyu

71. [The Compaction Cliff in Long-Running AI Agent Memory](#link71)
**Authors:** Saber Zerhoudi, Jelena Mitrovic, Michael Granitzer

72. [Class-Conditioned Gaussian Mixture Modeling for Imbalanced Time Series Quantification](#link72)
**Authors:** Md Shahriar Kabir, Mayesha Maliha R. Mithila, Anne H. H. Ngu, Myl\`ene C. Q. Farias, Byron Gao

73. [Dual-Layer Agentic Memory with Fast Write Routing and Slow Consolidation](#link73)
**Authors:** Wenzhi Li, Dong Nie, Rui Lan, Tongtong Lyu, Peiyao Wang, Lingzi Hong, Weihang Pan, Boyuan Pan, Yao Hu

74. [The Illusion of Control: Why Bare Classifier Inversion Silently Fails in Concept-Bottleneck Text Generation](#link74)
**Authors:** Qi Bing, Xiaowei Shao

75. [Activation-Weighted Seeded Residual Coding for Low-Bit LLM Weight Repair](#link75)
**Authors:** Zehao Liu, Chuangchuang Fang, Yang Ren

76. [From Diagnosis to Redesign: Using Quantitative Ethnography to Improve Multi-Agent LLM Reasoning](#link76)
**Authors:** Vedant Khatri, Anthony Cusimano, Zachari Swiecki, Zhen Xu, Xiner Liu, Renzhe Yu

77. [Counterfactual Quotient Models: Learning What Actions Change, Not What the World Does](#link77)
**Authors:** Junlin Chen, Ruijie Wang, Jianxin Li

78. [SANE: State Anomaly Neutralization for Stable Extreme-Context Delta-Rule Models](#link78)
**Authors:** Qingwen Lin, Boyan Xu, Xiao Liu, Zhifeng Hao, Ruichu Cai

79. [Can Large Language Models "Hyper-Thread"?](#link79)
**Authors:** Fei Ding

80. [The Variance of Thought: Policy Variance, Critical Forks, and Local Credit Assignment](#link80)
**Authors:** Yingru Li

81. [ChemDIRT: A Diversified Instruction, Representation, and Task Benchmark for Robust Chemistry-LLM Evaluation](#link81)
**Authors:** Eric Inae, Tim Gunn, Chris Bond, Meng Jiang

82. [Apodex 1.1: Scaling Agentic Intelligence for Complex Work](#link82)
...
83. [Context as an Environment: Programmatic Context Management for Long-Horizon Agents](#link83)
**Authors:** Yin Lin, Elaine Ang, Erkang Zhu, Bolin Ding, Jingren Zhou

84. [Data-Driven Dynamic Algorithm Dispatch with Large Language Models](#link84)
**Authors:** Rushil Shah, Emmanuel Lujan, Rabab Alomairy, Alan Edelman

85. [ReWorld: An Interactive World Model with Long-Horizon Memory](#link85)
...
86. [Signal or Noise? A Benchmark Study of Agent Skills in Web Development](#link86)
**Authors:** Ziyue Yang, Fan Ding

87. [SSDi8: Accurate and Efficient 8-bit Quantization for State Space Duality](#link87)
**Authors:** Hyunwoo Kim, Byoungchan Ko, Minseok Kang, Minwoo Kim, Dongjin Lee, Jaehoon Lee, Sungroh Yoon, Dahuin Jung

88. [Your AI, On a Dial: Controlling Investment Bias in LLMs with a Single Neuron](#link88)
...
89. [CONTRAMEM: Learning Self-Evolving Procedural Memory from Contrasting Multi-Model Trajectories](#link89)
...
90. [Learning Generalizable Behaviors for Terminal Agents](#link90)
**Authors:** Yihang Yao, Bo Pang, Xuan Phi Nguyen, Ding Zhao, Shafiq Joty, Semih Yavuz

91. [ChebBooster: A Training-Free Approach for Efficient Diffusion Transformer Inference via Chebyshev-Inspired Extrapolation](#link91)
**Authors:** Chengjie Lu, Tianchi Deng, Zhengqi He, Chengwen Luo, Xueliang Li

92. [LITERARYBIGFIVE: Author-Personalized Text Generation in a Unified Interpretable Space](#link92)
**Authors:** Jinghui Zhang, Lang Gao, Ao Li, Mingzhe Li, Ruihong Zeng, Zirui Song, Kentaro Inui, Xiuying Chen

93. [From Mastery Profile to Simulated Response: Stochastic Student Knowledge Graphs (SSKG) for Faithful LLM Student Simulation](#link93)
**Authors:** Yuan An, Emily Wang, Benjamin Wang, Ruhma Hashmi

94. [Prime Agent: A Self-Improving RLM Harness](#link94)
**Authors:** Seth Karten, Alex L. Zhang, Kevin Thomas, Sebastian M\"uller, Elie Bakouch, Daniel Auras, Mika Senghaas, Fares Obeid, Konstantin Dunas, Johannes Hagemann, Sami Jaghouar

95. [AutoSaddler: Automatic Harness Optimization with Durable Updates from Agent Execution Traces](#link95)
