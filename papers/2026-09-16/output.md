...
0. [OPEN-1B: A Fully Auditable Training Run](#link0)
**Authors:** John Donaghy, Brian Wilcox, O\u{g}uzhan Ersoy, Shikhar Rastogi, Adam St Arnaud, Alexey Titov, Jordan Greenberg, Ben Fielding, Harry Grieve

1. [Towards Scalable RLVR: Multimodal Instruction Following Data Synthesis and Distillation](#link1)
**Authors:** Yirong Zeng, Zhang Sai, Yuxian Wang, Yutai Hou, Yufei Liu, Xiao Ding, Bibo Cai

2. [Coupled Calibration and Learning: Mitigating Teacher Bias in LLM Distillation without Target-Domain Reward Feedback](#link2)
**Authors:** Haichen Hu, Yuheng Zhang, David Simchi-Levi

3. [Test-Time Unlearning via Sparse Autoencoder](#link3)
...
4. [Style-Debiased DPO: Updating LLM Knowledge with Factuality-Aware Synthetic Preference Data](#link4)
**Authors:** Takayuki Yamamoto, Daisuke Kawahara

5. [HISPO: Hierarchical Importance-Sampling Policy Optimization with Entropy-Derived Segments](#link5)
**Authors:** Quoc-Vinh Lai-Dang, Hyo-Sang Shin

6. [Latent Undertow: How Ordinary Typos Break Probes](#link6)
**Authors:** Elad David, Max Fomin, Amit LeVi

7. [Beyond Token-Local Imitation: Reward-Compatible Temporal Credit Assignment for On-Policy Distillation](#link7)
...
8. [Cascade: Hierarchical Recoverability Control for Large Language Model Unlearning](#link8)
**Authors:** Qingchen Yu, Shiying Duan, Xiaodong Li, Yuhua Wang, Zhiyu Li, Shiji Zhou, Yifan Sun, Zhaoxin Fan

9. [Early-Bird Decoding: Accelerating Diffusion LLMs with Learnable Block Sizes and Parallel Sampling](#link9)
**Authors:** Lixuan Wei, Wei Zhou, Jianwen Wu, Yipeng Shen, Meiling Wang, Haoran You

10. [Register Tokens for Bounded-State Reasoning in Diffusion Language Models](#link10)
**Authors:** Albert Ge, Chandan Singh, Yufan Zhuang, Xiaodong Liu, Jianfeng Gao, Frederic Sala

11. [Drift-Constrained Optimization: Only Direction Matters in Fine-Tuning Instruct Models](#link11)
**Authors:** Fei Yuan, Changjiang Gao, Yilei Tu, Yifeng Liu, Shujian Huang, Yu Qiao

12. [Spurious Tool Use: When RL Agents Learn the Wrong Reason to Act](#link12)
**Authors:** Yiwei Yang, Haoxiang Zhang, Bingbing Wen, Yao Lu, Yuchen Wu, Lei Zhang, Julian McAuley, Pan Lu, Bill Howe

13. [Overflip: Repetition-Induced Label Flips in Guardrail Models](#link13)
**Authors:** Xu He, Chih-Hsuan Lin, Hung-Mao Chen, Junjie Xiong, Yan Zhai, Kun Sun

14. [Verbalizing Subliminal Learning Effects Using Text Optimization](#link14)
**Authors:** Nathan Hu, Sanmi Koyejo, Christopher Potts

15. [Rewarding Reasoning, Not Answers: Fixing and Bounding Test-Time Reinforcement Learning on Medical QA](#link15)
**Authors:** Kailong Fan, Anqi Pu, Yichen Wu, Wanhua Li, Yicong Li, Hanspeter Pfister, Huafeng Liu, Xiang Li, Quanzheng Li, Ning Guo

16. [GrowMTP: Can RL Grow Its Own Draft Head?](#link16)
**Authors:** Minghua He, Lingzhe Zhang, Yuan Liu, Xiao Zhou, Aiwei Liu

17. [Interpreting and Steering LLM Agents for Social Simulations](#link17)
**Authors:** Jiayue Gaveal Fan, Arul Murugan, Shreyas Krishnan, Abhishek Nagaraj

18. [The Imitation Game: When LLMs Learn to Reason Like Programs via Code-Centric Reasoning Data Synthesis](#link18)
...
19. [Large Language Models Develop Belief State Geometry In-Context](#link19)
**Authors:** Daniel Balcells, Andrew Jun Lee, Chirag Rastogi, Paul M. Riechers, Adam Shai, Xavier Poncini

20. [State of Thought Enables Endogenous Reasoning](#link20)
**Authors:** Zhiren Gong, Yikun Hou, Zihao Zeng, Ming Xiao, Chau Yuen, Wei Yang Bryan Lim

21. [Corrupt Plans, Clean Traces: Evading Chain-of-Thought Monitoring with Plan Injection](#link21)
**Authors:** Keertana Chidambaram, Andrew Ilyas, Vasilis Syrgkanis

22. [Decoy Direction Optimization: A Post-Hoc Defense Against LLM Abliteration](#link22)
**Authors:** Aashiq Muhamed, Mona T. Diab, Virginia Smith

23. [ImpossibleRubrics: Stress-Testing Generated Rubrics as Reward Signals](#link23)
**Authors:** Bowen Qin, Yi Xie, Yesheng Liu, Xi Yang

24. [TimeThink: Eliciting Compositional Reasoning in Timeseries Large Language Models](#link24)
...
25. [T-LoopFormer: Token-Level Elastic-Depth Looped Transformers for Latent Reasoning With Dynamic Routing](#link25)
**Authors:** Mingqian Yu, Wenpeng Zhang, Peilin Zhao

26. [OPD-Aha: From Linguistic Momentum to Visual Reflection in Multimodal On-Policy Distillation](#link26)
**Authors:** Chenhao Qiu, Dawei Li, Yechao Zhang, Lei Gong, Zhen Tan

27. [TAME: Token Attribution and Masking for Emergent misalignment](#link27)
**Authors:** Md Rayhanul Masud, Md Rizwan Parvez

28. [Attention Mean Fields Predict Average Representation Dynamics and Reveal Context-Specific Computation](#link28)
**Authors:** Micah Adler, John W. Byers, Mark Crovella

29. [ECHO: Early-layer Collaborative Hierarchical Orchestration with Bonus Logits in Speculative Decoding](#link29)
**Authors:** Ziyang Ma, Zihong Zhang, Zuchao Li, Lefei Zhang, Baoyuan Qi, Siqi Li, Simin Yu

30. [RAG-CT: Mitigating Privacy Risks on Retrieval-Augmented Generation Systems via Scanning Prompt Distribution](#link30)
**Authors:** Xingyu Lyu, Jiayimei Wang, Jianfeng He, Ning Wang, Yidan Hu, Yimin Chen

31. [Bias Audits Detect Bias but Disagree on Ranking: Evidence from Ten Instruments and Ten Frontier Models](#link31)
**Authors:** William Guey, Pierrick Bougault, Wei Zhang, Vitor D. de Moura, Jos\'e O. Gomes

32. [TIAO: Token Importance-Aware Policy Optimization for Text Summarization](#link32)
**Authors:** Qixiu Li, Chenlong Bao, Xiang Zhu, Xiaoyong Li, Ruixin Cao, Shukai Chen, Zhenxiong Zhou

33. [Memorisation bias in medical AI](#link33)
**Authors:** Moritz A. Knolle, Martin J. Menten, Laurin Lux, M\'elanie Roschewitz, Emma A. M. Stanley, Georgios Kaissis, Daniel Rueckert, Ben Glocker

34. [Bypass Observation: A Conceptual Design of a Non-Intrusive Layer-Wise Semantic Extraction Architecture](#link34)
**Authors:** Haibin Tong, Jiang Yu

35. [Where Should a Document Live: Context, Representations, or Parameters?](#link35)
**Authors:** Nathana\"el Carraz Rakotonirina, Momchil Hardalov, Gonzalo Iglesias, Adri\`a de Gispert

36. [Reason What Matters: Retrieval-Grounded Reasoning for Universal Multimodal Embeddings](#link36)
**Authors:** Mingzhou Jiang, Peixi Wu, Hang Cheng, Yunhao Zhou, Biao Yang, Wei Yuan, Yun Li, Fan Yang, Wenwu Ou, Honghui He

37. [ZGCM-1: A Fully Open and Extremely Efficient Foundation Model for Math and Agentic Search](#link37)
...
38. [Same Flow, Different Paths: Variance Reduction in Flow Matching](#link38)
**Authors:** Alexander Tyurin

39. [AI Deployment Accountability Engineering: A Vision for Accountable AI in Safety-Critical Socio-Technical Systems](#link39)
**Authors:** Murat Kantarcioglu

40. [Z-Loss Backward Geometry in Dense Output Heads and Sparse Routers](#link40)
**Authors:** Bum Jun Kim

41. [Self-reported archetypes and behavioral failures in Large Language Models](#link41)
**Authors:** Tabia Tanzin Prama, Calla Glavin Beauregard, Christopher M. Danforth, Peter Sheridan Dodds

42. [How I learned to stop worrying and love StopGrads: Stationarity, Convergence, and a case study on Flow Map Learning](#link42)
**Authors:** Max W. Shen, Mark Goldstein, Zichu Wang, Aahlad Puli, Rajesh Ranganath

43. [POSPAN: Position-Constrained Span Masking for Language Model Pre-training](#link43)
**Authors:** Zhenyu Zhang, Lei Shen, Yuming Zhao, Meng Chen, Xiaodong He

44. [Convergent Emergence of In-Context Learning Across Modalities](#link44)
**Authors:** Nathan Breslow, Seungwook Han, Daniel Hyunsoo Lee, Aayush Mishra, Anqi Liu, Daniel Khashabi

45. [On the Importance of Gating: Memorization vs. In-Context Learning in State Space Models](#link45)
...
46. [AI Persuasion as a Threat to Human Control](#link46)
**Authors:** Joshua Levy, Mick Yang, Kellin Pelrine

47. [Anatomy of Associative Recall in Fixed-State Recurrences: A Matched-State Decomposition, an Interference Wall, and a Curriculum That Breaks It](#link47)
**Authors:** Julian Boesch, Andrew Wee

48. [Continuous-Time Machine Learning: A Unified Mathematical Perspective](#link48)
**Authors:** Waleed Razzaq, Yun-Sheng Zhao, Yun-Bo Zhao

49. [An Empirical Study of Counterfactual Self-Explanations in LLMs](#link49)
**Authors:** Giannis Kalyvas, Giorgos Filandrianos, Orfeas Menis Mastromichalakis, Vassilis Lyberatos, Giorgos Stamou

50. [What Does Layer-Importance Reveal About Transformers and State-Space Models?](#link50)
**Authors:** Istabrak Abbes, Nizar Islah, Irina Rish, Sarath Chandar

51. [CWM: Controllable White-Box Meta-Prompting for Adaptive Retrieval-Augmented Generation and Reasoning Ability](#link51)
**Authors:** Keuntae Kim, Eunhye Jeong, Yong Suk Choi

52. [UniCAR-RL: Seeing Better before Thinking Deeper in Visual Mathematics](#link52)
**Authors:** Yuzhe Li, Hao Yan, Hao Wang, Xingchen Liu, Ya-Qi Yu, Jihao Wu, Minghui Liao, Wei Chen, Yuliang Liu

53. [AppliedScientist: Automated Scientific Revision Through Iterative AI Reviewing](#link53)
**Authors:** Vidushee Vats, Karun Sharma, Shengzhi Li, Shichao Pei

54. [A unified framework for global and local interpretability using adaptive derivative-ordered random explanation](#link54)
**Authors:** Lemen Chao, Ming Lei, Anran Fanga

55. [Efficient One-to-Many Translation with Joint Multi-Stream Diffusion](#link55)
**Authors:** Yiwen Guan, Jacob Whitehill

56. [Generalized Agent Iteration: One Formal Framework for Iterative Policy Improvement and Recursive Self-Improvement](#link56)
**Authors:** Hongyao Tang, Yi Ma, Pengyi Li, Yifu Yuan

57. [Beyond Distribution Matching: Semantics-Consistent Tabular Diffusion with Weak Semantic Priors](#link57)
**Authors:** Yili Wang, Ruxue Shi, Mengnan Du, Hangting Ye, Yi Chang, Xin Wang

58. [LoopSpec: Pipelined Self-Speculative Decoding for Looped Transformers](#link58)
**Authors:** SangLyul Cho, Langqing Cui, Sehoon Kim, Dongsu Han, Insu Han

59. [FLoKD: Adaptive Knowledge Distillation for Federated Low-Rank LLM over Wireless Networks](#link59)
**Authors:** Xinlu Zhang, Na Yan, Yang Su, Yansha Deng, Toktam Mahmoodi

60. [Retrieval-Driven Memory Reconsolidation for Long-Term LLM Agents](#link60)
**Authors:** Yuanyi Song, Yukai Wang, Xinbei Ma, Zhihui Fu, Jianghao Lin, Weiwen Liu, Jun Wang, Huarong Deng, Yong Yu, Weinan Zhang

61. [Optimal Model Activation Policies for Inference Networks of Large Language Models](#link61)
**Authors:** Foivos Charalampakos, Md Ibrahim Ibne Alam, Iordanis Koutsopoulos, Koushik Kar

62. [Beyond the Name: Demographic Leakage in De-Identified R\'esum\'es and Evaluation Artifacts in LLM Bias Audits](#link62)
**Authors:** Qiangju Chen, Yang Xiao

63. [Smarter by the Moment: Environment-Driven Dynamic Policies for Continual LLM Improvement](#link63)
**Authors:** Ting-Wei Chang, Po-Chun Chen, Hen-Hsen Huang, Hsin-Hsi Chen

64. [Right Direction, Wrong Step: Geometric Analysis of Finite-Step Failure in Looped Transformers](#link64)
**Authors:** Zhihao Guo, Zonghan Wu, Haizhou Du, Huan Huo, Yilei Shao, Athanasios V. Vasilakos, Qingsong Wen

65. [Generative models for simulation based filtering: Formulations and Empirical Comparisons](#link65)
**Authors:** Mohammad Al-Jarrah, Wei Deng, Bamdad Hosseini, Amirhossein Taghvaei

66. [PaperDoctor: Evidence-Grounded and Actionable Feedback for Scientific Papers in Progress](#link66)
...
67. [CoMem: Collective-Individual Memory Synergy for Evolutionary Multi-Agent Systems](#link67)
**Authors:** Chengxin Yu, Zhaoxin Fan, Faguo Wu, Hongwei Zheng, Yun Zhou, Zhiyu Li

68. [Four Ledgers, Not One Score: Responsible Communication of LLM-Judge Calibration in Biomedical ML](#link68)
**Authors:** Sidi Chang, Peiying Zhu

69. [What Breaks Under Pruning in Smart Homes, and When? Evaluating LLM Degradation Across Architectures and Task Complexity](#link69)
**Authors:** Congjing Zhang, Vashishtha Patil, Henning Lange, Usman Aleem

70. [Asclepius: An Adaptive Harness for Long-Horizon Clinical Agents](#link70)
**Authors:** Grace Chang Yuan, Xiaoman Zhang, Sung Eun Kim, Luyang Luo, Pranav Rajpurkar

71. [Grounded Adjudication of Variations across Extracted TimeLines (GAVEL): Comparing Clinical Timelines Against Their Case Reports](#link71)
**Authors:** Jack Cummins, Sayantan Kumar, Ketan Tamirisa, Jeremy C. Weiss

72. [Competence-Preserving Resume Perturbations Expose Presentation Sensitivity in LLM Screening](#link72)
**Authors:** Qiangju Chen, Yang Xiao

73. [Question's Gambit: The First Move Matters in Agentic Deep Search](#link73)
