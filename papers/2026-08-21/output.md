...
0. [Metrics That Write Themselves: Evolving an Evaluator from Its Own Blind Spots](#link0)
**Authors:** Xing Zhang, Yanwei Cui, Guanghui Wang, Zhihao Lin, Peiyang He

1. [Mechanistic Tomography: Designed Measurement for Control-Oriented Interpretability](#link1)
**Authors:** Vijay Erramilli

2. [Inadvertent Context Leakage in Language Models](#link2)
**Authors:** Jaiden Fairoze, Neal Mangaokar, Kamalika Chaudhuri, Sanjam Garg, Saeed Mahloujifar

3. [ConceptGuard: Benchmarking Context-Sensitive Unlearning in Large Language Models](#link3)
**Authors:** Sahil Kale, Ian Harris

4. [SESSE: Sketch, Expand, Sort, Summarize, Evaluate -- LLM-as-Judge Evaluation via Structured Decomposition](#link4)
**Authors:** Dae Lee, Mihai Delgeanu, Adel Youssef

5. [Competence, Not Accuracy: A Diagnostic for Reference-Free Judge Gates in Skill Optimization](#link5)
**Authors:** Chenle Chen, Yangbo Wei, Chao Yao, Shaoqiang Lu, Junhong Qian, Chen Wu, Lei He

6. [Measuring the Partial-Credit Gap: A Strict Benchmark on Vietnam's 2025 Convex Marking Scheme](#link6)
**Authors:** Nguyen Quoc Hung, Nguyen Dang Minh, Le Nhu Quynh, Tran Khanh Linh, Nguyen Kieu Linh

7. [One Success Isn't Reliability: Thinkingbox, a Sandbox and Benchmark for Agents in Stateful Business Workflows](#link7)
...
8. [What is Missing from AI Post-Training AI: An Empirical Analysis](#link8)
**Authors:** Joy Jia Yin Lim, Xin Huang, Hao Peng, Yaxi Lu, Xin Cong, Zhong Zhang, Maosong Sun, Yankai Lin

9. [LoRA-GA$^2$: Low Rank Adaptation with Multi-step Gradient Adaptive Alignment](#link9)
**Authors:** Haonan He, Xinyue Fan

10. [Continuous Adversarial MeanFlow Transfer](#link10)
**Authors:** Yara Bahram, Zahra Dehghani, M\'elodie Desbos, Eric Granger, Pablo Piantanida, Mohammadhadi Shateri

11. [RTPO: Reverse-Turn Policy Optimization for Stabilizing Agentic RL Training](#link11)
**Authors:** Yugu Li, Jimmy Cao, Jianglin Qiao, Siyi Hu

12. [Inducing Task Models from Computer-Use Traces](#link12)
**Authors:** Yucheng Jiang, Zora Zhiruo Wang, Ruishi Chen, Diyi Yang

13. [Training-Free Inference-Time Self-Reflection and Cost-Bounded Early Stopping for Large Language Models](#link13)
**Authors:** Wei Yu, Suxing Liu, Minjie Yu, Jiahao Wang, Zhijian Zheng, Haocheng Deng, Bing Li

14. [Stopping and Routing LLM Judge Panels](#link14)
**Authors:** Bin Zhu, Yi Xie, Yanghui Rao

15. [Truncate Bad, Upweight Good: BoN-Style Distillation via Rank-Based Classification](#link15)
**Authors:** Yarin Bar, Yaniv Romano

16. [Grouping the Stochastic Machine: Precision, Not Capability, as the Frontier Metric for AI Systems](#link16)
**Authors:** George Andrikopoulos

17. [Improved Confidence Estimates for Black-Box Large Language Models](#link17)
**Authors:** Sokhna Diarra Mbacke, Mouloud Belbahri, Gabriel Loaiza-Ganem

18. [Position: Collusion Risks Among AI Reasoning Agents Justify Certification Requirements for Making Market Decisions](#link18)
**Authors:** Matthew Riemer, Tommaso Tosato, Amin Memarian, Maximilian Puelma Touzel, Glen Berseth, Irina Rish, Guillaume Dumas

19. [Are LLMs becoming similarly creative? Evidence from three years of models](#link19)
**Authors:** Nirav Patel, Josiah Crossman, Eva Aggarwal, Emily Wenger

20. [Hear2Act: Benchmarking When Prosody Should Change What an Assistant Does](#link20)
**Authors:** Xinyi Liu, Hooshang Nayyeri, Dilek Hakkani-Tur, Emine Yilmaz, JK Kim, Yifei Zhang, Charith Peris, Hari Thadakamalla

21. [Forking Fast: Efficiently Estimating Uncertainty Dynamics in Text Generation](#link21)
...
22. [SkillGate: Training In-Policy Skill Selection in Long-Horizon Agents](#link22)
**Authors:** Qingyao Li, Wenxiang Jiao, Shuai Shao, Kangning Zhang, Yuan Lu, Yi Guo, Weiwen Liu, Weinan Zhang, Yong Yu

23. [TestifAI: Tomography-Based Testing for Deep Learning Systems](#link23)
**Authors:** Arooj Arif, Tobias Hartung, Elena Botoeva, Alexandros Koliousis

24. [Learning how to Forget: Fine-tuning for Long-Context Sparse Attention](#link24)
**Authors:** Matthias Seeger, Zeyu Zhang, Vihang Patil, Konstantinos Benidis, Sebastian Schelter

25. [FACET: Preserving Source Intent and Executable State in Terminal Task Synthesis](#link25)
...
26. [When Text and Numbers Disagree: Evidence Arbitration in Large Language Models](#link26)
