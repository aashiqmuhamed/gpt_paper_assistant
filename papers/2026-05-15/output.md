...
0. [The Rate-Distortion-Polysemanticity Tradeoff in SAEs](#link0)
**Authors:** Tommaso Mencattini, Francesco Montagna, Francesco Locatello

1. [Support Before Frequency in Discrete Diffusion](#link1)
**Authors:** Adrian M\"uller, Antoine Gonon, Zebang Shen, Ya-Ping Hsieh, Niao He

2. [Uncertainty Quantification for Large Language Diffusion Models](#link2)
**Authors:** Artem Vazhentsev, Vladislav Smirnov, David Li, Maxim Panov, Timothy Baldwin, Artem Shelmanov

3. [Where Should Diffusion Enter a Language Model? Geometry-Guided Hidden-State Replacement](#link3)
**Authors:** Injin Kong, Hyoungjoon Lee, Yohan Jo

4. [Widening the Gap: Exploiting LLM Quantization via Outlier Injection](#link4)
**Authors:** Xiaohua Zhan, Kazuki Egashira, Robin Staab, Mark Vero, Martin Vechev

5. [Uncovering the Representation Geometry of Minimal Cores in Overcomplete Reasoning Traces](#link5)
**Authors:** Sanjoy Chowdhury, Dinesh Manocha

6. [Agentic Systems as Boosting Weak Reasoning Models](#link6)
**Authors:** Varun Sunkaraneni, Pierfrancesco Beneventano, Riccardo Neumarker, Tomaso Poggio, Tomer Galanti

7. [Factorization-Error-Free Discrete Diffusion Language Model via Speculative Decoding](#link7)
**Authors:** Xun Fang, Yunchen Li, Hang Yuan, Zhou Yu

8. [Language Generation as Optimal Control: Closed-Loop Diffusion in Latent Control Space](#link8)
**Authors:** ZiYi Dong, Yuliang Huang, Weijian Deng, Xiangyang Ji, Liang Lin, Pengxu Wei

9. [Resolving Action Bottleneck: Agentic Reinforcement Learning Informed by Token-Level Energy](#link9)
...
10. [Auditing Agent Harness Safety](#link10)
...
11. [Non-linear Interventions on Large Language Models](#link11)
**Authors:** Sangwoo Kim

12. [Stateful Reasoning via Insight Replay](#link12)
**Authors:** Bin Lei, Caiwen Ding, Jiachen Yang, Ang Li, Xin Eric Wang

13. [Learning from Language Feedback via Variational Policy Distillation](#link13)
**Authors:** Yang Li, Erik Nijkamp, Semih Yavuz, Shafiq Rayhan Joty

14. [Training ML Models with Predictable Failures](#link14)
**Authors:** Will Schwarzer, Scott Niekum

15. [Fusion-fission forecasts when AI will shift to undesirable behavior](#link15)
**Authors:** Neil F. Johnson, Frank Yingjie Huo

16. [DVMap: Fine-Grained Pluralistic Value Alignment via High-Consensus Demographic-Value Mapping](#link16)
**Authors:** Pengyun Zhu, Yuqi Ren, Zhen Wang, Lei Yang, Deyi Xiong

17. [GradShield: Alignment Preserving Finetuning](#link17)
**Authors:** Zhanhao Hu, Xiao Huang, Patrick Mendoza, Emad A. Alghamdi, Basel Alomair, Raluca Ada Popa, David Wagner

18. [SliceGraph: Mapping Process Isomers in Multi-Run Chain-of-Thought Reasoning](#link18)
**Authors:** Kang Chen, Junjie Nian, Yixin Cao, Yugang Jiang

19. [Learning from Failures: Correction-Oriented Policy Optimization with Verifiable Rewards](#link19)
**Authors:** Mengjie Ren, Jie Lou, Boxi Cao, Xueru Wen, Hongyu Lin, Xianpei Han, Le Sun, Xing Yu, Yaojie Lu

20. [Boosting Reinforcement Learning with Verifiable Rewards via Randomly Selected Few-Shot Guidance](#link20)
**Authors:** Kai Yan, Alexander G. Schwing, Yu-Xiong Wang

21. [Diagnosing Training Inference Mismatch in LLM Reinforcement Learning](#link21)
**Authors:** Tianle Zhong, Neiwen Ling, Yifan Pi, Zijun Wei, Tianshu Yu, Geoffrey Fox, Peng Wu, Xiao Yu

22. [Model-Adaptive Tool Necessity Reveals the Knowing-Doing Gap in LLM Tool Use](#link22)
**Authors:** Yize Cheng, Chenrui Fan, Mahdi JafariRaviz, Keivan Rezaei, Soheil Feiz

23. [Learning to Build the Environment: Self-Evolving Reasoning RL via Verifiable Environment Synthesis](#link23)
**Authors:** Yucheng Shi, Zhenwen Liang, Kishan Panaganti, Dian Yu, Wenhao Yu, Haitao Mi

24. [Selective Safety Steering via Value-Filtered Decoding](#link24)
**Authors:** Bat-Sheva Einbinder, Hen Davidov, Yee Whye Teh, Yarin Gal, Yaniv Romano

25. [From Sycophantic Consensus to Pluralistic Repair: Why AI Alignment Must Surface Disagreement](#link25)
**Authors:** Varad Vishwarupe, Nigel Shadbolt, Marina Jirotka

26. [Sycophancy is an Educational Safety Risk: Why LLM Tutors Need Sycophancy Benchmarks](#link26)
**Authors:** Enkelejda Kasneci, Gjergji Kasneci

27. [Why Retrieval-Augmented Generation Fails: A Graph Perspective](#link27)
**Authors:** Kai Guo, Xinnan Dai, Zhibo Zhang, Nuohan Lin, Shenglai Zeng, Jie Ren, Haoyu Han, Jiliang Tang

28. [Grounded Continuation: A Linear-Time Runtime Verifier for LLM Conversations](#link28)
**Authors:** Qisong He, Yi Dong, Xiaowei Huang

29. [InfoSFT: Learn More and Forget Less with Information-Aware Token Weighting](#link29)
**Authors:** Mahdi Sabbaghi, George Pappas, Adel Javanmard, Hamed Hassani

30. [Beyond What to Select: A Plug-and-play Oscillatory Data-Volume Scheduling for Efficient Model Training](#link30)
**Authors:** Suorong Yang, Hanqi Zhu, Hai Gan, Fangjian Su, Guang Li, Furao Shen, Soujanya Poria

31. [Reinforcement Learning with Semantic Rewards Enables Low-Resource Language Expansion without Alignment Tax](#link31)
**Authors:** Zeli Su, Ziyin Zhang, Zhou Liu, Xuexian Song, Zhankai Xu, Longfei Zheng, Xiaolu Zhang, Rong Fu, Guixian Xu, Wentao Zhang

32. [LiSA: Lifelong Safety Adaptation via Conservative Policy Induction](#link32)
...
33. [Teaching Large Language Models When Not to Know: Learning Temporal Critique for Ex-Ante Reasoning](#link33)
**Authors:** Chenlu Ding, Jiancan Wu, Yanchen Luo, Zheyuan Liu, Yancheng Yuan, Xiang Wang

34. [Knowledge Beyond Language: Bridging the Gap in Multilingual Machine Unlearning Evaluation](#link34)
**Authors:** Kyomin Hwang, Hyeonjin Kim, Sangyeon Cho, Nojun Kwak

35. [OpenDeepThink: Parallel Reasoning via Bradley--Terry Aggregation](#link35)
**Authors:** Shang Zhou, Wenhao Chai, Kaiyuan Liu, Huanzhi Mao, Qiuyang Mang, Jingbo Shang

36. [Polar probe linearly decodes semantic structures from LLMs](#link36)
**Authors:** Pablo J. Diego-Sim\'on, Pierre Orhan, Yair Lakretz, Jean-R\'emi King

37. [Bad Seeing or Bad Thinking? Rewarding Perception for Vision-Language Reasoning](#link37)
**Authors:** Haozhe Wang, Qixin Xu, Changpeng Wang, Taofeng Xue, Chong Peng, Wenhu Chen, Fangzhen Lin

38. [From Table to Cell: Attention for Better Reasoning with TABALIGN](#link38)
...
39. [Self-Distilled Agentic Reinforcement Learning](#link39)
...
40. [Dual-Dimensional Consistency: Balancing Budget and Quality in Adaptive Inference-Time Scaling](#link40)
**Authors:** Rongman Xu, Yifei Li, Tianzhe Zhao, Yanrui Wu, Bo Li, Hang Yan

41. [Enhanced and Efficient Reasoning in Large Learning Models](#link41)
**Authors:** Leslie G. Valiant

42. [Rethinking Layer Relevance in Large Language Models Beyond Cosine Similarity](#link42)
...
43. [Quantifying and Mitigating Premature Closure in Frontier LLMs](#link43)
**Authors:** Rebecca Handler, Suhana Bedi, Nigam Shah

44. [Mistletoe: Stealthy Acceleration-Collapse Attacks on Speculative Decoding](#link44)
**Authors:** Shuoyang Sun, Chang Da, Hao Fang, Kuofeng Gao, Xinhao Zhong, Yi Sun, Fan Mo, Shu-Tao Xia, Bin Chen

45. [When Answers Stray from Questions: Hallucination Detection via Question-Answer Orthogonal Decomposition](#link45)
**Authors:** Siyang Yao, Erhu Feng, Yubin Xia

46. [Efficient Multi-objective Prompt Optimization via Pure-exploration Bandits](#link46)
**Authors:** Donghao Li, Chengshuai Shi, Weijuan Ou, Cong Shen, Jing Yang

47. [Angel or Demon: Investigating the Plasticity Interventions' Impact on Backdoor Threats in Deep Reinforcement Learning](#link47)
**Authors:** Oubo Ma, Ruixiao Lin, Yang Dai, Jiahao Chen, Chunyi Zhou, Linkang Du, Shouling Ji

48. [Spontaneous symmetry breaking and Goldstone modes for deep information propagation](#link48)
**Authors:** Nabil Iqbal, T. Anderson Keller, Yue Song, Takeru Miyato, Max Welling

49. [A Unified Geometric Framework for Weighted Contrastive Learning](#link49)
**Authors:** Raphael Vock, Edouard Duchesnay, Benoit Dufumier

50. [SkillFlow: Flow-Driven Recursive Skill Evolution for Agentic Orchestration](#link50)
**Authors:** Mingda Zhang, Tiesunlong Shen, Haoran Luo, Wenjin Liu, Zikai Xiao, Erik Cambria, Xiaoying Tang

51. [TAPIOCA: Why Task- Aware Pruning Improves OOD model Capability](#link51)
**Authors:** Krish Sharma, Omar Naim, Soumadeep Saha, Nicholas Asher

52. [Mechanistic Interpretability of EEG Foundation Models via Sparse Autoencoders](#link52)
**Authors:** William Lehn-Schi{\o}ler, Magnus Ruud Kj{\ae}r, Rahul Thapa, Magnus Guldberg Pedersen, Anton Storgaard Mosquera, Nick Williams, Radu Gatej, Tue Lehn-Schi{\o}ler, S\'andor Beniczky, Sadasivan Puthusserypady, James Zou, Lars Kai Hansen

53. [HodgeCover: Higher-Order Topological Coverage Drives Compression of Sparse Mixture-of-Experts](#link53)
**Authors:** Tao Zhong, Dongzhe Zheng, Christine Allen-Blanchette

54. [From Descriptive to Prescriptive: Uncover the Social Value Alignment of LLM-based Agents](#link54)
**Authors:** Jinxian Qu, Qingqing Gu, Teng Chen, Luo Ji

55. [TFGN: Task-Free, Replay-Free Continual Pre-Training Without Catastrophic Forgetting at LLM Scale](#link55)
**Authors:** Anurup Ganguli

56. [Know When To Fold 'Em: Token-Efficient LLM Synthetic Data Generation via Multi-Stage In-Flight Rejection](#link56)
**Authors:** Anjir Ahmed Chowdhury, Syed Zawad, Feng Yan

57. [PreFT: Prefill-only finetuning for efficient inference](#link57)
**Authors:** Andrew Lanpouthakoun, Aryaman Arora, Zhengxuan Wu, Dhruv Pai, Ben Keigwin, Dan Jurafsky, Christopher Potts

58. [EvolveMem:Self-Evolving Memory Architecture via AutoResearch for LLM Agents](#link58)
**Authors:** Jiaqi Liu, Xinyu Ye, Peng Xia, Zeyu Zheng, Cihang Xie, Mingyu Ding, Huaxiu Yao

59. [GroupMemBench: Benchmarking LLM Agent Memory in Multi-Party Conversations](#link59)
**Authors:** Jingbo Yang, Kwei-Herng Lai, Xiaowen Wang, Shiyu Chang, Yaar Harari, Evgeniy Gabrilovich

60. [MeMo: Memory as a Model](#link60)
...
61. [XDomainBench: Diagnosing Reasoning Collapse in High-Dimensional Scientific Knowledge Composition](#link61)
...
62. [EndPrompt: Efficient Long-Context Extension via Terminal Anchoring](#link62)
...
63. [Self-Pruned Key-Value Attention: Learning When to Write by Predicting Future Utility](#link63)
**Authors:** Gergely Szilvasy (Meta FAIR), Manuel Faysse (Meta FAIR, MICS, CentraleSup\'elec), Maria Lomeli (Meta FAIR), Matthijs Douze (Meta FAIR), Pierre-Emmanuel Mazar\'e (Meta FAIR), Lo\"ic Cabannes (Meta FAIR), Wen-tau Yih (Meta FAIR), Herv\'e J\'egou (Meta FAIR)

64. [Improving Multi-turn Dialogue Consistency with Self-Recall Thinking](#link64)
**Authors:** Renning Pang, Tian Lan, Leyuan Liu, Xiaoming Huang, Piao Tong, Xiaosong Zhang

65. [FutureSim: Replaying World Events to Evaluate Adaptive Agents](#link65)
...
66. [PREPING: Building Agent Memory without Tasks](#link66)
**Authors:** Yumin Choi, Sangwoo Park, Minki Kang, Jinheon Baek, Sung Ju Hwang

67. [PEML: Parameter-efficient Multi-Task Learning with Optimized Continuous Prompts](#link67)
**Authors:** Anjir Ahmed Chowdhury, Syed Zawad, Xiaolong Ma, Xu Dong, Feng Yan

68. [Precise Verification of Transformers through ReLU-Catalyzed Abstraction Refinement](#link68)
**Authors:** Hengjie Liu, Zhenya Zhang, Jianjun Zhao

69. [Prompt Segmentation and Annotation Optimisation: Controlling LLM Behaviour via Optimised Segment-Level Annotations](#link69)
**Authors:** Devika Prasad, Luke Gerschwitz, Tong Li, Henry Xiao, Anjin Liu, Coco Wu, Anna Leontjeva, Luiz Pizzato

70. [Action-Inspired Generative Models](#link70)
**Authors:** Eshwar R. A., Debnath Pal

71. [MetaAgent-X : Breaking the Ceiling of Automatic Multi-Agent Systems via End-to-End Reinforcement Learning](#link71)
**Authors:** Yaolun Zhang, Yujie Zhao, Nan Wang, Yiran Wu, Jiayu Chang, Yizhao Chen, Qingyun Wu, Jishen Zhao, Huazheng Wang

72. [TabPFN-3: Technical Report](#link72)
...
73. [FrontierSmith: Synthesizing Open-Ended Coding Problems at Scale](#link73)
...
74. [Distribution-Aware Algorithm Design with LLM Agents](#link74)
**Authors:** Saharsh Koganti, Priyadarsi Mishra, Pierfrancesco Beneventano, Tomer Galanti

75. [LoMETab: Beyond Rank-1 Ensembles for Tabular Deep Learning](#link75)
**Authors:** Changryeol Choi, Hyewon Park, Yujin Kwon, Gowun Jeong

76. [Towards the Next Frontier of LLMs, Training on Private Data: A Cross-Domain Benchmark for Federated Fine-Tuning](#link76)
...
77. [From Text to Voice: A Reproducible and Verifiable Framework for Evaluating Tool Calling LLM Agents](#link77)
**Authors:** Md Tahmid Rahman Laskar, Xue-Yong Fu, Seyyed Saeed Sarfjoo, Quinten McNamara, Jonas Robertson, Shashi Bhushan TN

78. [Croissant Baker: Metadata Generation for Discoverable, Governable, and Reusable ML Datasets](#link78)
...
79. [Are Agents Ready to Teach? A Multi-Stage Benchmark for Real-World Teaching Workflows](#link79)
**Authors:** Zixin Chen, Peng Liu, Rui Sheng, Haobo Li, Jianhong Tu, Xiaodong Deng, Kashun Shum, Dayiheng Liu, Huamin Qu

80. [Performance-Driven Policy Optimization for Speculative Decoding with Adaptive Windowing](#link80)
**Authors:** Jie Jiang, Xing Sun

81. [Derivation Prompting: A Logic-Based Method for Improving Retrieval-Augmented Generation](#link81)
**Authors:** Ignacio Sastre, Guillermo Moncecchi, Aiala Ros\'a

82. [Graphs of Research: Citation Evolution Graphs as Supervision for Research Idea Generation](#link82)
**Authors:** Songyang Gao, Yinghui Xia, Siyi Liu, Hui Xiong

83. [Finite Sample Bounds for Learning with Score Matching](#link83)
**Authors:** Devin Smedira, Abhijith Jayakumar, Sidhant Misra, Marc Vuffray, Andrey Y. Lokhov

84. [ClawForge: Generating Executable Interactive Benchmarks for Command-Line Agents](#link84)
...
85. [Does RAG Know When Retrieval Is Wrong? Diagnosing Context Compliance under Knowledge Conflict](#link85)
**Authors:** Yihang Chen, Pin Qian, Su Wang, Sipeng Zhang, Huan Xu, Shuhuai Lin, Xinpeng Wei

86. [Exploring Geographic Relative Space in Large Language Models through Activation Patching](#link86)
**Authors:** Stef De Sabbata, Rahul Baiju, Stefano Mizzaro, Kevin Roitero

87. [XFP: Quality-Targeted Adaptive Codebook Quantization with Sparse Outlier Separation for LLM Inference](#link87)
**Authors:** Thomas Witt

88. [An Interpretable Latency Model for Speculative Decoding in LLM Serving](#link88)
**Authors:** Linghao Kong, Megan Flynn, Michael Peng, Nir Shavit, Mark Kurtz, Alexandre Marques

89. [Chain-of-Procedure: Hierarchical Visual-Language Reasoning for Procedural QA](#link89)
**Authors:** Guanhua Chen, Yutong Yao, Shenghe Sun, Ci-Jun Gao, Shudong Liu, Lidia S. Chao, Feng Wan, Derek F. Wong

90. [Towards Resource-Efficient LLMs: End-to-End Energy Accounting of Distillation Pipelines](#link90)
**Authors:** Katherine Lambert, Sasha Luccioni

91. [A Two-Dimensional Framework for AI Agent Design Patterns: Cognitive Function and Execution Topology](#link91)
**Authors:** Jia Huang, Joey Tianyi Zhou

92. [Concurrency without Model Changes: Future-based Asynchronous Function Calling for LLMs](#link92)
**Authors:** Guangyu Feng, Huanzhi Mao, Prabal Dutta, Joseph E. Gonzalez

93. [Compositional Sparsity as an Inductive Bias for Neural Architecture Design](#link93)
**Authors:** Hongyu Lin, Antonio Briola, Yuanrong Wang, Tomaso Aste

94. [Enjoy Your Layer Normalization with the Computational Efficiency of RMSNorm](#link94)
**Authors:** Yuxin Guo, Yihao Yue, Yunhao Ni, Yizhou Ruan, Jie Luo, Wenjun Wu, Lei Huang

95. [Beyond Individual Intelligence: Surveying Collaboration, Failure Attribution, and Self-Evolution in LLM-based Multi-Agent Systems](#link95)
