# Personalized Daily Arxiv Papers 07/15/2026
...
0. [Extractable Memorization From First Principles](#link0)
...
1. [Accelerating Masked Diffusion Large Language Models: A Survey of Efficient Inference Techniques](#link1)
**Authors:** Daehoon Gwak, Minhyung Lee, Junwoo Park, Jaegul Choo

2. [Agentic-DPO: From Imitation to Agentic Policy Optimization on Expert Trajectories](#link2)
**Authors:** Yixiong Chen, Alan Yuille

3. [SPARK: Susceptibility-Guided Profiling and Steering of Latent Reasoning States in Large Language Models](#link3)
**Authors:** Dongxu Zhang, Yiding Sun, Zihao Guo, Xiangyang Yang, Kai Tang, Lin Chen, Cheng Tan, Jihua Zhu

4. [From Critic to Confidence: PPO for Language-Based Quantitative Prediction with Confidence Estimation](#link4)
**Authors:** Mehak Dhaliwal, Rasta Tadayon, Andong Hua, Haewon Jeong, Yao Qin

5. [Scaling Point-in-Time Language Models](#link5)
**Authors:** Bryan Kelly, Semyon Malamud, Johannes Schwab, Teng Andrea Xu

6. [Can LLMs Write Reliable Rubrics? A Meta-Evaluation for Experiment Reproduction](#link6)
**Authors:** Hanhua Hong, Yizhi Li, Jiaoyan Chen, Luu Gia Huy, Sophia Ananiadou, Jung-jae Kim, Chenghua Lin

7. [SVR-R1: Bootstrapping Multi-modal Reasoning with Self-verification in Reinforcement Learning](#link7)
...
8. [From Neural Network Decisions to Training Cases: An Exact Account via Case-Based Decision Theory](#link8)
**Authors:** Manli Yan, Yuebin Lin, Yaowen Yu, Yong Zhao

9. [ANCHOR: Automated Alignment Auditing for CLI Agents on Real-World Harm](#link9)
**Authors:** Kefan Song, Yanjun Qi

10. [Signal-Guided Optimization for Machine Unlearning](#link10)
**Authors:** Xujia Li, Dan Li, Jian Lou, Wenjie Feng

11. [LLM Judges Can Be Too Generous When There Is No Reference Answer](#link11)
**Authors:** Chalamalasetti Kranti, Sowmya Vajjala

12. [The Computational Basis of Confidence in Large Language Models](#link12)
**Authors:** Dharshan Kumaran, Viorica Patraucean, Maks Ovsanikov, Petar Veli\v{c}kovi\'c, Nathaniel Daw

13. [Calibrated e-CUSUM Decoding for Quantized Reasoning Models: Why Token Log-Probability Is the Wrong Observable for Decoding Monitors](#link13)
...
14. [Valid $\ne$ Necessary: Diagnosing Latent Inefficiency in Chain-of-Thought](#link14)
**Authors:** Daeyeop Lee, Hwanjo Yu

15. [Knowledgeless Language Models: Suppressing Parametric Recall for Evidence-Grounded Language Modeling](#link15)
**Authors:** Roi Cohen, Yvan Carr\'e, Nick Lechtenb\"orger, Hendrik Droste, Lucas Kerschke, Russa Biswas, Gerard de Melo, Jan Buys

16. [OS-Pruner: Pruning Chains-of-Thought of Reasoning Models via Optimal Stopping](#link16)
**Authors:** Mohammed Ehab, Aymane El Gadarri, Vivek F. Farias, Adam Jozefiak, Ciamac C. Moallemi

17. [Ring-Zero: Scaling Zero RL to a Trillion Parameters for Emergent Reasoning](#link17)
...
18. [Interpreting Latent CoT Reasoning as Dynamical Systems](#link18)
**Authors:** Sabari Iyyappan Duraipandian, Shreya Sanjay Boyane, Manju Nagesh, Jerome Francis, Archana Vaidheeswaran, Kevin Zhu

19. [SinAE: A Single-Architecture Flow-Matching Autoencoder for Cross-Domain Atomic Systems](#link19)
**Authors:** Yuxuan Ren, Fan Yang, Jianhua Yao, Yatao Bian

20. [Laguerre Geometry for Interpreting Large Language Models](#link20)
**Authors:** Chunwei Ma, Russell Wolfinger

21. [The Illusion of Robustness: Aggregate Accuracy Hides Prediction Flips under Task-Irrelevant Context](#link21)
**Authors:** Yanzhe Zhang, Sanmi Koyejo, Diyi Yang

22. [The Ebb and Flow of Multimodal Focus: Scheduling Visual Relay Windows for Grounded VLM Reasoning](#link22)
**Authors:** Wencheng Ye, Yi Bin, Yujuan Ding, Hongye Fang, Zheng Wang, Xing Xu, Jingkuan Song, Yun Zhang, Sirui Da, Heng Tao Shen

23. [The Spectrum Is Not Enough: When Context Helps Time-Series Forecasting](#link23)
**Authors:** Mert Onur Cakiroglu, Mehmet Dalkilic, Hasan Kurban

24. [Track, Rank, Crack: Epistemic Working Memory Scales Multi-Hop Reasoning in Language Agents](#link24)
**Authors:** Ning Liu

25. [Saturation Makes Quantization Error Additive: A Coverage Model with a Certificate](#link25)
**Authors:** Joshua Hill

26. [The One-Word Census: Answer-Choice Conformity Across 44 Language Models](#link26)
**Authors:** Tapan Parikh

27. [When Are Sparse Feature Interventions Actually Localized? Matched Evaluation for SAE-Based Safety Control](#link27)
**Authors:** Daming Luo

28. [EvoCUA-1.5: Online Reinforcement Learning for Multi-turn Computer-Use Agents](#link28)
...
29. [Agentic Context Learning with Self-Discovered Specification](#link29)
...
30. [Evaluating Large Language Models on Misconceptions in Multi-Turn Medical Conversations](#link30)
**Authors:** Monica Munnangi, Saiph Savage

31. [ReDiTT: Retrieval Augmented Conditional Diffusion Transformers for Asynchronous Time Series](#link31)
**Authors:** Saiyue Lyu, Zhitian Zhang, Ruizhi Deng, Thibaut Durand

32. [Coresets Before Score Sets: Evaluation-Unsupervised Prompt Subset Selection for LLM Benchmarks](#link32)
...
33. [TAKE: Trajectory-Aware Knowledge Estimation for Text Dataset Distillation](#link33)
**Authors:** Tri-Nhan Vo, Dang Nguyen, Sunil Gupta

34. [Sparse Inter-Layer Dependencies of Transformer FFN Neurons](#link34)
**Authors:** Johannes Knittel, Hanspeter Pfister

35. [SETA: Scaling Environments for Terminal Agents](#link35)
...
36. [Norm Enforcement for AI Agents: Robustly Shaping Behavior in Multi-Agent Systems](#link36)
**Authors:** Yaowen Ye, Jacob Steinhardt

37. [Transforming LLMs into Efficient Cross-Encoders via Knowledge Distillation for RAG Reranking](#link37)
**Authors:** Shreeya Dasa Lakshminath, Shubhan S

38. [Are LLMs Ready for Scientific Discovery? A Capability-Oriented Benchmark for AI Scientists](#link38)
**Authors:** Chuhan Shi, Xiaoquan Ren, Sicheng Song, Haobo Li, Rui Sheng, Yushi Sun

39. [AgentAbstain: Do LLM Agents Know When Not to Act?](#link39)
...
40. [Less Experts, Faster Decoding: Cost-Aware Speculative Decoding for Mixture-of-Experts](#link40)
**Authors:** Jincheng Xie, Runheng Liu, Heyan Huang, Yawen Ling, Hanbin Dai, Yu Zheng, Wen Hu

41. [GRASP: GRanularity-Aware Search Policy for Agentic RAG](#link41)
**Authors:** Varun Gandhi, Jaewook Lee, Shantanu Todmal, Franck Dernoncourt, Ryan Rossi, Zichao Wang, Andrew Lan

42. [Continual Learning with Elastic Regularization and Synthetic Replay for Federated MLLM Fine-Tuning](#link42)
**Authors:** Jing Liu, Chenxuanyin Zou, Jiayang Ren, Gaoyun Fang, Chengfang Li, Yan Wang, Zhenchao Ma, Bo Hu

43. [A JoLT for the KV Cache: Near-Lossless KV Cache Compression via Joint Tucker and JL-Residual Allocation for LLMs](#link43)
**Authors:** Rahul Krishnan, Volker Schulz

44. [Route, Communicate, and Reason: Gated Routing and Adaptive Depth for Efficient Multi-Agent Reasoning](#link44)
**Authors:** Sudipto Ghosh, Tanmoy Chakraborty

45. [Generalized Distribution-Free Semi-Supervised Learning with Risk Rewrite](#link45)
**Authors:** Yushi Hirose, Hiroo Irobe, Takafumi Kanamori

46. [Same Loss, Same Noise, Opposite Schedules: Noise Structure and Optimizer Normalization Jointly Determine Whether Learning-Rate Cooldown Helps](#link46)
**Authors:** Subham Singh, Ashutosh Mishra, Subha Raut

47. [AVQ-Attention: Adaptive Vector-Quantized Attention](#link47)
**Authors:** Winfried van den dool, Patrick Forr\'e, Amir Habibian, Yuki M. Asano, Max Welling

48. [Replicating Belief, Not Bits: Epistemic State Replication for Agentic Systems](#link48)
**Authors:** Jun He, Deying Yu

49. [Toward Contemplative LLM: A Modular Framework for Evaluating and Enhancing LLM Alignment in Mental Health](#link49)
**Authors:** Asher Sprigler, Yang-Yang Feng, Iftach Amir, Jonathan E. Bogard, Todd S Braver, Yi Ding, David Kinney, Yixue Zhao

50. [Are we Merging the Right Models? Impact of Expert Training Duration on Model Merging for LLMs](#link50)
**Authors:** Nikita Kozodoi, Zainab Afolabi, Jack Butler

51. [Belief-reality separation lives in routing over a shared value slot in language models](#link51)
**Authors:** Oliver Steele, Jiangtao Wen, Yuxing Han

52. [OOD-RL-Bench: A Benchmark Framework for Out-of-Distribution Detection in Reinforcement Learning](#link52)
**Authors:** Emil Mittag, Richard Dazeley, Peter Vamplew

53. [Verifier-Based Reinforcement Fine-Tuning of Reasoning Models for Thermal Energy Storage Control](#link53)
**Authors:** Takumi Shioda, Kohei Terashima, Tatsuo Nagai

54. [LOGOS: A Living Logic for AI Agent Teams That Evolve With Humans](#link54)
**Authors:** Yuma Ichikawa, Yamato Arai, Kosaku Kimura, Akira Sakai, Hiromichi Kobashi

55. [Speculate with Memory: Lossless Acceleration for LLM Agents](#link55)
**Authors:** Yu Li, Qinyuan Ye, Prafulla Kumar Choubey, Jiaxin Zhang, Chien-Sheng Wu

56. [Learning Mechanistic Reasoning for Chemical Reactions with Large Language Models](#link56)
**Authors:** Xingyu Dang, Haocheng Tang, Junmei Wang, Yanjun Li

57. [Looped State-Space Language Models with Adaptive Exit-State Selection](#link57)
**Authors:** Zhenxuan Yu, Takeshi Kojima, Yutaka Matsuo, Yusuke Iwasawa

58. [Compile, Then Page: Executable SOP Programs and a Capability-Gated Runtime for Procedural LLM Agents](#link58)
**Authors:** Chenglin Yu, Li Yin, Ying Yu, Hongxia Yang, Ming Li

59. [StructAgent: Harness Long-horizon Digital Agents with Unified Causal Structure](#link59)
**Authors:** Wenyi Wu, Sibo Zhu, Kun Zhou, Aayush Salvi, Zixuan Song, Biwei Huang

60. [Gradient Flow Dynamics and Implicit Bias of Diagonal Linear Networks under Infinitesimal Initialization](#link60)
**Authors:** Jiajie Zhao, Jianxing Wang, Junjie Yang, Zhiwei Bai, Yaoyu Zhang

61. [Behavioural Signatures of Risk-Sensitive Decision-Making in Large Language Models](#link61)
**Authors:** Xuankun Rong, Wenke Huang, Bo Du, Dacheng Tao, Mang Ye

62. [Epistemic Stance Flexibility Probing: Measuring Prompt-Conditioned Register Shift in Large Language Models](#link62)
**Authors:** Binwen Liu, Yilin Ren

63. [NextFund: A Unified Performance Tracking Platform for Agentic Portfolio Management](#link63)
**Authors:** Changlun Li, Peixian Ma, Qiqi Duan, Zhenyu Lin, Peineng Wu

64. [Information-seeking failures of large language models in agentic clinical reasoning](#link64)
...
65. [How Query Visibility Changes KV-Cache Compression Rankings: A Matched-Budget Audit](#link65)
**Authors:** Daming Luo, Christy Liang, Junyu Xuan

66. [Closed-Loop Control with Rule-Aligned Small Language Models and Multi-Agent Self-Correction](#link66)
**Authors:** Yuchen Wang, Javal Vyas, Tong Liu, Mehmet Mercangoz

67. [The Compliance Trap: Diagnosing How AI Agents Consume Conflicting Memory](#link67)
**Authors:** Yixiong Chen, Xinyi Bai, Alan Yuille

68. [RCWT: Measuring Task-Budget Displacement from Coordination Content in LLM Calls](#link68)
**Authors:** Brenda Lelis, Rodrigo Cabral-Carvalho

69. [Efficient Test-Time Optimization for Multi-Agent Proof Autoformalization](#link69)
**Authors:** Tian-Shuo Liu, Shiyuan Zhang, Zijie Geng, Haoyu Liu, Runjie Xu, Pengyuan Wang, Lei Yuan, Yang Yu

70. [AdaPCLA: Adaptive Prior-Calibrated Logit Adjustment for Long-Tailed Longitudinal EHR Generation](#link70)
**Authors:** Shuai Cui, Chen Wenxuan, Wenjie Du, Jian Lou, Dan Li, Wenjie Feng

71. [Imaging-101: Benchmarking LLM Coding Agents on Scientific Computational Imaging](#link71)
