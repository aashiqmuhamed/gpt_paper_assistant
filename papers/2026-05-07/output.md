# Personalized Daily Arxiv Papers 05/07/2026
...
0. [Explaining and Preventing Alignment Collapse in Iterative RLHF](#link0)
**Authors:** Etienne Gauthier, Francis Bach, Michael I. Jordan

1. [Single-Position Intervention Fails: Distributed Output Templates Drive In-Context Learning](#link1)
**Authors:** Bryan Cheng, Jasper Zhang

2. [Data-dependent Exploration for Online Reinforcement Learning from Human Feedback](#link2)
**Authors:** Zhen-Yu Zhang, Yuting Tang, Jiandong Zhang, Lanjihong Ma, Masashi Sugiyama

3. [Balanced Aggregation: Understanding and Fixing Aggregation Bias in GRPO](#link3)
...
4. [What Happens Inside Agent Memory? Circuit Analysis from Emergence to Diagnosis](#link4)
**Authors:** Xutao Mao, Jinman Zhao, Gerald Penn, Cong Wang

5. [EvoLM: Self-Evolving Language Models through Co-Evolved Discriminative Rubrics](#link5)
...
6. [Leveraging Pretrained Language Models as Energy Functions for Glauber Dynamics Text Diffusion](#link6)
**Authors:** Tarun Kathuria, Sachin Kumar

7. [Correct Is Not Enough: Training Reasoning Planners with Executor-Grounded Rewards](#link7)
**Authors:** Tianyang Han, Hengyu Shi, Junjie Hu, Xu Yang, Zhiling Wang, Junhao Su

8. [Manifold Steering Reveals the Shared Geometry of Neural Network Representation and Behavior](#link8)
...
9. [RLearner-LLM: Balancing Logical Grounding and Fluency in Large Language Models via Hybrid Direct Preference Optimization](#link9)
**Authors:** Qiming Bao, Juho Leinonen, Paul Denny, Michael J. Witbrock

10. [Implicit Representations of Grammaticality in Language Models](#link10)
**Authors:** Yingshan Susan Wang, Linlu Qiu, Zhaofeng Wu, Roger P. Levy, Yoon Kim

11. [Self-Induced Outcome Potential: Turn-Level Credit Assignment for Agents without Verifiers](#link11)
**Authors:** Senkang Hu, Yong Dai, Xudong Han, Zhengru Fang, Yuzhi Zhao, Sam Tak Wu Kwong, Yuguang Fang

12. [Sparse Autoencoder Decomposition of Clinical Sequence Model Representations: Feature Complexity, Task Specialisation, and Mortality Prediction](#link12)
**Authors:** Chris Sainsbury, Feng Dong, Andreas Karwath

13. [Where Paths Split: Localized, Calibrated Control of Moral Reasoning in Large Language Models](#link13)
**Authors:** Chenchen Yuan, Zheyu Zhang, Gjergji Kasneci

14. [Power Distribution Bridges Sampling, Self-Reward RL, and Self-Distillation](#link14)
**Authors:** Akiyoshi Tomihari, Issei Sato

15. [Efficiently Aligning Language Models with Online Natural Language Feedback](#link15)
**Authors:** Christine Ye, Joe Benton

16. [Critical Windows of Complexity Control: When Transformers Decide to Reason or Memorize](#link16)
**Authors:** Sarwan Ali

17. [Conceptors for Semantic Steering](#link17)
...
18. [Estimating the expected output of wide random MLPs more efficiently than sampling](#link18)
**Authors:** Wilson Wu, Victor Lecomte, Michael Winer, George Robinson, Jacob Hilton, Paul Christiano

19. [Preference-Based Self-Distillation: Beyond KL Matching via Reward Regularization](#link19)
**Authors:** Xin Yu, Liuchen Liao, Yiwen Zhang, Yingchen Yu, Lingzhou Xue, Qinzhen Guo

20. [Enhancing Agent Safety Judgment: Controlled Benchmark Rewriting and Analogical Reasoning for Deceptive Out-of-Distribution Scenarios](#link20)
**Authors:** Zuoyu Zhang, Yancheng Zhu

21. [Automatically Finding and Validating Unexpected Side-Effects of Interventions on Language Models](#link21)
**Authors:** Quintin Pope, Ajay Hayagreeve Balaji, Jacques Thibodeau, Xiaoli Fern

22. [Stop Automating Peer Review Without Rigorous Evaluation](#link22)
**Authors:** Joachim Baumann, Jiaxin Pei, Sanmi Koyejo, Dirk Hovy

23. [Stabilizing LLM Supervised Fine-Tuning via Explicit Distributional Control](#link23)
**Authors:** Xinyu Wang, Changzhi Sun, Yuanbin Wu, Xiaoling Wang

24. [Agentic-imodels: Evolving agentic interpretability tools via autoresearch](#link24)
**Authors:** Chandan Singh, Yan Shuo Tan, Weijia Xu, Zelalem Gero, Weiwei Yang, Michel Galley, Jianfeng Gao

25. [Why Expert Alignment Is Hard: Evidence from Subjective Evaluation](#link25)
**Authors:** Tzu-Mi Lin, Wataru Hirota, Tatsuya Ishigaki, Lung-Hao Lee, Chung-Chi Chen

26. [EP-GRPO: Entropy-Progress Aligned Group Relative Policy Optimization with Implicit Process Guidance](#link26)
**Authors:** Song Yu, Li Li, Wenwen Zhao, Zhisheng Yang

27. [Validity-Calibrated Reasoning Distillation](#link27)
**Authors:** Khouloud Saadi, Di Wang

28. [OracleProto: A Reproducible Framework for Benchmarking LLM Native Forecasting via Knowledge Cutoff and Temporal Masking](#link28)
**Authors:** Yiding Ma, Chengyun Ruan, Kaibo Huang, Zhongliang Yang, Linna Zhou

29. [StoryAlign: Evaluating and Training Reward Models for Story Generation](#link29)
**Authors:** Haotian Xia, Hao Peng, Yunjia Qi, Xiaozhi Wang, Bin Xu, Lei Hou, Juanzi Li

30. [On the Hardness of Junking LLMs](#link30)
**Authors:** Marco Rando, Samuel Vaiter

31. [Uncertainty-Aware Exploratory Direct Preference Optimization for Multimodal Large Language Models](#link31)
**Authors:** Huatian Zhang, Zhendong Mao, Lei Zhang, Yongdong Zhang

32. [Distilling Bayesian Belief States into Language Models for Auditable Negotiation](#link32)
**Authors:** Zongqi Cui, Baihan Lin

33. [Gradients with Respect to Semantics Preserving Embeddings Tell the Uncertainty of Large Language Models](#link33)
**Authors:** Mingda Li, Rundong Lv, Xinyu Li, Weinan Zhang, Ting Liu

34. [Text Corpora as Concept Fields: Black-Box Hallucination and Novelty Measurement](#link34)
**Authors:** Nicholas S. Kersting, Vittorio Castelli, Chieh Ting Yeh, Xinzhu Wang, Saad Taame

35. [Learning Correct Behavior from Examples: Validating Sequential Execution in Autonomous Agents](#link35)
**Authors:** Reshabh K Sharma, Gaurav Mittal, Yu Hu

36. [Reinforcement Learning for Compositional Generalization with Outcome-Level Optimization](#link36)
**Authors:** Xiyan Fu, Wei Liu

37. [Contextual Multi-Objective Optimization: Rethinking Objectives in Frontier AI Systems](#link37)
**Authors:** Jie Zhou, Qin Chen, Liang He

38. [The Impossibility Triangle of Long-Context Modeling](#link38)
**Authors:** Yan Zhou

39. [Low-Cost Black-Box Detection of LLM Hallucinations via Dynamical System Prediction](#link39)
**Authors:** Dan Wilson, Mohamed Akrout

40. [Predict-then-Diffuse: Adaptive Response Length for Compute-Budgeted Inference in Diffusion LLMs](#link40)
**Authors:** Michael Rottoli, Subhankar Roy, Stefano Paraboschi

41. [Memory as a Markov Matrix: Sample Efficient Knowledge Expansion via Token-to-Dictionary Mapping](#link41)
**Authors:** Kaustubh Pethkar, Ziyang Xiong, Zuofeng Shang, Yingcong Li

42. [Replacing Parameters with Preferences: Federated Alignment of Heterogeneous Vision-Language Models](#link42)
**Authors:** Shule Lu, Yujing Wang, Hainan Zhang, Xiaoshan Yang, Hongwei Zheng, Yongxin Tong, Changsheng Xu, Zhiming Zheng

43. [FLUID: Continuous-Time Hyperconnected Sparse Transformer for Sink-Free Learning](#link43)
**Authors:** Waleed Razzaq, Yun-Bo Zhao

44. [Rethinking Local Learning: A Cheaper and Faster Recipe for LLM Post-Training](#link44)
**Authors:** Hengyu Shi, Tianyang Han, Peizhe Wang, Zhiling Wang, Xu Yang, Junhao Su

45. [Probing Structural Mathematical Reasoning in Language Models with Algebraic Trapdoors](#link45)
**Authors:** Igor Rivin

46. [SWAN: Semantic Watermarking with Abstract Meaning Representation](#link46)
...
47. [LLMs Uncertainty Quantification via Adaptive Conformal Semantic Entropy](#link47)
**Authors:** Hamed Karimi, Vaishali Meyappan, Reza Samavi

48. [Towards General Preference Alignment: Diffusion Models at Nash Equilibrium](#link48)
**Authors:** Jiaming Hu, Jiamu Bai, Haoyu Wang, Debarghya Mukherjee, Ioannis Ch. Paschalidis

49. [Elicitation Matters: How Prompts and Query Protocols Shape LLM Surrogates under Sparse Observations](#link49)
**Authors:** Ge Lei, Samuel J. Cooper

50. [Rollout Pass-Rate Control: Steering Binary-Reward RL Toward Its Most Informative Regime](#link50)
...
51. [Revisiting the Travel Planning Capabilities of Large Language Models](#link51)
**Authors:** Bo-Wen Zhang, Jin Ye, Peng-Yu Hua, Jia-Wei Cao, Jie-Jing Shao, Yu-Feng Li, Lan-Zhe Guo

52. [The Pinocchio Dimension: Phenomenality of Experience as the Primary Axis of LLM Psychometric Differences](#link52)
**Authors:** Hubert Plisiecki, Sabina Siudaj, Kacper Dudzic, Anna Sterna, Maciej Gorski, Karolina Drozdz, Marcin Moskalewicz

53. [Demystifying Manifold Constraints in LLM Pre-training](#link53)
**Authors:** Kang An, Jiaxiang Li, Donald Goldfarb, Shiqian Ma

54. [On the Wasserstein Gradient Flow Interpretation of Drifting Models](#link54)
**Authors:** Arthur Gretton, Li Kevin Wenliang, Alexandre Galashov, James Thornton, Valentin De Bortoli, Arnaud Doucet

55. [Concurrence of Symmetry Breaking and Nonlocality Phase Transitions in Diffusion Models](#link55)
**Authors:** Yifan F. Zhang, Fangjun Hu, Guangkuo Liu, Mert Okyay, Xun Gao

56. [UniVer: A Unified Perspective for Multi-step and Multi-draft Speculative Decoding](#link56)
**Authors:** Yepeng Weng, Qiao Hu, Takehisa Yairi

57. [OSAQ: Outlier Self-Absorption for Accurate Low-bit LLM Quantization](#link57)
**Authors:** Zhikai Li, Zhen Dong, Xuewen Liu, Jing Zhang, Qingyi Gu

58. [MedFabric and EtHER: A Data-Centric Framework for Word-Level Fabrication Generation and Detection in Medical LLMs](#link58)
...
59. [Adaptive Inverted-Index Routing for Granular Mixtures-of-Experts](#link59)
**Authors:** Klaus-Rudolf Kladny, Maximilian Mordig, Bernhard Sch\"olkopf, Michael Muehlebach

60. [Anticipating Innovation Using Large Language Models](#link60)
**Authors:** Enrico Maria Fenoaltea, Filippo Santoro, Giordano De Marzo, Segun Taofeek Aroyehun, Andrea Tacchella

61. [EdgeRazor: A Lightweight Framework for Large Language Models via Mixed-Precision Quantization-Aware Distillation](#link61)
**Authors:** Shu-Hao Zhang, Le-Tong Huang, Xiang-Sheng Deng, Xin-Yi Zou, Chen Wu, Nan Li, Shao-Qun Zhang

62. [Layerwise LQR for Geometry-Aware Optimization of Deep Networks](#link62)
**Authors:** Simon Dufort-Labb\'e, Pierre-Luc Bacon, Razvan Pascanu, Simon Lacoste-Julien, Aristide Baratin

63. [Programmatic Context Augmentation for LLM-based Symbolic Regression](#link63)
**Authors:** Hao Liu, Xiao-Wen Yang, Atharva Sehgal, Yixin Wang, Lan-Zhe Guo, Yu-Feng Li, Yisong Yue

64. [AdapShot: Adaptive Many-Shot In-Context Learning with Semantic-Aware KV Cache Reuse](#link64)
**Authors:** Jie Ou, Jinyu Guo, Shiyao Guo, Yuang Li, Ruiqi Wu, Zhaokun Wang, Wenyi Li, Wenhong Tian

65. [SCOUT: Active Information Foraging for Long-Text Understanding with Decoupled Epistemic States](#link65)
**Authors:** Zhenliang Zhang, Wenqing Wang, Yong Hu, Yaming Yang, Jiaheng Gao, Chen Shen, Xiaojun Wan

66. [Self-Improvement for Fast, High-Quality Plan Generation](#link66)
...
67. [On the Architectural Complexity of Neural Networks](#link67)
**Authors:** Nicholas J. Cooper, Fran\c{c}ois G. Meyer, Michael L. Roberts, Carlos Zapata-Carratal\'a, Lijun Chen, Danna Gurari

68. [Understanding In-Context Learning for Nonlinear Regression with Transformers: Attention as Featurizer](#link68)
**Authors:** Alexander Hsu, Zhaiming Shen, Wenjing Liao, Rongjie Lai

69. [CAR: Query-Guided Confidence-Aware Reranking for Retrieval-Augmented Generation](#link69)
**Authors:** Zhipeng Song, Yizhi Zhou, Xiangyu Kong, Jiulong Jiao, Xuezhou Ye, Chunqi Gao, Xueqing Shi, Yuhang Zhou, Heng Qi

70. [FASQ: Flexible Accelerated Subspace Quantization for Calibration-Free LLM Compression](#link70)
**Authors:** Ye Qiao, Yian Wang, Zhiheng Chen, Hyoukjun Kwon, Sitao Huang

71. [OpenSeeker-v2: Pushing the Limits of Search Agents with Informative and High-Difficulty Trajectories](#link71)
**Authors:** Yuwen Du, Rui Ye, Shuo Tang, Keduan Huang, Xinyu Zhu, Yuzhu Cai, Siheng Chen

72. [Not All That Is Fluent Is Factual: Investigating Hallucinations of Large Language Models in Academic Writing](#link72)
**Authors:** Humam Khan, Md Tabrez Nafis, Shahab Saquib Sohail, Aqeel Khalique, Rehan Hasan Khan

73. [Nsanku: Evaluating Zero-Shot Translation Performance of LLMs for Ghanaian Languages](#link73)
...
74. [Reliable Modeling of Distribution Shifts via Displacement-Reshaped Optimal Transport](#link74)
**Authors:** Philip Naumann, Jacob Kauffmann, Klaus-Robert M\"uller, Gr\'egoire Montavon

75. [Position: the Stochastic Parrot in the Coal Mine. Model Collapse is a Threat to Low-Resource Communities](#link75)
**Authors:** Devon Jarvis, Richard Klein, Benjamin Rosman, Steven James, Stefano Sarao Mannelli

76. [A Self-Attentive Meta-Optimizer with Group-Adaptive Learning Rates and Weight Decay](#link76)
**Authors:** JiangBo Zhao, ZhaoXin Liu

77. [KernelBench-X: A Comprehensive Benchmark for Evaluating LLM-Generated GPU Kernels](#link77)
**Authors:** Han Wang, Jintao Zhang, Kai Jiang, Haoxu Wang, Jianfei Chen, Jun Zhu

78. [Budgeted LoRA: Distillation as Structured Compute Allocation for Efficient Inference](#link78)
**Authors:** Mohammed Sabry, Anya Belz

79. [Mitigating Label Shift in Tabular In-Context Learning via Test-Time Posterior Adjustment](#link79)
