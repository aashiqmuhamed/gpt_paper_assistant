# Personalized Daily Arxiv Papers 07/09/2026
...
0. [Constrained Decoding for Diffusion Language Models via Efficient Inference over Finite Automata](#link0)
**Authors:** Meihua Dang, Stefano Ermon

1. [RL Post-Training Builds Compositional Reasoning Strategies](#link1)
**Authors:** Azwar Abdulsalam, Nishil Patel, Andrew Saxe

2. [Behavior Leverage Imbalance in Multi-Teacher On-Policy Distillation](#link2)
**Authors:** Jiabin Shen, Guang Chen, Chengjun Mao

3. [D2PO: Optimizing Diffusion Samplers via Dynamic Preference](#link3)
**Authors:** Jinkyu Kim, Jinyoung Choi, Bohyung Han

4. [Measuring Intelligence Beyond Human Scale](#link4)
**Authors:** Jerry Han, Rafael Moschopoulos, Ella Colby, Vishrut Goyal, Andrew Tu, Kia Ghods, Mark Braverman, Elad Hazan

5. [Selective Timestep Weighting and Advantage-Based Replay for Sample-Efficient Diffusion RLHF](#link5)
**Authors:** Eric Zhu, Abhinav Shrivastava, Soumik Mukhopadhyay

6. [Geometric Self-Distillation for Reasoning Generalization](#link6)
**Authors:** Josip Juki\'c, Ivan Titov

7. [Mechanistic Interpretability for Neural Networks: Circuits, Sparse Features and Symbolic Reasoning](#link7)
**Authors:** Pranav Sawant, Jakub Krej\v{c}\'i

8. [Multiplication Beyond Groups: Stratified Fourier Mechanisms in Transformer Circuits](#link8)
**Authors:** Zitong Andrew Chen, Junaid Hasan, Akhil Srinivasan, Hemkesh Bandi, Jarod Alper

9. [Single-Rollout Asynchronous Optimization for Agentic Reinforcement Learning](#link9)
**Authors:** Zhenyu Hou, Yujiang Li, Jie Tang, Yuxiao Dong

10. [Final Checkpoints Are Not Enough: Analyzing Latent Reasoning Faithfulness Along Training Trajectories](#link10)
**Authors:** Hengyu Jin, Shu Yang, Di Wang

11. [Reason Less, Verify More: Deterministic Gates Recover a Silent Policy-Violation Failure Mode in Tool-Using LLM Agents](#link11)
**Authors:** Vikas Reddy, Sumanth Reddy Challaram, Abhishek Basu

12. [Comprehensive Evaluation of Large Language Model Responses: A Multi-Factor Scoring System](#link12)
**Authors:** Yiming Gai, Junde Lu, Xuefei Huang

13. [When Does In-Context Search Help? A Sampling-Complexity Theory of Reflection-Driven Reasoning](#link13)
**Authors:** Yotam Wolf, Noam Wies, Amnon Shashua

14. [Fingerprint, Not Blueprint: How Positional Schemes Set the Default Spectral Algebra of Attention](#link14)
**Authors:** Li Hengyu (Institute for Solid State Physics, The University of Tokyo)

15. [Predicting LLM Safety Before Release by Simulating Deployment](#link15)
...
16. [Guidance Breaks the Fitted Operator: A Terminal-Fitted Repair for Classifier-Free Guidance](#link16)
**Authors:** Shiheng Zhang

17. [Operational Reframing and Approval-Framed Delegation in Multi-Agent LLM Safety](#link17)
**Authors:** Lifei Liu, Haoran Yu, Xiaochong Jiang, Su Wang, Pin Qian, Yihang Chen

18. [LLMs Silently Correct African American English: Auditing and Mitigating Dialect Bias via Activation Steering](#link18)
