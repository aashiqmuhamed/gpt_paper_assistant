# Personalized Daily Arxiv Papers 09/10/2026
...
0. [Which Tokens Should SFT Actually Learn? A Token-Trimming Perspective on Mathematical Reasoning](#link0)
**Authors:** Yaning Jia, Chunhui Zhang, Wenxuan Xu, Xingjian Diao, Xiaoyuan Wang, Soroush Vosoughi

1. [Forgetting Only What Matters: Layer-Selective Unlearning toward Robust LLMs](#link1)
**Authors:** Ravi Ranjan, Olivera Kotevska, Agoritsa Polyzou

2. [Structural Process Supervision for Latent Chain-of-Thought Reasoning](#link2)
**Authors:** Yiqi Li, Xu Chen, Chen Ju, Jiangchao Yao, Zhaoyang Li, Jinsong Lan, Xiaoyong Zhu, Bo Zheng, Yu Wang

3. [Why Sample What You Can Enumerate? Exact Policy Optimization for Genomic Tool Selection](#link3)
**Authors:** Haoyue Liu, Xiaoyu Ma, Ye Chen, Zhichao Wang, Xiaoying Tang

4. [Through the Looking Glass: Directly Reading and Writing Transformers](#link4)
**Authors:** Mark Oskin

5. [Cascading Gradient Inversion via LT-Code Inspired Peeling in Federated Learning](#link5)
**Authors:** Saeed Shariati, Mohsen Alambardar Meybodi

6. [World-Time Compute with Verified Code World Models](#link6)
...
7. [CompassOPD: Cross-Family On-Policy Distillation via Within-Family Likelihood Shifts](#link7)
**Authors:** Naibin Gu, Qingyi Si, Chenxu Yang, Chuanyu Qin, Junhao Zhou, Peng Fu, Zheng Lin, Weiping Wang

8. [Exact-Form Regret for Gradient Descent, Mirror Descent and Follow-the-Regularized-Leader](#link8)
**Authors:** Ashkan Soleymani, Gabriele Farina, Patrick Jaillet

9. [SocialRL: Refining LLMs' Social Intelligence through Multi-turn Reinforcement Learning and Reward Design](#link9)
...
10. [Edu-QuRating: Multi-Dimensional Educational Data Curation with Distilled Pairwise Judgements](#link10)
**Authors:** Oliver G. B. Garrod, Robin A. A. Ince, Meng Liu, Mohamed Huti, Moritz Boos, Amy Waldock, Dominic Andrews, Paul Atherton

11. [XAI-Arena: Can LLMs Assess the Quality of XAI Explanations?](#link11)
**Authors:** Yanfei Hu Fleischhauer, Alona Zharova, Nadja Klein, Stefan Feuerriegel

12. [RiLM: Parameter-Efficient Language Modeling via Geodesic Decoding](#link12)
**Authors:** Fang Li

13. [BRACE: Anchored Bellman-Residual Correction for Stale Critics in Asynchronous RL](#link13)
**Authors:** Guanqun Zhao, Zijun Xie, Binbin Zheng, Jiafeng Lu, Enlei Gong, Zeyu Chen

14. [AgentAudit: An Open, Extensible Framework for Full-Lifecycle Trust Evaluation of AI Agents](#link14)
**Authors:** Shrey Nag, Sachita, Abhishek Kumar Singh, Lipi Goel, Rajeshwar Singh Janwar

15. [A Function-Space Approach to the Statistical Mechanics of Learning Dynamics](#link15)
**Authors:** Yizhou Zhang, Weichen Wu, Lun Du, Zhengjie Miao

16. [Active Adaptation, Not Static Defense: Temporal Dynamics of Preventative Steering in Adversarial Fine-Tuning](#link16)
**Authors:** Jing Guan, Yachao Yang, Zhaoliang Liu, Yuyao Zhang, Fanyu Meng, Junlan Feng

17. [Direct Diversity Optimization for Diverse Successful Trajectories in Preference Post-Training](#link17)
**Authors:** Junwon Ko, Dong-Jae Lee, Minchan Kwon, Sunghyun Baek, Junmo Kim

18. [ConvMem: Convolutional Memory for Long-Context Reasoning](#link18)
**Authors:** Hongming Zhang, Zhaozhen Gu, Fengshuo Bai, Ming Hao, Qingyang Zhang, Yuanyuan Wang, Shiyang Tang, Yanna Wang, Bo Xu

19. [HyperTrace: Hypothesis-Based Preference Tracing for Online LLM Personalization](#link19)
...
20. [Osprey: Target-agnostic Pre-training Makes Stronger Drafters in Speculative Decoding](#link20)
...
21. [RAP: Research Attention Prediction Reveals Target-Conditioned Evidence Acquisition Biases](#link21)
**Authors:** Yingqian Wu, Jingcong Liang, Siyuan Wang, Zhenfei Yin, Philip Torr, Junchi Yu, Zhongyu Wei

22. [Distribution-Consistent Inference for Dynamic Sparse Mixture-of-Experts](#link22)
**Authors:** Dohyeon Kim, Bedionita Soro, Sung Ju Hwang

23. [Explaining f-Divergence-Based Regularization via Local Curvature and Sharpness-Aware Minimization](#link23)
**Authors:** Nour Jamoussi, Marios Kountouris

24. [Beyond Surface Imitation: Contrastive Modeling for Reasoning Path Alignment in Multimodal In-Context Learning](#link24)
**Authors:** Mingbo Yang, Wenqiang Wang, Zhaolu Kang, Peng Chen, Yannan Chen, Sunshang Wang, Yan Xiao

25. [ProbPlug: A Plugin Uncertainty Network for Reliable Confidence in LLM Binary Classification](#link25)
**Authors:** Jianzong Wang, Chuhang Liu, Botao Zhao, Zuheng Kang, Xulong Zhang, Xiaoyang Qu, Junqing Peng, Zhiewei Ye, Yayun He

26. [Building Multilingual Bridges: Data Mixing as the Pillar of Generalization for In-Language Reasoning](#link26)
...
27. [MedDeID enables locally governed clinical-text de-identification from real or synthetic training data](#link27)
**Authors:** Stig Hellemans, Tom Stroobants, Elyne Scheurwegs, Pieter Meysman, Philippe G. Jorens, Kris Laukens

28. [The Answer Path and the Grounding Instruction in LLM Question Answering over Knowledge Graphs](#link28)
**Authors:** Arquimedes Canedo

29. [From Fixed Keys to Readable Schemas: Small Language Models for Vehicle Agent Function Calls](#link29)
**Authors:** Hamed Jafarzadeh Asl, Yuanhao Yu, Vahid Partovi Nia

30. [TEFM: Token-Efficient Faithful Modeling for Structured Data](#link30)
**Authors:** Zhichao Hou, Lingdao Sha, Xueyu Mao, Yang Liu, Peijie Qiu, Rui Song

31. [Looped GPT-BERT: Trading Parameters for Computation in Small Language Modeling](#link31)
**Authors:** Tingshuo Fan, Hongtao Mu, Tianyu Zhou, Hansen Liu, Tao Ji

32. [Deep and shallow biases in language models](#link32)
**Authors:** An Vo, Vy Tuong Dang, Khai-Nguyen Nguyen, Emilio Villa-Cueva, Thamar Solorio, Anh Totti Nguyen, Daeyoung Kim

33. [Can Foundation Models Moderate Online Content? Evaluating Instruction- vs. Example-Driven Policy Operationalization](#link33)
