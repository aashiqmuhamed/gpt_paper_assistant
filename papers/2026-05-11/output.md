# Personalized Daily Arxiv Papers 05/11/2026
Total relevant papers: 169

Paper selection prompt and criteria at the bottom

Table of contents with paper titles:

0. [Towards Closing the Autoregressive Gap in Language Modeling via Entropy-Gated Continuous Bitstream Diffusion](#link0)
**Authors:** Georgios Batzolis, Mark Girolami, Luca Ambrogioni

1. [How to Train Your Latent Diffusion Language Model Jointly With the Latent Space](#link1)
...
2. [Dataset Watermarking for Closed LLMs with Provable Detection](#link2)
**Authors:** Pengrun Huang, Kamalika Chaudhuri, Yu-Xiang Wang

3. [$f$-Divergence Regularized RLHF: Two Tales of Sampling and Unified Analyses](#link3)
**Authors:** Di Wu, Chengshuai Shi, Jing Yang, Cong Shen

4. [TextLDM: Language Modeling with Continuous Latent Diffusion](#link4)
...
5. [Scaling Categorical Flow Maps](#link5)
**Authors:** Oscar Davis, Anastasiia Filippova, Pierre Ablin, Victor Turrisi, Amitis Shidani, Marco Cuturi, Louis B\'ethune

6. [SEIF: Self-Evolving Reinforcement Learning for Instruction Following](#link6)
**Authors:** Qingyu Ren, Qianyu He, Jiajie Zhu, Xingzhou Chen, Jingwen Chang, Zeye Sun, Han Xia, Fei Yu, Jiaqing Liang, Yanghua Xiao

7. [Fast Byte Latent Transformer](#link7)
...
8. [Rethinking Dense Sequential Chains: Reasoning Language Models Can Extract Answers from Sparse, Order-Shuffling Chain-of-Thoughts](#link8)
**Authors:** Yi-Chang Chen, Feng-Ting Liao, Da-shan Shiu, Hung-yi Lee

9. [Dr. Post-Training: A Data Regularization Perspective on LLM Post-Training](#link9)
**Authors:** Pingbang Hu, Xueshen Liu, Z. Morley Mao, Jiaqi W. Ma

10. [On the Invariance and Generality of Neural Scaling Laws](#link10)
**Authors:** Xing Han, Ziyin Liu, Suchi Saria, Paul Pu Liang

11. [Your Language Model is Its Own Critic: Reinforcement Learning with Value Estimation from Actor's Internal States](#link11)
**Authors:** Yunho Choi, Jongwon Lim, Woojin Ahn, Minjae Oh, Jeonghoon Shim, Yohan Jo

12. [Topology-Enhanced Alignment for Large Language Models: Trajectory Topology Loss and Topological Preference Optimization](#link12)
**Authors:** Yurui Pan, Ke Xu, Bo Peng

13. [How to Compress KV Cache in RL Post-Training? Shadow Mask Distillation for Memory-Efficient Alignment](#link13)
**Authors:** Rui Zhu, Weiheng Bai, Qiushi Wu, Yang Ren, Haixu Tang, Yuchu Liu

14. [Rethinking Importance Sampling in LLM Policy Optimization: A Cumulative Token Perspective](#link14)
**Authors:** Yuheng Zhang, Chenlu Ye, Shuowei Jin, Changlong Yu, Wei Xiong, Saurabh Sahu, Nan Jiang

15. [Gradient Starvation in Binary-Reward GRPO: Why Group-Mean Centering Fails and Why the Simplest Fix Works](#link15)
**Authors:** Wenhua Nie, Jianan Wu, Junlin Liu, Ziwei Li, Zheng Lin, Zhang Zijian, Yilong Fan, Haoran Zheng, Jyh-Shing Roger Jang

16. [Mitigating Cognitive Bias in RLHF by Altering Rationality](#link16)
**Authors:** Tiffany Horter, Andrew Markham, Niki Trigoni, Serena Booth

17. [Tree SAE: Learning Hierarchical Feature Structures in Sparse Autoencoders](#link17)
**Authors:** Tue M. Cao, Hoang X. Nhat, Raed Alharbi, My T. Thai

18. [Beyond Pairs: Your Language Model is Secretly Optimizing a Preference Graph](#link18)
**Authors:** Ning Liu, Chuanneng Sun, Kristina Klinkner, Shervin Malmasi

19. [Don't Retrain, Align: Adapting Autoregressive LMs to Diffusion LMs via Representation Alignment](#link19)
**Authors:** Fred Zhangzhi Peng, Alexis Fox, Anru R. Zhang, Alexander Tong

20. [SHRED: Retain-Set-Free Unlearning via Self-Distillation with Logit Demotion](#link20)
**Authors:** Zizhao Hu, Ameya Godbole, Johnny Tian-Zheng Wei, Mohammad Rostami, Jesse Thomason, Robin Jia

21. [Response Time Enhances Alignment with Heterogeneous Preferences](#link21)
**Authors:** Federico Echenique, Alireza Fallah, Baihe Huang, Michael I. Jordan

22. [A Theory of Online Learning with Autoregressive Chain-of-Thought Reasoning](#link22)
**Authors:** Ilan Doron-Arad, Idan Mehalel, Elchanan Mossel

23. [Theoretical Limits of Language Model Alignment](#link23)
**Authors:** Lucas Monteiro Paes, Natalie Mackraz, Barry-John Theobald, Federico Danieli

24. [Where's the Plan? Locating Latent Planning in Language Models with Lightweight Mechanistic Interventions](#link24)
**Authors:** Nicole Ma, Nick Rui

25. [Behavior Cue Reasoning: Monitorable Reasoning Improves Efficiency and Safety through Oversight](#link25)
**Authors:** Christopher Z. Cui, Taylor W. Killian, Prithviraj Ammanabrolu

26. [PLOT: Progressive Localization via Optimal Transport in Neural Causal Abstraction](#link26)
**Authors:** Jonathn Chang, Arya Datla, Ziv Goldfeld

27. [Distributional Process Reward Models: Calibrated Prediction of Future Rewards via Conditional Optimal Transport](#link27)
**Authors:** Rachel Ma, Dylan Hadfield-Menell, Kristjan Greenewald

28. [Tracing Uncertainty in Language Model "Reasoning"](#link28)
**Authors:** Nils Gr\"unefeld, Bertram H{\o}jer, Philipp Mondorf, Barbara Plank, Anna Rogers, Christian Hardmeier, Stefan Heinrich, Jes Frellsen

29. [Activation Differences Reveal Backdoors: A Comparison of SAE Architectures](#link29)
**Authors:** Sachin Kumar

30. [LaTER: Efficient Test-Time Reasoning via Latent Exploration and Explicit Verification](#link30)
**Authors:** Xuan Li, Yining Wang, Yuchen Liu, Guanjun Liu, Delai Qiu, Shengping Liu, Jiaen Liang, Wei Huang, Jun Yu, Junnan Zhu

31. [When Does a Language Model Commit? A Finite-Answer Theory of Pre-Verbalization Commitment](#link31)
**Authors:** Long Zhang, Wei-neng Chen, Feng-feng Wei, Zi-bo Qin

32. [Experience Sharing in Mutual Reinforcement Learning for Heterogeneous Language Models](#link32)
**Authors:** Xiaoze Liu, Dhananjay Ram, Yuting Zhang, Zhaoyang Zhang, Wei Xia, Stefano Soatto

33. [Confidence-Aware Alignment Makes Reasoning LLMs More Reliable](#link33)
**Authors:** Kejia Chen, Jiawen Zhang, Yihong Wu, Kewei Gao, Jian Lou, Zunlei Feng, Mingli Song, Ruoxi Jia

34. [The Coupling Tax: How Shared Token Budgets Undermine Visible Chain-of-Thought Under Fixed Output Limits](#link34)
**Authors:** Wenhua Nie, Junlin Liu, Jianan Wu, Zijie Meng, Yilong Fan, Zhang Zijian, Haoran Zheng, Jyh-Shing Roger Jang

35. [Guidance Is Not a Hyperparameter: Learning Dynamic Control in Diffusion Language Models](#link35)
**Authors:** Fan Zhou, Tim Van de Cruys

36. [Rubric-based On-policy Distillation](#link36)
...
45. [Rethinking State Tracking in Recurrent Models Through Error Control Dynamics](#link45)
**Authors:** Jiwan Chung, Heechan Choi, Seon Joo Kim

46. [When Are Experts Misrouted? Counterfactual Routing Analysis in Mixture-of-Experts Language Models](#link46)
**Authors:** Youngsik Yoon, Siwei Wang, Wei Chen, Jungseul Ok

47. [Curated Synthetic Data Doesn't Have to Collapse: A Theoretical Study of Generative Retraining with Pluralistic Preferences](#link47)
**Authors:** Ali Falahati, Mohammad Mohammadi Amiri, Kate Larson, Lukasz Golab

48. [Convergence and Emergence of In-Context Reinforcement Learning with Chain of Thought](#link48)
**Authors:** Zixuan Xie, Xinyu Liu, Rohan Chandra, Shangtong Zhang

49. [Adaptive Negative Reinforcement for LLM Reasoning:Dynamically Balancing Correction and Diversity in RLVR](#link49)
**Authors:** Yash Ingle, Jaival Chauhan, Ankit Yadav, Sudhakar Mishra

50. [Beyond Confidence: Rethinking Self-Assessments for Performance Prediction in LLMs](#link50)
**Authors:** Sree Bhattacharyya, Samarth Khanna, Leona Chen, Lucas Craig, Tharun Dilliraj, James Z. Wang

51. [Benchmarked Yet Not Measured -- Generative AI Should be Evaluated Against Real-World Utility](#link51)
**Authors:** Ishani Mondal, Shweta Bhardwaj

52. [The Memory Curse: How Expanded Recall Erodes Cooperative Intent in LLM Agents](#link52)
...
53. [Why Does Agentic Safety Fail to Generalize Across Tasks?](#link53)
**Authors:** Yonatan Slutzky, Yotam Alexander, Tomer Slor, Yoav Nagel, Nadav Cohen

54. [Understanding Performance Collapse in Layer-Pruned Large Language Models via Decision Representation Transitions](#link54)
**Authors:** Boyu Shi, Chang Liu, ChuanBao Gao, Xu Yang, Xin Geng

55. [Self-Programmed Execution for Language-Model Agents](#link55)
**Authors:** Luke J. O'Connor

56. [LLMs are not (consistently) Bayesian: Quantifying internal (in)consistencies of LLMs' probabilistic beliefs](#link56)
**Authors:** Chacha Chen, Matthew J\"orke, Adam Goli\'nski, Masha Fedzechkina, Guillermo Sapiro, Sinead Williamson, Nicholas Foti

57. [Where to Spend Rollouts: Hit-Utility Optimal Rollout Allocation for Group-Based RLVR](#link57)
**Authors:** Tao Wang, Shuo Li, Yan Sun, Dongsheng Ding, Edgar Dobriban

58. [Toward Privileged Foundation Models:LUPI for Accelerated and Improved Learning](#link58)
**Authors:** Xueying Ding, Leman Akoglu

59. [Susceptibilities and Patterning: A Primer on Linear Response in Bayesian Learning](#link59)
**Authors:** Chris Elliott, Daniel Murfet

60. [Teaching Language Models to Think in Code](#link60)
**Authors:** Hyeon Hwang, Jiwoo Lee, Jaewoo Kang

61. [The Moltbook Files: A Harmless Slopocalypse or Humanity's Last Experiment](#link61)
**Authors:** William Brach, Federico Torrielli, Stine Lyngs{\o} Beltoft, Annemette Brok Pirchert, Peter Schneider-Kamp, Lukas Galke Poech

62. [Inference Time Causal Probing in LLMs](#link62)
**Authors:** Sadegh Khorasani, Saber Salehkaleybar, Negar Kiyavash, Matthias Grossglauser

63. [ExpThink: Experience-Guided Reinforcement Learning for Adaptive Chain-of-Thought Compression](#link63)
**Authors:** Tingcheng Bian, Yuzhe Zhang, Jing Jin, Jinchang Luo, MingQuan Cheng, Haiwei Wang, Wenyuan Jiang, Miaohui Wang

64. [Rubric-Grounded RL: Structured Judge Rewards for Generalizable Reasoning](#link64)
**Authors:** Manish Bhattarai, Ismael Boureima, Nishath Rajiv Ranasinghe, Scott Pakin, Dan O'Malley

65. [Towards Security-Auditable LLM Agents: A Unified Graph Representation](#link65)
...
66. [Abductive Reasoning with Probabilistic Commonsense](#link66)
**Authors:** Joseph Cotnareanu, Chiara Roverato, Han Zhou, Didier Chetelat, Yingxue Zhang, Mark Coates

67. [Safe, or Simply Incapable? Rethinking Safety Evaluation for Phone-Use Agents](#link67)
...
68. [Signal Reshaping for GRPO in Weak-Feedback Agentic Code Repair](#link68)
**Authors:** Jia Li, Yuxin Su, Ting Peng, Hailiang Huang, Yuetang Deng, Michael R. Lyu

69. [Efficient Data Selection for Multimodal Models via Incremental Optimization Utility](#link69)
**Authors:** Jinhao Jing, Qiannian Zhao, Chao Huang, Zhan Su

70. [Tools as Continuous Flow for Evolving Agentic Reasoning](#link70)
**Authors:** Tairan Huang, Siyu Shang, Qiang Chen, Xiu Su, Yi Chen

71. [Self-Play Enhancement via Advantage-Weighted Refinement in Online Federated LLM Fine-Tuning with Real-Time Feedback](#link71)
**Authors:** Seohyun Lee, Wenzhi Fang, Dong-Jun Han, Seyyedali Hosseinalipour, Christopher G. Brinton

72. [KL for a KL: On-Policy Distillation with Control Variate Baseline](#link72)
**Authors:** Minjae Oh, Sangjun Song, Gyubin Choi, Yunho Choi, Yohan Jo

73. [Graph Representation Learning Augmented Model Manipulation on Federated Fine-Tuning of LLMs](#link73)
**Authors:** Hanlin Cai, Kai Li, Houtianfu Wang, Haofan Dong, Yichen Li, Falko Dressler, Ozgur B. Akan

74. [Interpreting Reinforcement Learning Agents with Susceptibilities](#link74)
**Authors:** Chris Elliott, Einar Urdshals, David Quarel, Daniel Murfet

75. [Measuring and Mitigating the Distributional Gap Between Real and Simulated User Behaviors](#link75)
**Authors:** Shuhaib Mehri, Philippe Laban, Sumuk Shashidhar, Marwa Abdulhai, Sergey Levine, Michel Galley, Dilek Hakkani-T\"ur

76. [Disagreement-Regularized Importance Sampling for Adversarial Label Corruption](#link76)
**Authors:** Csongor Horv\'ath, Ida-Maria Sintorn, Prashant Singh

77. [From 0-Order Selection to 2-Order Judgment: Combinatorial Hardening Exposes Compositional Failures in Frontier LLMs](#link77)
**Authors:** Hanmeng Liu, Shichao Weng, Xiulai Liu, Zhicai Zhang, Anli Yan, Xiaozhang Liu

78. [Beyond "I cannot fulfill this request": Alleviating Rigid Rejection in LLMs via Label Enhancement](#link78)
**Authors:** Ying Zhang, Congyu Qiao, Xin Geng, Ning Xu

79. [Prune-OPD: Efficient and Reliable On-Policy Distillation for Long-Horizon Reasoning](#link79)
**Authors:** Zhicheng Yang, Zhijiang Guo, Yifan Song, Minrui Xu, Yongxin Wang, Yiwei Wang, Xiaodan Liang, Jing Tang

80. [When Diffusion Model Can Ignore Dimension: An Entropy-Based Theory](#link80)
**Authors:** Ahmad Aghapour, Erhan Bayraktar

81. [Star Elastic: Many-in-One Reasoning LLMs with Efficient Budget Control](#link81)
...
82. [POETS: Uncertainty-Aware LLM Optimization via Compute-Efficient Policy Ensembles](#link82)
**Authors:** Nicolas Menet, Andreas Krause, Abbas Rahimi

83. [Securing Computer-Use Agents: A Unified Architecture-Lifecycle Framework for Deployment-Grounded Reliability](#link83)
**Authors:** Zejian Chen, Zhanyuan Liu, Chaozhuo Li, Mengxiang Han, Songyang Liu, Litian Zhang, Feng Gao, Yiming Hei, Xi Zhang

84. [Beyond Reasoning: Reinforcement Learning Unlocks Parametric Knowledge in LLMs](#link84)
**Authors:** Wanli Yang, Hongyu Zang, Junwei Zhang, Wenjie Shi, Du Su, Jingang Wang, Xueqi Cheng, Fei Sun

85. [Rethinking Experience Utilization in Self-Evolving Language Model Agents](#link85)
**Authors:** Weixiang Zhao, Yingshuo Wang, Yichen Zhang, Yanyan Zhao, Yu Zhang, Yang Wu, Dandan Tu, Bing Qin, Ting Liu

86. [The Text Uncanny Valley: Non-Monotonic Performance Degradation in LLM Information Retrieval](#link86)
**Authors:** Zekai Tong, Ruiyao Xu, Aryan Shrivastava, Chenhao Tan, Ari Holtzman

87. [GSM-SEM: Benchmark and Framework for Generating Semantically Variant Augmentations](#link87)
...
88. [Structural Rationale Distillation via Reasoning Space Compression](#link88)
**Authors:** Jialin Yang, Jiankun Wang, Jiajun Wu, Henry Leung, Jiayu Zhou, Steve Drew

89. [Uneven Evolution of Cognition Across Generations of Generative AI Models](#link89)
**Authors:** Isaac Galatzer-Levy, Daniel McDuff, Xin Liu, Jed McGiffin

90. [VecCISC: Improving Confidence-Informed Self-Consistency with Reasoning Trace Clustering and Candidate Answer Selection](#link90)
**Authors:** James Petullo, Sonny George, Dylan Cashman, Nianwen Xue

91. [MatryoshkaLoRA: Learning Accurate Hierarchical Low-Rank Representations for LLM Fine-Tuning](#link91)
**Authors:** Ionut-Vlad Modoranu, Mher Safaryan, Dan Alistarh

92. [Retrieve, Integrate, and Synthesize: Spatial-Semantic Grounded Latent Visual Reasoning](#link92)
**Authors:** Jin Cui, Xinyue Long, Xunyong Zhang, Yadong Zhang, Chuanchang Su, Jingye Gan, Boran Zhao, Pengju Ren

93. [Can LLMs Take Retrieved Information with a Grain of Salt?](#link93)
**Authors:** Behzad Shayegh, Mohamed Osama Ahmed, Fred Tung, Leo Feng

94. [Arrow: A Foundation Model for Causal Discovery](#link94)
**Authors:** Ryan Thompson, He Zhao, Daniel M. Steinberg, Edwin V. Bonilla

95. [Same Signal, Opposite Meaning: Direction-Informed Adaptive Learning for LLM Agents](#link95)
**Authors:** Ziming Li, Jiatan Huang, Xiaoguang Guo, Guilin Wang, Chuxu Zhang

96. [A Generalized Singular Value Theory for Neural Networks](#link96)
**Authors:** Brian Charles Brown, Robert Bridges, David Grimsman, Mauricio Munoz, Sean Warnick

97. [RuleSafe-VL: Evaluating Rule-Conditioned Decision Reasoning in Vision-Language Content Moderation](#link97)
**Authors:** Zhifeng Lu, Dianyuan Wang, Yuhu Shang, Zhenbo Xu

98. [Convergent Stochastic Training of Attention and Understanding LoRA](#link98)
**Authors:** Zhengkai Sun, Dibyakanti Kumar, Alejandro F Frangi, Anirbit Mukherjee, Mingfei Sun

99. [Conformal Agent Error Attribution](#link99)
**Authors:** Naihe Feng, Yi Sui, Shiyi Hou, Ga Wu, Jesse C. Cresswell

100. [Less Random, More Private: What is the Optimal Subsampling Scheme for DP-SGD?](#link100)
**Authors:** Andy Dong, Ayfer \"Ozg\"ur

101. [Generative Modeling with Flux Matching](#link101)
**Authors:** Peter Pao-Huang, Xiaojie Qiu, Stefano Ermon

102. [MIND: Monge Inception Distance for Generative Models Evaluation](#link102)
**Authors:** Quentin Berthet, Yu-Han Wu, Clement Crepy, Romuald Elie, Klaus Greff, Michael Eli Sander

103. [Continuous First, Discrete Later: VQ-VAEs Without Dimensional Collapse](#link103)
**Authors:** Xinyu Zhao, Nikita Karagodin, Hamed Hassani, Sinan Hersek, Paul Pu Liang, Yury Polyanskiy

104. [When Symbol Names Should Not Matter: A Logistic Theory of Fresh-Symbol Classification](#link104)
**Authors:** Wenjie Guan, Jelena Bradic

105. [Training-Induced Escape from Token Clustering in a Mean-Field Formulation of Transformers](#link105)
**Authors:** Noboru Isobe, Daisuke Inoue, Masaaki Imaizumi

106. [SOD: Step-wise On-policy Distillation for Small Language Model Agents](#link106)
**Authors:** Qiyong Zhong, Mao Zheng, Mingyang Song, Xin Lin, Jie Sun, Houcheng Jiang, Xiang Wang, Junfeng Fang

107. [PaT: Planning-after-Trial for Efficient Test-Time Code Generation](#link107)
**Authors:** Youngsik Yoon, Sungjae Lee, Seockbean Song, Siwei Wang, Wei Chen, Jungseul Ok

108. [CASCADE: Case-Based Continual Adaptation for Large Language Models During Deployment](#link108)
**Authors:** Siyuan Guo, Yali Du, Hechang Chen, Yi Chang, Jun Wang

109. [Future Validity is the Missing Statistic: From Impossibility to $\Phi$-Estimation for Grammar-Faithful Speculative Decoding](#link109)
**Authors:** Wenhua Nie, Zijie Meng, Kun Zou, Zheng Lin, Ziwei Li, Haoran Zheng, Jyh-Shing Roger Jang, Hao Zhang

110. [Memory-Efficient Looped Transformer: Decoupling Compute from Memory in Looped Language Models](#link110)
...
111. [Reason to Play: Behavioral and Brain Alignment Between Frontier LRMs and Human Game Learners](#link111)
...
130. [On the Role of Strain and Vorticity in Numerical Integration Error for Flow Matching](#link130)
**Authors:** Chenxi Tao, Seung-Kyum Choi

131. [Distributional simplicity bias and effective convexity in Energy Based Models](#link131)
**Authors:** Aur\'elien Decelle, Alfonso de Jes\'us Navas G\'omez, Beatriz Seoane

132. [Inference-Time Attribute Distribution Alignment for Unconditional Diffusion](#link132)
**Authors:** Hao Luan, See-Kiong Ng, Chun Kai Ling

133. [A Rod Flow Model for Adam at the Edge of Stability](#link133)
**Authors:** Eric Regis, Sinho Chewi

134. [RateQuant: Optimal Mixed-Precision KV Cache Quantization via Rate-Distortion Theory](#link134)
**Authors:** Fei Zuo, Zikang Zhou, Hao Cong, Xiaoyan Xi, Ho Fai Leung

135. [CA-SQL: Complexity-Aware Inference Time Reasoning for Text-to-SQL via Exploration and Compute Budget Allocation](#link135)
**Authors:** James Petullo, Nianwen Xue

136. [Tessellations of Semi-Discrete Flow Matching](#link136)
**Authors:** Emile Pierret, Johannes Hertrich, Samuel Hurault, Julie Delon

137. [SGD for Variational Inference: Tackling Unbounded Variance via Preconditioning and Dynamic Batching](#link137)
**Authors:** Hippolyte Labarri\`ere, Cesare Molinari, Silvia Villa, Lorenzo Rosasco

138. [PACEvolve++: Improving Test-time Learning for Evolutionary Search Agents](#link138)
...
139. [MEMOREPAIR: Barrier-First Cascade Repair in Agentic Memory](#link139)
**Authors:** Yang Zhao, Chengxiao Dai, Mengying Kou, Yue Xiu

140. [GraphReAct: Reasoning and Acting for Multi-step Graph Inference](#link140)
**Authors:** Xingtong Yu, Zhongwei Kuai, Chang Zhou, Xuanting Xie, Renhe Jiang, Xikun Zhang, Hong Cheng, Xinming Zhang, Yuan Fang

141. [Revisiting Adam for Streaming Reinforcement Learning](#link141)
**Authors:** Florin Gogianu, Adrian Catalin Lutu, Razvan Pascanu

142. [SimCT: Recovering Lost Supervision for Cross-Tokenizer On-Policy Distillation](#link142)
**Authors:** Jie Sun, Mao Zheng, Mingyang Song, Qiyong Zhong, Yilin Cheng, Bichuan Feng, Pengfei Liu, Junfeng Fang, Xiang Wang

143. [The Minimax Rate of Second-Order Calibration](#link143)
**Authors:** Kamil Ciosek, Banafsheh Rafiee, Sina Ghiassian, Nicol\`o Felicioni

144. [Towards Differentially Private Reinforcement Learning with General Function Approximation](#link144)
**Authors:** Yi He, Xingyu Zhou

145. [Approximation Error Upper and Lower Bounds for H\"{o}lder Class with Transformers](#link145)
**Authors:** Xin He, Yuling Jiao, Xiliang Lu, Jerry Zhijian Yang

146. [On Training in Imagination](#link146)
**Authors:** Nadav Timor, Ravid Shwartz-Ziv, Micah Goldblum, Yann LeCun, David Harel

147. [Why DDIM Hallucinates More than DDPM: A Theoretical Analysis of Reverse Dynamics](#link147)
**Authors:** Muhammad H. Ashiq, Samanyu Arora, Abhinav N. Harish, Ishaan Kharbanda, Hung Yun Tseng, Grigorios G. Chrysos

148. [PolySQL: Scaling Text-to-SQL Evaluation Across SQL Dialects via Automated Backend Isomorphism](#link148)
**Authors:** Yotam Perlitz, Elad Venezian, Corentin Royer, Francesco Fusco, Andrea Giovannini

149. [Learning Agent Routing From Early Experience](#link149)
**Authors:** Yimin Wang, Jiahao Qiu, Xuan Qi, Xinzhe Juan, Jingzhe Shi, Zelin Zhao, Hongru Wang, Shilong Liu, Mengdi Wang

150. [Learning and Reusing Policy Decompositions for Hierarchical Generalized Planning with LLM Agents](#link150)
**Authors:** Shirin Sohrabi, Haritha Ananthakrishnan, Harsha Kokel, Kavitha Srinivas, Michael Katz

151. [Zero-Shot Neural Network Evaluation with Sample-Wise Activation Patterns](#link151)
**Authors:** Yameng Peng, Andy Song, HaythamM. Fayek, Vic Ciesielski, Xiaojun Chang

152. [TeamBench: Evaluating Agent Coordination under Enforced Role Separation](#link152)
...
153. [SHARP: A Self-Evolving Human-Auditable Rubric Policy for Financial Trading Agents](#link153)
**Authors:** Xiwen Chen, Wenhui Zhu, Songzhu Zheng, Kashif Rasul, Yueyue Deng, Huayu Li

154. [Agentick: A Unified Benchmark for General Sequential Decision-Making Agents](#link154)
**Authors:** Roger Creus Castanyer, Pablo Samuel Castro, Glen Berseth

155. [A Unified Measure-Theoretic View of Diffusion, Score-Based, and Flow Matching Generative Models](#link155)
**Authors:** Aditya Ranganath, Mukesh Singhal

156. [Breaking the Illusion: When Positive Meets Negative in Multimodal Decoding](#link156)
...
157. [MedExAgent: Training LLM Agents to Ask, Examine, and Diagnose in Noisy Clinical Environments](#link157)
**Authors:** Yicheng Gao, Xiaolin Zhou, Yahan Li, Yue Zhao, Ruishan Liu

158. [Switchcraft: AI Model Router for Agentic Tool Calling](#link158)
**Authors:** Sharad Agarwal, Pooria Namyar, Alec Wolman, Rahul Ambavat, Ankur Gupta, Qizheng Zhang

159. [LKV: End-to-End Learning of Head-wise Budgets and Token Selection for LLM KV Cache Eviction](#link159)
**Authors:** Enshuai Zhou, Yifan Hao, Chao Wang, Rui Zhang, Di Huang, Jiaming Guo, Xing Hu, Zidong Du, Qi Guo, Yunji Chen

160. [MELD: Multi-Task Equilibrated Learning Detector for AI-Generated Text](#link160)
**Authors:** Chenjun Li, Cheng Wan, Johannes C. Paetzold

161. [NSMQ Riddles: A Benchmark of Scientific and Mathematical Riddles for Quizzing Large Language Models](#link161)
