# Personalized Daily Arxiv Papers 06/12/2026
...
0. [Breaking Entropy Bounds: Accelerating RL Training via MTP with Rejection Sampling](#link0)
...
1. [Learning to Reason by Analogy via Retrieval-Augmented Reinforcement Fine-Tuning](#link1)
**Authors:** Zilin Xiao, Qi Ma, Chun-cheng Jason Chen, Xintao Chen, Avinash Atreya, Hanjie Chen, Vicente Ordonez

2. [EvoBrowseComp: Benchmarking Search Agents on Evolving Knowledge](#link2)
**Authors:** Yunhan Wang, Jiaan Wang, Lianzhe Huang, Xianfeng Zeng, Fandong Meng

3. [PolyAlign: Conditional Human-Distribution Alignment](#link3)
**Authors:** L. D. M. S. Sai Teja, Ufaq Khan, Sathira Silva, Xiao Wu, Muhammad Haris Khan

4. [Categorical Prior Lock-in: Why In-Context Learning Fails for Structured Data](#link4)
**Authors:** Antonio Pelusi, Stefano Braghin, Alberto Trombetta

5. [Reasoning as Pattern Matching: Shared Mechanisms in Human and LLM Everyday Reasoning](#link5)
**Authors:** Zach Studdiford, Gary Lupyan

6. [Risk Under Pressure: Compute-Aware Evaluation of Adversarial Robustness in Language Models](#link6)
**Authors:** Malikeh Ehghaghi, Bogl\'arka Ecsedi, Marsha Chechik, Colin Raffel

7. [PAWS: Preference Learning with Advantage-Weighted Segments](#link7)
...
8. [Operadic consistency: a label-free signal for compositional reasoning failures in LLMs](#link8)
**Authors:** Nathaniel Bottman, Yinhong Liu, Kyle Richardson

9. [SENTINEL: Failure-Driven Reinforcement Learning for Training Tool-Using Language Model Agents](#link9)
...
10. [DailyReport: An Open-ended Benchmark for Evaluating Search Agents on Daily Search Tasks](#link10)
...
11. [Zero-source LLM Hallucination Detection with Human-like Criteria Probing](#link11)
**Authors:** Jiahao Yang, Shuhai Zhang, Hailong Kang, Feng Liu, Qi Chen, Mingkui Tan

12. [RLCSD: Reinforcement Learning with Contrastive On-Policy Self-Distillation](#link12)
**Authors:** Leyi Pan, Shuchang Tao, Yunpeng Zhai, Lingzhe Zhang, Zhaoyang Liu, Bolin Ding, Aiwei Liu, Lijie Wen

13. [To Intervene or Not: Guiding Inference-time Alignment with Probabilistic Model Blending](#link13)
**Authors:** Jin Gan, Xin Li, Jun Luo

14. [SICI: A Semantic-Pragmatic Complexity Index Reveals Regime Shifts in LLM Stance Detection](#link14)
**Authors:** Fuqiang Niu, Bowen Zhang

15. [APPO: Agentic Procedural Policy Optimization](#link15)
**Authors:** Xucong Wang, Ziyu Ma, Yong Wang, Yuxiang Ji, Shidong Yang, Guanhua Chen, Pengkun Wang, Xiangxiang Chu

16. [AgentBeats: Agentifying Agent Assessment for Openness, Standardization, and Reproducibility](#link16)
...
17. [Localizing Anchoring Pathways in Language Models](#link17)
**Authors:** Hillary N. Owusu, Sarah Wiegreffe, Naomi H. Feldman

18. [Constructing Evaluation Datasets for Procedural Reasoning: Balancing Naturalness, Grounding, and Multi-Hop Coverage](#link18)
**Authors:** Sarah Elshabrawy, Rahul K. Dass, Ashok K. Goel

19. [MLUBench: A Benchmark for Lifelong Unlearning Evaluation in MLLMs](#link19)
**Authors:** He Li, Haoang Chi, Qizhou Wang, Yunxin Mao, Zhiheng Zhang, Jie Tan, Tongliang Liu, Wenjing Yang, Bo Han

20. [Observable Patterns Are Not Explanations: A Causal-Geometric Analysis of Latent Reasoning Models](#link20)
**Authors:** Darpan Aswal, Thomas Palmeira Ferraz, Yongxin Zhou, Maxime Peyrard

21. [Operads for compositional reasoning in LLMs](#link21)
**Authors:** Nathaniel Bottman, Kyle Richardson

22. [Influcoder: Distilling Decoders' Gradient Influence Rankings into an Encoder for Data Attribution](#link22)
**Authors:** Dimitri Kachler, Damien Sileo, Pascal Denis

23. [MARS: Margin-Adversarial Risk-controlled Stopping for Parallel LLM Test-time Scaling](#link23)
**Authors:** Wenbo Chen, Puheng Li, Mengyang Liu, Weijie Su, Tianpei Xie

24. [ReSum: Synergizing LLM Reasoning and Summarization with Reinforcement Learning](#link24)
**Authors:** Xucong Wang, Ziyu Ma, Yong Wang, Shidong Yang, Hailang Huang, Renda Li, Pengkun Wang, Xiangxiang Chu

25. [No Hidden Prompts Needed! You Can Game AI Peer Review with Presentation-Only Revisions](#link25)
...
26. ["Did you lie?" Evaluating Lie Detectors across Model Scale and Belief-Verified Model Organisms](#link26)
**Authors:** Alan Cooney, David Africa, Geoffrey Irving

27. [GENIE: A Fine-Grained Measure for Novelty](#link27)
**Authors:** Ramya Namuduri, Manya Wadhwa, Anshun Asher Zheng, Greg Durrett, Junyi Jessy Li

28. [Prefill Awareness in Large Language Models](#link28)
**Authors:** Andy Wang, Parv Mahajan, David Demitri Africa, Alexandra Souly, Jordan Taylor, Robert Kirk

29. [ICA Lens: Interpreting Language Models Without Training Another Dictionary](#link29)
**Authors:** Sida Liu, Feijiang Han

30. [Anatomy of Post-Training: Using Interpretability to Characterize Data and Shape the Learning Signal](#link30)
...
31. [From Passive Generation to Investigation: A Proactive Scientific Peer Review Agent](#link31)
**Authors:** Haishuo Fang, Yue Feng, Iryna Gurevych

32. [Few-Shot Resampling for Scalable Statistically-Sound Data Mining](#link32)
**Authors:** Leonardo Pellegrina, Fabio Vandin

33. [The Containment Gap: How Deployed Agentic AI Frameworks Fail Public-Facing Safety Requirements](#link33)
**Authors:** Md Jafrin Hossain, Mohammad Arif Hossain, Weiqi Liu, Nirwan Ansari

34. [A Data-Centric Framework for Detecting and Correcting Corrupted Labels](#link34)
**Authors:** Ha-Linh Nguyen, Hong-Anh Nguyen, Minh-Duc La, Thu-Trang Nguyen, Son Nguyen, Hieu Dinh Vo

35. [Mental-R1: Aligning LLM Reasoning for Mental Health Assessment](#link35)
**Authors:** Xin Wang, Boyan Gao, Yibo Yang, David A. Clifton

36. [Bergson: An Open Source Library for Data Attribution](#link36)
**Authors:** Lucia Quirke, Louis Jaburi, David Johnston, William Z. Li, Gon\c{c}alo Paulo, Guillaume Martres, Girish Gupta, Stella Biderman, Nora Belrose

37. [Mirror Descent Beyond Euclidean Stability: An Exponential Separation in Initialization Sensitivity](#link37)
**Authors:** Shira Vansover-Hager, Matan Schliserman, Ofir Schlisselberg, Tomer Koren

38. [Spectrally Regularized Latent Flow Matching for Turbulence Generation](#link38)
**Authors:** Khalid Rafiq, Aditya G. Nair

39. [One Polluted Page Is Enough: Evaluating Web Content Pollution in Generative Recommenders](#link39)
**Authors:** Minghao Luo, Liang Chen

40. [RoVE: Rotary Value Embeddings Attention for Relative Position-dependent Value Pathways](#link40)
**Authors:** Alejandro Garc\'ia-Castellanos, Maurice Weiler, Erik J Bekkers

41. [Deployment-Centered Evaluation: Predicting Query-Level Rejection Risk in a Clinical LLM System](#link41)
**Authors:** Alyssa Unell, Miguel Fuentes, Brenna Li, Bridget Lin, Meena Jagadeesan, Sanmi Koyejo, Nigam Shah

42. [Reward Modeling for Multi-Agent Orchestration](#link42)
**Authors:** King Yeung Tsang, Zihao Zhao, Vishal Venkataramani, Haizhou Shi, Zixuan Ke, Semih Yavuz, Shafiq Joty, Hao Wang

43. [Re-evaluating Confidence Remasking in Masked Diffusion Language Models](#link43)
**Authors:** Stipe Frkovic, Metod Jazbec, Dan Zhang, Christian A. Naesseth, Ilija Bogunovic, Eric Nalisnick

44. [Least-Action-Guided Diffusion for Physical Extrapolation](#link44)
**Authors:** Zhongxin Yang, Yuanwei Bin, Xiang I. A. Yang, Shiyi Chen

45. [The Hidden Power of Scaling Factor in LoRA Optimization](#link45)
...
46. [Detect, Remask, Repair: Diffusion Editing for Faithful Summarization of Evolving Contexts](#link46)
**Authors:** Hao Zou, Zachary Horvitz, Chandhru Karthick, Zhou Yu, Kathleen McKeown

47. [RogueAI: A Reverse Turing Test for Detecting Licensed AI Deception in Dialogue](#link47)
**Authors:** Sara Candussio, Emanuele Ballarin, Lorenzo Bonin, Sandro Junior Della Rovere, Luca Bortolussi

48. [Sparse probes and murky physics: a case study of interpretability challenges in a foundation model for continuum dynamics](#link48)
**Authors:** Katherine Rosenfeld, Maike Sonnewald

49. [SciR: A Controllable Benchmark for Scientific Reasoning in LLMs](#link49)
**Authors:** Pierre Beckmann, Marco Valentino, Andre Freitas

50. [IAPO: Input Attribution-Aware Policy Optimization for Tool Use in Small Multimodal Agents](#link50)
**Authors:** Yifan Yang, Zhen Zhang, Jiayi Tian, Liyan Tan, Zheng Zhang

51. [EvoArena: Tracking Memory Evolution for Robust LLM Agents in Dynamic Environments](#link51)
...
52. [From Verdict to Process: Agentic Reinforcement Learning for Multi-Stage Fact Verification](#link52)
**Authors:** Rongxin Yang, Shenghong He, Siyuan Zhu, Chao Yu

53. [NTS-CoT: Mitigating Hallucinations in LLM-based News Timeline Summarization with Chain-of-Thought Reasoning](#link53)
**Authors:** Feng Lyu, Huiqin Yan, Sijing Duan, Hao Wu, Shuang Gu, Xue Qiao, Weixu Zhang, Haolun Wu

54. [LLMs Can Better Capture Human Judgments--With the Right Prompts](#link54)
...
55. [Constrained Semantic Decompression in LLMs through Persian Proverb-Conditioned Story Generation](#link55)
**Authors:** Zahra Habibzadeh, Paria Khoshtab, Amir Mesbah, Yadollah Yaghoobzadeh

56. [Counterexample Guided Learning in the Large using Reasoning Agents](#link56)
**Authors:** Hongyi Liu, Frederic Sala, Thomas Reps, Adithya Murali

57. [MiniMax Sparse Attention](#link57)
...
58. [Implicit Neural Representations of Individual Behavior](#link58)
**Authors:** Andrew Kang, Priya Narasimhan

59. [CRUMB: Efficient Prior Fitted Network Inference via Distributionally Matched Context Batching](#link59)
**Authors:** Jamie Heredge, Mattia J. Villani, Pranav Deshpande, Akshay Seshadri, Niraj Kumar

60. [Attention by Synchronization in Coupled Oscillator Networks](#link60)
**Authors:** Fabio Pasqualetti, Taosha Guo

61. [GraphInfer-Bench: Benchmarking LLM's Inference Capability on Graphs](#link61)
**Authors:** Zhuoyi Peng, Jingzhou Jiang, Hanlin Gu, Lixin Fan, Yi Yang

62. [Claw-SWE-Bench: A Benchmark for Evaluating OpenClaw-style Agent Harnesses on Coding Tasks](#link62)
...
63. [LLM-as-an-Investigator: Evidence-First Reasoning for Robust Interactive Problem Diagnosis](#link63)
**Authors:** Fabrizio Marozzo, Pietro Li\`o

64. [ToolSense: A Diagnostic Framework for Auditing Parametric Tool Knowledge in LLMs](#link64)
**Authors:** Ashutosh Hathidara, Sai Shruthi Sistla, Sebastian Schreiber, Sahil Bansal

65. [SkillCAT: Contrastive Assessment and Topology-Aware Skill Self-Evolution for LLM Agents](#link65)
**Authors:** Kunfeng Chen, Qihuang Zhong, Juhua Liu, Bo Du

66. [ARMOR-MAD: Adaptive Routing for Heterogeneous Multi-Agent Debate in Large Language Model Reasoning](#link66)
**Authors:** Fuqiang Niu, Bowen Zhang

67. [Recursive Binding on a Budget: Subspace Carving in Order-p Tensor Memories](#link67)
**Authors:** Travis Pence, Daisuke Yamada, Vikas Singh

68. [TerraBench: Can Agents Reason Over Heterogeneous Earth-System Data?](#link68)
...
69. [RePAIR: Predictive Self-Supervised Representation Learning in Chess](#link69)
**Authors:** Christoph Koller, Johannes F\"urnkranz, Timo Bertram

70. [SafeLLM: Extraction as a Hallucination-Resistant Alternative to Rewriting in Safety-Critical Settings](#link70)
...
71. [HyperTool: Beyond Step-Wise Tool Calls for Tool-Augmented Agents](#link71)
**Authors:** Yaxin Du, Yifan Zhou, Yujie Ge, Jiajun Wang, Xianghe Pang, Shuo Tang, Tuney Zheng, Bryan Dai, Jian Yang, Siheng Chen

72. [(Human) Attention Is (Still) All You Need: Human oversight makes AI-assisted social science reliable](#link72)
**Authors:** Chen Zhu, Xiaolu Wang, Weilong Zhang

73. [HarnessBridge: Learnable Bidirectional Controller for LLM Agent Harness](#link73)
**Authors:** Xiaoxuan Wang, Haixin Wang, Alexander Taylor, Jason Cong, Yizhou Sun, Wei Wang

74. [Redesign Mixture-of-Experts Routers with Manifold Power Iteration](#link74)
**Authors:** Songhao Wu, Ang Lv, Ruobing Xie, Yankai Lin

75. [From Uniform to Learned Graph Priors: Diffusion for Structure Discovery](#link75)
**Authors:** Qi Shao, Hao Guo, Jiawen Chen, Duxin Chen, Wenwu Yu

76. [nD-RoPE: A Generalized RoPE for n-Dimensional Position Embedding](#link76)
**Authors:** Boyang Li, Yulin Wu, Sizhe Xu, Nuoxian Huang, Zhonghang Yuan, Shangyi Guo, Shu Yang, Takahiro Yabe

77. [Simplicity Suffices for Parameter Noise Injection in Stochastic Gradient Descent](#link77)
**Authors:** Benjamin Leblanc, Louis-Jacob Lebel, Teddy Kana, Richard Kamel

78. [HyPE: Category-Aware Hypergraph Encoding with Persistent Edge Embeddings for Persona-Grounded Dialogue](#link78)
**Authors:** Sangwon Youn, Yoonjin Jang, Youngjoong Ko

79. [Multiagent Protocols with Aggregated Confidence Signals](#link79)
**Authors:** Ali Elahi, Barbara Di Eugenio

80. [Finding Multiple Interpretations in Datasets](#link80)
**Authors:** Matthew Chak, Paul Anderson

81. [Rethinking Psychometric Evaluation of LLMs: When and Why Self-Reports Predict Behavior](#link81)
