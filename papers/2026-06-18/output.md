...
0. [Rethinking Reward Supervision: Rubric-Conditioned Self-Distillation](#link0)
**Authors:** Siyi Gu, Jialin Chen, Sophia Zhou, Arman Cohan, Rex Ying

1. [STARE: Surprisal-Guided Token-Level Advantage Reweighting for Policy Entropy Stability](#link1)
**Authors:** Haipeng Luo, Qingfeng Sun, Songli Wu, Can Xu, Wenfeng Deng, Han Hu, Yansong Tang

2. [Sumi: Open Uniform Diffusion Language Model from Scratch](#link2)
**Authors:** Mengyu Ye, Keito Kudo, Wataru Ikeda, Ryosuke Matsuda, Keisuke Sakaguchi, Jun Suzuki

3. [From Sparse Features to Trustworthy Proxies: Certifying SAE-Based Interpretability](#link3)
**Authors:** Dibyanayan Bandyopadhyay, Asif Ekbal

4. [Diffusion-Proof: Recipe for Formal Theorem Proving Beyond Auto-Regressive Generation](#link4)
**Authors:** Ruida Wang, Rui Pan, Pengcheng Wang, Shizhe Diao, Tong Zhang

5. [Learning from Your Own Mistakes: Constructing Learnable Micro-Reflective Trajectories for Self-Distillation](#link5)
**Authors:** Zhilin Huang, Hang Gao, Ziqiang Dong, Yuan Chen, Yifeng Luo, Chujun Qin, Jingyi Wang, Yang Yang, Guanjun Jiang

6. [REVES: REvision and VErification--Augmented Training for Test-Time Scaling](#link6)
...
7. [GraphPO: Graph-based Policy Optimization for Reasoning Models](#link7)
**Authors:** Yuliang Zhan, Xinyu Tang, Jian Li, Dandan Zheng, Weilong Chai, Jingdong Chen, Jun Zhou, Ge Wu, Wenyue Tang, Hao Sun

8. [Mechanism-Guided Selective Unlearning for RLVR-Induced Reasoning](#link8)
**Authors:** Chenyu Zhou, Qiliang Jiang, Shuning Wu, Xu Zhou

9. [Output Vector Editing for Memorization Mitigation in Large Language Models](#link9)
**Authors:** Ahmad Dawar Hakimi, Kaiwei Lei, Isabelle Augenstein, Hinrich Sch\"utze

10. [DRIFT: Refining Instruction Data via On-Policy Data Attribution](#link10)
**Authors:** Zefan Wang, Lincheng Li, Tianyu Yu, Yuan Yao

11. [DreamReasoner-8B: Block-Size Curriculum Learning for Diffusion Reasoning Models](#link11)
**Authors:** Zirui Wu, Lin Zheng, Jiacheng Ye, Shansan Gong, Xueliang Zhao, Yansong Feng, Wei Bi, Lingpeng Kong

12. [Ghost Attractor Networks: Basin-Structured Dynamical Decoders for Closed-Loop Sequential Generation](#link12)
**Authors:** Tianyu Wang, Ying Wang, Zhihao Liu, Xi Vincent Wang, Lihui Wang

13. [Self-CTRL: Self-Consistency Training with Reinforcement Learning](#link13)
**Authors:** Itamar Pres, Laura Ruis, Melat Ghebreselassie, Belinda Z. Li, Jacob Andreas

14. [Beyond Safe Data: Pretraining-Stage Alignment with Regular Safety Reflection](#link14)
**Authors:** Jinhan Li, Kexian Tang, Yihan Xu, Zhuorui Ye, Kaifeng Lyu

15. [SAGE: Retain-Aware Post-Hoc Sanitization of Final Unlearning Vector](#link15)
**Authors:** Jingyuan Zhang, Yucheng Bai, Peixi Wen, Zhehao Huang, Zhengbao He, Hanling Tian, Xinwen Cheng, Haiyin Ran, Xiaolin Huang

16. [CODEBLOCK: Learning to Supervise Code at the Right Granularity](#link16)
**Authors:** Zhijie Deng, Ling Li, Jinlong Pang, Kaiqin Hu, Qi Xuan, Zhaowei Zhu, Jiaheng Wei

17. [RECOM: A Validity Discrimination Tradeoff in Automatic Metrics for Open Ended Reddit Question Answering](#link17)
**Authors:** Pushwitha Krishnappa, Amit Das, Vinija Jain, Aman Chadha, Tathagata Mukherjee

18. [Beyond Reward Engineering: A Data Recipe for Long-Context Reinforcement Learning](#link18)
**Authors:** Xiaoyue Xu, Sikui Zhang, Xiaorong Wang, Xu Han, Chaojun Xiao

19. [EfficientRollout: System-Aware Self-Speculative Decoding for RL Rollouts](#link19)
...
20. [SAE Interventions are Unreliable: Post-Intervention Recovery of Suppressed Behavior](#link20)
**Authors:** Mingyue Cui, Linghui Shen, Xingyi Yang

21. [Steerable Cultural Preference Optimization of Reward Models](#link21)
**Authors:** Minsik Oh, Advit Deepak, Sophie Wu, Douwe Kiela, Ekaterina Shutova

22. [Learning from Own Solutions: Self-Conditioned Credit Assignment for Reinforcement Learning with Verifiable Rewards](#link22)
...
23. [On the Residual Scaling of Looped Transformers: Stability and Transferability](#link23)
**Authors:** Shaowen Wang, Bingrui Li, Ge Zhang, Wenhao Huang, Shen Yan, Jian Li

24. [The Wrong Kind of Right: Quantifying and Localizing Misfired Alignment in LLMs](#link24)
**Authors:** Naihao Deng, Yiming Feng, Chimaobi Okite, Kaijian Zou, Lu Wang, Rada Mihalcea, Yulong Chen

25. [Stealthy World Model Manipulation via Data Poisoning](#link25)
**Authors:** Yibin Hu, Xiaolin Sun, Zizhan Zheng

26. [PreUnlearn: Auditing Collateral Knowledge Damage Before Large Language Model Unlearning](#link26)
**Authors:** Bo Su, Ankit Shah, Thai Le

27. [LLM Parameters for Math Across Languages: Shared or Separate?](#link27)
**Authors:** Behzad Shomali, Luisa Victor, Tim Selbach, Ali Hamza Bashir, David Berghaus, Joachim Koehler, Mehdi Ali, Markus Frey

28. [SFT Overtraining Predicts Rank Inversion via Entropy Collapse Under RLVR](#link28)
**Authors:** Siddharth Aphale, Kelly Liu

29. [LLMZero: Discovering Adaptive Training Strategies for RL Post-Training via LLM Agents](#link29)
...
30. [RODS: Reward-Driven Online Data Synthesis for Multi-Turn Tool-Use Agents](#link30)
**Authors:** Ruishan Fang, Siyuan Lu, Chenyi Zhuang, Tao Lin

31. [UBP2: Uncertainty-Balanced Preference Planning for Efficient Preference-based Reinforcement Learning](#link31)
**Authors:** Mohamed Nabail, Leo Cheng, Jingmin Wang, Nicholas Rhinehart

32. [The Reward Was in Your Data All Along: Correcting Flow Matching with Discriminator-Guided RL](#link32)
...
33. [Be Your Own Teacher: Steering Protein Language Models via Unsupervised Reward Optimization](#link33)
**Authors:** Lanqing Li, Shentong Mo, Yang Yu, Pheng-Ann Heng

34. [SciRisk-Bench: A Risk-Dimension-Aware Benchmark for AI4Science Safety](#link34)
...
35. [BLADE: Scalable Bi-level Adaptive Data Selection for LLM Training](#link35)
...
36. [Sparsity Curse: Understanding RLVR Model Parameter Space from Model Merging](#link36)
**Authors:** Chenrui Wu, Zexi Li, Jiajun Bu, Jiangchuan Liu, Haishuai Wang

37. [Geometric and Stochastic Analysis of Discontinuities in Sparse Mixture-of-Experts](#link37)
**Authors:** Tho Tran Huu, Huu-Tuan Nguyen, Thien-Hai Nguyen, Nhat-Tri Ho, Viet-Hoang Tran, Tho Quan, Tan Minh Nguyen

38. [SenFlow: Inter-Sentence Flow Modeling for AI-Generated Text Detection in Hybrid Documents](#link38)
**Authors:** Jingkun Luo, Yifan Sun, Da-Tian Peng, Guanxiong Pei

39. [Learning User Simulators with Turing Rewards](#link39)
**Authors:** Yingshan Susan Wang, Cedegao E. Zhang, Linlu Qiu, Zexue He, Pengyuan Li, Alex Pentland, Roger P. Levy, Yoon Kim

40. [Enhancing Multilingual Reasoning via Steerable Model Merging](#link40)
...
41. [Explaining Attention with Program Synthesis](#link41)
**Authors:** Amiri Hayes, Belinda Li, Jacob Andreas

42. [JetFlow: Breaking the Scaling Ceiling of Speculative Decoding with Parallel Tree Drafting](#link42)
...
43. [BCL: Bayesian In-Context Learning Framework for Information Extraction](#link43)
