...
0. [SemRF: A Semantic Reference Frame for Residual-Stream Dynamics in Language Models](#link0)
**Authors:** Jian Gu, Aldeida Aleti, Chunyang Chen, Hongyu Zhang

1. [Reinforcement Learning with Metacognitive Feedback Elicits Faithful Uncertainty Expression in LLMs](#link1)
**Authors:** Gabrielle Kaili-May Liu, Avi Caciularu, Gal Yona, Idan Szpektor, Arman Cohan

2. [Bridging the Gap Between Latent and Explicit Reasoning with Looped Transformers](#link2)
**Authors:** Ying Fan, Anej Svete, Kangwook Lee

3. [BlockPilot: Instance-Adaptive Policy Learning for Diffusion-based Speculative Decoding](#link3)
**Authors:** Hao Zhang, Yiming Hu, Yong Wang, Mingqiao Mo, Xin Xiao, Xiangxiang Chu

4. [Predictable GRPO: A Closed-Form Model of Training Dynamics](#link4)
**Authors:** Rajat Ghosh, Datta Nimmaturi, Aryan Singhal, Vaishnavi Bhargava, Henry Wong, Johnu George, Debojyoti Dutta

5. [Signed-Permutation Coordinate Transport for RMSNorm Transformers](#link5)
**Authors:** John Sweeney

6. [Arena-T2I Hard: Benchmarking and Improving Faithfulness with Dependency-Aware Checklist](#link6)
**Authors:** Yuanhao Ban, Tong Xie, Sohyun An, Yunqi Hong, Evan Frick, I-Hung Hsu, Wei-Lin Chiang, Ion Stoica, Cho-Jui Hsieh

7. [CORTEX: Token-Level Hallucination Detection in RAG via Comparative Internal Representations](#link7)
**Authors:** Kazuaki Furumai, Shuichiro Haruta, Kazunori Matsumoto, Daisuke Kamisaka

8. [RoPoLL: Robust Panel of LLM Judges](#link8)
**Authors:** Anish Acharya, Kris W Pan, Brian Verkhovsky

9. [QVal: Cheaply Evaluating Dense Supervision Signals for Long-Horizon LLM Agents](#link9)
**Authors:** Sergio Hern\'andez-Guti\'errez, Matteo Merler, Ilze Amanda Auzina, Joschka Str\"uber, Ameya Prabhu, Matthias Bethge

10. [Fora: From Weight-Space to Function-Space Protection in Capability-Preserving Fine-Tuning](#link10)
**Authors:** Rui Zhou, Tianci Xie

11. [Behavior Cloning is Not All You Need: The Optimality of On-Policy Distillation for Noisy Expert Feedback](#link11)
**Authors:** Ved Sriraman, Peihan Liu, Daniel Hsu, Adam Block

12. [Which Tokens Matter? Adaptive Token Selection for RLVR with the Relative Surprisal Index](#link12)
**Authors:** Outongyi Lv, Yanzhao Zheng, Yuanwei Zhang, Zhenghao Huang, Xingjun Wang, Baohua Dong, Hangcheng Zhu, Yingda Chen

13. [OTCache: Optimal Transport for Geometry-Aware Caching in Diffusion Models](#link13)
**Authors:** Huanlin Gao, Fang Zhao, Qiang Hui, Fuyuan Shi, Shaoan Zhao, Yantao Li, Chao Tan, Ting Lu, Yuren You, Kai Wang, Shiguo Lian

14. [Learning to Select, Not Relearn: Hard-Routed Mixtures of Reasoning LoRAs](#link14)
**Authors:** Seyed Alireza Molavi, Zhan Su, Yan Hu, Peyman Sheikholharam Mashhadi, Stefan Byttner, Prayag Tiwari

15. [TAG-DLM: Diffusion Language Models for Text-Attributed Graph Learning](#link15)
**Authors:** Lingjie Chen, Yuanchen Bei, Haobo Xu, Yanjun Zhao, Yuzhong Chen, Hanghang Tong

16. [Revisiting the Volume Hypothesis](#link16)
**Authors:** Ari Pakman, Lior Kreimer, Yakir Berchenko

17. [On the Convergence of Self-Improving Online LLM Alignment](#link17)
**Authors:** Xudong Wu, Pangpang Liu, Vaneet Aggarwal, Jiayu Chen

18. [Addressing Over-Refusal in LLMs with Competing Rewards](#link18)
**Authors:** Taeyoun Kim, Aviral Kumar

19. [Calibration, Not Compilation: Detecting and Repairing Misspecified Probabilistic Programs Written by Language Models](#link19)
**Authors:** Jian Xu, Delu Zeng, John Paisley, Qibin Zhao

20. [Fork-Think with Confidence](#link20)
**Authors:** Zena Al-Khalili, Rafi Hakim, Dietrich Klakow, Ji-Ung Lee

21. [Nonlinearity-Aware LoRA: Structured Gate Adaptation under Low-Rank Constraints](#link21)
**Authors:** Shuai Yuan, Sudong Cai, Bingzhi Chen, Shuyuan Zheng, Chuan Xiao, Makoto Onizuka, Rui Mao

22. [Explicit Fuzzy Logic in the Feed-Forward Layer: Self-Forgetting Quantifiers Discover Legible Grammatical-Licensing Detectors](#link22)
**Authors:** Mark Oskin

23. [CHERRY: Compressed Hierarchical Experts with Recurrent Representational Yield](#link23)
**Authors:** Dohyeon Kwon, Youngjin Park

24. [Measuring Judgment Quality in Natural-Language Explanations: Evidence from Forecasting Tournaments](#link24)
**Authors:** Christopher W. Karvetski, Sheldon S. Huang, Simas Ku\v{c}inskas, Nadja Flechner, Jingyu Hu, Philip Tetlock, Ezra Karger

25. [Mixture-of-Control: State-Aware Fine-Tuning for Transformer-based Models](#link25)
**Authors:** Duc Anh Nguyen, Tien Ngoc Luu, Tung Pham, Toan Tran

26. [Moral Safety in LLMs: Exposing Performative Compliance with Puzzled Cues](#link26)
**Authors:** Mohammadamin Shafiei, Shuyue Stella Li, Yulia Tsvetkov

27. [Contrastive Reflection for Iterative Prompt Optimization](#link27)
...
28. [Calibrating the Evaluator: Does Probability Calibration Mitigate Preference Coupling in LLM Agent Feedback Loops?](#link28)
**Authors:** Zewen Liu

29. [Geometry-Preserving Orthonormal Initialization for Low-Rank Adaptation in RLVR](#link29)
**Authors:** Ruijia Zhang, Jiacheng Zhu, Hanqing Zhu, Laixi Shi

30. [Introduction to Stochastic Differential Equations for Generative Machine Learning: A Variational Perspective](#link30)
**Authors:** Ole Winther, Paul Jeha, Sander Dieleman, Andriy Mnih, Manfred Opper, Andrea Dittadi

31. [Improving Certified Robustness via Adversarial Distillation](#link31)
**Authors:** Matteo Melis, Jesus Martinez Del Rincon, Vishal Sharma

32. [When Calibration Rankings Reverse: Accuracy-Controlled Evaluation for Fair Comparison of LLMs](#link32)
**Authors:** Zhichao Yang, Caiqi Zhang, Ruihan Yang, Chengzu Li, Nigel Collier, Deqing Yang

33. [Evo-PI: Aligning Medical Reasoning via Evolving Principle-Guided Supervision](#link33)
**Authors:** Xianda Zheng, Huan Gao, Meng-Fen Chiang, Michael Witbrock, Kaiqi Zhao, Shangyang Li

34. [Robust Text Watermarking for Large Language Models via Dual Semantic Embeddings](#link34)
**Authors:** Jonas Sch\"afer, Cezary Pilaszewicz, Gerhard Wunder

35. [Self-Study Reconsidered: The Hidden Fragility of Learning from Self-Generated QA](#link35)
**Authors:** Ekaterina Alimaskina, Denis Shveykin, Gleb Molodtsov, Igor Shalygin, Alexey Kadeishvili, Aleksandr Beznosikov

36. [BayesBench: Evaluating LLM Belief Trajectories Under Multi-Turn Evidence Accumulation](#link36)
...
37. [Triospect: A Three-Dimensional Framework for Robust Statistical AI-Generated Text Detection Against Diverse Attacks](#link37)
**Authors:** Guangsheng Bao, Lihua Rong, Yanbin Zhao, Xiao Yu, Qiji Zhou, Yue Zhang

38. [Test-Time Verification for Text-to-SQL via Outcome Reward Models](#link38)
...
39. [From Search to Synthesis: Training LLMs as Zero-Shot Workflow Generators](#link39)
**Authors:** Gan Luo, Zihan Qin, Bin Dong, Wotao Yin

40. [Revising RVL-CDIP: Quantifying Errors and Test-Train Overlap](#link40)
...
41. [Introspective Coupling: Self-Explanation Training Tracks Behavioral Change Despite Fixed Supervision](#link41)
**Authors:** Zifan Carl Guo, Laura Ruis, Jacob Andreas, Belinda Z. Li

42. [When LLMs Read Tables Carelessly: Measuring and Reducing Data Referencing Errors](#link42)
**Authors:** Yuqing Yang, Qi Zhu, Zhen Han, Boran Han, Zhengyuan Shen, Shuai Wang, Vassilis N. Ioannidis, Huzefa Rangwala

43. [CDR-Bench: Evaluating Faithful Execution of Compositional, Order-Sensitive Data Refinement Recipes](#link43)
**Authors:** Yuchen Huang, Xiang Li, Zhenqing Ling, Sijia Li, Qianli Shen, Daoyuan Chen, Yi R. Fung, Yaliang Li

44. [Resolving superposition in AI for interpretability and cross-modal alignment in patient-neuronal images](#link44)
