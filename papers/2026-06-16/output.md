...
Total relevant papers: 137

Paper selection prompt and criteria at the bottom

Table of contents with paper titles:

0. [Semantic DLM+: Improving Diffusion Language Models through Bias-variance Trade-off in Transition Kernel Design](#link0)
**Authors:** Keyue Jiang, Yuxiang Wang, Yanan Zhao, Xiang Yu, Qifang Zhao, Bohan Tang, Baojian Zhou, Yanghua Xiao, Lin Qu, Xiaoxiao Xu

1. [Scalable Circuit Learning for Interpreting Large Language Models](#link1)
**Authors:** Naiyu Yin, Dennis Wei, Tian Gao, Amit Dhurandhar, Karthikeyan Natesan Ramamurthy, Yue Yu

2. [Tyler: Typed Latent Reasoning for Language Models -- When to Think, What to Compute, and How Much to Allocate](#link2)
**Authors:** Hanyu Lin, Min Cai, Jiawei Wen, Haodi Zhang

3. [Latent Thought Flow: Efficient Latent Reasoning in Large Language Models](#link3)
**Authors:** Xiandong Zou, Jing Huang, Jianshu Li, Pan Zhou

4. [LESS Is More: Mutual-Stability Sampling for Diffusion Language Models](#link4)
**Authors:** Amr Mohamed, Guokan Shang, Michalis Vazirgiannis

5. [A First-Principles Derivation of LLM Policy Optimization: From Expected Reward to GRPO and Its Structural Extensions](#link5)
...
6. [ExpRL: Exploratory RL for LLM Mid-Training](#link6)
**Authors:** Violet Xiang, Amrith Setlur, Chase Blagden, Nick Haber, Aviral Kumar

7. [GD$^2$PO: Mitigating Multi-Reward Conflicts via Group-Dynamic reward-Decoupled Policy Optimization](#link7)
...
8. [VibeThinker-3B: Exploring the Frontier of Verifiable Reasoning in Small Language Models](#link8)
**Authors:** Sen Xu, Shixi Liu, Wei Wang, Jixin Min, Yingwei Dai, Zhibin Yin, Yirong Chen, Xin Zhou, Junlin Zhang

9. [Entropy-Gated Latent Recursion](#link9)
**Authors:** Soham Bhattacharjee, Dushyant Singh Chauhan, Salem Lahlou, Martin Takac, Nils Lukas

10. [Mean-Field Parallel Decoding for Discrete Diffusion Language Models](#link10)
**Authors:** Tamim Zoabi, Ameen Ali, Liran Ringel, Lior Wolf

11. [MoECa: Aligning Feature Reuse with Expert Decomposition in Diffusion Transformers](#link11)
**Authors:** Maoliang Li, Haojing Chen, Jiayu Chen, Zihao Zheng, Xinhao Sun, Hailong Zou, Xiang Chen

12. [Greedy Coordinate Diffusion: Effective and Semantically Coherent Adversarial Attacks via Diffusion Guidance](#link12)
**Authors:** Bohdan Turbal, Blossom Metevier, Max Springer, Aleksandra Korolova

13. [Multi-Turn Reflective Masking Elicits Reasoning in Mask Diffusion Models](#link13)
**Authors:** Yanming Zhang, Yihan Bian, Jingyuan Qi, Yuguang Yao, Lifu Huang, Tianyi Zhou

14. [Temporal Difference Learning for Diffusion Models](#link14)
**Authors:** Qizhen Ying, Yangchen Pan, Victor Adrian Prisacariu, Junfeng Wen

15. [GRACE: Step-Level Benchmark for Faithful Reasoning over Context](#link15)
**Authors:** Hoang Pham, Dong Le, Anh Tuan Luu

16. [Follow the Latent Roadmap: Navigating Revocable Decoding for Diffusion LLMs with Anchor Tokens](#link16)
**Authors:** Yizhen Yao, Qinglin Zhu, Runcong Zhao, Xiangxiang Dai, Yanzheng Xiang, Yulan He, Lin Gui

17. [Understanding Diversity Collapse in RLVR via the Lens of Overtraining](#link17)
**Authors:** Suqin Yuan, Jinkun Chen, Jiyang Zheng, Muyang Li, Lei Feng, Dadong Wang, Tao Xiang, Tongliang Liu, Bo An

18. [Simplifying the Modeling of Arbitrary Conditionals in Natural Language](#link18)
**Authors:** Yinhan Lu, Eric Elmoznino, L\'eo Gagnon, Sarthak Mittal, Tejas Kasetty, Guillaume Lajoie

19. [BALTO: Balanced Token-Level Policy Optimization for Hallucination Mitigation](#link19)
**Authors:** Ning Li, Zixuan Guo, Yan Xu, Wenbo Fei, Yifan Niu, Chang Luo, Yasheng Wang, Weiwen Liu, Yong Yu, Weinan Zhang

20. [STRIDE: Strategic Trajectory Reasoning via Discriminative Estimation for Verifiable Reinforcement Learning](#link20)
...
21. [Auditing Machine Unlearning: A Systematic Research on Whether Models Truly Forget](#link21)
**Authors:** Dayong Ye, Tianqing Zhu, Ruiding Huang, Xinbo Fu, Jiayang Li, Bo Liu, Huan Huo, Wanlei Zhou

22. [CoRA: Confidence-Rationale Alignment for Reliable Chain-of-Thought Reasoning](#link22)
...
23. [SpecAlign: Efficient Specification-Grounded Alignment of Large Language Models via Synthetic Data](#link23)
**Authors:** Wenjie Wang, Yue Huang, Zhengqing Yuan, Han Bao, Shiyi Du, Yuchen Ma, Yue Zhao, Yanfang Ye, Xiangliang Zhang

24. [QPILOTS: Efficient Test-Time Q-Steering for Flow Policies](#link24)
...
25. [Integrating Reasoning and Generalization in Text-to-SQL via Self-Enhanced Fine-Tuning](#link25)
**Authors:** Feng Lyu, Jinfeng Cen, Sijing Duan, Hao Wu, Shucheng Li, Weixu Zhang, Haolun Wu

26. [Constitutional Value Potentials: reading and steering internal priority margins in language models](#link26)
**Authors:** Tong Che, Rui Wu

27. [The Value Axis: Language Models Encode Whether They're on the Right Track](#link27)
**Authors:** Nick Jiang, Isaac Kauvar, Jack Lindsey

28. [From Tokens to Regions: CUDA-Sensitive Instruction Tuning for GPU Kernel Generation](#link28)
**Authors:** Wentao Chen, Jiace Zhu, Xing Zhe Chai, Zeng Qu, Qiaoling Xiao, Liucheng Duan, An Zou

29. [Beyond Accuracy: Measuring Bias Acknowledgment in Chain-of-Thought Reasoning for Responsible AI Evaluation](#link29)
...
30. [Frame-Conditioned Moral Computation in LLaMA 3.1-8B-Instruct: A Mechanistic Interpretability Audit of Ethical Reasoning](#link30)
**Authors:** Ali Dasdan, Manan Shah, W. Russell Neuman, Chad Coleman, Kund Meghani, Safinah Ali

31. [Emergent retokenization symmetry in large language models: phenomenology and applications](#link31)
**Authors:** Kanishk Jain, Matthew Day, Tankut Can

32. [Rapid Poison: Practical Poisoning Attacks Against the Rapid Response Framework](#link32)
**Authors:** David Huang, Jaewon Chang, Avidan Shah, Prateek Mittal, Chawin Sitawarin

33. [Nemotron 3 Ultra: Open, Efficient Mixture-of-Experts Hybrid Mamba-Transformer Model for Agentic Reasoning](#link33)
...
34. [Wasserstein Convergence of ODE-Based Samplers in Decentralized Diffusion Model via Velocity Field Decomposition](#link34)
**Authors:** Chencheng Tang, Xuanyu Xue, Fangyikang Wang, Chao Zhang, Hubery Yin

35. [How Much Can We Trust LLM Search Agents? Measuring Endorsement Vulnerability to Web Content Manipulation](#link35)
**Authors:** Yimeng Chen, Zhe Ren, Firas Laakom, Yu Li, Dandan Guo, J\"urgen Schmidhuber

36. [Who Flips? Self- and Cross-Model Counterarguments Reveal Answer Instability in LLMs](#link36)
**Authors:** Nafiseh Nikeghbal, Amir Hossein Kargaran, Shaghayegh Kolli, Jana Diesner

37. [Replay What Matters: Off-Policy Replay for Efficient LLM Reinforcement Unlearning](#link37)
**Authors:** Zirui Pang, Chenlong Zhang, Haosheng Tan, Zhuoran Jin, Jiaheng Wei, Zixin Zhong

38. [PACT: Privileged Trace Co-Training for Multi-Turn Tool-Use Agents](#link38)
...
39. [Demystifying Variance in Circuit Discovery of LLMs](#link39)
**Authors:** Frank Zhengqing Wu, Francesco Tonin, Volkan Cevher

40. [Phantoms and Disclosures: a Causal Framework for Auditing Synthetic Data](#link40)
**Authors:** Kareem Amin, Rudrajit Das, Alessandro Epasto, Adel Javanmard, Dennis Kraft, M\'onica Ribero, Sergei Vassilvitskii

41. [Privacy from Symmetry: Orthogonally Equivariant Transformers for LLM Inference](#link41)
**Authors:** Alexander Yukhimchuk, Andrey Shulga, Mladen Kolar, Martin Tak\'a\v{c}

42. [How Should World Models Be Evaluated? A Decision-Making-Centric Position](#link42)
**Authors:** Yang Yu, Shiyuan Zhang, Yifei Sheng, Haoxiang Ren, Haoxin Lin

43. [Mask-Proof: An LLM-based Automated Data Curation Pipeline on Mathematical Proofs](#link43)
...
44. [ReQAT: Achieving Full-Precision Reasoning Accuracy with 4-bit Floating-Point Quantization-Aware Training](#link44)
**Authors:** Janghwan Lee, Sihwa Lee, Jinseok Kim, Yongjik Kim, Jieun Lim, Jinwook Oh, Jungwook Choi

45. [A Mechanistic Understanding of Pronoun Fidelity in LLMs](#link45)
**Authors:** Katharina Trinley, Jesujoba O. Alabi, Dietrich Klakow, Vagrant Gautam

46. [A Gradient Perspective on RLVR Stability and Winner Advantage Policy Optimization](#link46)
...
47. [Localizing Credit at the Divergence: Path-Conditioned Self-Distillation for LLM Reasoning](#link47)
**Authors:** Yu Li, Shu Hong, Tian Lan

48. [SHARD: Safe and Helpful Alignment via Self-Reframing Distillation](#link48)
**Authors:** Viswonathan Manoranjan, Amogh Gupta, Anvesh Rao Vijjini, Thomas Hofweber, Snigdha Chaturvedi

49. [Rethinking Scaffolding in LLM Tutors: The Interactional Mismatch Between Benchmarks and Real-World Deployments](#link49)
**Authors:** Alexandra Neagu, Jeffrey T. H. Wong, Marcus Messer, Rhodri Nelson, Peter B. Johnson

50. [The Information-Theoretic Benefit of Shared Representations under Orthogonality Constraints](#link50)
**Authors:** Thomas Dittrich, Oliver Potocki, Philipp Grohs

51. [AI Engram: In Search of Memory Traces in Artificial Intelligence](#link51)
**Authors:** Jea Kwon, Dong-Kyum Kim, Jiwon Kim, Yonghyun Kim, Woong Kook, Meeyoung Cha

52. [CHILLGuard: Towards Fine-Grained Chinese LLM Safety Guardrail with Scalable Data Construction and Model-aware Preference Alignment](#link52)
...
53. [Metric Match: A Subset Selection Approach to Evaluating LLM Judge Reliability](#link53)
**Authors:** Alyssa Unell, Natalie Dullerud, Naomi Boneh, Meena Jagadeesan, Tatsu Hashimoto, Nigam Shah, Sanmi Koyejo

54. [The Quality-Utility Paradox: Why High-Reward Data Impairs Small Model Mathematical Reasoning](#link54)
**Authors:** Haolong Qian, Xianliang Yang, Yinuo ma, Lirong Che, Feng Lu, Ye Guo, Lei Song, Jiang Bian, Chun Yuan

55. [PathRouter: Aligning Rewards with Retrieval Quality in Agentic Graph Retrieval-Augmented Generation](#link55)
**Authors:** Bo Wang, Heyan Huang, Yaolin Li, Wei Tang, Yuan Zhang, Wenbo Li, Mingze Gao, Ge Shi, Chong Feng

56. [Greed Is Learned: Visible Incentives as Reward-Hacking Triggers](#link56)
**Authors:** Tong Che, Rui Wu

57. [Retrievable Gradients: Continual Post-Training Without Cumulative Weight Drift](#link57)
...
58. [Communication-Efficient Verifiable Attention for LLM Inference](#link58)
**Authors:** Ziqun Chen, Ming Wu, Michael Heinrich, Jason Zeng, Huiying Lan, Tianwei Zhang, Rui Tan

59. [A Large-Scale Multi-Dimensional Empirical Study of LLMs for Conversation Summarization](#link59)
**Authors:** Weixiao Zhou, Gengyao Li, Xianfu Cheng, Junnan Zhu, Feifei Zhai, Zhoujun Li

60. [Context-Aware RL for Agentic and Multimodal LLMs](#link60)
**Authors:** Peiyang Xu, Bangzheng Li, Sijia Liu, Karthik R. Narasimhan, Pramod Viswanath, Prateek Mittal, Xingyu Fu

61. [Can Neural Networks Achieve Optimal Computational-statistical Tradeoff? An Analysis on Single-Index Model](#link61)
**Authors:** Siyu Chen, Beining Wu, Miao Lu, Zhuoran Yang, Tianhao Wang

62. [Scaling LLM Reasoning from Minimal Labels: A Semi-Supervised Framework with a Lightweight Verifier](#link62)
**Authors:** Keizo Kato, Chenhui Chu, Yugo Murawaki, Sado Kurohashi

63. [KVEraser: Learning to Steer KV Cache for Efficient Localized Context Erasing](#link63)
**Authors:** Mufei Li, Shikun Liu, Dongqi Fu, Haoyu Wang, Yinglong Xia, Hong Li, Hong Yan, Pan Li

64. [RoboPIN: Grounded Embodied Reasoning via Pinned Chain-of-Thought](#link64)
**Authors:** Yaoting Huang, Yifu Yuan, Linqi Han, Chengwen Li, Shuoheng Zhang, Xianze Yao, Hongyao Tang, Yan Zheng, Jianye Hao

65. [How Post-Training Shapes Biological Reasoning Models](#link65)
**Authors:** Lukas Fesser, Hanlin Zhang, Michelle M. Li, Eric Wang, Bryan Perozzi, Shekoofeh Azizi, Sham M. Kakade, Marinka Zitnik

66. [AuAu: A Benchmark for Auditing Authoritarian Alignment in Large Language Models](#link66)
**Authors:** Andreas Einwiller, Max Klabunde, Florian Lemmerich

67. [Reward Hacking in Language Model Agents: Revisiting AI Safety Gridworlds](#link67)
**Authors:** \"Omer Veysel \c{C}a\u{g}atan, Xuandong Zhao

68. [When Confidence Lacks Concepts: Interpretable OOD Detection via Representation Perturbations](#link68)
**Authors:** Anju Chhetri, Pratik Shrestha, Ramesh Rana, Prashnna Gyawali, Binod Bhattarai

69. [LiFT: Local Search via Linear Programming for Overfitting-Controlled Transformers](#link69)
**Authors:** Abhishek Shukla, Anikeit Khanna, Ankur Sinha, Faiz Hamid

70. [AdaMame: A Training Recipe for Adaptive Multilingual Reasoning](#link70)
**Authors:** Dayeon Ki, Kevin Duh, Marine Carpuat

71. [Not All Skills Help: Measuring and Repairing Agent Knowledge](#link71)
**Authors:** Yixuan Wang, Yiyang Zhou, Yiming Liang, Congyu Zhang, Fuxiao Liu, Jiawei Zhou, Huaxiu Yao

72. [Ling and Ring 2.6 Technical Report: Efficient and Instant Agentic Intelligence at Trillion-Parameter Scale](#link72)
...
73. [Exploring Extrinsic and Intrinsic Properties for Effective Reasoning with Code Interpreter](#link73)
...
74. [Skill-to-LoRA: From Using Skills to Learning Behaviors for Token-Efficient LLM Agents](#link74)
**Authors:** Tianyi Zhang, Zhonghao Qi

75. [DEEPRUBRIC: Evidence-Tree Rubric Supervision for Efficient Reinforcement Learning of Deep Research Agents](#link75)
**Authors:** Minghang Zhu, Chuyang Wei, Junhao Xu, Yilin Cheng, Zhumin Chen, Jiyan He

76. [Your Privacy My Cloak: Backdoor Attacks on Differentially Private Federated Learning](#link76)
**Authors:** Xiaolin Li, Ning Wang, Ninghui Li, Wenhai Sun

77. [Neuron Level Analysis of Large Language Model in Legal Domain Reasoning](#link77)
**Authors:** Eri Onami, Youmi Ma, Shuhei Kurita, Naoaki Okazaki

78. [Heteroskedastic Signals in Budgeted LLM Verification: Structural Heterogeneity Limits Optimization Gains](#link78)
**Authors:** Jinlong Yang

79. [Spokes: Optimizing for Diverse Pretraining Data Selection](#link79)
**Authors:** Clarence Lee, Yejin Choi, Luke Zettlemoyer, Pang Wei Koh, Hai Leong Chieu

80. [S1-DeepResearch: Beyond Search, Toward Real-World Long-Horizon Research Agents](#link80)
**Authors:** Yao Dong, Xinglin Xiao, Liwei Dong, Xinlong Jin, Zhengbo Li, Heng Zhang, Duyun Wang, Nan Xu

81. [Not all Jensen-Shannon Divergence Estimators are Equal](#link81)
**Authors:** Alba Garrido, Alejandro Almod\'ovar, Mar Elizo, Patricia A. Apell\'aniz, Santiago Zazo, Juan Parras

82. [Towards Pareto-Optimal Tool-Integrated Agents with Pareto Ranking Policy Optimization](#link82)
**Authors:** Junyi Li, Xiaowei Qian, Yingyi Zhang, Wenlin Zhang, Guojing Li, Sheng Zhang, Xiao Han, Yichao Wang, Xiangyu Zhao

83. [Exact Posterior Score Estimation for Solving Linear Inverse Problems](#link83)
...
84. [DiRecT: Safe Diffusion-Based Planning via Receding-Horizon Denoising](#link84)
**Authors:** Paolo Giaretta, Zeyang Li, Navid Azizan

85. [Is Code Better Than Language for Algorithmic Reasoning](#link85)
**Authors:** Terry Tong, Yu Feng, Surbhi Goel, Dan Roth

86. [Adaptive and Explicit safe: Triggering Latent Safety Awareness in Large Reasoning Models](#link86)
**Authors:** Ke Miao, Jiaxin Li, Hongliang Chen, Yuke Hu, Zhan Qin

87. [Let LLMs Judge Each Other: Multi-Agent Peer-Reviewed Reasoning for Medical Question Answering](#link87)
**Authors:** Zaifu Zhan, Shuang Zhou, Rui Zhang

88. [Minimal Oversight: Uncertainty-Aware Governance for Delegated AI Systems](#link88)
**Authors:** Carlos R. B. Azevedo

89. [Rethinking the Role of Efficient Attention in Hybrid Architectures](#link89)
**Authors:** Ziqing Qiao, Yinuo Xu, Chaojun Xiao, Zhou Su, Zihan Zhou, Yingfa Chen, Xiaoyue Xu, Xu Han, Zhiyuan Liu

90. [Stop When Further Reasoning Won't Help: Attention-State Adaptive Generation in Reasoning Models](#link90)
**Authors:** Jiakai Li, Ke Qin, Rongzheng Wang, Yizhuo Ma, Qizhi Chen, Muquan Li, Shuang Liang

91. [Active Learning with Low-Rank Structure for Data Selection](#link91)
**Authors:** Vincent Cohen-Addad, Sasidhar Kunapuli, Vahab Mirrokni, Mahdi Nikdan, David P. Woodruff, Samson Zhou

92. [On Defining Erasure Harms for NLP](#link92)
**Authors:** Yu Lu Liu, Arnav Goel, Jackie Chi Kit Cheung, Alexandra Olteanu, Ziang Xiao, Su Lin Blodgett

93. [OpenClaw-Skill: Collective Skill Tree Search for Agentic Large Language Models](#link93)
**Authors:** Tianyi Lin, Chuanyu Sun, Jingyi Zhang, Changxu Wei, Huanjin Yao, Shunyu Liu, Xikun Zhang, Liu Liu, Jiaxing Huang

94. [Recurrent Reasoning on Symbolic Puzzles with Sequence Models](#link94)
**Authors:** Gowrav Mannem, Chowdhury Marzia Mahjabin, Jason Chen, Shivank Garg, Kevin Zhu

95. [MA-SBI: Misspecification-Aware Simulation-Based Inference via Side-Channel Guidance](#link95)
**Authors:** Arunkumar V, Manoranjan Gandhudi, Gangadharan G. R., Arun Prakash, S. Senthilkumar

96. [Can LLM Agents Infer World Models? Evidence from Agentic Automata Learning](#link96)
**Authors:** Reef Menaged, Gili Lior, Shauli Ravfogel, Roee Aharoni, Gabriel Stanovsky

97. [Topological Flow Matching](#link97)
**Authors:** Kacper Wyrwal, \.Ismail \.Ilkan Ceylan, Alexander Tong

98. [SILAGE: Memory-Efficient, Full-Gradient-Free Nonconvex Optimization for Nested Finite Sums](#link98)
**Authors:** Igor Sokolov, Laurent Condat, Peter Richt\'arik

99. [Probabilistic Signature Inversion: Learning Conditional Distributions from Truncated Signatures](#link99)
**Authors:** Junoh Kang, Kiseop Lee, Bohyung Han

100. [Scaling Adaptive Depth with Norm-Agnostic Residual Networks](#link100)
**Authors:** Tom\'as Figliolia, Beren Millidge

101. [The Data Manifold under the Microscope](#link101)
**Authors:** Marios Koulakis, Constantin Seibold

102. [A Compositional Framework for Open-ended Intelligence](#link102)
**Authors:** Ida Momennejad, Roberta Raileanu

103. [ACCORD: Action-Conditioned Contextual Grounding for Language Agents](#link103)
**Authors:** Lai Jiang, Cheng Qian, Zhenhailong Wang, Pan Lu, Heng Ji, Hao Peng

104. [StarOR: Synergizing Tree Search and Test-Time Reinforcement Learning for Optimization Modeling](#link104)
**Authors:** Jiajun Li, Yu Ding, Shisi Guan, Ran Hou, Wanyuan Wang

105. [Taylor-Calibrate: Principled Initialization for Hybrid Linear Attention Distillation](#link105)
**Authors:** Zhongzhu Zhou, Qingyang Wu, Junxiong Wang, Mayank Mishra, Shuaiwen Leon Song, Ben Athiwaratkun, Chenfeng Xu

106. [Speaking the Language of Science: Toward a General-Purpose Generative Foundation Model for the Natural Sciences](#link106)
**Authors:** Mingyang Li, Yurou Liu, Jieping Ye, Bing Su, Ji-Rong Wen, Zheng Wang

107. [ToolMenuBench: Benchmarking Tool-Menu Filtering Strategies for Reliable and Efficient LLM Agents](#link107)
**Authors:** Rahul Suresh Babu, Laxmipriya Ganesh Iyer

108. [HiMPO: Hindsight-Informed Memory Policy Optimization for Less-Entangled Credit in Long-Horizon Agents](#link108)
**Authors:** Jiangze Yan, Yi Shen, Wenjing Zhang, Jieyun Huang, Zhaoxiang Liu, Ning Wang, Kai Wang, Shiguo Lian

109. [Adapting Reinforcement Learning with Chain-of-Thought Supervision for Explainable Detection of Hateful and Propagandistic Memes](#link109)
**Authors:** Mohamed Bayan Kmainasi, Mucahid Kutlu, Ali Ezzat Shahroor, Abul Hasnat, Firoj Alam

110. [The Art of Mixology: Mixup-based Obfuscation for Privacy-Preserving Split Learning in Large Language Models](#link110)
**Authors:** Chen Chen, Xiang Gao, Xianshun Wang, Chengran Li, Shengyu Xia, Xueluan Gong, Linru Zhang, Qian Wang, Kwok-Yan Lam

111. [Taming Curvature: Architecture Warm-Up for Stable Transformer Training](#link111)
...
112. [Beyond Layer Importance in Layer-wise Sparsity: An Inter-Layer Perturbation-Absorption Perspective](#link112)
**Authors:** Tao Jing, Ningxin Wu, Chen Kang, Dong Yu, Changliang Li, Pengyuan Liu

113. [SciOrch: Learning to Orchestrate Expert LLMs for Solving Frontier Multimodal Scientific Reasoning Tasks](#link113)
**Authors:** Jingru Guo, Xiangyuan Xue, Lian Zhang, Wanghan Xu, Siki Chen, Philip Torr, Wanli Ouyang, Lei Bai, Zhenfei Yin

114. [Distilling Drifting Transformers with Representation Autoencoders](#link114)
**Authors:** Jiawei Zhang, Mengfei Xia, Gen Li, Yuantao Gu

115. [Trust-Region Diffusion Policies for Massively Parallel On-Policy RL](#link115)
...
116. [Tying the Loop -- Tied Expert Layers in Mixture-of-Experts Language Models](#link116)
**Authors:** Martin Jaggi

117. [Lost at the End: Primacy Bias in Multimodal Retrieval-Augmented Question Answering](#link117)
**Authors:** Jieyuan Liu, Jianyang Gu, Shijie Chen, Jefferson Chen, Zhen Wang

118. [VeriGraph: Towards Verifiable Data-Analytic Agents](#link118)
**Authors:** Jiajie Jin, Zhao Yang, Wenle Liao, Yuyang Hu, Guanting Dong, Xiaoxi Li, Yutao Zhu, Zhicheng Dou

119. [Does Traversal Order Matter? A Systematic Study of Tree Traversal Methods in Transformer Grammars](#link119)
**Authors:** Zongru Liu, Pengyu Ji, Pengcheng Wang, Kewei Tu

120. [State-Grounded Multi-Agent Synthetic Data Generation for Tool-Augmented LLMs](#link120)
...
121. [AdaSTORM: Scaling LLM Reasoning on Dynamic Graphs via Adaptive Spatio-Temporal Multi-Agent Collaboration](#link121)
**Authors:** Bing Hao, Ruijie Wang, Haodong Qian, Yunlong Chu, Yuhang Liu, Yumeng Lin, Minglai Shao, Jianxin Li

122. [Variance Reduction for Non-Log-Concave Sampling with Applications to Inverse Problems](#link122)
**Authors:** M. Berk Sahin, Ahmet Ege Tanriverdi, Behzad Sharif, Abolfazl Hashemi

123. [Fantastic Pretraining Optimizers and Where to Find Them II: Hyperball Optimization](#link123)
**Authors:** Kaiyue Wen, Xingyu Dang, Kaifeng Lyu, Tengyu Ma, Percy Liang

124. [When in Doubt, Plan It Out: Committed Small Language Model Deliberation for Reactive Reinforcement Learning](#link124)
**Authors:** Nathan Gavenski, Juarez Monteiro, Francisco Galuppo, Adriano Veloso, Odinaldo Rodrigues

125. [PrologMCP: A Standardized Prolog Tool Interface for LLM Agents](#link125)
**Authors:** Agnieszka Mensfelt, Adarsh Prabhakaran, Adrian Haret, Vince Trencsenyi, Kostas Stathis

126. [PolyKV: Heterogeneous Retention and Allocation for KV Cache Compression](#link126)
**Authors:** Chao Fei, Panos Kalnis

127. [LatentGym: A Testbed For Cross-Task Experiential Learning With Controllable Latent Structure](#link127)
...
128. [Conflict-Aware Federated Fine-Tuning of Large Language Models with Mixture-of-Experts](#link128)
**Authors:** Yijun Lu, Zihan Fang, Pengpeng Qiao, Zheng Lin, Jing Yang, Yuxin Zhang, Por Lip Yee, Zhe Chen, Jun Luo

129. [Compositional Reasoning Depth Predicts Clinical AI Failure: Empirical Evidence Consistent with Transformer Compositionality Limits in Electronic Health Record Question Answering](#link129)
**Authors:** Sanjay Basu

130. [Control-Plane Placement Shapes Forgetting: An Architectural Study of Agent Memory Across Thirteen System Configurations](#link130)
**Authors:** Dongxu Yang

131. [Equity with Efficiency: An Empirical Study of Tokenizers for Multilingual Large Language Models](#link131)
**Authors:** Kieron Seven Jun Wei Lee, Muhammad Reza Qorib, Andrew Ivan Soegeng, Hwee Tou Ng

132. [NeuroSymbolic AI for Legal AI-TRISM: Trustworthy, Reliable, Interpretable, Safe Models](#link132)
**Authors:** Deepa Tilwani, Yash Saxena, Ankur Padia, Srinivasan Parthasarathy, Manas Gaur

133. [SING: Synthetic Intention Graph for Scalable Active Tool Discovery in LLM Agents](#link133)
