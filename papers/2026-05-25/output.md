...
0. [Convex Optimization for Alignment and Preference Learning on a Single GPU](#link0)
**Authors:** Miria Feng, Mert Pilanci

1. [LLMs as Noisy Channels: A Shannon Perspective on Model Capacity and Scaling Laws](#link1)
**Authors:** Xu Ouyang, Deyi Liu, Yuhang Cai, Jing Liu, Yuan Yang, Chen Zheng, Thomas Hartvigsen, Yiyuan Ma

2. [DiLaDiff: Distilled Latent-Augmented Diffusion for Language Modeling](#link2)
**Authors:** Jean-Marie Lemercier, Tomas Geffner, Karsten Kreis, Morteza Mardani, Arash Vahdat, Ante Juki\'c

3. [The Readout Shortcut: Positional Number Copying Dominates Arithmetic CoT Readout in Small Language Models](#link3)
**Authors:** Ming Liu

4. [Sparse Autoencoders Map Brain-LLM Alignment onto Cortical Semantic Topography](#link4)
**Authors:** Dongxin Guo, Jikun Wu, Siu Ming Yiu

5. [Test-Time Training Undermines Safety Guardrails](#link5)
**Authors:** Simone Antonelli, Sadegh Akhondzadeh, Aleksandar Bojchevski

6. [When Do LLMs Reason? A Dynamical Systems View via Entropy Phase Transitions](#link6)
**Authors:** Wei Xia, Haoqing Wang, Zhi-Hong Deng, Yehui Tang

7. [Learned Relay Representations for Forward-Thinking Discrete Diffusion Models](#link7)
**Authors:** Benjamin Rozonoyer, Jacopo Minniti, Dhruvesh Patel, Neil Band, Avishek Joey Bose, Tim G. J. Rudner, Andrew McCallum

8. [Every Component is a Lookup: Token Attribution and Composition from a Single Decomposition](#link8)
**Authors:** Po-Kai Chen, Niki van Stein, Aske Plaat

9. [Multilingual Steering by Design: Multilingual Sparse Autoencoders and Principled Layer Selection](#link9)
**Authors:** Yusser Al Ghussin, Daniil Gurgurov, Tanja Baeumel, Josef van Genabith, Patrick Schramowski, Simon Ostermann

10. [Learnability-Informed Fine-Tuning of Diffusion Language Models](#link10)
...
11. [Decomposing and Measuring Evaluation Awareness](#link11)
**Authors:** Changling Li, Terry Jingchen Zhang, Jie Zhang, Zhijing Jin, Sahar Abdelnabi, Maksym Andriushchenko

12. [MemAudit: Post-hoc Auditing of Poisoned Agent Memory via Causal Attribution and Structural Anomaly Detection](#link12)
...
13. [Metacognition as Reward: Reinforcing LLM Reasoning via Knowledge and Regulation Signals](#link13)
**Authors:** Sirui Chen, Lei Xu, Yuying Zhao, Yutian Chen, Yu Wang, Beier Zhu, Hanwang Zhang, Shengjie Zhao, Chaochao Lu

14. [Instance-Optimal Estimation with Multiple LLM Judges on a Budget](#link14)
**Authors:** Junghyun Lee, Sanghwa Kim, Yassir Jedra, Alexandre Prouti\`ere, Se-Young Yun

15. [It's the humans, not the data: Geopolitical bias in LLMs originates in post-training, amplified by the language of the prompt](#link15)
**Authors:** Stuart Bladon, Brinnae Bent

16. [How Hard is it to Rig a Benchmark? A Social Choice Analysis of Leaderboard Robustness](#link16)
**Authors:** Polina Gordienko, Georg Schollmeyer, Frauke Kreuter, Christoph Jansen

17. [Contrastive Distribution Matching for Amortized Sequential Monte Carlo in Discrete Diffusion](#link17)
**Authors:** Jaihoon Kim, Taehoon Yoon, Prin Phunyaphibarn, Seungjun Kim, Morteza Mardani, Minhyuk Sung

18. [ARES: Automated Rubric Synthesis for Scalable LLM Reinforcement Learning](#link18)
**Authors:** Xiaoyuan Li, Keqin Bao, Moxin Li, Yubo Ma, Yichang Zhang, Wenjie Wang, Fuli Feng, Dayiheng Liu

19. [Transcoders Trace Visual Grounding and Hallucinations in Vision-Language Models](#link19)
**Authors:** Dimitrios Damianos, Leon Voukoutis, Georgios Skyrianos, Vassilis Katsouros, Georgios Paraskevopoulos

20. [Hierarchical Concept Geometry in Language Models Emerges from Word Co-occurrence](#link20)
**Authors:** Andres Nava, Matthieu Wyart

21. [Convergence Without Understanding: When Language Models Agree on Representations but Disagree on Reasoning](#link21)
**Authors:** Muhammad Usama, Dong Eui Chang

22. [From Correctness to Preference: A Framework for Personalized Agentic Reinforcement Learning](#link22)
**Authors:** Ranxu zhang, zeyang li, Jiacheng Huang, Rui Zhang, Xiaozhou Xu, sun zhe, Yanyong Zhang, Chao Wang

23. [PathCal: State-Aware Reflection-Marker Calibration for Efficient Reasoning](#link23)
...
24. [Positional Failures in Long-Context LLMs: A Blind Spot in Reasoning Benchmarks](#link24)
**Authors:** Chuyifei Zhang, Hongyu Cui, Xiaowen Huang, Jitao Sang

25. [How Far Will They Go? Red-Teaming Online Influence with Large Language Models](#link25)
**Authors:** Daniel C. Ruiz, Anna Serbina, Ashwin Rao, Emilio Ferrara, Luca Luceri

26. [Unextractable Protocol Models: Collaborative Training and Inference without Weight Materialization](#link26)
...
27. [Reading Calibrated Uncertainty from Language Model Trajectories](#link27)
**Authors:** Aliai Eusebi, Alexander Herzog, Xiaoyu Liang, Marie Vasek, Enrico Mariconti, Lorenzo Cavallaro

28. [Empirical Bayes Conformal Prediction for Vision and Language Models](#link28)
**Authors:** Jiapeng Zeng, Yogesh Prabhu, Zhanpeng Zeng, Michael A. Newton, Vikas Singh

29. [Infra-Bayesian Reinforcement Learning Agents Outperform Classical RL For Worst-Case Robustness](#link29)
**Authors:** Manish Aryal, Faiyaz Azam, Agnivo Banerjee, Sai Sidhanth Manoharan Jayanthi, Allegra Laro, Cl\'ement Legentilhomme, Andrew Lin, Florian Lorkowski, Radman Rakhshandehroo, Patric Rommel, Emanuel Ruzak, Nathan Theng, Paul Yushin Rapoport

30. [The Attribution Contract: Feature Attribution for Generative Language Models](#link30)
**Authors:** Giang Nguyen

31. [Model Collapse as Cultural Evolution](#link31)
**Authors:** Dongxin Guo, Jikun Wu, Siu Ming Yiu

32. [Complete-muE: Optimal Hyperparameter Transfer and Scaling for MoE Models](#link32)
**Authors:** Hongwu Peng, Ohiremen Dibua, Yuanjun Xiong, Yifan Gong, Jianming Zhang, Yan Kang

33. [Co-ReAct: Rubrics as Step-Level Collaborators for ReAct Agents](#link33)
**Authors:** Jiazheng Kang, Bowen Zhang, Zixin Song, Jiangwang Chen, Xiao Yang, Da Zhu, Guanjun Jiang

34. [Beyond Binary Edits Robust Multimodal Knowledge Editing with Adversarial Subspace Alignment](#link34)
**Authors:** Haoyuan Wang, Xiaohao Liu, Jiajie Su, Jianmao Xiao, Chaochao Chen

35. [Training-Free Looped Transformers](#link35)
**Authors:** Lizhang Chen, Jonathan Li, Chen Liang, Ni Lao, Qiang Liu

36. [Label-Efficient Dataset Pruning via Semi-Supervised Pseudo-Labeling](#link36)
**Authors:** Yeseul Cho, Baekrok Shin, Changmin Kang, Chulhee Yun

37. [CoSPlay: Cooperative Self-Play at Test-Time with Self-Generated Code and Unit Test](#link37)
**Authors:** Zhangyi Hu, Chenhui Liu, Tian Huang, Jindong Li, Yang Yang, Jiemin Wu, Zining Zhong, Menglin Yang, Yutao Yue

38. [NLG Evaluation: Past, Present, Future](#link38)
**Authors:** Ehud Reiter

39. [PACE: Two-Timescale Self-Evolution for Small Language Model Agents](#link39)
**Authors:** Chen Ling, Pei Chen, Albert Guan, Jiaming Qu, Shayan Ali Akbar, Madhu Gopinathan, Erwin Cornejo

40. [DART: Semantic Recoverability for Structured Tool Agents](#link40)
**Authors:** Ke Yang, Panpan Li, Zonghan Wu, Kejin Xu, Huaxi Huang, Xiaoshui Huang

41. [FuRA: Full-Rank Parameter-Efficient Fine-Tuning with Spectral Preconditioning](#link41)
**Authors:** Yequan Zhao, Ruijie Zhang, Liyan Tan, Niall Moran, Tong Qin, Zheng Zhang

42. [Learning Through Noise: Why Subliminal Learning Works and When It Fails](#link42)
**Authors:** Vincent C. Brockers, Roman D. Ventzke, Valentin Neuhaus, Bel\'en Hidalgo-Ogalde, Viola Priesemann

43. [From Raw Experience to Skill Consumption: A Systematic Study of Model-Generated Agent Skills](#link43)
...
44. [Onsager-Machlup Posterior Transport for Deep Gaussian Processes](#link44)
**Authors:** Jian Xu, Delu Zeng, John Paisley, Qibin Zhao

45. [From Residuals to Reasons: LLM-Guided Mechanism Inference from Tabular Data](#link45)
**Authors:** Mohammad R. Rezaei, Rahul G. Krishnan

46. [ImProver 2: Iteratively Self-Improving LMs for Neurosymbolic Proof Optimization](#link46)
**Authors:** Riyaz Ahuja, Tate Rowney, Jeremy Avigad, Sean Welleck

47. [Non-normal spectral signatures of instability in neural network training dynamics](#link47)
**Authors:** Souvik Ghosh

48. [Tensor Cache: Eviction-conditioned Associative Memory for Transformers](#link48)
**Authors:** Kabir Swain, Sijie Han, Daniel Karl I. Weidele, Mauro Martino, Antonio Torralba

49. [The Implicit Bias of Depth: From Neural Collapse to Softmax Codes](#link49)
**Authors:** Connall Garrod, Jonathan P. Keating, Christos Thrampoulidis

50. [Certification from Examples is Hard for Circuits and Transformers under Minimal Overparametrization](#link50)
**Authors:** Artur Back de Luca, Kimon Fountoulakis

51. [Do Language Models Know What Not to Say? Causal Evidence for Statistical Preemption in LLMs](#link51)
**Authors:** Dongxin Guo, Jikun Wu, Siu Ming Yiu

52. [Push Your Agent: Measuring and Enforcing Quantitative Goal Persistence in Long-Horizon LLM Agents](#link52)
**Authors:** Yuandao Cai, Yuzhang Zhu, Liyou Gao, Wensheng Tang, Shengchao Qin

53. [OpenSkillEval: Automatically Auditing the Open Skill Ecosystem for LLM Agents](#link53)
**Authors:** Jiahao Ying, Boxian Ai, Wei Tang, Siyuan Liu, Yixin Cao

54. [Design and Report Benchmarks for Knowledge Work](#link54)
**Authors:** Yining Hua, Hongbin Na, Cyrus Ayubcha, Levi Lian

55. [Hidden Human-Like Nature of Machine-Generated Texts: Theory and Detection Enhancement](#link55)
**Authors:** Chenwang Wu, Yiu-ming Cheung, Bo Han, Defu Lian

56. [Cost-Effective Model Evaluation with Meta-Learning](#link56)
**Authors:** Trinh Pham, Viet Huynh, Hongzhi Yin, Quoc Viet Hung Nguyen, Thanh Tam Nguyen

57. [Anytime Training with Schedule-Free Spectral Optimization](#link57)
**Authors:** Anuj Apte, Pranav Deshpande, Niraj Kumar, Shouvanik Chakrabarti, Junhyung Lyle Kim

58. [Inductive Deductive Synthesis: Enabling AI to Generate Formally Verified Systems](#link58)
