# Personalized Daily Arxiv Papers 06/08/2026
...
0. [Data-Efficient Autoregressive-to-Diffusion Language Models via On-Policy Distillation](#link0)
...
1. [The Piggyback Hypothesis of Generalization: Explaining and Mitigating Emergent Misalignment](#link1)
**Authors:** Jiachen Zhao, Zhengxuan Wu, Aryaman Arora, Yiyou Sun, David Bau, Weiyan Shi

2. [A Geometric View for Understanding Concept Learning and Neuron Interpretation in Sparse Autoencoders](#link2)
**Authors:** Chenhao Zhang, Chris Lin, Su-In Lee

3. [RASFT: Rollout-Adaptive Supervised Fine-Tuning for Reasoning](#link3)
**Authors:** Yongliang Miao, Fengyuan Liu, Wei Shi, Yanguang Liu, Fei Sun, Na Zou, Mengnan Du

4. [TALAN: Task-Aligned Latent Adaptation Networks for Targeted Post-Training of Large Language Models](#link4)
**Authors:** Chengkai Zhang, Ziteng Liu, Junpu Wang, Zeyi Tao, Yang Wang, Sagar Chordia, Qin Huang

5. [Auditing Training Data in Domain-adapted LLMs: LoRA-MINT](#link5)
**Authors:** Gonzalo Mancera, Daniel DeAlcala, Aythami Morales, Julian Fierrez, Ruben Tolosana, Francisco Jurado

6. [Teaching the Way, Not the Answer: Privileged Tutoring Distillation for Multimodal Policy Optimization](#link6)
**Authors:** Shizhe Xiang, Ke An, Wenlong Yu, Yue Liu, Jian Luan, Pei Fu, Qilong Wang

7. [FAIR-Calib: Frontier-Aware Instability-Reweighted Calibration for Post-Training Quantization of Diffusion Large Language Models](#link7)
**Authors:** Haoyu Huang, Linlin Yang, Sheng Xu, Boyu Liu, Guodong Guo, Zhongqian Fu, Hang Zhou, Baochang Zhang

8. [From Sampled Outcomes to Capability Distributions: Rethinking Supervision for LLM Routing](#link8)
**Authors:** Guannan Lai, Haoran Hu, Long Chen, Zhenguo Li, Han-Jia Ye

9. [Uncertainty-Aware LLM-Guided Policy Shaping for Sparse-Reward Reinforcement Learning](#link9)
**Authors:** Ujjwal Bhatta, Utsabi Dangol, Sumaly Bajracharya, Rodrigue Rizk, KC Santosh

10. [Beyond Rubrics: Exploration-Guided Evaluation Skills for Reward Modeling](#link10)
**Authors:** Xing Yue, Linjuan Wu, Daoxin Zhang, Yongliang Shen, Weiming Lu

11. [On the Geometry of On-Policy Distillation](#link11)
**Authors:** Zhennan Shen, Yanshu Li, Qingyu Yin, Chak Tou Leong, Zhilin Wang, Yanxu Chen, Rongduo Han, Sunbowen Lee, Yi R. Fung

12. [What Do People Actually Want From AI? Mapping Preference Plurality](#link12)
**Authors:** Julia Sep\'ulveda Coelho, Scott A. Hale

13. [OpenHalDet: A Unified Benchmark for Hallucination Detection across Diverse Generation Scenarios](#link13)
...
14. [Position: Don't Just "Fix it in Post": A Science of AI Must Study Training Dynamics](#link14)
**Authors:** Stella Biderman, Mohammad Aflah Khan, Niloofar Mireshghallah, Catherine Arnett, Fazl Barez, Naomi Saphra

15. [Data-Constrained Language Model Pretraining: Improved Regularization and Scaling Laws](#link15)
**Authors:** Zhiwei Xu, Shihao Wu, Hanseul Cho, Wei Hu, Yixin Wang

16. [Characterize Then Distill: Mechanistic Reasoning in Large Output Spaces](#link16)
**Authors:** Debjyoti Saha Roy, Byron C. Wallace, Javed A. Aslam

17. [Elmes*: Automated Construction of Fine-Grained Evaluation Rubrics for Large Language Models in Long-Tail Educational Scenarios](#link17)
**Authors:** Tao Liu, Ye Lu, Ruohua Zhang, Siyu Song, Wentao Liu, Aimin Zhou, Hao Hao

18. [How Language Models Fail: Token-Level Signatures of Committed and Persistent Reasoning Failures](#link18)
**Authors:** Tanvi Thoria, Kiana Jafari, Marc R. Schlichting, Mykel J. Kochenderfer

19. [DyCon: Dynamic Reasoning Control via Evolving Difficulty Modeling](#link19)
**Authors:** Tengyao Tu, Yulin Li, Hui-Ling Zhen, Libo Qin, Zhoujun Wei, Jinghua Piao, Zhuotao Tian, Yong Li, Min Zhang

20. [Second-Order Path Kernel Interpolation Formulas in Machine Learning](#link20)
**Authors:** Jin Guo, Roy Y. He, Jean-Michel Morel

21. [Interpreting Brain Responses to Language with Sparse Features from Language Models](#link21)
**Authors:** Michael A. Lepori, Kendrick Kay, Greta Tuckute

22. [Where Rectified Flows Leak: Characterising Membership Signals Along the Interpolation Path](#link22)
**Authors:** Thomas Sesmat, Gabriel Meseguer-Brocal, Geoffroy Peeters

23. [Improving Cross-Lingual Factual Recall via Consistency-Driven Reinforcement Learning](#link23)
...
24. [The Fine-Tuning Trap: Evaluating Negative Transfer and the Role of PEFT in Sub-1B Mathematical Reasoning](#link24)
**Authors:** Rahul Nair, Chun Tao

25. [Skip a Layer or Loop It? Learning Program-of-Layers in LLMs](#link25)
**Authors:** Ziyue Li, Yang Li, Tianyi Zhou

26. [Re-Centering Humans in LLM Personalization](#link26)
**Authors:** Lechen Zhang, Jiarui Liu, Tal August

27. [SlimSearcher: Training Efficiency-Aware Web Agents via Adaptive Reward Gating](#link27)
**Authors:** Zequn Xie, Junjie Wang, Dan Yang, Jie Feng, Yue Shen, Jian Wang, Jinjie Gu

28. [Sycophantic Praise: Evaluating Excessive Praise in Language Models](#link28)
**Authors:** Daniel Vennemeyer, Phan Anh Duong, Meryl Ye, Ruihong Huang, Tianyu Jiang

29. [ThinkBooster: A Unified Framework for Seamless Test-Time Scaling of LLM Reasoning](#link29)
**Authors:** Vladislav Smirnov (MBZUAI), Chieu Nguyen (MBZUAI), Sergey Senichev (Independent Researcher), Minh Ngoc Ta (MBZUAI), Ekaterina Fadeeva (ETH Z\"urich), Artem Vazhentsev (MBZUAI), Daria Galimzianova (MBZUAI), Nikolai Rozanov (MBZUAI, Imperial College London), Viktor Mazanov (Innopolis University), Jingwei Ni (ETH Z\"urich), Tianyi Wu (NUS), Igor Kiselev (Accenture), Mrinmaya Sachan (ETH Z\"urich), Iryna Gurevych (MBZUAI), Preslav Nakov (MBZUAI), Timothy Baldwin (MBZUAI), Artem Shelmanov (MBZUAI)

30. [A Comprehensive Anatomy of Human and DeepSeek-R1 LLM Mathematical Reasoning](#link30)
**Authors:** Yuxiang Chen, Jun Wang

31. [Explain Like I'm 5 or Whatever I Choose: Evaluating the Interactive Potential of Language Model Responses](#link31)
**Authors:** Indu Panigrahi, Tal August

32. [SafeGene: Reusable Adapters for Transferable Safety Alignment](#link32)
**Authors:** Yanghan Wang, Zhiqiang Kou, Fu Feng, Jing Wang, Xin Geng

33. [Quantum-Inspired Trace-Augmented Evidence Selection for Reasoning over Structured Hypothesis Spaces](#link33)
**Authors:** Laura Wynter, Nirvik Sahoo, Paul Griffin

34. [TRACE: Trajectory Reasoning through Adaptive Cross-Step Evidence Aggregation for LLM Agents](#link34)
...
35. [Self-evolving LLM agents with in-distribution Optimization](#link35)
**Authors:** Yudi Zhang, Meng Fang, Zhenfang Chen, Mykola Pechenizkiy

36. [Accounting for Context: Shaping Moral Credences for Value Alignment](#link36)
**Authors:** Jazon Szabo, Sanjay Modgil

37. [Exploring Agentic Tool-Calling Decisions via Uncertainty-Aligned Reinforcement Learning](#link37)
**Authors:** Yijin Zhou, Linqian Zeng, Xiaoya Lu, Wenyuan Xie, Dongrui Liu, Junchi Yan, Jing Shao

38. [Your UnEmbedding Matrix is Secretly a Feature Lens for Text Embeddings](#link38)
**Authors:** Songhao Wu, Zhongxin Chen, Yuxuan Liu, Heng Cui, Cong Li, Rui Yan

39. [Generative Modeling of Discrete Latent Structures via Dynamic Policy Gradients](#link39)
**Authors:** Stefan Ivanovic, Ge Liu, Mohammed El-Kebir

40. [Principles and Practice of Deep Representation Learning: or a Mathematical Theory of Memory](#link40)
**Authors:** San Buchanan, Druv Pai, Peng Wang, Yi Ma

41. [Uniform Stability and Generalization Error of GD and SGD on Fixed-Point Parameters](#link41)
**Authors:** Jonghyun Shin, Sejun Park

42. [Beyond Linear and Overcomplete Regimes: A Mean-Field Analysis of Bottleneck Autoencoders](#link42)
**Authors:** Santanu Das, Ramyak Bilas, Pascal Esser, Satyaki Mukherjee

43. [Closed-Form Spectral Regularization for Multi-Task Model Merging](#link43)
**Authors:** Yongxian Wei, Runxi Cheng, Xingxuan Zhang, Li Shen, Chun Yuan, Peng Cui, Dacheng Tao

44. [Online Pandora's Box for Contextual LLM Cascading](#link44)
**Authors:** Alexandre Belloni, Yan Chen, Yehua Wei

45. [CrowdMath: A Dataset of Crowdsourced Mathematical Research Discussions](#link45)
**Authors:** Sherin Muckatira, Jesse Geneson, Slava Gerovitch, Pavel Etingof, Mikhail Gronas, Anna Rumshisky

46. [OpenSkill: Open-World Self-Evolution for LLM Agents](#link46)
...
47. [mmPISA-bench: Do LLMs Reason Equally Well Across 43 Languages?](#link47)
**Authors:** Yerzhan Sapenov, Jaromir Savelka

48. [TabSwift: An Efficient Tabular Foundation Model with Row-Wise Attention](#link48)
**Authors:** Si-Yang Liu, Han-Jia Ye

49. [StainFlow: Entity-Stain Tracking and Evidence Linking for Process Rewards in GUI Agents](#link49)
...
50. [SigmaScale: LLM Compression with SVD-based Low-Rank Decomposition and Learned Scaling Matrices](#link50)
**Authors:** Ernests Lavrinovics, Marco Letizia, Roy Janco, Shai Segal, Johannes Bjerva, Maurizio Pierini

51. [Phun-Bench: Evaluating LLMs on Phonological Understanding in Chinese](#link51)
**Authors:** Xing Yue, Yongliang Shen, Weiming Lu

52. [Act As a Real Researcher: A Suite of Benchmarks Evaluating Frontier LLMs and Agentic Harnesses in Research Lifecycle](#link52)
...
53. [Sparse Subspace-to-Expert Sharing for Task-Agnostic Continual Learning](#link53)
**Authors:** Fatema Siddika, Md Anwar Hossen, Tanwi Mallick, Ali Jannesari

54. [Progress-SQL: Improving Reinforcement Learning for Text-to-SQL via Progressive Rewards](#link54)
**Authors:** Shihao Zhang, Xiaoman Wang, Yuan Liu, Yunshi Lan, Weining Qian

55. [When Better Codebooks Are Not Enough: Predictive Performance and Behavioral Reliability in LLM Political Event Coding](#link55)
**Authors:** Zixian He, Bharath Raahul Murugesan, Patrick Brandt, Yibo Hu

56. [Are Large Language Models Suitable for Graph Computation? Progress and Prospects](#link56)
**Authors:** Yuting Zhang, Yi Han, Kai Wang, Wei Ni, Angela Bonifati, Wenjie Zhang

57. [MADE: Beyond Scoring via a Multilingual Agentic Diagnosing Engine for Fine-Grained Evaluation Insights](#link57)
...
58. [The Masked Advantage: Uncovering Local-Language Access to Cultural Knowledge in LLMs](#link58)
...
---
## 0. [Data-Efficient Autoregressive-to-Diffusion Language Models via On-Policy Distillation](https://arxiv.org/abs/2606.06712) <a id="link0"></a>
**ArXiv ID:** 2606.06712
**Authors:** Xingyu Su, Jacob Helwig, Shubham Parashar, Atharv Chagi, Lakshmi Jotsna, Degui Zhi, James Caverlee, Dileep Kalathil, Shuiwang Ji
...
**Comment:** Matches criterion 3: Presents a new method (On-Policy Distillation) for transforming autoregressive language models into diffusion language models, addressing train-inference mismatch and knowledge retention, showing strong empirical performance and data efficiency. This is a significant advance in diffusion language models.
**Relevance:** 9
**Novelty:** 8

---

## 1. [The Piggyback Hypothesis of Generalization: Explaining and Mitigating Emergent Misalignment](https://arxiv.org/abs/2606.06667) <a id="link1"></a>
**ArXiv ID:** 2606.06667
**Authors:** Jiachen Zhao, Zhengxuan Wu, Aryaman Arora, Yiyou Sun, David Bau, Weiyan Shi
...
**Comment:** Matches criterion 4: New paradigms to evaluating open-ended text generation. Proposes Eval-Skill, an exploration-guided method synthesizing reusable evaluation skills for reward modeling, reframing reward guidance as context evolution.
**Relevance:** 8
**Novelty:** 7

---

## 11. [On the Geometry of On-Policy Distillation](https://arxiv.org/abs/2606.07082) <a id="link11"></a>
**ArXiv ID:** 2606.07082
**Authors:** Zhennan Shen, Yanshu Li, Qingyu Yin, Chak Tou Leong, Zhilin Wang, Yanxu Chen, Rongduo Han, Sunbowen Lee, Yi R. Fung

**Abstract:** arXiv:2606.07082v1 Announce Type: new  Abstract: On-policy distillation (OPD) is increasingly used to improve large language model reasoning, but its training dynamics remain poorly understood. We characterize the trajectory of OPD updates in parameter space and compare it with supervised fine-tuning (SFT) and reinforcement learning with verifiable rewards (RLVR). A suite of parameter-space diagnostics consistently places OPD in a relaxed off-principal regime: compared with SFT, its updates affect fewer weights and avoid principal directions more strongly, while compared with RLVR, they remain less tightly constrained. Beyond this static localization, OPD exhibits subspace locking: its cumulative updates rapidly enter a narrow low-dimensional channel. Constraining training to the update subspace formed early in training preserves OPD performance but substantially degrades SFT, indicating that the locked subspace is functionally sufficient for OPD. Control experiments further show that sparsifying the update tokens and shifting rollout generation off-policy preserve the rank dynamics, whereas mixing the OPD objective with RLVR changes them. Overall, these results suggest that OPD is not merely an intermediate point between SFT and RLVR, but induces its own update geometry in parameter space.

**Comment:** Matches criterion 1 (methodological improvements to RLHF or instruction-following). Paper studies on-policy distillation (OPD) for LLM reasoning fine-tuning, analyzing its unique training dynamics compared to supervised fine-tuning and RL with verifiable rewards.
**Relevance:** 8
**Novelty:** 7

---

## 12. [What Do People Actually Want From AI? Mapping Preference Plurality](https://arxiv.org/abs/2606.06674) <a id="link12"></a>
**ArXiv ID:** 2606.06674
**Authors:** Julia Sep\'ulveda Coelho, Scott A. Hale
...
**Comment:** Matches criterion 11 (AI alignment techniques). Paper analyzes limitations of RLHF and preference aggregation in LLM alignment, revealing fundamental problems in current alignment practices and preference plurality.
**Relevance:** 8
**Novelty:** 7

---

## 13. [OpenHalDet: A Unified Benchmark for Hallucination Detection across Diverse Generation Scenarios](https://arxiv.org/abs/2606.06959) <a id="link13"></a>
**ArXiv ID:** 2606.06959
**Authors:** Xinyi Li, Zhen Fang, Yongxin Deng, Jinyuan Luo, Hongnan Ma, Changdae Oh, Zijing Shi, Shanshan Ye, Hanchen Wang, Shu-Lin Chen, Yadan Luo, Mengyue Yang, Sean Du, Sharon Li, Ling Chen
...
**Comment:** Does not match any specific criteria. Focuses on multilingual post-evaluation diagnosis and benchmarking analysis rather than new paradigms for open-ended text generation evaluation or instruction-following fine-tuning.
**Relevance:** 3
**Novelty:** 4

---

## 58. [The Masked Advantage: Uncovering Local-Language Access to Cultural Knowledge in LLMs](https://arxiv.org/abs/2606.07422) <a id="link58"></a>
**ArXiv ID:** 2606.07422
**Authors:** Yang Zhang, Xiao Fei, Amr Mohamed, Sarah Almeida Carneiro, Mersin Konomi, Mingmeng Geng, Ahmed Asaad, Guokan Shang, Michalis Vazirgiannis
...
**Comment:** No criteria matched. The paper studies cultural knowledge access in LLMs across languages but does not address instruction-following fine-tuning, contamination, diffusion LMs, evaluation paradigms, or other specified criteria.
**Relevance:** 3
**Novelty:** 3
