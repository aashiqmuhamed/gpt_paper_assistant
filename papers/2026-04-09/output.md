# Personalized Daily Arxiv Papers 04/09/2026
...
0. [Improving Robustness In Sparse Autoencoders via Masked Regularization](#link0)
**Authors:** Vivek Narayanaswamy, Kowshik Thopalli, Bhavya Kailkhura, Wesam Sakla

1. [DataSTORM: Deep Research on Large-Scale Databases using Exploratory Data Analysis and Data Storytelling](#link1)
**Authors:** Shicheng Liu, Yucheng Jiang, Sajid Farook, Camila Nicollier Sanchez, David Fernando Castro Pena, Monica S. Lam

2. [$S^3$: Stratified Scaling Search for Test-Time in Diffusion Language Models](#link2)
...
3. [The Detection--Extraction Gap: Models Know the Answer Before They Can Say It](#link3)
**Authors:** Hanyang Wang, Mingxuan Zhu

4. [Discrete Flow Matching Policy Optimization](#link4)
**Authors:** Maojiang Su, Po-Chung Hsieh, Weimin Wu, Mingcheng Lu, Jiunhau Chen, Jerry Yao-Chieh Hu, Han Liu

5. [Distributional Open-Ended Evaluation of LLM Cultural Value Alignment Based on Value Codebook](#link5)
**Authors:** Jaehyeok Lee, Xiaoyuan Yi, Jing Yao, Hyunjin Hwang, Roy Ka-Wei Lee, Xing Xie, JinYeong Bak

6. [RAGEN-2: Reasoning Collapse in Agentic RL](#link6)
...
7. [STDec: Spatio-Temporal Stability Guided Decoding for dLLMs](#link7)
**Authors:** Yuzhe Chen, Jiale Cao, Xuyang Liu, Jin Xie, Aiping Yang, Yanwei Pang

8. [To Lie or Not to Lie? Investigating The Biased Spread of Global Lies by LLMs](#link8)
...
9. [Rethinking Generalization in Reasoning SFT: A Conditional Analysis on Optimization, Data, and Model Capability](#link9)
**Authors:** Qihan Ren, Peng Wang, Ruikun Cai, Shuai Shao, Dadi Guo, Yuejin Xie, Yafu Li, Quanshi Zhang, Xia Hu, Jing Shao, Dongrui Liu

10. [Geometric Properties of the Voronoi Tessellation in Latent Semantic Manifolds of Large Language Models](#link10)
**Authors:** Marshall Brett

11. [The Master Key Hypothesis: Unlocking Cross-Model Capability Transfer via Linear Subspace Alignment](#link11)
...
12. [Fast-dVLM: Efficient Block-Diffusion VLM via Direct Conversion from Autoregressive VLM](#link12)
...
13. [Cognitive Loop of Thought: Reversible Hierarchical Markov Chain for Efficient Mathematical Reasoning](#link13)
**Authors:** Jia-Chen Zhang, Zheng Zhou, Yu-Jie Xiong

14. [Distributed Interpretability and Control for Large Language Models](#link14)
**Authors:** Dev Arpan Desai, Shaoyi Huang, Zining Zhu

15. [Transformer See, Transformer Do: Copying as an Intermediate Step in Learning Analogical Reasoning](#link15)
**Authors:** Philipp Hellwig, Willem Zuidema, Claire E. Stevenson, Martha Lewis

16. [When Is Thinking Enough? Early Exit via Sufficiency Assessment for Efficient Reasoning](#link16)
**Authors:** Yang Xiang, Yixin Ji, Ruotao Xu, Dan Qiao, Zheming Yang, Juntao Li, Min Zhang

17. [Personalized RewardBench: Evaluating Reward Models with Human Aligned Personalization](#link17)
**Authors:** Qiyao Ma, Dechen Gao, Rui Cai, Boqi Zhao, Hanchu Zhou, Junshan Zhang, Zhe Zhao

18. [ReDAct: Uncertainty-Aware Deferral for LLM Agents](#link18)
...
19. [Beyond Surface Judgments: Human-Grounded Risk Evaluation of LLM-Generated Disinformation](#link19)
**Authors:** Zonghuan Xu, Xiang Zheng, Yutao Wu, Xingjun Ma

20. [GCoT-Decoding: Unlocking Deep Reasoning Paths for Universal Question Answering](#link20)
**Authors:** Guanran Luo, Wentao Qiu, Zhongquan Jian, Meihong Wang, Qingqiang Wu

21. [Beyond Accuracy: Diagnosing Algebraic Reasoning Failures in LLMs Across Nine Complexity Dimensions](#link21)
**Authors:** Parth Patil, Dhruv Kumar, Yash Sinha, Murari Mandal

22. [WRAP++: Web discoveRy Amplified Pretraining](#link22)
**Authors:** Jiang Zhou, Yunhao Wang, Xing Wu, Tinghao Yu, Feng Zhang

23. [Self-Preference Bias in Rubric-Based Evaluation of Large Language Models](#link23)
**Authors:** Jos\'e Pombal, Ricardo Rei, Andr\'e F. T. Martins

24. [ART: Attention Replacement Technique to Improve Factuality in LLMs](#link24)
**Authors:** Ziqin Luo, Yihao Quan, Xiaofeng Zhang, Xiaosong Yuan, Chen Shen

25. [On the Step Length Confounding in LLM Reasoning Data Selection](#link25)
**Authors:** Bing Wang, Rui Miao, Chen Shen, Shaotian Yan, Kaiyuan Liu, Ximing Li, Xiaosong Yuan, Sinan Fan, Jun Zhang, Jieping Ye

26. [Blind Refusal: Language Models Refuse to Help Users Evade Unjust, Absurd, and Illegitimate Rules](#link26)
**Authors:** Cameron Pattison, Lorenzo Manuali, Seth Lazar

27. [Steering the Verifiability of Multimodal AI Hallucinations](#link27)
**Authors:** Jianhong Pang, Ruoxi Cheng, Ziyi Ye, Xingjun Ma, Zuxuan Wu, Xuanjing Huang, Yu-Gang Jiang

28. [SHAPE: Stage-aware Hierarchical Advantage via Potential Estimation for LLM Reasoning](#link28)
**Authors:** Zhengyang Ai, Zikang Shan, Xiaodong Ai, Jingxian Tang, Hangkai Hu, Pinyan Lu

29. [The Illusion of Stochasticity in LLMs](#link29)
**Authors:** Xiangming Gu, Soham De, Michalis Titsias, Larisa Markeeva, Petar Veli\v{c}kovi\'c, Razvan Pascanu

30. [In-Context Learning in Speech Language Models: Analyzing the Role of Acoustic Features, Linguistic Structure, and Induction Heads](#link30)
**Authors:** Charlotte Pouw, Hosein Mohebbi, Afra Alishahi, Willem Zuidema

31. [Multi-objective Evolutionary Merging Enables Efficient Reasoning Models](#link31)
...
32. [Reason in Chains, Learn in Trees: Self-Rectification and Grafting for Multi-turn Agent Policy Optimization](#link32)
**Authors:** Yu Li, Sizhe Tang, Tian Lan

33. [VLMShield: Efficient and Robust Defense of Vision-Language Models against Malicious Prompts](#link33)
...
34. [Blending Human and LLM Expertise to Detect Hallucinations and Omissions in Mental Health Chatbot Responses](#link34)
**Authors:** Khizar Hussain, Bradley A. Malin, Zhijun Yin, Susannah Leigh Rose, Murat Kantarcioglu

35. [Riemann-Bench: A Benchmark for Moonshot Mathematics](#link35)
**Authors:** Suhaas Garre, Erik Knutsen, Sushant Mehta, Edwin Chen

36. [Improving Semantic Uncertainty Quantification in Language Model Question-Answering via Token-Level Temperature Scaling](#link36)
**Authors:** Tom A. Lamb, Desi R. Ivanova, Philip H. S. Torr, Tim G. J. Rudner

37. [State-of-the-Art Arabic Language Modeling with Sparse MoE Fine-Tuning and Chain-of-Thought Distillation](#link37)
...
38. [Adaptive Prompt Structure Factorization: A Framework for Self-Discovering and Optimizing Compositional Prompt Programs](#link38)
**Authors:** Haoyue Liu, Zhichao Wang, Yongxin Guo, Haoran Shou, Xiaoying Tang

39. [Gemma 4, Phi-4, and Qwen3: Accuracy-Efficiency Tradeoffs in Dense and MoE Reasoning Language Models](#link39)
**Authors:** Md Motaleb Hossen Manik, Ge Wang

40. [Neural Computers](#link40)
...
41. [When to Call an Apple Red: Humans Follow Introspective Rules, VLMs Don't](#link41)
**Authors:** Jonathan Nemitz, Carsten Eickhoff, Junyi Jessy Li, Kyle Mahowald, Michal Golovanevsky, William Rudman

42. [DiffuMask: Diffusion Language Model for Token-level Prompt Pruning](#link42)
...
43. [On the Price of Privacy for Language Identification and Generation](#link43)
**Authors:** Xiaoyu Li, Andi Han, Jiaojiao Jiang, Junbin Gao

44. [MoE Routing Testbed: Studying Expert Specialization and Routing Behavior at Small Scale](#link44)
...
45. [Select-then-Solve: Paradigm Routing as Inference-Time Optimization for LLM Agents](#link45)
