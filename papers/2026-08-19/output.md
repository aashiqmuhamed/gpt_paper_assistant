...
0. [Forward Pass Domain Adaptation (Without Cross-Layer Backpropagation)](#link0)
**Authors:** Rivaan Patil, Simon Dennis, Hao Guo, Kevin Shabahang

1. [Agent Lightning v1.0: Towards Harnessed Agentic RL](#link1)
**Authors:** Zhiyuan He, Siwei Zhang, Zhiwen Zhou, Yuqing Yang, Yu Kang, Yuge Zhang, Luna K. Qiu, Tin Yan Tsui, Jiahang Xu, Chong Luo

2. [Conditional Evaluation of Language Models with Cheap Auxiliary Signals](#link2)
**Authors:** Zhi Zhang, Lingfeng Lyu, Yue Kang, Doudou Zhou

3. [Rethinking Reverse KL as Adaptive Entropy Distillation](#link3)
**Authors:** Shizhen Li, Zhiyu Shen, Yuyin Lu, Yunhe Pang, Jielin Song, Yanghui Rao, Fu Lee Wang

4. [PlanPO: Group Planning-Aware Policy Optimization for Multi-Turn Agentic LLMs](#link4)
**Authors:** Dayang Liang, Liyuan He, Xuan Feng, Shuxin Li, Bo An, Yunlong Liu

5. [Le Critique: Privileged Value Functions for LLM Reinforcement Learning](#link5)
**Authors:** Siddarth Venkatraman, Matthieu Dinot, Laurence Aitchison

6. [Write, Execute, Refine: From Skill Followers to Skill Optimizers via Reinforcement Learning from Execution Feedback](#link6)
**Authors:** Kang Peng, Zhiwei Zhang, Yichen Zhang, Zezhong Wang, Yiming Du, Geng Tu, Baojun Wang, Bin Liang, Ruifeng Xu, Kam-Fai Wong

7. [KnowSim: Evaluating Information Calibration in LLM Assistants with User Simulators that Learn](#link7)
**Authors:** Yoonjoo Lee, Hyoungwook Jin, Tae Soo Kim, Shaoyang Zhang, Philippe Laban, Q. Vera Liao

8. [Spectral Saliency for Machine Unlearning](#link8)
**Authors:** Cedar Site Bai, Amber Yijia Zheng, Raymond A. Yeh, Brian Bullins

9. [Mitigating Rubric Interference in LLM Judges via On-Policy Self-Distillation](#link9)
**Authors:** Dingyao Yu, Tong Zhang, Yutao Mou, Yunxiao Zhang, Wei Ye, Shikun Zhang

10. [Beyond the Trace: Coupling an Interpretable Reasoning-State Readout to Native MoE Routing](#link10)
**Authors:** Kang Chen, Sihan Zhao, Yixin Cao, Yugang Jiang

11. [Mixture-of-Expert Blocks Contain Strong Hallucination Detection Signals](#link11)
**Authors:** Joao Fonseca, Rodrigo Rodrigues, Paolo Romano

12. [SubZero+: Efficient Zeroth-Order LLM Fine-Tuning via Large Learning Rates](#link12)
**Authors:** Ziming Yu, Shuyao Xiao, Xingyu Zhao, Sike Wang, Pan Zhou, Peiyu Zang, Xiangda Yan, Yongjie Yang, Jia Li

13. [Fool's Gold: Defensive Deception Against Safety-Removal Attacks on Open-Weight Models](#link13)
**Authors:** Mark Russinovich

14. [BayesPrompt: human readable prompts that make sense](#link14)
**Authors:** Franky Kevin Nando Tezoh, Ali Hussaini Umar, Alessandro Laio, Guido Sanguinetti, Riccardo Rende

15. [SAUL: Sharpness-Aware Augmented-Lagrangian Unlearning](#link15)
**Authors:** Jaewan Choi, Junyoung Yang, Sangdon Park

16. [Learn What's Left, Not What's Mastered: Saturation Aware Advantage Reweighting for Multi-Reward Policy Optimization](#link16)
**Authors:** Yixuan Wang, Yifei Chen, Haichao Zhang, Haozheng Luo, Xander Wu, Jie Ni, Yun Fu, Nuno Vasconcelos, Yijiang Li

17. [Towards Better Agents for Multi-Turn User Interaction: The Next User Turn Is More Than Context](#link17)
**Authors:** Yiwen Zhao, Zhihao Wen, Yuchen Mao, Mingxuan Jiang, Yihao Hu, Pan Wang, Xin Zhang, Wei Wu

18. [LEGO-RL: Harness-Native Reinforcement Learning for Coding Agents](#link18)
...
19. [A decodability criterion predicts when hidden-state selection beats majority voting in large language models](#link19)
**Authors:** Zhixiang wang, Ziliang Hong, Ulas Bagci

20. [Discrete Diffusion Language Models Are Training-Free Multi-Label Classifiers](#link20)
**Authors:** Pawan Kumar

21. [Do Uncertainty Signals Help? A Systematic Study of Uncertainty-Aware Decoding with Rollback Mechanisms](#link21)
**Authors:** Xianzong Wu, Xiaohong Li, Yuejun Guo, Xinyang Liu, Tianlin Li, Junjie Wang, Qiang Hu

22. [Learning to Unlearn: Machine Unlearning via Learning the Unlearning Behaviors](#link22)
**Authors:** Hang Zhang, Kaifeng Zhang, Yixiao Ma, Weijie Xu, Ye Zhu, Kai Ming Ting

23. [TRUSS: Towards Task-Reliable and User-Safe Automated Agent Skill Generation](#link23)
**Authors:** Zhibo Zhang, Zhen Ouyang, Ling Shi, Kailong Wang

24. [Evaluating the Diversity of AI-Generated Content with Diversity Profiles](#link24)
**Authors:** Xiuyuan Hu, Xuege Hou, Guoqing Liu, Yang Zhao, Jieran Li, Dongbiao Sun, Jos\'e Miguel Hern\'andez-Lobato, Hao Zhang, Xue Liu

25. [Sparse Prototype Code Underlies Classification and Prediction Across Modalities](#link25)
**Authors:** Yehonatan Avidan, Daniel D. Lee, Haim Sompolinsky

26. [Randomly initialized autoencoders: fixed points and edge-of-chaos](#link26)
**Authors:** Leonid Berlyand, Roman Sarapin, Yitzchak Shmalo, Victor Slavin, Sasha Sodin

27. [Benchmarking the Benchmarks: Evaluating Automated Safety Benchmarks for Small Language Models](#link27)
**Authors:** Nyamtulla Shaik, Fengjun Li, Bo Luo

28. [The IOL-AI Challenge: An Open Challenge towards Advancing Linguistic Reasoning](#link28)
...
29. [Learning reshapes power-law anisotropy in internal representations](#link29)
**Authors:** Asahi Nakamuta, Jun-nosuke Teramae

30. [D$^2$ACCI: A Dual-Loop Diagnostic Protocol for Evidence-Preserving Agent Memory](#link30)
**Authors:** Xule Liu, Yijun Liu, Chao Li, Shao Kun

31. [Spectral Rank Certification for Foundation Model Adapters](#link31)
**Authors:** Mohammed Ahnouch, Lotfi Elaachak

32. [Beyond Suspicious Steps: Ontological Trust in Long-Horizon Agents](#link32)
**Authors:** An He, Yao Wang, Haibin Zhang

33. [Encoded but Not Actionable: Auditing the Decode-Generate-Steer Gap in Frozen LLMs for Geometric Constraints](#link33)
**Authors:** Man Liang, Xinzhao Cheng, Faizan Wajid

34. [Chain-of-Experience for Continual LLM Improvement](#link34)
**Authors:** Haoqin Tu, Yunhao Fang, Yizhong Wang, Cihang Xie, Shen Yan

35. [StartupBench: Benchmarking General-Purpose Agents on Market-Validated End-to-End Workflows](#link35)
...
36. [Q-based Variational Inverse Reinforcement Learning](#link36)
**Authors:** Ondrej Bajgar, Peter Tisnikar, Alessandro Abate, Konstantinos Gatsis, Maike Osborne

37. [PertMind: Eliciting Emergent Biological Reasoning in LLM via Reinforcement Learning on Cellular Perturbation Data](#link37)
...
38. [Cross-Model Memory Transfer via Target-Side Reader Adaptation](#link38)
**Authors:** Mingyuan Li, Guangsheng Yu, Xu Wang, Shaoxiong Ji

39. [Q-Interference: Memory-Efficient Phase-Aware Quantum-Inspired Attention](#link39)
**Authors:** Emama Nahid, Tahmid Imtiaz Imu, Huayue Gu, Liran Ma, Zhipeng Cai, Honghui Xu

40. [LLM-Derived Preference Judgments Are Not Self-Consistent](#link40)
**Authors:** Matthew T. Ford, Francis Bahk, Jingjing Wang, Adam S. Jovine, Tinghan Ye, David B. Shmoys, Peter I. Frazier

41. [Do LLMs Know a Good Hypothesis When They See One? Logit-Based Energy Scoring Outperforms Prompted LLM-as-Judge for Scientific Hypothesis Ranking](#link41)
**Authors:** Swati Rajwal, Sanjay Das, Tirthankar Ghosal

42. [WANDR: A Benchmark for Wide and Deep Research](#link42)
...
43. [On the Fragility of Self-Improving Agents: Variance, Task Order, and Underspecification](#link43)
**Authors:** Qinyuan Ye, Yu Li, Yada Pruksachatkun, Jiaxin Zhang, Chien-Sheng Wu

44. [Diagnosing and Mitigating Perception-Decision Misalignment in Omni-LLMs via Modality Subspace Activation](#link44)
**Authors:** Hongbo Jiang, Jie Li, Yunhang Shen, Tianyu Xie, Pingyang Dai

45. [Efficient Coreset Selection via K-Nearest Neighbor Graphs](#link45)
**Authors:** Yingfan Liu, Leiyu Zhang, Jiadong Xie, Mingzhe Wang, Jeffrey Xu Yu, Jiangtao Cui

46. [Can LLMs Reason in a Legally Meaningful Manner? A Small-scale Study on European Court of Human Rights Cases](#link46)
**Authors:** Amogh Raina, Ilias Chalkidis, Daniel Hershcovich, Henrik Palmer Olsen

47. [Operator-Theoretic Generalization Bounds for Multitask Deep Learning](#link47)
**Authors:** Mahdi Mohammadigohari, Thomas Borsani, Giuseppe Di Fatta

48. [MAPLE: MoE Adaptive Plug-and-play Layer-wise Expert allocation](#link48)
**Authors:** Lie Li, Wen Li, Junxiao Shen, Gusheng Hu

49. [Proteus: Incremental Memory Activation for Long-Context Sequence Modeling](#link49)
**Authors:** Reza Bayat, Ali Behrouz, Vahab Mirrokni, Aaron Courville

50. [Children, but not language models, show accelerating returns in word learning](#link50)
**Authors:** Michael C. Frank

51. [On the Principles Behind Neural Network Optimizers](#link51)
**Authors:** Yushun Zhang

52. [Large Discovery Models: Empirically-grounded Model-Based Open-Ended Search](#link52)
