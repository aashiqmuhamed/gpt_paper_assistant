# Personalized Daily Arxiv Papers 07/21/2026
...
0. [Uncovering Latent Reasoning Strategies in Language Models](#link0)
**Authors:** Awni Altabaa, John Lafferty

1. [FlowBlock: Wavefront-Parallel Decoding for Self-Correcting Diffusion Language Models](#link1)
**Authors:** Bing Tian, Haikun Liu, Xiaocheng Zhong, Zhuohui Duan, Zhaokai Luo, Huayi Jin, Zhiyong Wang, Xiaofei Liao

2. [Though Language Models Err While They Strive: Conformal Prediction for Self-Correcting Scientific Generation](#link2)
**Authors:** Mingqiao Mo, Yunlong Tan, Hao Zhang

3. [Enhancing Rubric-based RL via Self-Distillation](#link3)
...
4. [LLM-as-a-Coach: Experiential Learning for Non-Verifiable Tasks](#link4)
**Authors:** Tianzhu Ye, Li Dong, Guanheng Chen, He Zhu, Xun Wu, Shaohan Huang, Furu Wei

5. [Normalized Rewards for Preference Optimization](#link5)
**Authors:** Shawn Im, Federico Danieli, Skyler Seto, Barry-John Theobald, Katherine Metcalf

6. [Group Entropy-Controlled Policy Optimization](#link6)
**Authors:** Guangran Cheng, Chengqi Lyu, Songyang Gao, Wenwei Zhang, Kai Chen

7. [How Does Alignment Tuning Shape Representations of Sycophancy and Related Cue-Induced Biases in LLMs?](#link7)
**Authors:** Prakhar Gupta, Terry Jingchen Zhang, Florent Draye, Bernhard Sch\"olkopf, Zhijing Jin

8. [Distilled Reinforcement Learning for LLM Post-training](#link8)
**Authors:** Chen Wang, Zhaochun Li, Jionghao Bai, Yining Zhang, Hexuan Deng, Ge Lan, Yue Wang

9. [Trace-Based On-Policy Distillation for Masked Diffusion Language Models](#link9)
**Authors:** Haolin Ren, Ziyang Huang, Chenhao Yuan, Jun Zhao, Kang Liu

10. [PoLoRA: A Preconditioned Orthogonalized LoRA Optimizer](#link10)
**Authors:** Nikhil Ghosh, Tetiana Parshakova, Robert M. Gower

11. [Learning from Synthetic Data without Model Collapse in Iterative Instruction Tuning](#link11)
**Authors:** Xiaonan Luo, Yue Huang, Kehan Guo, Ping He, Chuan Zou, Ting Hua, Xiangliang Zhang

12. [A Dual-Hypothesis Reasoning Framework for LLM Guardrails](#link12)
**Authors:** Md Asiful Islam, Mihai Surdeanu

13. [Beyond Semantic Equivalence: Logical Graphs for LLM Uncertainty Quantification](#link13)
**Authors:** Yanni Dong, Minghua Liu, Meiling Zhu, Xiaowei Huang, Lijun Zhang

14. [What does a Bayes-filtered transformer believe? A predictive Monte Carlo approach](#link14)
**Authors:** Afiq Abdillah Effiezal Aswadi, Haotong Ma, Susan Wei

15. [PPO-HSC: An Exploratory Reinforcement Learning Framework Based on Wide-Area Policy Coverage Optimization](#link15)
**Authors:** Yujie Shen, Haowen Chen

16. [ST-Veto: Spatio-Temporal Token Veto for Diffusion MLLMs via Taylor Prediction and Visual Grounding](#link16)
**Authors:** Keuntae Kim, Beomseok Lee, Hyunwoo Kim, Yong Suk Choi

17. [TRACE: Trajectory-Based Safety Patch Learning for LLM Post-Training Realignment](#link17)
**Authors:** Changyue Li, Jiaming He, Youliang Yuan, Jialin Wu, Boxi Yu, Zhicong Huang, Pinjia He

18. [CADENCE: Closing the Reasoning Gap via Coverage-Adaptive On-Policy Distillation](#link18)
**Authors:** Satyam Kumar, Saurabh Jha

19. [TopoTuner: Topological Finetuning of Large Language Models](#link19)
**Authors:** Abdulkadir Erol, Yash Mahajan, Vepaul Hariprashad, Baha Rababah, Santu Karmaker, Cuneyt G. Akcora, Mubarak Shah

20. [RIMS: Preference Optimization via Smoothed Multi-pair Aggregation for Small-Scale LLM Retrieval-Augmented Generation](#link20)
**Authors:** Pei Tian, Zihan Dong, Tianci Liu, Linjun Zhang, Haoyu Wang

21. [Verify, Repair, Repeat, or Stop? Robust Stopping for Noisy Verify-Repair Loops in LLM Agents](#link21)
**Authors:** Yitao Wu, Si Shen, Rui Yang, Hong Peng, Bin Hu

22. [Is Your Model Thinking or Just Stagnating? PUMA: Diagnosing Reasoning Pathology via Phase-Momentum Alignment](#link22)
**Authors:** Cheng Yan, Guangyang Ye, Wuyang Zhang, Fan Xu, Zhijun Fan, Xiang Xia, Yanyong Zhang

23. [Beyond Memory Leaderboards: Evaluating Scientific Memory as Budgeted Context Restoration](#link23)
**Authors:** Maksim Sheverev, David Finkelstein, Sergey Nikolenko

24. [Can We Break LLMs Out of Self-Loops? Fine-Grained Reasoning Control with Activation Steering](#link24)
**Authors:** Sheldon Yu, Tong Yu, Xunyi Jiang, Rohan Surana, Gagan Mundada, Sungchul Kim, Lina Yao, Julian McAuley, Junda Wu

25. [From Outcomes to Actions: Leveraging Hindsight for Long-Horizon Language Agent Training](#link25)
...
26. [Theoretical Foundations of $\max$@$k$ Reinforcement Learning](#link26)
**Authors:** Riccardo Poiani, Martino Bernasconi, Andrea Celli

27. [RAIL Guard: Closing the Evaluation-to-Remediation Gap in Responsible AI for LLM Agents](#link27)
**Authors:** Sumit Verma, Pritam Prasun, Pritish Kumar

28. [Zero Hallucination, by Construction: Hallucination-Aware Layered Oversight for Trustworthy Enterprise AI](#link28)
**Authors:** Bogdan Raduta, Horia Velicu, Alexandru Preda, Serban Chiricescu

29. [BACON: Budgeted Human Calibration for Modeling and Evaluation with Multiple AI Judges](#link29)
**Authors:** Lei Shi, Anlan Zhang, Rita Lyu, Zhengmian Hu, Tong Yu, David Arbour, Avi Feller, Saayan Mitra, Ritwik Sinha

30. [OR Else: A Differentiable Trust Region for Policy Optimization](#link30)
**Authors:** Chinmay Rane, Kanishka Tyagi, Michael Manry

31. [Stress Testing Concept Erasure with Large Language Model Agents](#link31)
**Authors:** Yuyang Xue, Feng Chen, Zhihua Liu, Edward Moroshko, Jingyu Sun, Steven McDonagh, Sotirios A. Tsaftaris

32. [LLM Unlearning for Cyber Defense: A Survey on Methods, Challenges, and Emerging Threats](#link32)
**Authors:** Ruppikha Sree Shankar, Abhishek Bhardwaj, Arnav Doshi, Anusri Nagarajan, Troy Paulus Asia, Saptarshi Sengupta

33. [Why Does Feedback-Augmented Self-Distillation Fail to Improve Retrieval-Interleaved Search Agents?](#link33)
**Authors:** Fan Yang, Rui Meng, Yuxin Wen

34. [Planning with Transformers: Chain of Computation and Structured Context Windows](#link34)
**Authors:** Ehsan Futuhi, Nathan R. Sturtevant

35. [Automated Discovery Has No Universally Superior Harness](#link35)
**Authors:** Akshat Gupta, Jermaine Lei, Alexander Lu, Gopala Anumanchipalli, Leshem Choshen

36. [FIFA World Cup 2026 as a Contamination-Free Benchmark for LLM Forecasting Agents: Four Models, a Bookmaker, and 104 Matches](#link36)
**Authors:** Jiacheng Ding, Cong Guo, Jason Xu

37. [Mechanistic Attention Guidance for Agent Memory Refinement](#link37)
**Authors:** Yechao Hong, Haiquan Qiu, Yaqing Wang, Quanming Yao

38. [Auditing Question-Order Effects in Large Language Models with the QQ Equality: Mechanism Characterization and a Saturation Caveat](#link38)
**Authors:** Pilsung Kang

39. [SOS-LoRA: Static Orthogonal-Subspace Low-Rank Adaptation with Fixed Multi-Scale Scaling](#link39)
**Authors:** Yupeng Chang, Yuan Wu, Yi Chang

40. [Persistent Sparse Autoencoders: Learning Feature Timescales in Language Models](#link40)
**Authors:** Haoyan Luo, Mateo Espinosa Zarlenga, Mateja Jamnik

41. [Scaling Limits of Constant-Stepsize SGD at Flat Minima](#link41)
**Authors:** Jingyi Zhang, Cheng Mao, Debankur Mukherjee

42. [Let the Data Decide: Supervision Analysis, Capability Trade-offs, and Adaptive Objective Routing in Continued Pre-Training via Off-Policy Distillation](#link42)
**Authors:** Jiangan Yuan, Zhixuan Li, Han Xu

43. [It's Not What You Say, It's How You Say It: Evaluating LLM Responses to Expressions of Belief](#link43)
**Authors:** Kevin Du, Clara K\"umpel, Michelle Wastl, Alex Warstadt

44. [AGG: Jacobian-Aggregated Group Gradient for Efficient GRPO Training of Diffusion Models](#link44)
**Authors:** Ruiyi Ding, Jie Li, He Kang, Ziyan Liu, Chengru Song, Yuan chen

45. [Token-Level Off-Policy Learning for Faithful Generation Under Distribution Shift](#link45)
**Authors:** Zitong Huang, Gustavo Lucas Carvalho, Deqing Fu, Robin Jia

46. [Training Continuous Chain of Thought Models: A Tale of Two Regimes](#link46)
**Authors:** Varun Yerram, He He, Eunsol Choi

47. [Reward-Driven LLM Agent Workflows: Synthesizing POMDP Routing and Self-Correction for Autonomous Decision-Making](#link47)
**Authors:** Amez Amanj Ali, Kuo-Kun Tseng

48. [It Takes 8 Tokens: Weak-to-Strong Off-Policy RL via Auxiliary Branches](#link48)
**Authors:** Dayu Wang, Jiaye Yang, Weikang Li, Jiahui Liang, Liwei Qian, Xin Pei, Jizhou Huang

49. [Can Transformers Really Do It All? On the Compatibility of Inductive Biases Across Tasks](#link49)
**Authors:** Damien Teney, Liangze Jiang, Hemanth Saratchandran, Simon Lucey

50. [Counterfactual Shapley Credit Assignment](#link50)
**Authors:** Mingxuan Li, Kaizhan-Lee, Elias Bareinboim

51. [Distributional Soft Bellman Operator under the Cram\'er Geometry](#link51)
**Authors:** Keru Wang, Yixin Deng, Yao Lyu, Stephen Redmond, Shengbo Eben Li

52. [Shapley Context Pruning: A Cooperative Game Perspective for Context Reranking and Pruning](#link52)
**Authors:** Yanqiao Chen, Dongsheng Hou, Yuhan Rui, Zhen Cao, Yepang Liu

53. [MADA-RL: Multi-Agent Debate-Aware Reinforcement Learning for Parameter-Efficient Reasoning in Compact Models](#link53)
**Authors:** Martino M. L. Pulici, Cuong Xuan Chu, Evgeny Kharlamov, Zifeng Ding, Volker Tresp, Yunpu Ma

54. [Learning from World Feedback: Why Model Uncertainty Fails as a Risk Signal in Model-Based RL](#link54)
**Authors:** Zhaohui Wang

55. [Diversity-Oriented Fine-Tuning for Uncertainty-Based Hallucination Detection](#link55)
**Authors:** Qiuyuan Li, Hongliang Dai, Piji Li

56. [From Memory to Skills: Evidence-Grounded Co-Evolution Governance for Long-Horizon LLM Agents](#link56)
...
57. [Explaining and Tuning Transformer-based LLMs in Arithmetic Tasks with Human Strategies](#link57)
**Authors:** Luyu Qiu, Jianing Li, Hwanhee Kim, Xiaoyong Wei, Yueyuan Zheng, Janet Hsiao, Lei Chen

58. [CoCurve: Cross-Module Co-Pruning Curvature for Training-Free Structured LLM Pruning](#link58)
**Authors:** Zhiren Gong, Zihao Zeng, Zijie Wang, Tiantong Wang, Chau Yuen, Wei Yang Bryan Lim

59. [Three-Body Scattering for Generative Modeling](#link59)
**Authors:** Peng Sun, Zhenglin Cheng, Deyuan Liu, Jun Xie, Xinyi Shang, Tao Lin

60. [Multi-level context Modeling for consistent expert selection in Mixture-of-Experts](#link60)
**Authors:** Shuhan Huang, Naifan Zhang, Yuanbo Tang, Yang Li, Wai Kin Victor Chan

61. [Rethinking Heterogeneous LLM Merging: A Weighted Model Averaging Perspective](#link61)
**Authors:** Jiahe Fan, Yinghao Hou, Si Chen, Aiyuan Zhang, Hong Xie, Defu Lian

62. [Generalised Bellman recurrence and three dualities in sequential decision-making](#link62)
**Authors:** Fernando E. Rosas, David Hyland, Daniel Polani

63. [Diagnosing Correctness Probes under Self-Judgement Confounding](#link63)
**Authors:** Yi-Long Lu

64. [Kernelized Linear Attention: Breaking the Capacity Wall with Symmetric Cones](#link64)
**Authors:** Ayoub Ghriss, Sourav Chakraborty

65. [More Than Memory: Task-Conditioned Signed FFN Writes in Long-Context Retrieval](#link65)
**Authors:** Zhibo Yang

66. [First-Order Predictable but Pairwise Fragile: Local Task Adaptation in Trained Transformers](#link66)
**Authors:** Irina Piontkovskaia, Sergey Nikolenko

67. [PPL-Factory: Task-Aware and Budget-Aware Data Selection from Language Modeling to Reasoning](#link67)
**Authors:** Hang Zhang, Warren J. Gross

68. [DiFA: Inference-Time Forward-Process Alignment for Diffusion Models](#link68)
**Authors:** Shigui Li, Delu Zeng

69. [LenGuard-GPC: Length Guarding with Guided-Prompt Consistency for Spatial Reasoning Reinforce Learning](#link69)
**Authors:** Xingjian Tao, Yiwei Wang, Yujun Cai, Jing Tang

70. [Learning Spatio-Temporal Foundation Models from Pure Synthetic Data](#link70)
**Authors:** Yutong Feng, Shiyuan Piao, Yutong Xia, Xu Liu, Wenqi Fan, Fugee Tsung, See-Kiong Ng, Yuxuan Liang

71. [Interactive Task Alignment as a POMDP](#link71)
**Authors:** Andy Dai, Zexue He, Zhenyu Zhang, Alex Pentland, Jiaxin Pei

72. [The Art of Not Forgetting](#link72)
**Authors:** Ashmith Atmuri, Akshay Kumar, Yashaswini Rao Bhogarajula

73. [A Survey on the Verification of Reinforcement Learning Policies](#link73)
**Authors:** Luca Marzari, Ezio Bartocci, Enrico Marchesini

74. [C$^2$KV: Compressed and Composable KV Cache Reuse for Efficient LLM Inference](#link74)
**Authors:** Chuheng Du, Junyi Chen, Hanlin Tang, Kan Liu, Tao Lan, Lin Qu, Chaoyue Niu, Shengzhong Liu, Guihai Chen, Fan Wu

75. [SGN: A Similarity-based Generative Network for Data Generation under Distribution Shift](#link75)
**Authors:** Jiaqi Zhu, Xincheng Chen, Yuncheng Wu, Zhaojing Luo, Beng Chin Ooi

76. [AgentBrew: Lifelong Knowledge Brewing from Strong Teachers to Weak LLM Agents](#link76)
**Authors:** Yangqin Jiang, Chao Huang

77. [Retain or Consolidate? Budget-Dependent Operator Selection for Language Agent Memory](#link77)
**Authors:** Qingcan Kang, Mingyang Liu, Shixiong Kai, Kaichao Liang, Zhentao Tang, Yuqi Cui, Tao Zhong, Mingxuan Yuan

78. [SelectInfer: Selective Neuron Loading and Computation for On-Device LLMs](#link78)
**Authors:** Huzaifa Shaaban Kabakibo, Eric Schniedermeyer, Artem Burchanow, Lin Wang

79. [Accurate and Efficient Long-Term Memory for LLM Agents](#link79)
**Authors:** Zicheng Zhao, Xinyang Guo, Luyao Lv, Menghan Wang, Ming Li, Shuaicheng Li

80. [MXSens: Sensitivity-Aware Mixed-Precision Quantization for Efficient LLM Inference](#link80)
