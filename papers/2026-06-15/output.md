...
0. [Natively Unlearnable Large Language Models](#link0)
**Authors:** Gaurav R. Ghosal, Pratyush Maini, Aditi Raghunathan

1. [Efficient On-Device Diffusion LLM Inference with Mobile NPU](#link1)
**Authors:** Tuowei Wang, Yanfan Sun, Ju Ren

2. [Diffusion Policy Optimization without Drifting Apart](#link2)
**Authors:** Haozhe Jiang, Haiwen Feng, Pieter Abbeel, Jiantao Jiao, Angjoo Kanazawa, Nika Haghtalab

3. [From Chatbot to Digital Colleague: The Paradigm Shift Toward Persistent Autonomous AI](#link3)
...
4. [Retrospective Progress-Aware Self-Refinement for LLM Agent Training](#link4)
...
5. [A Low-Rank Subspace Analysis of LLM Interventions](#link5)
**Authors:** Angira Sharma, Christian Schroeder de Witt, Philip Torr, Anisoara Calinescu, Jialin Yu

6. [A theoretical model for task routing in mixture-of-expert transformers](#link6)
**Authors:** Yongli Xiang, Vinoth Nandakumar, Yunzhi Yao, Peike Li, Tongliang Liu

7. [GitOfThoughts: Version-Controlled Reasoning and Agent Memory You Can Replay, Diff, and Merge](#link7)
**Authors:** Pavan C Shekar, Abhishek H S, Aswanth Krishnan

8. [Rethinking Backdoor Adversarial Unlearning through the Lens of Catastrophic Forgetting in Continual Learning](#link8)
**Authors:** Zhenqian Zhu, Yamin Hu, Yujiang Liu, Luping Wei, Wenbo Hou, Bin Li, Haodong Li, Wenjian Luo

9. [Every Eval Ever: A Unifying Schema and Community Repository for AI Evaluation Results](#link9)
**Authors:** Jan Batzner, Sree Harsha Nelaturu, Anastassia Kornilova, Jon Crall, Tommaso Cerruti, Yanan Long, Yifan Mai, Sanchit Ahuja, Asaf Yehudai, Marek \v{S}uppa, John P. Lalor, Oluwagbemike Olowe, Jatin Ganhotra, Brian H. Hu, Eliya Habba, Andrew M. Bean, Chang Liu, Sander Land, Steven Dillmann, Aniketh Garikaparthi, Elron Bandel, Saki Imai, James Edgell, Wm. Matthew Kennedy, Jenny Chim, Patrick Meusling, Asteria Kaeberlein, Venkata Ramachandra Karthik Chundi, Manasi Patwardhan, Martin Ku, Austin Meek, Leon Knauer, Brian Wingenroth, Srishti Yadav, Usman Gohar, Felix Friedrich, Michelle Lin, Jennifer Mickel, Arman Cohan, Stella Biderman, Irene Solaiman, Zeerak Talat, Anka Reuel, Mubashara Akhtar, Gjergji Kasneci, Avijit Ghosh, Leshem Choshen

10. [Can Editing 1 Neuron Fix Repetition Loops in LLMs?](#link10)
**Authors:** Aristotelis Lazaridis, Aman Sharma, Dylan Bates, Brian King, Vincent Lu, Jack FitzGerald

11. [SuperThoughts: Reasoning Tokens in Superposition](#link11)
**Authors:** Zheyang Xiong, Shivam Garg, Max Yu, Vaishnavi Shrivastava, Haoyu Zhao, Anastasios Kyrillidis, Dimitris Papailiopoulos

12. [Capability Minimization as a Safety Primitive: Risk-Aware Causal Gating for Least-Privilege LLM Agents](#link12)
**Authors:** Laxmipriya Ganesh Iyer, Rahul Suresh Babu

13. [Implicit Reasoning for Large Language Model-based Generative Recommendation](#link13)
**Authors:** Yinhan He, Liam Collins, Bhuvesh Kumar, Jundong Li, Neil Shah, Donald Loveland

14. [Be My Tutor: On-Policy Co-Distillation for Mutual LLM Improvement via Peer Feedback](#link14)
**Authors:** Woohyeon Byeon, Jiwon Jeon, Jeonghye Kim, Youngchul Sung

15. [Behavioral Audit of Machine Unlearning Has a Privacy Cost](#link15)
**Authors:** Liou Tang, James Joshi, Ashish Kundu

16. [Right or Wrong, Models Comply: Directional Blindness in LLM Moral Judgment](#link16)
**Authors:** Jihye Kim, Jeffrey Flanigan

17. [AdaSR: Adaptive Streaming Reasoning with Hierarchical Relative Policy Optimization](#link17)
**Authors:** Junlong Tong, Wenqi Xu, Yingqi Fan, Anhao Zhao, Xuan Lu, Yang Tan, Xiaoyu Shen

18. [The Culture Funnel: You Can't Align What isn't in the Data](#link18)
**Authors:** Ananya Sahu, Mehrnaz Mofakhami, Daniel D'Souza, Thomas Euyang, Julia Kreutzer, Marzieh Fadaee

19. [CacheRL:Multi-Turn Tool-Calling Agents via Cached Rollouts and Hybrid Reward](#link19)
**Authors:** Md Amirul Islam, Sumiran Thakur, Huancheng Chen, Su Min Park, Jiayun Wang, Gyuhak Kim

20. [Decoupled Mixture-of-Experts for Parametric Knowledge Injection](#link20)
**Authors:** Baoqing Yue, Weihang Su, Qingyao Ai, Yichen Tang, Changyue Wang, Jiacheng Kang, Jingtao Zhan, Yiqun Liu

21. [Towards Direct Latent-Space Synthesis for Parallel Branches in LLM-Agent Workflows](#link21)
**Authors:** Shikun Liu, Mufei Li, Dongqi Fu, Haoyu Wang, Yinglong Xia, Hong Li, Hong Yan, Pan Li

22. [LLMs Contain Multitudes: How Deployment Context Reshapes Model-Level Preferences and Values](#link22)
**Authors:** Filip Trhlik, Aoife O'Flynn, Angela Yu, Arduin Findeis, Paula Buttery

23. [Adversarial Concept Search: Predicting Compositional Errors From Feature Geometry](#link23)
**Authors:** Jennifer Meng Lu, Ruochen Zhang, Isabelle Lee, David Alvarez-Melis, Ellie Pavlick, Naomi Saphra

24. [BayLing-Duplex: Native Full-Duplex Speech Dialogue with a Single Autoregressive LLM](#link24)
**Authors:** Qingkai Fang, Shoutao Guo, Yang Feng

25. [When Language Representations Interact: Separability and Cross-Lingual Effects in LLMs](#link25)
**Authors:** Boris Marinov, Angira Sharma, Christian Schroeder de Witt, Philip Torr, Anisoara Calinescu, Jialin Yu

26. [HarnessX: A Composable, Adaptive, and Evolvable Agent Harness Foundry](#link26)
...
27. [Graph-based Target Back-Propagation for Context Adaptation in Multi-LLM Agentic Systems](#link27)
**Authors:** Tan Zhu, Tong Yao, Kananart Kuwaranancharoen, Amit Singh, Yushang Lai, Deepa Mohan, Shankara Bhargava

28. [CARE: Controlling LLM-Generated Policies through Auditable Review of Evidence in Scientific Experimentation](#link28)
**Authors:** Guanyu Liu, Weiyi Kong, Zeyu Wang, Boer Zhang, Baiqing Li, Peiyu Zhang, Tianyu Shi

29. [Orchestra-o1: Omnimodal Agent Orchestration](#link29)
...
30. [Running the Gauntlet: Re-evaluating the Capabilities of Agents Beyond Familiar Environments](#link30)
...
31. [Hybrid Open-Ended Tri-Evolution Makes Better Deep Researcher](#link31)
**Authors:** Hongming Piao, Chi Liu, Mengzhuo Chen, Yan Shu, Derek Li, Ying Wei, Bryan Dai

32. [Beyond a Single Explanation of the Adam--SGD Gap](#link32)
**Authors:** Chenxiang Zhang, Rustem Islamov, Enea Monzio Compagnoni, Jun Pang, Aurelien Lucchi, Antonio Orvieto

33. [Uncertainty Estimation and Generalization Bounds for Modern Deep Learning](#link33)
**Authors:** Luis A. Ortega

34. [Small LLMs: Pruning vs. Training from Scratch](#link34)
**Authors:** Yufeng Xu, Taiming Lu, Kunjun Li, Jiachen Zhu, Mingjie Sun, Zhuang Liu

35. [SIMMER: Benchmarking Latent Failures in LLM Executable Planning with a World Model](#link35)
**Authors:** Xiaoxin Lu, Ranran Haoran Zhang, Rui Zhang

36. [Gefen: Optimized Stochastic Optimizer](#link36)
**Authors:** Nadav Benedek, Tomer Koren, Ohad Fried

37. [EM-NeSy: Expectation Maximization for Neurosymbolic Learning](#link37)
**Authors:** Annegret Seibt, Luc De Raedt, Giuseppe Marra

38. [When Sample Selection Bias Precipitates Model Collapse](#link38)
**Authors:** Xinbao Qiao, Xianglong Du, Wei Liu, Jingqi Zhang, Peihua Mai, Meng Zhang, Yan Pang

39. [Communication Policy Evolution for Proactive LLM Agents](#link39)
...
40. [Beyond Perplexity: UTF-8 Validity in Byte-aware Language Models](#link40)
**Authors:** Sangwhan Moon, Daisuke Oba, Youmi Ma, Tatsuya Hiraoka, Naoaki Okazaki

41. [Persona-Pruner: Sculpting Lightweight Models for Role-Playing](#link41)
**Authors:** Jinsu Kim, Jihoon Tack, Noah Lee, Jongheon Jeong

42. [StreamMemBench: Streaming Evaluation of Agent Memory for Future-Oriented Assistance](#link42)
**Authors:** Guanming Liu, Yuqi Ren, Hansu Gu, Peng Zhang, Weihang Wang, Jiahao Liu, Ning Gu, Tun Lu

43. [Harsher on Male? Evaluating LLMs on Gender-Asymmetric Moral Framing Across Diverse Conflict Scenarios](#link43)
**Authors:** Guangzong Si, Dong Wang, Zhenhao Li, Yifan Yu, Panwang Pan, Wentao Zhu

44. [DLawBench: Evaluating LLMs Through Multi-Turn Legal Consultation](#link44)
