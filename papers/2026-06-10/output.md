...
0. [Advancing the State-of-the-Art in Empirical Privacy Auditing](#link0)
**Authors:** Nicole Mitchell, Galen Andrew, Arun Ganesh, Brendan McMahan, Peter Kairouz

1. [A Unifying Lens on Supervised Fine-Tuning Through Target Distribution Design](#link1)
**Authors:** Tong Xie, Yuanhao Ban, Yunqi Hong, Sohyun An, Yihang Chen, Cho-Jui Hsieh

2. [How Does Reasoning Flow? Tracing Attention-Induced Information Flow for Targeted RL in LLMs](#link2)
...
3. [Beyond Uniform Token-Level Trust Region in LLM Reinforcement Learning](#link3)
**Authors:** Renjie Mao, Xiangxin Zhou, Lvfang Tao, Yixin Ding, Yu Shi, Yongguang Lin, Yuheng Wu, Honglin Zhu, Qian Qiu, Wenxi Zhu

4. [Mechanistic Analysis of Alignment Algorithms in Language Models](#link4)
**Authors:** Aarush Sinha, Ishan Garg, Veeraraju Elluru, Arth Singh, Kushal Garg

5. [Alignment Defends LLMs from Property Inference Attacks](#link5)
**Authors:** Pengrun Huang, Chhavi Yadav, Ruihan Wu, Kamalika Chaudhuri

6. [Null-Space Constrained Low-Rank Adaptation for Response-Specified Large Language Model Unlearning](#link6)
**Authors:** Bocheng Ju, Jianhua Wang, Chengliang Liu, Xiaolin Chang

7. [Attention-Discounted Adaptive Sampler for Masked Diffusion Language Models](#link7)
**Authors:** Yusuf Sahin, Ahmed Rockey Saikia, Volkan Cevher, Paolo Favaro

8. [Routing-Aware Expert Calibration for Machine Unlearning in Mixture-of-Experts Language Models](#link8)
**Authors:** Jingyi Xie, Yijun Lin, Yinjiang Xiong, Zhikun Zhang, Sai Li

9. [When RL Fails after SFT: Rejuvenating Model Plasticity for Robust SFT-to-RL Handoff](#link9)
**Authors:** Runze Liu, Jiashun Liu, Xu Wan, Yuqian Fu, Ling Pan

10. [Prefilling-dLLM: Predictive Prefilling for Long-Context Inference in Diffusion Language Models](#link10)
**Authors:** Jing Xiong, Qi Han, Shansan Gong, Yunta Hsieh, Chengyue Wu, Chaofan Tao, Chenyang Zhao, Ngai Wong

11. [MIRAGE: A Polarity-Flipping Encoding Subspace in LLM Agents](#link11)
**Authors:** Pratibha Revankar, Kargi Chauhan, Jihye Kim, Sadiba Nusrat Nur, Vincent Siu, Chenguang Wang

12. [RealMath-Eval: Why SOTA Judges Struggle with Real Human Reasoning](#link12)
**Authors:** Yiteng Mao, Kenan Xu, Yijia Lyu, Wenhao Li, Jianlong Chen, Xiangfeng Wang

13. [K-Forcing: Joint Next-K-Token Decoding via Push-Forward Language Modeling](#link13)
**Authors:** Zhiwei Tang, Yuanyu He, Yizheng Han, Wangbo Zhao, Jiasheng Tang, Fan Wang, Bohan Zhuang

14. [It Takes One to Bias Them All: Breaking Bad with One-Shot GRPO](#link14)
**Authors:** Naihao Deng, Yilun Zhu, Naichen Shi, Clayton Scott, Rada Mihalcea

15. [Reasoning or Memorization? Direction-Aware Diversity Exploration in LLM Reinforcement Learning](#link15)
**Authors:** Jiangnan Xia, Yucheng Shi, Yu Yang, Kishan Panaganti, Zhenwen Liang, Ninghao Liu

16. [Interactions Between Crosscoder Features: A Compact Proofs Perspective](#link16)
**Authors:** Dmitry Manning-Coe, Thomas Read, Anna Soligo, Oliver Clive-Griffin, Chun-Hei Yip, Rajashree Agrawal, Jason Gross

17. [PhantomBench: Benchmarking the Non-existential Threat of Language Models](#link17)
**Authors:** Haeji Jung, Hila Gonen

18. [Integrating Local and Global Entropy for Uncertainty Quantification in LLMs](#link18)
**Authors:** Johanne Medina, Tianyi Zhou, Keivin Isufaj, Aristides Gionis, Sanjay Chawla

19. [Deployment-Time Memorization in Foundation-Model Agents](#link19)
...
20. [Flow-DPPO: Divergence Proximal Policy Optimization for Flow Matching Models](#link20)
**Authors:** Bowen Ping, Xiangxin Zhou, Penghui Qi, Minnan Luo, Liefeng Bo, Tianyu Pang

21. [Does Reasoning Preserve Alignment? On the Trustworthiness of Large Reasoning Models](#link21)
...
22. [READER: Robust Evidence-based Authorship Decoding via Extracted Representations](#link22)
**Authors:** Jiaxu Liu, Sunnan Mu, Dong Huang, Liuyin Wang, Jing Shao, Jie Zhang

23. [From Observation to Intervention: A Causal Audit of Expert Importance in Mixture-of-Experts Models](#link23)
**Authors:** Leonard Engmann, Christian Medeiros Adriano, Holger Giese

24. [Are We Evaluating Knowledge or Phrasing? Mitigating MCQA Sensitivity with ParaEval](#link24)
**Authors:** Jo\~ao Maria Janeiro, Mathurin Videau, Andrea Caciolai, Benjamin Piwowarski, Patrick Gallinari, Loic Barrault

25. [HIPIF: Hierarchical Planning and Information Folding for Long-Horizon LLM Agent Learning](#link25)
...
26. [A Continuous-Time Markov Chain Framework for Insertion Language Models](#link26)
**Authors:** Dhruvesh Patel, Benjamin Rozonoyer, Soumitra Das, Tahira Naseem, Tim G. J. Rudner, Andrew McCallum

27. [Fast and Highly Expressive Policy Learning for Offline Reinforcement Learning via Bootstrapped Flow Q-Learning](#link27)
**Authors:** Thanh Nguyen, Tri Ton, Hongbin Choe, Tung M. Luu, Chang D. Yoo

28. [SPACE: Source-free Proxy Anchor Concept Erasure for MLLMs](#link28)
**Authors:** Zhijing Zhang, Jiaqi Ding, Qianshan Wei, Nan Zhou, Jiaqi Li, Yongliang Wu, Tongxin Zhu, Xiaolin Fang

29. [Attention Amnesia in Hybrid LLMs: When CoT Fine-Tuning Breaks Long-Range Recall, and How to Fix It](#link29)
**Authors:** Xinyu Zhou, Boyu Zhu, Yi Xu, Zhiwei Li, Yingfa Chen, Huiming Wang, Zhijiang Guo

30. [The Confident Liar: Diagnosing Multi-Agent Debate with Log-Probabilities and LLM-as-Judge](#link30)
**Authors:** Ali Keramati, Justin Cheok, Jacob Horne, Mark Warschauer

31. [SocraticPO: Policy Optimization via Interactive Guidance](#link31)
...
32. [3SPO: State-Score-Supervised Policy Optimization for LLM Agents](#link32)
**Authors:** Yu Han, Kailing Li, Yang Jiao, Yulin Dai, Yuqian Fu, Linhai Zhuo, Tianwen Qian

33. [PreAct-Bench: Benchmarking Predictive Monitoring in LLMs](#link33)
...
34. [What Fits (Into Few Tokens) Doesn't Overfit: Compression and Generalization in ML Research Agents](#link34)
**Authors:** Martin Andres Bertran, Aaron Roth, Zhiwei Steven Wu

35. [Rotate2Think: Geometric Priming via Orthogonal Rotation to Improve Language Model Reasoning](#link35)
**Authors:** Aditya Sharma, Christopher J. Pal, Amal Zouaq

36. [TD-Grokking: Learning from Zero-Reward Problems by Training-Time Decomposition](#link36)
**Authors:** Ningyuan Xi, Hao Xu, Hongsheng Xin, Ning Miao

37. [CIAware-Bench: Benchmarking Control Intervention Awareness Across Frontier LLMs](#link37)
...
38. [The Arbiter Agent: Continually Monitoring Multi-Agent Conversations to Detect Emergent Misalignment](#link38)
**Authors:** Filippo Tonini, Federico Torrielli, Anton Danholt Lautrup, Peter Schneider-Kamp, Mustafa Mert \c{C}elikok, Lukas Galke Poech

39. [EEVEE: Towards Test-time Prompt Learning in the Real World for Self-Improving Agents](#link39)
**Authors:** Weixian Xu, Shilong Liu, Mengdi Wang

40. [Exploring the Design Space of Reward Backpropagation for Flow Matching](#link40)
**Authors:** Ruoyu Wang, Boye Niu, Xiangxin Zhou, Yushi Huang, Tongliang Liu, Chi Zhang

41. [One Lens, Many Worlds : A Capability-Typed Interface for World-Model Interpretability](#link41)
...
42. [Sample Where You Struggle: Sharpening Base Model Reasoning via Entropy-Guided Power Sampling](#link42)
**Authors:** Hong Guo, Nianhui Guo, Christoph Meinel, Haojin Yang

43. [Using Probabilistic Programs to Train Inductive Reasoning in Large Language Models](#link43)
**Authors:** Liyi Zhang, Akshay K. Jagadish, Brenden M. Lake, Thomas L. Griffiths

44. [Janus: A Benchmark for Goal-Conditioned Information Distortion in LLMs](#link44)
**Authors:** Polydoros Giannouris, Mohsinul Kabir, Sophia Ananiadou

45. [Predicting Future Behaviors in Reasoning Models Enables Better Steering](#link45)
...
46. [Pushing the Limits of LLM Tool Calling via Experiential Knowledge Integration and Activation](#link46)
**Authors:** Yupu Hao, Zhuoran Jin, Huanxuan Liao, Kang Liu, Jun Zhao

47. [TRACE: A Unified Rollout Budget Allocation Framework for Efficient Agentic Reinforcement Learning](#link47)
...
48. [Baseline-Free Policy Optimization for Neural Combinatorial Optimization](#link48)
**Authors:** Carlos S. Sep\'ulveda, Gonzalo A. Ruz

49. [Recalling Too Well: Sycophancy Evaluation and Mitigation in Memory-Augmented Models](#link49)
**Authors:** Shelly Bensal, Axel Magnuson, Aparna Balagopalan, Daniel M. Bikel

50. [ReasonAlloc: Hierarchical Decoding-Time KV Cache Budget Allocation for Reasoning Models](#link50)
**Authors:** Wenhao Liu, Hao Shi, Yunhe Li, Weizhi Fei, Xiangyuan Wang, Mengzhe Ruan, Hanxu Hou, Peisong Wang, Linqi Song, Shuang Qiu

51. [Early-Token Confidence Predicts Reasoning Quality in Multi-Agent LLM Debate](#link51)
**Authors:** Ali Keramati, Justin Cheok, Jacob Horne, Mark Warschauer

52. [From Context-Aware to Conflict-Aware: Generalizing Contrastive Decoding for Knowledge Conflict in LLMs](#link52)
**Authors:** Runze Jiang, Taiqiang Wu, Yan Wang, Bingyu Zhu, Longtao Huang

53. [Role-Agent: Bootstrapping LLM Agents via Dual-Role Evolution](#link53)
**Authors:** Xucong Wang, Ziyu Ma, Shidong Yang, Tongwen Huang, Pengkun Wang, Yong Wang, Xiangxiang Chu

54. [Unifying Data, Memory, and Compute Efficiency in LLM training: A Survey](#link54)
**Authors:** Vanessa Schmidt, Huy Hoang Nguyen, C\'edric Jung, Shirin Salehi, Anke Schmeink

55. [When to Align, When to Predict: A Phase Diagram for Multimodal Learning](#link55)
**Authors:** Ilay Kamai, Hugues Van Assel, Aviv Regev, Hagai B. Perets, Randall Balestriero

56. [FOGO: Forgetting-aware Orthogonalization Optimizer](#link56)
**Authors:** Toan Nguyen, Yang Liu, Trung Le, Celso de Melo, Flora D. Salim

57. [Cross-Modal Knowledge Distillation without Paired Data: Theoretical Foundation and Algorithm](#link57)
**Authors:** Trong Khiem Tran, Anh Duc Chu, Quang Hung Pham, Phi Le Nguyen, Trong Nghia Hoang

58. [Which LoRA? An Empirical Study on the Effectiveness of LoRA Techniques During Multilingual Instruction Tuning](#link58)
**Authors:** Thamali Wijewardhana, Napoleon H. Reyes, Surangika Ranathunga

59. [A Theory on Flow Matching with Neural Networks](#link59)
**Authors:** Yihan He, Qishuo Yin, Yuan Cao, Jianqing Fan, Han Liu

60. [Beyond Static Evaluation: Co-Evolutionary Mechanisms for LLM-Driven Strategy Evolution in Adversarial Games](#link60)
...
61. [Convergence of Monte Carlo Optimistic Policy Iteration: Beyond Uniform State-Action Updates](#link61)
**Authors:** Octave Oliviers, Glenn Vinnicombe

62. [PADD: Path-Aligned Decompression Distillation for Non-Router Teacher to Guide MoE Student Learning](#link62)
**Authors:** Xinyue Peng, Yi Qian, Jiaojiao Lin, Wenjian Shao, Yanming Liu

63. [Benchmarking Knowledge Editing using Logical Rules](#link63)
**Authors:** Tatiana Moteu Ngoli, NDah Jean Kouagou, Hamada M. Zahera, Axel-Cyrille Ngonga Ngomo

64. [Rank Collapse, Fixed Points, and the Renormalization Group Structure of MLP Residual Networks](#link64)
**Authors:** Parviz Haggi-Mani, Irina Rish

65. [Recoverable but Not Stationary:Local Linear Structures in Weights and Activations](#link65)
**Authors:** Irina Piontkovskaia, Sergey Nikolenko

66. [Learning What to Remember: Observability-Safe Memory Retention via Constrained Optimization for Long-Horizon Language Agents](#link66)
**Authors:** Qingcan Kang, Liu Mingyang, Shixiong Kai, Kaichao Liang, Tao Zhong, Mingxuan Yuan

67. [ComBench: A Benchmark for Rigorous Proof Reasoning and Constructive Realization in Olympiad-Level Combinatorics](#link67)
...
68. [SHAPE: Coalition-Aware Expert Pruning for Sparse Mixture-of-Experts LLMs](#link68)
**Authors:** Yuhao Zhang

69. [Hasse Diagrams for Attention: A Partial Order Framework for Designing Transformer Masks](#link69)
**Authors:** Chentao Li, Han Guo

70. [SpenseGPT: Practical One-shot Pruning Enabling Sparse and Dense GEMMs for LLM Inference](#link70)
**Authors:** Jaeseong Lee, Seung-won Hwang, Samyam Rajbhandari

71. [Express Language Modeling](#link71)
**Authors:** Albert Gong, Annabelle Michael Carrell, Raaz Dwivedi, Lester Mackey

72. [Dynamic Linear Attention](#link72)
**Authors:** Xin Wang, Hui Shen, Boyuan Zheng, Xueshen Liu, Minkyoung Cho, Zhongwei Wan, Zesen Zhao, Zhuoqing Mao, Shen Yan, Mi Zhang

73. [Unifying Local Communications and Local Updates for LLM Pretraining](#link73)
**Authors:** Pietro Cagnasso, Eugene Belilovsky, Edouard Oyallon

74. [Time Series as Language: A Universal Tokenizer for General-Purpose Time Series Foundation Models](#link74)
**Authors:** Yunhao Zhang, Ruiying Qi, Jiale Zheng, Jianfeng Zhang, Lujia Pan, Junchi Yan

75. [Optimal Post-Training Quantization Scales and Where to Find Them](#link75)
**Authors:** Juan Amboage, Pablo Monteagudo-Lago, Ian Colbert, Giuseppe Franco, Nicholas Fraser

76. [From Senses to Decisions: The Information Flow of Auditory and Visual Perception in Multimodal LLMs](#link76)
**Authors:** Wish Suharitdamrong, Muhammad Awais, Xiatian Zhu, Sara Atito

77. [Mitigating Manifold Departure: Uncertainty-Aware Subspace Rectification for Trustworthy MLLM Decoding](#link77)
...
78. [N-GRPO: Embedding-Level Neighbor Mixing for Enhanced Policy Optimization](#link78)
**Authors:** Xukun Zhu, Hang Yu, Peng Di, Linchao Zhu

79. [Continual LLM Upcycling: A Predictor-Gated Bank-Wise Sparsity Training Recipe for Dense-to-Sparse LLMs](#link79)
**Authors:** Ruixuan Huang, Jinyuan Shi, Hantao Huang, Yifan Huang, Ziyi Guan, Hao Zeng, Ian En-Hsu Yen, Minghui Yu

80. [Divide and Cooperate: Role-Decomposed Multi-Agent LLM Training with Cross-Agent Learning Signals](#link80)
**Authors:** Jaewan Park, Solbee Cho, Jay-Yoon Lee

81. [ActiveMem: Distributed Active Memory for Long-Horizon LLM Reasoning](#link81)
**Authors:** Yunhan Jiang, Wenbin Duan, Shasha Guo, Liang Pang, Xiaoqian Sun, Huawei Shen

82. [TENP: Trapezoidal Expert Neuron Pruning For Mixture-of-Experts](#link82)
**Authors:** Jiangyang He, Shaolin Zhu, Deyi Xiong

83. [Less Context, Better Agents: Efficient Context Engineering for Long-Horizon Tool-Using LLM Agents](#link83)
**Authors:** Abhilasha Lodha, Mahsa Pahlavikhah Varnosfaderani, Abir Chakraborty, Abhinav Mithal

84. [Compositional Generative Modeling from Decentralized Data](#link84)
**Authors:** Mashrur M. Morshed, Vishnu Naresh Boddeti

85. [LC-QAT: Data-Efficient 2-Bit QAT for LLMs via Linear-Constrained Vector Quantization](#link85)
**Authors:** Haoyu Wang, Xingyu Yu, Haiyan Zhao, Fengxiang Wang, Xu Han

86. [Trace Only What You Need: Structure-Aware On-Demand Hypergraph Memory for Long-Document Question Answering](#link86)
**Authors:** Xiangjun Zai, Xingyu Tan, Chen Chen, Xiaoyang Wang, Wenjie Zhang

87. [TabClaw: An Interactive and Self-Evolving Agent for Spreadsheet Manipulation and Table Reasoning](#link87)
**Authors:** Mingyue Cheng, Shuo Yu, Daoyu Wang, Qingchuan Li, Xiaoyu Tao, Qingyang Mao, Yitong Zhou, Qi Liu

88. [VISTA: A Versatile Interactive User Simulation Toolkit for Agent Evaluation](#link88)
**Authors:** Yunan Lu, Ryan Shea, Yusen Zhang, Zhou Yu

89. [Infini Memory: Maintainable Topic Documents for Long-Term LLM Agent Memory](#link89)
...
90. [Where You Inject Diversity Matters: A Unified Framework for Diverse Generation](#link90)
**Authors:** Cheng Zhang, Rui Xin, Chudi Zhong

91. [T1-Bench: Benchmarking Multi-Scenario Agents in Real-World Domains](#link91)
...
92. [Small Data, Big Noise: Adversarial Training for Robust Parameter-Efficient Fine-Tuning](#link92)
**Authors:** Eitan Cohen, Idan Simai, Uri Shaham

93. [LakeQA: An Exploratory QA Benchmark over a Million-Scale Data Lake](#link93)
