...
0. [LLMs Gaming Verifiers: RLVR can Lead to Reward Hacking](#link0)
...
1. [Modeling LLM Unlearning as an Asymmetric Two-Task Learning Problem](#link1)
**Authors:** Zeguan Xiao, Siqing Li, Yong Wang, Xuetao Wei, Jian Yang, Yun Chen, Guanhua Chen

2. [Beyond Importance Sampling: Rejection-Gated Policy Optimization](#link2)
**Authors:** Ziwu Sun, Zhen Gao, Jiyong Zhang, Jiaheng Li

3. [Quantifying and Understanding Uncertainty in Large Reasoning Models](#link3)
**Authors:** Yangyi Li, Chenxu Zhao, Mengdi Huai

4. [Weight Patching: Toward Source-Level Mechanistic Localization in LLMs](#link4)
**Authors:** Chenghao Sun, Chengsheng Zhang, Guanzheng Qin, Rui Dai, Xinmei Tian

5. [Improving Sparse Autoencoder with Dynamic Attention](#link5)
**Authors:** Dongsheng Wang, Jinsen Zhang, Dawei Su, Hui Huang

6. [Reinforcement Learning via Value Gradient Flow](#link6)
**Authors:** Haoran Xu, Kaiwen Hu, Somayeh Sojoudi, Amy Zhang

7. [Reasoning Dynamics and the Limits of Monitoring Modality Reliance in Vision-Language Models](#link7)
**Authors:** Danae S\'anchez Villegas, Samuel Lewis-Lim, Nikolaos Aletras, Desmond Elliott

8. [Segment-Level Coherence for Robust Harmful Intent Probing in LLMs](#link8)
**Authors:** Xuanli He, Bilgehan Sel, Faizan Ali, Jenny Bao, Hoagy Cunningham, Jerry Wei

9. [Does RL Expand the Capability Boundary of LLM Agents? A PASS@(k,T) Analysis](#link9)
**Authors:** Zhiyuan Zhai, Wenjing Yan, Xiaodan Shao, Xin Wang

10. [Enhancing LLM-based Search Agents via Contribution Weighted Group Relative Policy Optimization](#link10)
**Authors:** Junzhe Wang, Zhiheng Xi, yajie yang, Hao Luo, Shihan Dou, Tao Gui, Qi Zhang

11. [Gating Enables Curvature: A Geometric Expressivity Gap in Attention](#link11)
**Authors:** Satwik Bathula, Anand A. Joshi

12. [How to Fine-Tune a Reasoning Model? A Teacher-Student Cooperation Framework to Synthesize Student-Consistent SFT Data](#link12)
**Authors:** Zixian Huang, Kaichen Yang, Xu Huang, Feiyang Hao, Qiming Ge, Bowen Li, He Du, Kai Chen, Qipeng Guo

13. [LongAct: Harnessing Intrinsic Activation Patterns for Long-Context Reinforcement Learning](#link13)
**Authors:** Bowen Ping, Zijun Chen, Tingfeng Hui, Qize Yu, Chenxuan Li, Junchi Yan, Baobao Chang

14. [CausalDetox: Causal Head Selection and Intervention for Language Model Detoxification](#link14)
**Authors:** Yian Wang, Yuen Chen, Agam Goyal, Hari Sundaram

15. [From Tokens to Steps: Verification-Aware Speculative Decoding for Efficient Multi-Step Reasoning](#link15)
**Authors:** Kiran Purohit, Ramasuri Narayanam, Soumyabrata Pal

16. [IUQ: Interrogative Uncertainty Quantification for Long-Form Large Language Model Generation](#link16)
**Authors:** Haozhi Fan, Jinhao Duan, Kaidi Xu

17. [Internal Knowledge Without External Expression: Probing the Generalization Boundary of a Classical Chinese Language Model](#link17)
**Authors:** Jiuting Chen, Yuan Lian, Hao Wu, Tianqi Huang, Hiroshi Sasaki, Makoto Kouno, Jongil Choi

18. [MixAtlas: Uncertainty-aware Data Mixture Optimization for Multimodal LLM Midtraining](#link18)
**Authors:** Bingbing Wen, Sirajul Salekin, Feiyang Kang, Bill Howe, Lucy Lu Wang, Javier Movellan, Manjot Bilkhu

19. [Faithfulness Serum: Mitigating the Faithfulness Gap in Textual Explanations of LLM Decisions via Attribution Guidance](#link19)
**Authors:** Bar Alon, Itamar Zimerman, Lior Wolf

20. [Numerical Instability and Chaos: Quantifying the Unpredictability of Large Language Models](#link20)
**Authors:** Chashi Mahiul Islam, Alan Villarreal, Mao Nishino, Shaeke Salman, Xiuwen Liu

21. [Calibrate-Then-Delegate: Safety Monitoring with Risk and Budget Guarantees via Model Cascades](#link21)
**Authors:** Edoardo Pona, Milad Kazemi, Mehran Hosseini, Yali Du, David Watson, Osvaldo Simeone, Nicola Paoletti

22. [ReSS: Learning Reasoning Models for Tabular Data Prediction via Symbolic Scaffold](#link22)
**Authors:** Chenlang Yi, Gang Li, Zizhan Xiong, Tue Minh Cao, Yanmin Gong, My T. Thai, Tianbao Yang

23. [Exploration and Exploitation Errors Are Measurable for Language Model Agents](#link23)
**Authors:** Jaden Park, Jungtaek Kim, Jongwon Jeong, Robert D. Nowak, Kangwook Lee, Yong Jae Lee

24. [Psychological Steering of Large Language Models](#link24)
**Authors:** Leonardo Blas, Robin Jia, Emilio Ferrara

25. [Awakening Dormant Experts:Counterfactual Routing to Mitigate MoE Hallucinations](#link25)
**Authors:** Wentao Hu, Yanbo Zhai, Xiaohui Hu, Mingkuan Zhao, Shanhong yu, Xue Liu, Kaidong Yu, Shuangyong Song, Xuelong Li

26. [IE as Cache: Information Extraction Enhanced Agentic Reasoning](#link26)
**Authors:** Hang Lv, Sheng Liang, Hongchao Gu, Wei Guo, Defu Lian, Yong Liu, Hao Wang, Enhong Chen

27. [PeerPrism: Peer Evaluation Expertise vs Review-writing AI](#link27)
**Authors:** Soroush Sadeghian, Alireza Daqiq, Radin Cheraghi, Sajad Ebrahimi, Negar Arabzadeh, Ebrahim Bagheri

28. [Shuffle the Context: RoPE-Perturbed Self-Distillation for Long-Context Adaptation](#link28)
**Authors:** Zichong Li, Chen Liang, Liliang Ren, Tuo Zhao, Yelong Shen, Weizhu Chen

29. [SPAGBias: Uncovering and Tracing Structured Spatial Gender Bias in Large Language Models](#link29)
**Authors:** Binxian Su, Haoye Lou, Shucheng Zhu, Weikang Wang, Ying Liu, Dong Yu, Pengyuan Liu

30. [Reward Design for Physical Reasoning in Vision-Language Models](#link30)
**Authors:** Derek Lilienthal, Manisha Mukherjee, Sameera Horawalavithana

31. [Knowing When Not to Answer: Evaluating Abstention in Multimodal Reasoning Systems](#link31)
**Authors:** Nishanth Madhusudhan, Vikas Yadav, Alexandre Lacoste

32. [Stateful Evidence-Driven Retrieval-Augmented Generation with Iterative Reasoning](#link32)
**Authors:** Qi Dong, Ziheng Lin, Ning Ding

33. [The Cost of Language: Centroid Erasure Exposes and Exploits Modal Competition in Multimodal Language Models](#link33)
**Authors:** Akshay Paruchuri, Ishan Chatterjee, Henry Fuchs, Ehsan Adeli, Piotr Didyk

34. [AdaSplash-2: Faster Differentiable Sparse Attention](#link34)
**Authors:** Nuno Gon\c{c}alves, Hugo Pitorro, Vlad Niculae, Edoardo Ponti, Lei Li, Andre Martins, Marcos Treviso

35. [DiscoTrace: Representing and Comparing Answering Strategies of Humans and LLMs in Information-Seeking Question Answering](#link35)
**Authors:** Neha Srikanth, Jordan Boyd-Graber, Rachel Rudinger

36. [Zeroth-Order Optimization at the Edge of Stability](#link36)
**Authors:** Minhak Song, Liang Zhang, Bingcong Li, Niao He, Michael Muehlebach, Sewoong Oh

37. [CROP: Token-Efficient Reasoning in Large Language Models via Regularized Prompt Optimization](#link37)
**Authors:** Deep Shah, Sanket Badhe, Nehal Kathrotia, Priyanka Tiwari

38. [Expressivity of Transformers: A Tropical Geometry Perspective](#link38)
**Authors:** Ye Su, Yong Liu

39. [AI-Assisted Peer Review at Scale: The AAAI-26 AI Review Pilot](#link39)
...
40. [On the Expressive Power and Limitations of Multi-Layer SSMs](#link40)
**Authors:** Nikola Zubi\'c, Qian Li, Yuyi Wang, Davide Scaramuzza

41. [Towards Verified and Targeted Explanations through Formal Methods](#link41)
**Authors:** Hanchen David Wang, Diego Manzanas Lopez, Preston K. Robinette, Ipek Oguz, Taylor T. Johnson, Meiyi Ma

42. [TREX: Automating LLM Fine-tuning via Agent-Driven Tree-based Exploration](#link42)
**Authors:** Zerun Ma, Guoqiang Wang, Xinchen Xie, Yicheng Chen, He Du, Bowen Li, Yanan Sun, Wenran Liu, Kai Chen, Yining Li

43. [StoryCoder: Narrative Reformulation for Structured Reasoning in LLM Code Generation](#link43)
**Authors:** Geonhui Jang, Dongyoon Han, YoungJoon Yoo

44. [Mean Flow Policy Optimization](#link44)
**Authors:** Xiaoyi Dong, Xi Sheryl Zhang, Jian Cheng

45. [No More Guessing: a Verifiable Gradient Inversion Attack in Federated Learning](#link45)
**Authors:** Francesco Diana, Chuan Xu, Andr\'e Nusser, Giovanni Neglia

46. [Step-level Denoising-time Diffusion Alignment with Multiple Objectives](#link46)
**Authors:** Qi Zhang, Dawei Wang, Shaofeng Zou

47. [Generative Augmented Inference](#link47)
**Authors:** Cheng Lu, Mengxin Wang, Dennis J. Zhang, Heng Zhang

48. [ConfLayers: Adaptive Confidence-based Layer Skipping for Self-Speculative Decoding](#link48)
**Authors:** Walaa Amer, Uday das, Fadi Kurdahi

49. [Towards Scalable Lightweight GUI Agents via Multi-role Orchestration](#link49)
