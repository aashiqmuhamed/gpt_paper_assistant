# Personalized Daily Arxiv Papers 07/23/2026
...
0. [Sound Probabilistic Safety Bounds for Large Language Models](#link0)
**Authors:** Mahdi Nazeri, Anne-Kathrin Schmuck, Sadegh Soudjani, Alessandro Abate

1. [Reference-Free Evaluation of Reasoning in Open-Ended Question Answering](#link1)
**Authors:** Guneet Singh Kohli, Yuxiang Zhou, Michael Sejr Schlichtkrull, Gregory E Dean, Maria Liakata

2. [S2T-RLHF: Hierarchical Credit Assignment for Stable Preference-Based RLHF](#link2)
**Authors:** Wei Chen, Guanghui Zhu, Yafei Li, Limin Wang, Yihua Huang

3. [From Trajectories to Prefixes: Reusing Teacher Trajectories via Replayed Prefixes and Online Continuation](#link3)
**Authors:** Yihan Wang, Zhong Guan, Haoran Sun, Jiale Huang, Likang Wu, Hongke Zhao

4. [Wisdom of LLM Crowds: Aggregation and Contamination in Language Model Ensembles](#link4)
**Authors:** Igor Douven

5. [Total Variation Distance Estimation in Autoregressive Models](#link5)
**Authors:** Eric Price, Kevin Tian, Zhiyang Xun, Yusong Zhu

6. [Co-Evolving LLM Evaluators and Policies via DynamicRubric](#link6)
...
7. [When JSON Is Not Enough: Semantic Reliability of Schema-Constrained LLM Ordering Agents](#link7)
**Authors:** Yin Li

8. [Unlearning as Distribution Restoration: A Controlled Counterfactual Study, a Validated Selective Screen, and the Limits of Oracle-Free Certification](#link8)
**Authors:** Sen Yang, Yuen-Hei Yeung

9. [LAARA: Layer-Aware Adaptive Rank Allocation for Parameter-Efficient Fine-Tuning](#link9)
**Authors:** Ashutosh Tripathi, Surya Deep Singh, Pranab Sahoo, Sriparna Saha

10. [Measuring Reward-Seeking via Contrastive Belief Updates](#link10)
...
11. [REGEN: Replay-recycling for Expert-to-Generalist distillation with Offline Reinforcement Learning](#link11)
**Authors:** Yunjie Chen, Xiaoxin Chen, Fang Wang

12. [MUX: Continuous Reasoning via Multiplexed Tokens](#link12)
**Authors:** Ayhan Suleymanzade, Halil Alperen Gozeten, Michael Bronstein, \.Ismail \.Ilkan Ceylan, Jinwoo Kim

13. [Multi-Mask Diffusion Language Models for Few-Step Generation](#link13)
**Authors:** Sijin Chen, Yinuo Ren, Heyang Zhao, Ziheng Cheng, Quanquan Gu, Lexing Ying

14. [SLPO: Scaling Latent Reasoning via a Surrogate Policy](#link14)
**Authors:** Runyang You, Zhiyuan Liu, Yongqi Li, Wenjie Li

15. [Fishing Out Free Riders: Shapley-Based Reward Attribution for Parallel Reasoning via Reinforcement Learning](#link15)
**Authors:** Wentao Zhang, Haoyu Zhang, Xinke Jiang, Yuxuan Cheng, Yuhan Pan, Miao Li, Zhipeng Qiao, Tao Feng, Zhen Tao, Dengji Zhao

16. [Building Fast, Evaluating Slow: Pipeline Choices Dominate Autointerpretability Score Variance](#link16)
**Authors:** Sinie van der Ben, Neele Roch, Anna Hedstr\"om, Mennatallah El-Assady

17. [SAAG: Structured Agent Assessment and Grounding](#link17)
**Authors:** Ritvik Garimella, Vedant Khandelwal, Anvi Kohli, Amit Sheth

18. [Reward-Aware Population Scaling of Evolutionary Strategies in LLM Fine-Tuning](#link18)
**Authors:** Sung Cho, Gyubin Han

19. [On the Computational Complexity of Structural Generalization](#link19)
**Authors:** Zichao Wei

20. [ResearchArena: Evaluating Sabotage and Monitoring in Automated AI R&D](#link20)
**Authors:** Lena Libon, Ben Rank, Jehyeok Yeon, David Schmotz, Jeremy Qin, Daniel Donnelly, Derck Prinzhorn, Maksym Andriushchenko

21. [SciHazard: A Benchmark for Measuring Scientific Safety Risks with Decomposed Harm Scoring](#link21)
**Authors:** Chunxiao Li, Yuan Xiong, Lijun Li, Tianyi Du, Wenlong Zhang, Lei Bai, Jing Shao

22. [From Dependency to Compositionality: A Neurosymbolic Lifting of LLM Outputs via Combinatory Categorial Grammar](#link22)
**Authors:** Remo Pareschi

23. [Gotta Catch them all: the modes of Sycophancy](#link23)
**Authors:** Shreyans Jain, Alexandra Yost, Amirali Abdullah

24. [SLAI T-Rex: Full-Parameter Post-training of the DeepSeek-V4 Family on Ascend SuperPOD](#link24)
...
25. [Reinforcement Learning for Large Language Model Selective Evidence Adoption from Contaminated Retrieval Results](#link25)
**Authors:** Yanyu Chen, Yue Li, Yongyi Cui, Dongsheng Shi, Lichang Dai

26. [HalluTruthQA: A Fine-Grained Benchmark for Hallucination Detection, Localization, and Explanation in Arabic Question Answering](#link26)
...
27. [A Multi-Dimensional Evaluation of Explainability in Media Bias Detection](#link27)
**Authors:** Ting Chen, Raina Zhang, Benjamin M. Ampel, Sagar Samtani

28. [D2VBench: Benchmarking Large Language Models with Value Dilemmas in Daily Scenarios](#link28)
**Authors:** Siyi Hao, Yidi Cao, Linhao Yu, Yuqi Ren, Deyi Xiong

29. [Notes to Self: Can LLMs Benefit from Experiential Abstractions?](#link29)
**Authors:** Chang Liu, Xinyu Li, Artur Dubrawski

30. [LKValues: Aligning Large Language Models with Sri Lankan Societal Values](#link30)
...
31. [Analytic Distribution of Classifier-Free Guidance for Schedule Design](#link31)
**Authors:** Enze Jiang, Zheng Ma

32. [LLM Detection as an Intervention: Downstream Impact under Strategic User Behavior](#link32)
**Authors:** Meena Jagadeesan, Tatsunori Hashimoto, Jon Kleinberg

33. [Probabilistic Concept-Aware Steering for Trustworthy LLM Inference](#link33)
**Authors:** Brian Becker, Rui Chu, Yingjie Lao

34. [Bayesian Wind Tunnels for Model Selection](#link34)
**Authors:** Siddhartha R Dalal, Vishal Misra, Abhay Parekh

35. [When Reasoning Narrows the Move: Diversity Collapse in LLM Game Play](#link35)
**Authors:** Junyi Sha, Renfei Tan, David Simchi-Levi

36. [Anatomy of a Sound Neural Reasoner: One-Shot Amortization, First-Pass Poisoning, and Search Inertness in Clue-Rich Completion](#link36)
**Authors:** Aleksey Komissarov

37. [Leveraging Offline Supervision for Efficient and Generalizable Reinforcement Learning in Large-Scale Vision-Language-Action Models](#link37)
**Authors:** Dmitriy Poyarkov, Aleksei Staroverov, Aleksandr I. Panov

38. [SynPre-FL: Synthetic data-driven pretraining integrated Federated Learning training framework](#link38)
...
39. [Efficient Clustering with Provable Guardrails for LLM Inference at Scale](#link39)
**Authors:** Longshaokan Wang, Wai Tsang Keung, Punit Ghodasara, Roman Wang, Ali Dashti, Francesc Moreno-Noguer

40. [The Blessing of Dimensionality: How Near-Orthogonality in High-Dimensional Spaces Explains Temporal Portability](#link40)
**Authors:** Abigail Woodring, Adrian Chan, Rana Muhammad Shahroz Khan, Sukwon Yun, Chau-Wai Wong, Tianlong Chen

41. [PEARL: Solver-in-the-Loop Interactive Optimization Modeling from Natural Language](#link41)
**Authors:** Hongliang Lu, Zhong Li, Yuxuan Chen, Yuan Lan, Fan Zhang, Zaiwen Wen

42. [AgentDebugX: An Open-Source Toolkit for Failure Observability, Attribution, and Recovery in LLM Agents](#link42)
...
**Comment:** Matches criterion 13: The paper studies AI control and monitoring for sabotage detection in automated AI R&D, focusing on oversight and control of AI system behavior during deployment. This aligns with new paradigms for AI control and monitoring.
**Relevance:** 7
**Novelty:** 7

---

## 21. [SciHazard: A Benchmark for Measuring Scientific Safety Risks with Decomposed Harm Scoring](https://arxiv.org/abs/2607.18665) <a id="link21"></a>
**ArXiv ID:** 2607.18665
**Authors:** Chunxiao Li, Yuan Xiong, Lijun Li, Tianyi Du, Wenlong Zhang, Lei Bai, Jing Shao
...
**Comment:** Matches criterion 5: introduces SciHazard, a new dataset and evaluation framework for scientific safety risks in LLMs, with expert validation and extensive benchmarking.
**Relevance:** 7
**Novelty:** 7

---

## 22. [From Dependency to Compositionality: A Neurosymbolic Lifting of LLM Outputs via Combinatory Categorial Grammar](https://arxiv.org/abs/2607.18961) <a id="link22"></a>
**ArXiv ID:** 2607.18961
**Authors:** Remo Pareschi
...
**Comment:** Matches criterion 2: The paper studies LLM detection methods and their downstream impact, which relates to membership inference and detection of LLM-generated content. It analyzes strategic user behavior in response to detection, which is a novel angle on contamination and membership inference effects.
**Relevance:** 6
**Novelty:** 6

---

## 33. [Probabilistic Concept-Aware Steering for Trustworthy LLM Inference](https://arxiv.org/abs/2607.18259) <a id="link33"></a>
**ArXiv ID:** 2607.18259
**Authors:** Brian Becker, Rui Chu, Yingjie Lao
...
**Comment:** No criteria matched. This paper presents an interactive optimization modeling system using LLMs but does not focus on RLHF, test contamination, diffusion LMs, or interpretability. It is about tool integration and iterative debugging for optimization code generation.
**Relevance:** 3
**Novelty:** 5

---

## 42. [AgentDebugX: An Open-Source Toolkit for Failure Observability, Attribution, and Recovery in LLM Agents](https://arxiv.org/abs/2607.18754) <a id="link42"></a>
**ArXiv ID:** 2607.18754
**Authors:** Kunlun Zhu, Xuyan Ye, Zhiguang Han, Yuchen Zhao, Bingxuan Li, Weijia Zhang, Muxin Tian, Xiangru Tang, Pan Lu, James Zou, Jiaxuan You, Heng Ji
