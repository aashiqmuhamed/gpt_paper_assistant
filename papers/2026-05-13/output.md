# Personalized Daily Arxiv Papers 05/13/2026
Total relevant papers: 210

Paper selection prompt and criteria at the bottom

Table of contents with paper titles:

0. [Steering Without Breaking: Mechanistically Informed Interventions for Discrete Diffusion Language Models](#link0)
**Authors:** Hanhan Zhou, Shamik Roy, Rashmi Gangadharaiah

1. [Qwen-Scope: Turning Sparse Features into Development Tools for Large Language Models](#link1)
...
2. [BitLM: Unlocking Multi-Token Language Generation with Bitwise Continuous Diffusion](#link2)
**Authors:** Shaobin Zhuang, Yuang Ai, Jiaming Han, Xiaohui Li, Huaibo Huang, Xiangyu Yue, Xuefeng Hu, Kun Xu, Yali Wang, Hao Chen

3. [How LLMs Are Persuaded: A Few Attention Heads, Rerouted](#link3)
**Authors:** Xiangkun Sun, Lingkai Kong, Aoqi Zhang, Liang Zeng, Tonghan Wang

4. [Language Modeling with Hyperspherical Flows](#link4)
**Authors:** Justin Deschenaux, Caglar Gulcehre

5. [Unlearning with Asymmetric Sources: Improved Unlearning-Utility Trade-off with Public Data](#link5)
**Authors:** Ahmed Mehdi Inane, Vincent Quirion, Gintare Karolina Dzugaite, Ioannis Mitliagkas

6. [Robust LLM Unlearning Against Relearning Attacks: The Minor Components in Representations Matter](#link6)
**Authors:** Zeguan Xiao, Xuanzhe Xu, Yun Chen, Yong Wang, Jian Yang, Yanqing Hu, Guanhua Chen

7. [Block-R1: Rethinking the Role of Block Size in Multi-domain Reinforcement Learning for Diffusion Large Language Models](#link7)
**Authors:** Yan Jiang, Ruihong Qiu, Zi Huang

8. [LEAP: Unlocking dLLM Parallelism via Lookahead Early-Convergence Token Detection](#link8)
**Authors:** Haohui Zhang, Zhiye Wang, Xiaoying Gan, Xinbing Wang, Bo Jiang

9. [Stories in Space: In-Context Learning Trajectories in Conceptual Belief Space](#link9)
**Authors:** Eric Bigelow, Rapha\"el Sarfati, Daniel Wurgaft, Owen Lewis, Thomas McGrath, Jack Merullo, Atticus Geiger, Ekdeep Singh Lubana

10. [Containment Verification: AI Safety Guarantees Independent of Alignment](#link10)
**Authors:** Royce Moon, Lav R. Varshney

11. [The Geometry of Forgetting: Temporal Knowledge Drift as an Independent Axis in LLM Representations](#link11)
**Authors:** Rania Elbadry, Ahmed Heakl, Fan Zhang, Dani Bouch, Yuxia Wang, Preslav Nakov, Zhuohan Xie

12. [Geometric Factual Recall in Transformers](#link12)
**Authors:** Shauli Ravfogel, Gilad Yehudai, Joan Bruna, Alberto Bietti

13. [Data-driven Circuit Discovery for Interpretability of Language Models](#link13)
**Authors:** Daking Rai, Mor Geva, Ziyu Yao

14. [DiffScore: Text Evaluation Beyond Autoregressive Likelihood](#link14)
**Authors:** Wen Lai, Yingli Shen, Dingnan Jin, Qing Cui, Jun Zhou, Maosong Sun, Alexander Fraser

15. [Self-Distilled Trajectory-Aware Boltzmann Modeling: Bridging the Training-Inference Discrepancy in Diffusion Language Models](#link15)
...
16. [Spurious Correlation Learning in Preference Optimization: Mechanisms, Consequences, and Mitigation via Tie Training](#link16)
**Authors:** Christian Moya, Alex Semendinger, Guang Lin, Elliott Thornley

17. [BSO: Safety Alignment Is Density Ratio Matching](#link17)
**Authors:** Tien-Phat Nguyen, Truong Nguyen, Thin Nguyen, Duy Minh Ho Nguyen, Ngoc-Thanh Dinh, Trung Le

18. [Anti-Self-Distillation for Reasoning RL via Pointwise Mutual Information](#link18)
**Authors:** Guobin Shen, Xiang Cheng, Chenxiao Zhao, Lei Huang, Jindong Li, Dongcheng Zhao, Xing Yu

19. [Entropy Polarity in Reinforcement Fine-Tuning: Direction, Asymmetry, and Control](#link19)
...
20. [20/20 Vision Language Models: A Prescription for Better VLMs through Data Curation Alone](#link20)
...
21. [Internalizing Curriculum Judgment for LLM Reinforcement Fine-Tuning](#link21)
**Authors:** Han Zheng, Yining Ma, Karthick Gunasekaran, Bharathan Balaji, Zheng Du, Shiv Vitaladevuni, Cathy Wu

22. [Do LLMs Experience an Internal Polylogue? Investigating Reasoning through the Lens of Personas](#link22)
**Authors:** Nils A. Herrmann, Leander Girrbach, Kirill Bykov, Zeynep Akata

23. [Multi-Stream LLMs: Unblocking Language Models with Parallel Streams of Thoughts, Inputs and Outputs](#link23)
**Authors:** Guinan Su, Yanwu Yang, Xueyan Li, Jonas Geiping

24. [The Attacker in the Mirror: Breaking Self-Consistency in Safety via Anchored Bipolicy Self-Play](#link24)
**Authors:** Gabriele La Malfa, Emanuele La Malfa, Saar Cohen, Jie M. Zhang, Michael Luck, Michael Wooldridge, Elizabeth Black

25. [PRISM: Generation-Time Detection and Mitigation of Secret Leakage in Multi-Agent LLM Pipelines](#link25)
**Authors:** Riya Tapwal, Abhishek Kumar, Carsten Maple

26. [Primal-Dual Guided Decoding for Constrained Discrete Diffusion](#link26)
**Authors:** Federico Tomasi, Dmitrii Moor, Alice Wang, Mounia Lalmas

27. [Targeted Neuron Modulation via Contrastive Pair Search](#link27)
**Authors:** Sam Herring, Jake Naviasky, Karan Malhotra

28. [TRACE: Distilling Where It Matters via Token-Routed Self On-Policy Alignment](#link28)
**Authors:** Jiaxuan Wang, Xuan Ouyang, Zhiyu Chen, Yulan Hu, Zheng Pan, Xin Li, Lan-Zhe Guo

29. [Scaling Laws and Tradeoffs in Recurrent Networks of Expressive Neurons](#link29)
**Authors:** Aaron Spieler, Georg Martius, Anna Levina

30. [Overtrained, Not Misaligned](#link30)
**Authors:** Joel Schreiber, Ariel Goldstein

31. [Auto-Rubric as Reward: From Implicit Preferences to Explicit Multimodal Generative Criteria](#link31)
**Authors:** Juanxi Tian, Fengyuan Liu, Jiaming Han, Yilei Jiang, Yongliang Wu, Yesheng Liu, Haodong Li, Furong Xu, Wanhua Li

32. [Internalizing Safety Understanding in Large Reasoning Models via Verification](#link32)
**Authors:** Yi Zhang, Yuxin Chen, Leheng Sheng, Dongcheng Zhang, Chaochao Lu, Xiang Wang, An Zhang

33. [Routers Learn the Geometry of Their Experts: Geometric Coupling in Sparse Mixture-of-Experts](#link33)
**Authors:** Sagi Ahrac, Noya Hochwald, Mor Geva

34. [Trust the Batch, On- or Off-Policy: Adaptive Policy Optimization for RL Post-Training](#link34)
**Authors:** Rasool Fakoor, Murdock Aubry, Nicholas Stranges, Alexander J. Smola

35. [Combining On-Policy Optimization and Distillation for Long-Context Reasoning in Large Language Models](#link35)
**Authors:** Miguel Moura Ramos, Duarte M. Alves, Andr\'e F. T. Martins

36. [Not All Turns Matter: Credit Assignment for Multi-Turn Jailbreaking](#link36)
**Authors:** Zhida He, Xiaoyu Wen, Han Qi, Ziyuan Zhou, Peng Yu, Xingcheng Xu, Dongrui Liu, Xia Hu, Chaochao Lu, Qiaosheng Zhang

37. [Latent Personality Alignment: Improving Harmlessness Without Mentioning Harms](#link37)
**Authors:** Linh Le, David Williams-King, Mohamed Amine Merzouk, Aton Kamanda, Adam Oberman

38. [Shepherd: A Runtime Substrate Empowering Meta-Agents with a Formalized Execution Trace](#link38)
**Authors:** Simon Yu, Derek Chong, Ananjan Nandi, Dilara Soylu, Jiuding Sun, Christopher D Manning, Weiyan Shi

39. [Agent-ValueBench: A Comprehensive Benchmark for Evaluating Agent Values](#link39)
**Authors:** Haonan Dong, Qiguan Feng, Kehan Jiang, Haoran Ye, Xin Zhang, Guojie Song

40. [Mid-Training with Self-Generated Data Improves Reinforcement Learning in Language Models](#link40)
**Authors:** Aswin RRV, Jacob Dineen, Divij Handa, Mihir Parmar, Ben Zhou, Swaroop Mishra, Chitta Baral

41. [CauSim: Scaling Causal Reasoning with Increasingly Complex Causal Simulators](#link41)
**Authors:** Nicol\'as Astorga, Anita Kriz, Mihaela van der Schaar

42. [Deep Reasoning in General Purpose Agents via Structured Meta-Cognition](#link42)
...
43. [Agent-BRACE: Decoupling Beliefs from Actions in Long-Horizon Tasks via Verbalized State Uncertainty](#link43)
...
44. [Bias by Necessity: Impossibility Theorems for Sequential Processing with Convergent AI and Human Validation](#link44)
**Authors:** Jikun Wu, Dongxin Guo, Siu-Ming Yiu

45. [Learning the Preferences of a Learning Agent](#link45)
**Authors:** Karim Abdel Sadek, Mark Bedaywi, Rhys Gould, Stuart Russell

46. [More Edits, More Stable: Understanding the Lifelong Normalization in Sequential Model Editing](#link46)
**Authors:** Xin Ma, Wei Chen, Qi Liu, Derong Xu, Zhi Zheng, Tong Xu, Enhong Chen

47. [The Generalized Turing Test: A Foundation for Comparing Intelligence](#link47)
**Authors:** Daniel Mitropolsky, Susan S. Hong, Riccardo Neumarker, Emanuele Rimoldi, Tomaso Poggio

48. [TokenRatio: Principled Token-Level Preference Optimization via Ratio Matching](#link48)
**Authors:** Truong Nguyen, Tien-Phat Nguyen, Linh Ngo Van, Duy Minh Ho Nguyen, Khoa Doan, Trung Le

49. [Instructions shape Production of Language, not Processing](#link49)
**Authors:** Andreas Waldis, Leshem Choshen, Yufang Hou, Yotam Perlit

50. [Understanding and Preventing Entropy Collapse in RLVR with On-Policy Entropy Flow Optimization](#link50)
**Authors:** Huimin Xu, Shuai Zhao, Xiaobao Wu, Anh Tuan Luu

51. [Verifiable Process Rewards for Agentic Reasoning](#link51)
**Authors:** Huining Yuan, Zelai Xu, Huaijie Wang, Xiangmin Yi, Jiaxuan Gao, Xiao-Ping Zhang, Yu Wang, Chao Yu, Yi Wu

52. [When Emotion Becomes Trigger: Emotion-style dynamic Backdoor Attack Parasitising Large Language Models](#link52)
**Authors:** Ziyu Liu, Tao Li, Tianjie Ni, Xiaolong Lan, Wengang Ma, Tao Yang, Guohua Wang, Junjiang He

53. [Test-Time Personalization: A Diagnostic Framework and Probabilistic Fix for Scaling Failures](#link53)
**Authors:** Linhai Zhang, Yulan He

54. [M2A: Synergizing Mathematical and Agentic Reasoning in Large Language Models](#link54)
**Authors:** Junjian Wang, Xin Zhou, Qiran Xu, Kun Zhan

55. [Measuring Five-Nines Reliability: Sample-Efficient LLM Evaluation in Saturated Benchmarks](#link55)
**Authors:** Eungyeup Kim, Chenchen Gu, Vashisth Tiwari, J. Zico Kolter

56. [Do Linear Probes Generalize Better in Persona Coordinates?](#link56)
**Authors:** Prasad Mahadik, Adrians Skapars

57. [FORTIS: Benchmarking Over-Privilege in Agent Skills](#link57)
...
58. [AgentPSO: Evolving Agent Reasoning Skill via Multi-agent Particle Swarm Optimization](#link58)
**Authors:** Hyunmin Hwang, Jaemin Kim, Choonghan Kim, Hangeol Chang, Jong Chul Ye

59. [Persona-Conditioned Adversarial Prompting: Multi-Identity Red-Teaming for Adversarial Discovery and Mitigation](#link59)
**Authors:** Cristian Morasso, Anisa Halimi, Muhammad Zaid Hameed, Douglas Leith

60. [Learning, Fast and Slow: Towards LLMs That Adapt Continually](#link60)
...
61. [Belief or Circuitry? Causal Evidence for In-Context Graph Learning](#link61)
**Authors:** Katharine Kowalyshyn, Timothy Duggan, Daniel Little, Michael C Hughes

62. [GEAR: Granularity-Adaptive Advantage Reweighting for LLM Agents via Self-Distillation](#link62)
**Authors:** Sijia Li, Yuchen Huang, Zifan Liu, Yanping Li, Jingjing Fu, Li Zhao, Jiang Bian, Ling Zhang, Jun Zhang, Rui Wang

63. [How You Begin is How You Reason: Driving Exploration in RLVR via Prefix-Tuned Priors](#link63)
**Authors:** Yifan Xu, Junren Chen, Yifan Chen

64. [Cross-Family Universality of Behavioral Axes via Anchor-Projected Representations](#link64)
**Authors:** Su-Hyeon Kim, Yo-Sub Han

65. [expo: Exploration-prioritized policy optimization via adaptive kl regulation and gaussian curriculum sampling](#link65)
**Authors:** Mingxiong Lin, Zhangquan Gong, Maowen Tang, Qian Li, Chuangchuang Wang, Jian Ma, Sutian Huang, Kai Tang, Haonan Lu

66. [$\xi$-DPO: Direct Preference Optimization via Ratio Reward Margin](#link66)
**Authors:** Zhengyuan Fan, Zhonghua Wu, Yuxuan Du, Qun Chen

67. [SoK: Unlearnability and Unlearning for Model Dememorization](#link67)
**Authors:** Mengying Zhang, Derui Wang, Ruoxi Sun, Xiaoyu Xia, Shuang Hao, Minhui Xue

68. [Positive Alignment: Artificial Intelligence for Human Flourishing](#link68)
**Authors:** Ruben Laukkonen, Seb Krier, Chlo\'e Bakalar, Shamil Chandaria, Morten Kringelbach, Adam Elwood, Daniel Ford, Fernando Rosas, Maty Bohacek, Matija Franklin, Nenad Toma\v{s}ev, Stephanie Chan, Verena Rieser, Roma Patel, Michael Levin, Arun Rao

69. [From Generic Correlation to Input-Specific Credit in On-Policy Self Distillation](#link69)
**Authors:** Guobin Shen, Lei Huang, Xiang Cheng, Chenxiao Zhao, Jindong Li, Dongcheng Zhao, Xing Yu

70. [Sampling More, Getting Less: Calibration is the Diversity Bottleneck in LLMs](#link70)
...
71. [The Scaling Law of Evaluation Failure: Why Simple Averaging Collapses Under Data Sparsity and Item Difficulty Gaps, and How Item Response Theory Recovers Ground Truth Across Domains](#link71)
**Authors:** Jung Min Kang

72. [Consistency as a Testable Property: Statistical Methods to Evaluate AI Agent Reliability](#link72)
**Authors:** Harsh Raj, Niranjan Orkat, Suvrorup Mukherjee, Aritra Guha, Cheryl Flynn, Subhabrata Majumdar

73. [Correcting Selection Bias in Sparse User Feedback for Large Language Model Quality Estimation: A Multi-Agent Hierarchical Bayesian Approach](#link73)
**Authors:** Andrea Morandi, Mahesh Viswanathan

74. [Can Agent Benchmarks Support Their Scores? Evidence-Supported Bounds for Interactive-Agent Evaluation](#link74)
**Authors:** Shanshan Gao, Liyi Zhou

75. [The Bicameral Model: Bidirectional Hidden-State Coupling Between Parallel Language Models](#link75)
**Authors:** Cedric Flamant, Udaya Ghai, Kanna Shimizu

76. [Primal Generation, Dual Judgment: Self-Training from Test-Time Scaling](#link76)
**Authors:** Yizhu Jiao, Ruixiang Zhang, Richard Bai, Jiawei Han, Ronan Collobert, Yizhe Zhang

77. [Where Reliability Lives in Vision-Language Models: A Mechanistic Study of Attention, Hidden States, and Causal Circuits](#link77)
**Authors:** Logan Mann, Ajit Saravanan, Ishan Dave, Shikhar Shiromani, Saadullah Ismail, Yi Xia, Emily Huang

78. [TMAS: Scaling Test-Time Compute via Multi-Agent Synergy](#link78)
**Authors:** George Wu, Nan Jing, Qing Yi, Chuan Hao, Ming Yang, Feng Chang, Yuan Wei, Jian Yang, Ran Tao, Bryan Dai

79. [Self-ReSET: Learning to Self-Recover from Unsafe Reasoning Trajectories](#link79)
**Authors:** Dongcheng Zhang, Yi Zhang, Yuxin Chen, An Zhang, Xiang Wang, Chaochao Lu

80. [fg-expo: Frontier-guided exploration-prioritized policy optimization via adaptive kl and gaussian curriculum](#link80)
**Authors:** Mingxiong Lin, Zhangquan Gong, Maowen Tang, Qian Li, Chuangchuang Wang, Jian Ma, Sutian Huang, Kai Tang, Haonan Lu

81. [Probing Cross-modal Information Hubs in Audio-Visual LLMs](#link81)
**Authors:** Jihoo Jung, Chaeyoung Jung, Ji-Hoon Kim, Joon Son Chung

82. [Benchmarking Safety Risks of Knowledge-Intensive Reasoning under Malicious Knowledge Editing](#link82)
**Authors:** Qinghua Mao, Xi Lin, Jinze Gu, Jun Wu, Siyuan Li, Yuliang Chen

83. [Beyond Accuracy: Evaluating Strategy Diversity in LLM Mathematical Reasoning](#link83)
**Authors:** Xia Yang, Xuanyi Zhang, Hao Hu, Feng Ji

84. [LoopUS: Recasting Pretrained LLMs into Looped Latent Refinement Models](#link84)
**Authors:** Taekhyun Park, Yongjae Lee, Dohee Kim, Hyerim Bae

85. [Towards Order Fairness: Mitigating LLMs Order Sensitivity through Dual Group Advantage Optimization](#link85)
**Authors:** Xu Chu, Guanyu Wang, Zhijie Tan, Xinrong Chen, Ziyu Li, Tong Mo, Weiping Li

86. [Pretraining Exposure Explains Popularity Judgments in Large Language Models](#link86)
**Authors:** Jamshid Mozafari, Bhawna Piryani, Adam Jatowt

87. [PiCA: Pivot-Based Credit Assignment for Search Agentic Reinforcement Learning](#link87)
**Authors:** Dongyi Liu, Yifan Niu, Qinwen Wang, Han Xiao, Jia Li

88. [Taming Extreme Tokens: Covariance-Aware GRPO with Gaussian-Kernel Advantage Reweighting](#link88)
**Authors:** Cheng Wang, Qin Liu, Wenxuan Zhou, Muhao Chen

89. [Beyond GRPO and On-Policy Distillation: An Empirical Sparse-to-Dense Reward Principle for Language-Model Post-Training](#link89)
**Authors:** Yuanda Xu, Hejian Sang, Zhengze Zhou, Ran He, Zhipeng Wang, Alborz Geramifard

90. [ORCE: Order-Aware Alignment of Verbalized Confidence in Large Language Models](#link90)
**Authors:** Chen Li, Xiaoling Hu, Songzhu Zheng, Jiawei Zhou, Chao Chen

91. [Evolutionary Task Discovery: Advancing Reasoning Frontiers via Skill Composition and Complexity Scaling](#link91)
**Authors:** Liqin Ye, Yanbin Yin, Michael Galarnyk, Yuzhao Heng, Sudheer Chava, Chao Zhang

92. [On Distinguishing Capability Elicitation from Capability Creation in Post-Training: A Free-Energy Perspective](#link92)
**Authors:** Yuhao Li, Shengchao Liu

93. [Detecting overfitting in Neural Networks during long-horizon grokking using Random Matrix Theory](#link93)
**Authors:** Hari K. Prakash, Charles H Martin

94. [H\"older Policy Optimisation](#link94)
...
95. [A Theory of Time-Sensitive Language Generation: Sparse Hallucination Beats Mode Collapse](#link95)
**Authors:** Atul Ganju, Travis McVoy, Shaddin Dughmi, Shang-Hua Teng

96. [The First Drop of Ink: Nonlinear Impact of Misleading Information in Long-Context Reasoning](#link96)
**Authors:** Muhan Gao, Zih-Ching Chen, Kuan-Hao Huang

97. [The tractability landscape of diffusion alignment: regularization, rewards, and computational primitives](#link97)
**Authors:** Ankur Moitra, Andrej Risteski, Dhruv Rohatgi

98. [EGL-SCA: Structural Credit Assignment for Co-Evolving Instructions and Tools in Graph Reasoning Agents](#link98)
**Authors:** Zike Yuan, Yukun Cao, Han Zhang, Jianzhi Yan, Le Liu, Cai ke, Yue Yu, Hui Wang, Ming Liu, Bing Qin

99. [Latent Chain-of-Thought Improves Structured-Data Transformers](#link99)
**Authors:** Carson Dudley, Samet Oymak

100. [Don't Click That: Teaching Web Agents to Resist Deceptive Interfaces](#link100)
**Authors:** Yilin Zhang, Yingkai Hua, Chunyu Wei, Xin Wang, Yueguo Chen

101. [Rotation-Preserving Supervised Fine-Tuning](#link101)
**Authors:** Hangzhan Jin, Tianwei Ni, Lu Li, Pierre-Luc Bacon, Mohammad Hamdaqa, Doina Precup

102. [On Predicting the Post-training Potential of Pre-trained LLMs](#link102)
**Authors:** Xiaoyuan Li, Yubo Ma, Kexin Yang, Moxin Li, Keqin Bao, Wenie Wang, Fuli Feng, Dayiheng Liu

103. [Reasoning Compression with Mixed-Policy Distillation](#link103)
**Authors:** Han Yang, Mingyan Wu, Bailan He, Zeyu Cao, Sikuan Yan, Kevin Qinghong Lin, Zifeng Ding

104. [Probabilistic Calibration Is a Trainable Capability in Language Models](#link104)
**Authors:** Davide Baldelli, Sruthi Kuriakose, Maryam Hashemzadeh, Amal Zouaq, Sarath Chandar

105. [SeePhys Pro: Diagnosing Modality Transfer and Blind-Training Effects in Multimodal RLVR for Physics Reasoning](#link105)
...
106. [Mechanistic Interpretability of ASR models using Sparse Autoencoders](#link106)
**Authors:** Dan Pluth, Zachary Nicholas Houghton, Yu Zhou, Vijay K. Gurbani

107. [Log analysis is necessary for credible evaluation of AI agents](#link107)
...
108. [Separate First, Fuse Later: Mitigating Cross-Modal Interference in Audio-Visual LLMs Reasoning with Modality-Specific Chain-of-Thought](#link108)
**Authors:** Xuanchen Li, Yuheng Lu, Chenrui Cui, Tianrui Wang, Zikang Huang, Yu Jiang, Long Zhou, Longbiao Wang, Jianwu Dang

109. [VERDI: Single-Call Confidence Estimation for Verification-Based LLM Judges via Decomposed Inference](#link109)
**Authors:** Jasmine Qi, Danylo Dantsev, Muyang Sun

110. [OPT-BENCH: Evaluating the Iterative Self-Optimization of LLM Agents in Large-Scale Search Spaces](#link110)
**Authors:** Xiaozhe Li, Jixuan Chen, Xinyu Fang, Shengyuan Ding, Haodong Duan, Qingwen Liu, Kai Chen

111. [Missing Old Logits in Asynchronous Agentic RL: Semantic Mismatch and Repair Methods for Off-Policy Correction](#link111)
**Authors:** Zhong Guan, Yongjian Guo, Haoran Sun, Wen Huang, Shuai Di, Xiong Jun Wu, Likang Wu, Hongke Zhao

112. [Deep Minds and Shallow Probes](#link112)
**Authors:** Su Hyeong Lee, Risi Kondor

113. [Learning to Explore: Scaling Agentic Reasoning via Exploration-Aware Policy Optimization](#link113)
**Authors:** Xingyuan Hua, Sheng Yue, Ju Ren

114. [Optimizer-Induced Mode Connectivity: From AdamW to Muon](#link114)
**Authors:** Fangzhao Zhang, Sungyoon Kim, Erica Zhang, Yiqi Jiang, Mert Pilanci

115. [MATRA: Modeling the Attack Surface of Agentic AI Systems -- OpenClaw Case Study](#link115)
**Authors:** Tim Van hamme, Thomas Vissers, Javier Carnerero-Cano, Mario Fritz, Emil C. Lupu, Lieven Desmet, Dinil Mon Divakaran

116. [Forge: Quality-Aware Reinforcement Learning for NP-Hard Optimization in LLMs](#link116)
**Authors:** Xiaozhe Li, Xinyu Fang, Shengyuan Ding, Yang Li, Linyang Li, Haodong Duan, Qingwen Liu, Kai Chen

117. [The Wittgensteinian Representation Hypothesis: Is Language the Attractor of Multimodal Convergence?](#link117)
**Authors:** Zhaoyang Zhang, Run Shao, Dongyue Wu, Jiajie Teng, Chao Tao, Jingdong Chen, Haifeng Li

118. [When to Re-Commit: Temporal Abstraction Discovery for Long-Horizon Vision-Language Reasoning](#link118)
**Authors:** Chen Li, Zhantao Yang, Fangyi Chen, Han Zhang, Anudeepsekhar Bolimera, Marios Savvides

119. [OmniThoughtVis: A Scalable Distillation Pipeline for Deployable Multimodal Reasoning Models](#link119)
**Authors:** Yuanhao Yue, Chengyu Wang, Yuanjie Lyu, Lei Shen, Jun Huang

120. [Constant-Target Energy Matching: A Unified Framework for Continuous and Discrete Density Estimation](#link120)
**Authors:** Zhijun Zeng, Yixuan Jiang, Pipi Hu, Zuoqiang Shi

121. [SLASH the Sink: Sharpening Structural Attention Inside LLMs](#link121)
**Authors:** Yiming Liu, Bin Lu, Xinbing Wang, Chenghu Zhou, Meng Jin

122. [Error whitening: Why Gauss-Newton outperforms Newton](#link122)
**Authors:** Maricela Best McKay, Nathan P. Lawrence, Brian Wetton, R. Bhushan Gopaluni

123. [Do Self-Evolving Agents Forget? Capability Degradation and Preservation in Lifelong LLM Agent Adaptation](#link123)
**Authors:** Ye Yu, Xiaopeng Yuan, Haibo Jin, Heming Liu, Yaoning Yu, Haohan Wang

124. [OUI as a Structural Observable: Towards an Activation-Centric View of Neural Network Training](#link124)
**Authors:** Alberto Fern\'andez-Hern\'andez, Jose I. Mestre, Cristian P\'erez-Corral, Manuel F. Dolz, Jose Duato, Enrique S. Quintana-Ort\'i

125. [Interpretability Can Be Actionable](#link125)
...
126. [Learning Agentic Policy from Action Guidance](#link126)
**Authors:** Yuxiang Ji, Zengbin Wang, Yong Wang, Shidong Yang, Ziyu Ma, Guanhua Chen, Zonghua Sun, Liaoni Wu, Xiangxiang Chu

127. [Curriculum Learning-Guided Progressive Distillation in Large Language Models](#link127)
**Authors:** Jincheng Cao, Fanzhi Zeng, Leqi Liu, Aryan Mokhtari

128. [When Agents Overtrust Environmental Evidence: An Extensible Agentic Framework for Benchmarking Evidence-Grounding Defects in LLM Agents](#link128)
**Authors:** Strick Sheng, Ziyue Wang, Liyi Zhou

129. [Gradient-Free Noise Optimization for Reward Alignment in Generative Models](#link129)
**Authors:** Jeongsol Kim, Hongeun Kim, Jian Wang, Jong Chul Ye

130. [Absurd World: A Simple Yet Powerful Method to Absurdify the Real-world for Probing LLM Reasoning Capabilities](#link130)
**Authors:** Ryan Albright, Golam Md Muktadir, Zarif Ikram, S M Jubaer, Mehrab Hossain, Dianbo Liu

131. [When Can Human-AI Teams Outperform Individuals? Tight Bounds with Impossibility Guarantees](#link131)
**Authors:** Dongxin Guo, Jikun Wu, Siu-Ming Yiu

132. [TMPO: Trajectory Matching Policy Optimization for Diverse and Efficient Diffusion Alignment](#link132)
...
133. [Trust Region Inverse Reinforcement Learning: Explicit Dual Ascent using Local Policy Updates](#link133)
**Authors:** Anish Diwan, Davide Tateo, Christopher E. Mower, Haitham Bou-Ammar, Jan Peters, Oleg Arenz

134. [Emergent Semantic Role Understanding in Language Models](#link134)
**Authors:** Carla Griffiths, Mirco Musolesi

135. [An Empirical Study of Automating Agent Evaluation](#link135)
...
136. [Slicing and Dicing: Configuring Optimal Mixtures of Experts](#link136)
**Authors:** Margaret Li, Sneha Kudugunta, Danielle Rothermel, Luke Zettlemoyer

137. [Muon is Not That Special: Random or Inverted Spectra Work Just as Well](#link137)
**Authors:** Zakhar Shumaylov, Natha\"el Da Costa, Peter Zaika, B\'alint Mucs\'anyi, Alex Massucco, Yoav Gelberg, Carola-Bibiane Sch\"onlieb, Yarin Gal, Philipp Hennig

138. [ReAD: Reinforcement-Guided Capability Distillation for Large Language Models](#link138)
**Authors:** Xueqi Cheng, Xugui Zhou, Tyler Derr, Yushun Dong

139. [Context Convergence Improves Answering Inferential Questions](#link139)
**Authors:** Jamshid Mozafari, Bhawna Piryani, Adam Jatowt

140. [One-Step Generative Modeling via Wasserstein Gradient Flows](#link140)
**Authors:** Jiaqi Han, Puheng Li, Qiushan Guo, Renyuan Xu, Stefano Ermon, Emmanuel J. Cand\`es

141. [Mitigating Context-Memory Conflicts in LLMs through Dynamic Cognitive Reconciliation Decoding](#link141)
**Authors:** Yigeng Zhou, Wu Li, Yifan Lu, Yequan Wang, Xuebo Liu, Wenya Wang, Jun Yu, Min Zhang, Jing Li

142. [PRISM: A Geometric Risk Bound that Decomposes Drift into Scale, Shape, and Head](#link142)
**Authors:** Chieh-Yen Lin, Shao-Hua Sun

143. [The Metacognitive Probe: Five Behavioural Calibration Diagnostics for LLMs](#link143)
**Authors:** Rafael C. T. Oliveira

144. [Scalable Token-Level Hallucination Detection in Large Language Models](#link144)
**Authors:** Rui Min, Tianyu Pang, Chao Du, Minhao Cheng, Yi R. Fung

145. [Navigating the Sea of LLM Evaluation: Investigating Bias in Toxicity Benchmarks](#link145)
**Authors:** Regina Gugg, Selina Niederl\"ander, Andreas St\"ockl, Martin Flechl

146. [Iterative Critique-and-Routing Controller for Multi-Agent Systems with Heterogeneous LLMs](#link146)
**Authors:** Wenzhi Fang, Liangqi Yuan, Guangchen Lan, Dong-Jun Han, Christopher G. Brinton

147. [A Comparative Study of Controlled Text Generation Systems Using Level-Playing-Field Evaluation Principles](#link147)
**Authors:** Michela Lorandi, Anya Belz

148. [MAGE: Multi-Agent Self-Evolution with Co-Evolutionary Knowledge Graphs](#link148)
**Authors:** Ruiyi Yang, Zechen Li, Hao Xue, Imran Razzak, Flora D. Salim

149. [Strategic Exploitation in LLM Agent Markets: A Simulation Framework for E-Commerce Trust](#link149)
...
150. [MedHopQA: A Disease-Centered Multi-Hop Reasoning Benchmark and Evaluation Framework for LLM-Based Biomedical Question Answering](#link150)
...
151. [Learning to Foresee: Unveiling the Unlocking Efficiency of On-Policy Distillation](#link151)
...
152. [Extending Kernel Trick to Influence Functions](#link152)
**Authors:** Zhenhuan Sun, Shahrokh Valaee

153. [A Causal Language Modeling Detour Improves Encoder Continued Pretraining](#link153)
**Authors:** Rian Touchent, Eric de la Clergerie

154. [Understanding Sample Efficiency in Predictive Coding](#link154)
**Authors:** Gaspard Oliviers, Elene Lominadze, Rafal Bogacz

155. [Lower bounds for one-layer transformers that compute parity](#link155)
**Authors:** Daniel Hsu

156. [SearchSkill: Teaching LLMs to Use Search Tools with Evolving Skill Banks](#link156)
**Authors:** Jinchao Hu, Meizhi Zhong, Kehai Chen, Min Zhang

157. [ADMM-Q: An Improved Hessian-based Weight Quantizer for Post-Training Quantization of Large Language Models](#link157)
**Authors:** Ryan Lucas, Mehdi Makni, Xiang Meng, Adam Deng, Rahul Mazumder

158. [PriorZero: Bridging Language Priors and World Models for Decision Making](#link158)
**Authors:** Junyu Xiong, Yuan Pu, Jia Tang, Yazhe Niu

159. [A Unified Graph Language Model for Multi-Domain Multi-Task Graph Alignment Instruction Tuning](#link159)
**Authors:** Haibo Chen, Xin Wang, Jiaheng Chao, Ling Feng, Wenwu Zhu

160. [Question Difficulty Estimation for Large Language Models via Answer Plausibility Scoring](#link160)
**Authors:** Jamshid Mozafari, Bhawna Piryani, Adam Jatowt

161. [Search Your Block Floating Point Scales!](#link161)
...
162. [Epistemic Uncertainty for Test-Time Discovery](#link162)
**Authors:** Kainat Riaz, Muhammad Ahmed Mohsin, Ahsan Bilal, Muhammad Umer, Ayesha Mohsin, Aqib Riaz, Ali Subhan, John M. Cioffi

163. [BoostAPR: Boosting Automated Program Repair via Execution-Grounded Reinforcement Learning with Dual Reward Models](#link163)
**Authors:** Yuanhao Li, Hongbo Wang, Xiaotang Shang, Xunzhu Tang, Yiming Cao, Xuhong Chen

164. [CoCoDA: Co-evolving Compositional DAG for Tool-Augmented Agents](#link164)
**Authors:** Ziyang Yu, Qiyue Li, Liang Zhao

165. [Sharpen Your Flow: Sharpness-Aware Sampling for Flow Matching](#link165)
**Authors:** Aditi Gupta, Soon Hoe Lim, Annan Yu, N. Benjamin Erichson

166. [Shaping Schema via Language Representation as the Next Frontier for LLM Intelligence Expanding](#link166)
**Authors:** Zhiqin Yang, Yuhan Liu, Jingwen Fu, Pei Fu anf Bo Han, Masashi Sugiyama, Nanning Zheng

167. [Grid Games: The Power of Multiple Grids for Quantizing Large Language Models](#link167)
**Authors:** Vage Egiazarian, Erik Schultheis, Andrei Panferov, Earl Killian, Torsten Hoefler, Dan Alistarh

168. [Expected Batch Optimal Transport Plans and Consequences for Flow Matching](#link168)
**Authors:** Samuel Bo\"it\'e, Julie Delon, Kimia Nadjahi

169. [LOFT: Low-Rank Orthogonal Fine-Tuning via Task-Aware Support Selection](#link169)
**Authors:** Lanxin Zhao, Bamdev Mishra, Pratik Jawanpuria, Lequan Lin, Dai Shi, Junbin Gao, Andi Han

170. [Output Composability of QLoRA PEFT Modules for Plug-and-Play Attribute-Controlled Text Generation](#link170)
**Authors:** Michela Lorandi, Anya Belz

171. [Variational Linear Attention: Stable Associative Memory for Long-Context Transformers](#link171)
**Authors:** Vishal Pandey, Gopal Singh

172. [Aligning Flow Map Policies with Optimal Q-Guidance](#link172)
**Authors:** Christos Ziakas, Alessandra Russo, Avishek Joey Bose

173. [Behavioral Determinants of Deployed AI Agents in Social Networks: A Multi-Factor Study of Personality, Model, and Guardrail Specification](#link173)
**Authors:** Sarah Wilson, Diem Linh Dang, Usman Ali Moazzam, Shan Ye, Gail Kaiser

174. [Delightful Gradients Accelerate Corner Escape](#link174)
**Authors:** Jincheng Mei, Ian Osband

175. [Enabling Performant and Flexible Model-Internal Observability for LLM Inference](#link175)
**Authors:** Nengneng Yu, Sixian Xiong, Yibo Zhao, Wei Wang, Zaoxing Liu

176. [Ace-Skill: Bootstrapping Multimodal Agents with Prioritized and Clustered Evolution](#link176)
**Authors:** Feng Xiong, Zengbin Wang, Yong Wang, Xuecai Hu, Jinghan He, Liang Lin, Yuan Liu, Xiangxiang Chu

177. [Embeddings for Preferences, Not Semantics](#link177)
**Authors:** Carter Blair, Ariel D. Procaccia, Milind Tambe

178. [Enhancing Multilingual Counterfactual Generation through Alignment-as-Preference Optimization](#link178)
**Authors:** Yilong Wang, Qianli Wang, Bohao Chu, Yihong Liu, Jing Yang, Simon Ostermann

179. [Optimal Representations for Generalized Contrastive Learning with Imbalanced Datasets](#link179)
**Authors:** Thuan Nguyen, Shuchin Aeron, D. Richard Brown III, Prakash Ishwar

180. [MaskTab: Scalable Masked Tabular Pretraining with Scaling Laws and Distillation for Industrial Classification](#link180)
**Authors:** Bo Zheng, Yudong Chen, Zihua Xiong, Shuai Fang, Peidong He, Yang Yang, Sheng Guo

181. [Alignment as Jurisprudence](#link181)
**Authors:** Nicholas Caputo

182. [StoicLLM: Preference Optimization for Philosophical Alignment in Small Language Models](#link182)
**Authors:** Ishmam Khan, Sindhuja Thogarrati, Shuo Zhang

183. [CTFusion: A CTF-based Benchmark for LLM Agent Evaluation](#link183)
**Authors:** Dongjun Lee, Ga-eun Bae, Insu Yun

184. [Adaptive Calibration in Non-Stationary Environments](#link184)
**Authors:** Junyan Liu, Haipeng Luo, Lillian J. Ratliff

185. [Optimistic Dual Averaging Unifies Modern Optimizers](#link185)
**Authors:** Thomas Pethick, Wanyun Xie, Roman Machacek, Volkan Cevher

186. [Remember the Decision, Not the Description: A Rate-Distortion Framework for Agent Memory](#link186)
**Authors:** Mingxi Zou, Zhihan Guo, Langzhang Liang, Zhuo Wang, Qifan Wang, Qingsong Wen, Irwin King, Lizhen Qu, Zenglin Xu

187. [SAGE: Scalable Automated Robustness Augmentation for LLM Knowledge Evaluation](#link187)
**Authors:** Xiaoyuan Li, Yuzhe Wang, Moxin Li, Keqin Bao, Rui Men, Yichang Zhang, Dayiheng Liu, Wenjie Wang, Fuli Feng

188. [Test-Time Compute for Dense Retrieval: Agentic Program Generation with Frozen Embedding Models](#link188)
**Authors:** Han Xiao

189. [Freeze Deep, Train Shallow: Interpretable Layer Allocation for Continued Pre-Training](#link189)
**Authors:** Yu-Hang Wu, Qin-Yuan Liu, Qiu-Yang Zhao, Bo Jiang, Jiang-Feng Yang, Qing-Wei Cong

190. [Enforcing Constraints in Generative Sampling via Adaptive Correction Scheduling](#link190)
**Authors:** Noah Trupin, Yexiang Xue

191. [Gradient Clipping Beyond Vector Norms: A Spectral Approach for Matrix-Valued Parameters](#link191)
**Authors:** Alexander Yukhimchuk, Mladen Kolar, Martin Tak\'a\v{c}, Sayantan Choudhury

192. [RewardHarness: Self-Evolving Agentic Post-Training](#link192)
...
193. [ComplexMCP: Evaluation of LLM Agents in Dynamic, Interdependent, and Large-Scale Tool Sandbox](#link193)
**Authors:** Yuanyang Li, Xue Yang, Longyue Wang, Weihua Luo, Hongyang Chen

194. [Fairness of Explanations in Artificial Intelligence (AI): A Unifying Framework, Axioms, and Future Direction toward Responsible AI](#link194)
**Authors:** Gideon Popoola, John Sheppard

195. [Re$^2$Math: Benchmarking Theorem Retrieval in Research-Level Mathematics](#link195)
**Authors:** Zicheng Lyu, Wenjie Yang, Shengzhong Zhang, Zengfeng Huang

196. [PRISM: Pareto-Efficient Retrieval over Intent-Aware Structured Memory for Long-Horizon Agents](#link196)
**Authors:** Jingyi Peng, Zhongwei Wan, Weiting Liu, Qiuzhuang Sun

197. [TIDE-Bench: Task-Aware and Diagnostic Evaluation of Tool-Integrated Reasoning](#link197)
**Authors:** Yize Li, Junzhi Li, Jason Song, Chuxiong Sun, Rui Wang, Changwen Zheng

198. [IndustryBench: Probing the Industrial Knowledge Boundaries of LLMs](#link198)
...
199. [How Does Differential Privacy Affect Social Bias in LLMs? A Systematic Evaluation](#link199)
**Authors:** Eduardo Tenorio, Karuna Bhaila, Xintao Wu

200. [Instruction Lens Score: Your Instruction Contributes a Powerful Object Hallucination Detector for Multimodal Large Language Models](#link200)
**Authors:** Runhe Lai, Xinhua Lu, Yanqi Wu, Jinlun Ye, Weijiang Yu, Ruixuan Wang

201. [Unpredictability dissociates from structured control in language agents](#link201)
**Authors:** Jia Xiao

202. [Human-Inspired Memory Architecture for LLM Agents](#link202)
**Authors:** Doga Kerestecioglu, Alexei Robsky, Clemens Vasters, Anshul Sharma, Yitzhak Kesselman

203. [LLM Jaggedness Unlocks Scientific Creativity](#link203)
**Authors:** Shray Mathur, J. Anibal Boscoboinik, Esther H. R. Tsai, Kevin G. Yager

204. [Incentivizing Truthfulness and Collaborative Fairness in Bayesian Learning](#link204)
**Authors:** Rachael Hwee Ling Sim, Jue Fan, Xiao Tian, Xinyi Xu, Patrick Jaillet, Bryan Kian Hsiang Low

205. [A Study on Hidden Layer Distillation for Large Language Model Pre-Training](#link205)
**Authors:** Maxime Guigon, Lucas Dixon, Micha\"el E. Sander

206. [Training-Inference Consistent Segmented Execution for Long-Context LLMs](#link206)
**Authors:** Xianpeng Shang, Jiang Li, Zehua Duo, Qianyi Cai, Xiangdong Su

207. [MEME: Multi-entity & Evolving Memory Evaluation](#link207)
**Authors:** Seokwon Jung, Alexander Rubinstein, Arnas Uselis, Sangdoo Yun, Seong Joon Oh

208. [Token Economics for LLM Agents: A Dual-View Study from Computing and Economics](#link208)
