...
Total relevant papers: 245

Paper selection prompt and criteria at the bottom

Table of contents with paper titles:

0. [DSL-LLaDA: Scaling Continuous Denoising to 8B Masked Diffusion LMs](#link0)
**Authors:** Longxuan Yu, Yunshu Wu, Yu Fu, Siheng Xiong, Rob Brekelmans, Hui Liu, Yue Dong, Greg Ver Steeg

1. [Efficient Exploration for Iterative Nash Preference Optimization](#link1)
**Authors:** Tianlong Nan, Xiaopeng Li, Christian Kroer, Tianyi Lin

2. [An Enigma of Artificial Reason: Investigating the Production-Evaluation Gap in Large Reasoning Models](#link2)
**Authors:** Mingzhong Sun, Teresa Yeo, Armando Solar-Lezama, Tan Zhi-Xuan

3. [Unveiling the Entropy Dynamics of Chain-of-Thought Reasoning](#link3)
**Authors:** Ting Xu, Xu He, Yupu Lu, Jiankai Sun, Dong Li, Wai Lam, Jianye Hao

4. [Subliminal Learning Is Steering Vector Distillation](#link4)
**Authors:** Camila Blank, Agam Bhatia, Senthooran Rajamanoharan, Arthur Conmy, Neel Nanda

5. [FLARE: Diffusion for Hybrid Language Model](#link5)
...
6. [Unlocking the Black Box of Latent Reasoning: An Interpretability-Guided Approach to Intervention](#link6)
**Authors:** Shuochen Chang, Tong Bai, Xiaofeng Zhang, Qianli Ma, Qingyang Liu, Zhaohe Liao, Yibo Miao, Li Niu

7. [The Deterministic Horizon: When Extended Reasoning Fails and Tool Delegation Becomes Necessary](#link7)
**Authors:** Dongxin Guo, Jikun Wu, Siu Ming Yiu

8. [S-SPPO: Semantic-Calibrated Self-Play Preference Optimization](#link8)
...
9. [When Data Is Scarce: Scaling Sparse Language Models with Repeated Training](#link9)
...
10. [SimSD: Simple Speculative Decoding in Diffusion Language Models](#link10)
...
11. [How Hard Can It Be? Hardness-Aware Multi-Objective Unlearning](#link11)
**Authors:** Jiangwei Chen, Xinyuan Niu, Rachael Hwee Ling Sim, Zhengyuan Liu, Nancy F. Chen, Bryan Kian Hsiang Low

12. [Revise, Don't Freeze: Sampler-Matched Training for Self-Correcting Masked Diffusion Language Models](#link12)
**Authors:** Longxuan Yu, Shaorong Zhang, Yu Fu, Hui Liu, Yue Dong, Greg Ver Steeg

13. [Latent Reward Steering: An Adaptive Inference-Time Framework that Implicitly Promotes Cognitive Behaviors in Reasoning LLMs](#link13)
...
14. [Weak Critics Make Strong Learners: On-Policy Critique Distillation for Scalable Oversight](#link14)
**Authors:** Can Jin, Jiakang Li, Rui Wu, Eddy Zhang, Dimitris N. Metaxas

15. [Capability Self-Assessment: Teaching LLMs to Know Their Limits](#link15)
**Authors:** Haoyan Yang, Reza Shirkavand, Yukai Jin, Jiawei Zhou, Shangqian Gao, Heng Huang

16. [Deep Research as Rubric for Reinforcement Learning](#link16)
...
17. [Hidden Thoughts Are Not Secret: Reasoning Trace Exposure in LLMs](#link17)
**Authors:** Yu-An Lu, Ci-Yang Tsai, Yu-Lin Tsai, Raluca Ada Popa, Chia-Mu Yu

18. [ROGUE: Misaligned Agent Behavior Arising from Ordinary Computer Use](#link18)
**Authors:** Jeremy Tien, Abishek Anand, Yu-Rou Tuan, Yuchen Shen, J. Zico Kolter, Aran Nayebi

19. [Training Prompt Matters: State-Adaptive Optimization for Robust Fine-Tuning](#link19)
**Authors:** Wenhang Shi, Yiren Chen, Shuqing Bian, Zhe Zhao, Jinhao Dong, Pengfei Hu, Wei Lu, Xiaoyong Du

20. [BlockGen: Flexible Blockwise Sequence Modeling with Hybrid Samplers](#link20)
**Authors:** Justin Deschenaux, Caglar Gulcehre

21. [SPADE-Bench: Evaluating Spontaneous Strategic Deception in Agents via Plan-Action Divergence](#link21)
**Authors:** Yuyan Bu, Haowei Li, Qirui Zheng, Bowen Dong, Kaiyue Yang, Jiaming Ji, Yingshui Tan, Wenxin Li, Yaodong Yang, Juntao Dai

22. [Investigating and Alleviating Harm Amplification in LLM Interactions](#link22)
**Authors:** Ruohao Guo, Wei Xu, Alan Ritter

23. [Enhancing LLM Metacognition via Cognitive Pairwise Training](#link23)
...
24. [Geometric Latent Reasoning Induces Shorter Generations in LLMs](#link24)
**Authors:** Shashi Kumar, Yacouba Kaloga, Petr Motlicek, Ina Kodrasi, Andrea Cavallaro

25. [Mechanistic Diagnostics of Spatial Lexical Bias in Multimodal Large Language Model Spatial Reasoning](#link25)
**Authors:** Chuang Ma, Qianying Liu, Tomoyuki Obuchi, Fei Cheng, Wang Yang, Sudong Cai, Shuyuan Zheng, Akiko Aizawa, Sadao Kurohashi

26. [Massive Spikes in LLMs are Bias Vectors: Mechanistic Uncovering and Spike-Free Quantization](#link26)
**Authors:** Yung-Chin Chen, Chung Peng Lee, Ze-Wei Liou, Naveen Verma

27. [Off-the-Shelf LLMs as Process Scorers: Training-Free Alternative to PRMs for Mathematical Reasoning](#link27)
**Authors:** Atoosa Chegini, Soheil Feizi

28. [Decentralized Instruction Tuning: Conflict-Aware Splitting and Weight Merging](#link28)
**Authors:** Minsik Choi, Geewook Kim

29. [Adaptive Order Policies for Masked Diffusion](#link29)
**Authors:** Jama Hussein Mohamud, Mohsin Hasan, Mirco Ravanelli, Yoshua Bengio

30. [Agentic Transformers Provably Learn to Search via Reinforcement Learning](#link30)
**Authors:** Tong Yang, Yu Huang, Yingbin Liang, Yuejie Chi

31. [Dialectics of Alignment: Harnessing Unsafe Knowledge for Dynamic Safety Routing](#link31)
**Authors:** Maryam Hashemzadeh, Jerry Huang, Minseon Kim, Marc-Alexandre C\^ot\'e, Sarath Chandar

32. [TriAlign: Towards Universal Truth Consistency in Personalized LLM Alignment](#link32)
**Authors:** Thi-Nhung Nguyen, Linhao Luo, Rollin Omari, Junae Kim, Thuy-Trang Vu, Dinh Phung

33. [Near-Optimal Pure Machine Unlearning for Smooth Strongly Convex Losses](#link33)
**Authors:** Matthew Regehr, Gautam Kamath, Andrew Lowy

34. [Low-Resource Safety Failures Are Action Failures, Not Representation Failures](#link34)
**Authors:** Rashad Aziz, Ikhlasul Akmal Hanif, Fajri Koto

35. [Doing What They Say, Not What They Reason: Locating the Faithfulness Gap in LLM Agents](#link35)
**Authors:** Yufeng Wang

36. [SkillHarm: Lifecycle-Aware Skill-Based Attacks via Automated Construction](#link36)
...
37. [Quantized Reasoning Models Think They Need to Think Longer, but They Do Not](#link37)
**Authors:** Sanae Lotfi, Polina Kirichenko, Steven Li, Zechun Liu

38. [Lost in Delusion: Examining LLM Safety Under User Delusions and Distress](#link38)
**Authors:** Andrew Aquilina, Chetna Nihalani, Vasudha Varadarajan, Nathan S. Fishbein, Yu-Ru Lin, Maarten Sap

39. [Trust Functions: Near-Lossless Weak-to-Strong Generalization by Learning When to Trust the Weak Teacher](#link39)
**Authors:** Arda Uzunoglu, Alvin Zhang, Daniel Khashabi

40. [THRD: A Training-Free Multi-Turn Defense Framework for Jailbreak Attacks on Large Language Models](#link40)
**Authors:** Zhiqing Ma, Zhonghao Xu, Dong Yu, Chen Kang, Changliang Li, Pengyuan Liu

41. [RealityTest: How People Probe AI Identity and Whether Models Disclose It](#link41)
**Authors:** Anna Gausen, Sarenne Wallbridge, Bessie O'Dell, Christopher Summerfield, Hannah Rose Kirk

42. [POIROT: Interrogating Agents for Failure Detection in Multi-Agent Systems](#link42)
**Authors:** I\~naki Dellibarda Varela, R. Sendra-Arranz, Pablo Romero-Sorozabal, J. M. Valverde-Garc\'ia, Annemarie F. Laudanski, \'Alvaro Guti\'errez, Eduardo Rocon, Manuel Cebrian

43. [BAGEN: Are LLM Agents Budget-Aware?](#link43)
...
44. [Benchmarking LLM-as-a-Judge for Long-Form Output Evaluation](#link44)
**Authors:** Junjie Chen, Yuxi Dong, Haitao Li, Weihang Su, Yujia Zhou, Min Zhang, Yiqun Liu, Qinyao Ai

45. [Argument Collapse: LLMs Flatten Long-Form Public Debate](#link45)
**Authors:** Yekyung Kim, Yapei Chang, Chau Minh Pham, Mohit Iyyer

46. [Isolating LLM Lexical Bias: A Curation-Free Triangulated Metric for Preference-Stage Learning](#link46)
**Authors:** Xiaoyang Ming, Jose Hernandez, Thomas Stephan Juzek

47. [TrustLDM: Benchmarking Trustworthiness in Language Diffusion Models](#link47)
**Authors:** Yichuan Mo, Yukun Jiang, Yanbo Shi, Mingjie Li, Michael Backes, Yang Zhang, Yisen Wang

48. [CARE-RL: Capability-Aware Reinforcement Learning for Mitigating Cross-Domain Conflicts](#link48)
**Authors:** Rui Zhang, Xinle Wu, Yao Lu

49. [RLVR without Ineffective Samples: Group Prioritized Off-Policy Optimization for LLM Reasoning](#link49)
**Authors:** Yixiu Mao, Yun Qu, Qi Wang, Heming Zou, Xiangyang Ji

50. [TukaBench: A Culturally Grounded Jailbreak Benchmark for African Languages](#link50)
**Authors:** Victor Akinode, Senyu Li, Wassim Hamidouche, Waqas Zamir, Inbal Becker-Reshef, David Ifeoluwa Adelani

51. [Cross-lingual Self-Consistency for Multilingual Reasoning with Language Models](#link51)
**Authors:** Ahmed Elhady, Eneko Agirre, Mikel Artetxe

52. [CAST: Non-Privileged Clipped Asymmetric Self-Teaching with Advantage Flipping for GRPO](#link52)
**Authors:** Yang Li, Gongle Xue, Yijia Guo, Yuheng Yuan, Liwen Hu, Lei Ma

53. [AlphaToken: Decoupling Adaptation and Stability for Path-Aware Response Token Valuation in LLM Post-Training](#link53)
**Authors:** Liu Qing, Ou Wu, Yi Du

54. [Diagnosing LLM Arbitration Behavior over Pre-evidence Epistemic States in RAG-based Fact-Checking](#link54)
**Authors:** Yuxi Sun, Wenbo Shang, Wei Gao, Xin Huang, Jing Ma

55. [SafeSteer: Localized On-Policy Distillation for Efficient Safety Alignment](#link55)
**Authors:** Hao Li, Jingkun An, Zijun Song, Pengyu Zhu, Rui Li, Hao Wang, Wendi Feng, Yesheng Liu, Lijun Li, Jin-Ge Yao, Lei Sha

56. [SafeMCP: Proactive Power Regulation for LLM Agent Defense via Environment-Grounded Look-Ahead Reasoning](#link56)
**Authors:** Lichao Wang, Zhaoxing Ren, Tianzhuo Yang, Jiaming Ji, Chi Harold Liu, Yaodong Yang, Juntao Dai

57. [MENTIS: What Belief Changes Under Alignment? Measuring Multi-Scale Latent Torsion in Language Models](#link57)
**Authors:** Partha Pratim Saha, Samarth Raina, Mayur Parvatikar, Amit Dhanda, Vinija Jain, Aman Chadha, Amitava Das

58. [The Paradox of Outcome Optimization: A Causal Information-Theoretic Bound on Reasoning Shortcuts in LLMs](#link58)
**Authors:** Zihan Chen, Yiming Zhang, Wenxiang Geng, Zenghui Ding, Yining Sun

59. [A Pre-Training Analogue of Grokking in Language Models: Tracing Delayed Grammatical Generalization](#link59)
**Authors:** Sherin Muckatira, Namrata Shivagunde, Vijeta Deshpande, Anna Rumshisky

60. [Dynamic Proxy-Mixing: Transferring Replay Controllers from Small to Large Models for Continual Instruction Tuning](#link60)
**Authors:** Ibne Farabi Shihab, Fariya Afrin, Anuj Sharma

61. [Before the Model Learns the Bug:Fuzzing RLVR Verifiers](#link61)
**Authors:** Jaideep Ray

62. [Not What, But How: A Communicative Audit of LLM Response Framing](#link62)
**Authors:** Siddhesh Milind Pawar, Sarah Masud, Haneul Yoo, Alice Oh, Isabelle Augenstein

63. [Not All Flips Are Conformity: Decomposing Stance Convergence in Multi-Agent LLM Debate](#link63)
**Authors:** Xiqi Hao, Zengqing Wu, Yu-Xuan Qiu, Chuan Xiao, Ruiqi Xu, Shuyuan Zheng, Jianbin Qin

64. [KACE: Knowledge-Adaptive Context Engineering for Mathematical Reasoning](#link64)
**Authors:** Jayant Parashar, Suchendra M. Bhandarkar

65. [A Theoretical Framework for Self-Play Theorem Proving Algorithms](#link65)
**Authors:** Thomas Chen, Zhiyuan Li

66. [Extreme Low-Bit Inference in Reasoning Models: Failure Modes and Targeted Recovery](#link66)
**Authors:** Ekaterina Alimaskina, Darya Rudas, Denis Shveykin, Gleb Molodtsov, Pavel Vasiliev, Aleksandr Beznosikov

67. [TRACE: Trajectory Risk-Aware Compression for Long-Horizon Agent Safety](#link67)
**Authors:** Zhepei Hong, Lin Wang, Liting Li, Haokai Ma, Junfeng Fang, Fei Shen, Dan Zhang, Xiang Wang

68. [Sparse Autoencoders for Interpretable Emotion Control in Text-to-Speech](#link68)
**Authors:** Hongfei Du, Jiacheng Shi, Sidi Lu, Gang Zhou, Ye Gao

69. [MESA: Improving MoE Safety Alignment via Decentralized Expertise](#link69)
**Authors:** Yitong Sun, Yao Huang, Teng Li, Ranjie Duan, Yichi Zhang, Xingjun Ma, Hui Xue, Xingxing Wei

70. [A Finite-Calibration Regime Map for LLM Judge Panels](#link70)
**Authors:** Bin Zhu, Yanghui Rao

71. [OPD+: Rethinking the Advantage Design for On-Policy Distillation](#link71)
**Authors:** Hanyang Zhao, Haoxian Chen, Han Lin, Genta Indra Winata, David Yao, Wenpin Tang

72. [OpenWebRL: Demystifying Online Multi-turn Reinforcement Learning for Visual Web Agents](#link72)
**Authors:** Rui Yang, Qianhui Wu, Yuxi Chen, Hao Bai, Wenlin Yao, Hao Cheng, Baolin Peng, Huan Zhang, Tong Zhang, Jianfeng Gao

73. [Encoded but Not Routed: Explaining the Table-Chart Gap in Scientific Claim Verification](#link73)
**Authors:** Sunisth Kumar, Xanh Ho, Tim Schopf, Andre Greiner-Petter, Florian Boudin, Akiko Aizawa

74. [ATLAS: Agentic Test-time Learning-to-Allocate Scaling](#link74)
**Authors:** Peijia Qin, Qi Cao, Pengtao Xie

75. [ANDES: Agent Native Data Evolving Synthesis Tool for Autonomous Instruction Alignment](#link75)
**Authors:** Zhengyang Zhao, Shengjie Ye, Lu Ma, Hao Liang, Hengyi Feng, Wentao Zhang

76. [Subliminal Learning is a LoRA Artifact](#link76)
**Authors:** Todd Nief, Harvey Yiyun Fu, Mark Muchane, Ari Holtzman

77. [EST-PRM: Stress-Testing Process Reward Models Before They Become Load-Bearing](#link77)
**Authors:** Ibne Farabi Shihab, Fariya Afrin, Sanjeda Akter, Anuj Sharma

78. [Normalized Relevance Measure as a Unifying Framework to Explain Neural Network Latent Structures](#link78)
**Authors:** Ping Xiong, Thomas Schnake, Gr\'egoire Montavon, Klaus-Robert M\"uller, Shinichi Nakajima

79. [Internalize the Temperature: On-Policy Self-Distillation as Policy Reheater for Reinforcement Learning](#link79)
**Authors:** Xuewei Yang, Jiachen Yu, Jie Wu, Shaoning Sun, Junjie Wang, Yujiu Yang

80. [Escaping the Mode Lottery: Multi-Response Training Improves Language Model Generalization](#link80)
**Authors:** Hasan Amin, Kian Ahrabian, Ming Yin, Rajiv Khanna

81. [Learning from Saturated Data: Signals Beyond Correctness for LLM Training](#link81)
**Authors:** Hanno Hiss, Jasper Dekoninck, Martin Vechev

82. [Trust Region On-Policy Distillation](#link82)
**Authors:** Xingrun Xing, Haoqing Wang, Boyan Gao, Ziheng Li, Yehui Tang

83. [Multi-Objective Reference-Aligned Machine Unlearning](#link83)
**Authors:** Rasa Khosrowshahli, Stephen Asobiela, Beatrice Ombuki-Berman, Shahryar Rahnamayan

84. [Agreement Metrics for LLM-as-Judge Evaluation: What to Report and Why](#link84)
**Authors:** Delip Rao, Chris Callison-Burch

85. [TriLens: Per-Layer Logit-Lens Entropy for White-Box Hallucination Detection](#link85)
**Authors:** Bohan Yang, Yijun Gong, Zhi Zhang, Ge Zhang, Wenpeng Xing, Meng Han

86. [EPIC: Efficient and Parallel Inference under CFG Constraints for Diffusion Language Models](#link86)
**Authors:** Hyundong Jin, Yo-Sub Han

87. [Evaluating Interactive Reasoning in Large Language Models: A Hierarchical Benchmark with Executable Games](#link87)
**Authors:** Mingyuan Fan, Weiguang Han, Daixin Wang, Cen Chen, Zhiqiang Zhang, Jun Zhou

88. [RoleCDE:Benchmarking and Mitigating Role-Alignment Trade-offs in Role-Playing Agents](#link88)
**Authors:** Huayi Lai, Shichao Song, Simin Niu, Hanyu Wang, Jiawei Yang, Zhouxing Wang, Zhiqiang Yin, Xun Liang

89. [Self-Healing Agentic Orchestrators for Reliable Tool-Augmented Large Language Model Systems](#link89)
**Authors:** Rahul Suresh Babu, Adarsh Agrawal

90. [Variational Learning for Insertion-based Generation](#link90)
**Authors:** Yangtian Zhang, Zhe Wang, Arthur Gretton, Rex Ying, David van Dijk, Michalis K. Titsias, Jiaxin Shi

91. [AnyEdit++: Adaptive Long-Form Knowledge Editing via Bayesian Surprise](#link91)
**Authors:** Bowen Tian, Caixue He, Jiemin Wu, Jingying Wang, Wenshuo Chen, Zexi Li, Yutao Yue

92. [SentGuard: Sentence-Level Streaming Guardrails for Large Language Models](#link92)
**Authors:** Jiaqi Yu, Xin Wang, Yixu Wang, Jie Li, Yan Teng, Xingjun Ma, Yingchun Wang

93. [HMPO: Hybrid Median-length Policy Optimization for Chain-of-Thought Compression](#link93)
...
94. [DiscourseFlip: An Oblique Discourse-Level Opinion Manipulation Attack against Black-box Retrieval-Augmented Generation](#link94)
**Authors:** Yuyang Gong, Miaokun Chen, Jiawei Liu, Zhuo Chen, Guoxiu He, Wei Lu, XiaoFeng Wang, Xiaozhong Liu

95. [Foundation-Preserving Adaptation via Generalized Rayleigh-Quotient Optimization](#link95)
**Authors:** Dongjun Kim, Adrian de Wynter, Huancheng Chen, Heasung Kim, Haris Vikalo

96. [Mitigating Hallucinations in Large Language Models Via Decoder Layer Skipping](#link96)
**Authors:** Hanze Li, Jinhao You, Yichen Guo, Kai Tang, Shuangyang Xie, Xiande Huang

97. [PR2: Predictive Routing Replay for MoE-Based LLM Reinforcement Learning](#link97)
...
98. [Rethinking the Role of Positional Encoding: Sliding-Window Transformers without PE Remain Turing Complete](#link98)
**Authors:** Qian Li, Xinyu Mao, Shang-Hua Teng

99. [Detector-Evasive LLM Paraphrasing via Constrained Policy Optimization](#link99)
**Authors:** Mingyi Wang, Zhuoer Shen, Yuheng Bu, Shaofeng Zou

100. [A Primer in Post-Training Reasoning Data: What We Know About How It Works](#link100)
**Authors:** Yaoming Li, Guangxiang Zhao, Qilong Shi, Lin Sun, Xiangzheng Zhang, Tong Yang

101. [Score $\times$ Decoder: A Unified View of Unsupervised Inference-Time Scaling for Hallucination Mitigation](#link101)
**Authors:** Yun-Chen Cheng, Che-Yu Lin, Cheng-Lin Yang

102. [Do Text Edits Generalize to Visual Generation? Benchmarking Cross-Modal Knowledge Editing in UMMs](#link102)
**Authors:** Xin Gao, Cheng Yang, Chufan Shi, Taylor Berg-Kirkpatrick

103. [ContinuousBench: Can Differentially Private Synthetic Text Improve Capabilities?](#link103)
...
104. [FineVerify: Scaling Test-Time Compute with Fine-Grained Self-Verification for Agentic Search](#link104)
**Authors:** James Xu Zhao, Hui Chen, Bryan Hooi, See-Kiong Ng

105. [Learning When to Translate for Multilingual Reasoning](#link105)
**Authors:** Deokhyung Kang, Hyounghun Kim, Gary Geunbae Lee

106. [From "Weak" Signals to Strong Models: Preference Delta Aggregation with LoRA Merging](#link106)
**Authors:** Qi Sun, Siyue Zhang, Yulin Chen, Yuxiang Xue, Ru Peng, Chen Zhao

107. [WaveFilter: Enhancing the Long-Context Capability of Diffusion LLMs via Wavelet-Guided KV Cache Filtering](#link107)
**Authors:** Jinnan Yang, Yan Wang, Zhen Bi, Kehao Wu, Xiaojie Li, Jungang Lou, Zechao Li, Jing Liu

108. [eMoT: evolving Memory-of-Thought via Symbolic Anchoring and Memory Corrosion](#link108)
**Authors:** Xiang Li, Jiwei Wei, Ke Liu, Yitong Qin, Jinyu Guo, Malu Zhang, Peng Wang, Yang Yang

109. [Thinking Economically: A Hierarchical Framework for Adaptive-Complexity Reasoning in LLMs](#link109)
...
110. [On the Difficulty of Learning a Meta-network for Training Data Selection](#link110)
**Authors:** Zilin Du, Junqi Zhao, Boyang Albert Li

111. [COMAP: Co-Evolving World Models and Agent Policies for LLM Agents](#link111)
**Authors:** Youwei Liu, Jian Wang, Hanlin Wang, Wenjie Li

112. [A Multi-Domain Red Teaming Framework for Safety, Robustness, and Fairness Evaluation of Medical Large Language Models](#link112)
...
113. [CultureForest: Understanding and Evaluating Cultural Norm Grounded Reasoning in LLMs](#link113)
**Authors:** Yangfan Ye, Xiaocheng Feng, Jialong Tang, Xiayu Cao, Zihan Zhang, Xiachong Feng, Baosong Yang, Bing Qin

114. [On the Scaling of PEFT: Towards Million Personal Models of Trillion Parameters](#link114)
...
115. [InfoAtlas: A Foundation Model for Zero-Shot Statistical Dependence Estimate](#link115)
**Authors:** Zhengyang Hu, Yanzhi Chen, Hanxiang Ren, Qunsong Zeng, Youyi Zheng, Adrian Weller, Kaibin Huang, Yanchao Yang

116. [Model-Based Quality Assessment for Massively Multilingual Parallel Data](#link116)
**Authors:** Abdelaziz M. A. Ibrahim, Zihao Li, J\"org Tiedemann, Shaoxiong Ji

117. [Cost-Aware Diffusion Draft Trees for Speculative Decoding](#link117)
**Authors:** Shuai Zhang, Huachuan Qiu, Hongliang He, Yong Dai

118. [IDEAFix: Evaluation Framework for Creative Defixation Prompting in LLMs](#link118)
**Authors:** F. Carichon, S. Sharma, M. Girard, R. Rampa, G. Farnadi

119. [Scaling Agentic Capabilities via Grounded Interaction Synthesis](#link119)
**Authors:** Wenhang Shi, Jinhao Dong, Yiren Chen, Zhe Zhao, Shuqing Bian, Wei Lu, Xiaoyong Du

120. [CAPF: Guiding Search-Agent Rollouts with Credit-Attenuated Privileged Feedback](#link120)
**Authors:** Bin Chen, Xinye Liao, Yiming Liu, Xin Liao, Chonghan Liu

121. [From Reward-Free Representations to Preferences: Rethinking Offline Preference-Based Reinforcement Learning](#link121)
**Authors:** Jun-Jie Yang, Chia-Heng Hsu, Kui-Yuan Chen, Ping-Chun Hsieh

122. [OmniOPD: Logit-Free On-Policy Distillation via Speculative Verification](#link122)
**Authors:** Yuhang Zhou, Lizhu Zhang, Yifan Wu, Mingyi Wang, Peng Bo, Jiayi Liu, Xiangjun Fan, Zhuokai Zhao

123. [Reinforcement Learning with Pairwise Preferences in Long-Term Decision Problems](#link123)
**Authors:** Jonathan Cola\c{c}o Carr, Prakash Panangaden, Doina Precup, Benjamin Van Roy

124. [Which Institutional Frameworks Do Chatbots Assume? Auditing Jurisdictional Defaults in Multilingual LLMs](#link124)
**Authors:** Zhizhi Wang, Harini Suresh

125. [FLaG: Fine-Grained Latent Grouping for Hallucination Detection](#link125)
**Authors:** Wentao Ye, Liyao Li, Zhiqing Xiao, Muzhi Zhu, Jiaqi Hu, Zhanming Shen, Xiaomeng Hu, Sean Du, Haobo Wang

126. [Where Do Deep-Research Agents Go Wrong? Span-Level Error Localization in Agent Trajectories](#link126)
...
127. [HERO'S JOURNEY: Testing Complex Rule Induction with Text Games](#link127)
**Authors:** Anshun Asher Zheng, Kanishka Misra, David I. Beaver, Junyi Jessy Li

128. [Revisiting Ripple Effects in Knowledge Editing through Pressure-Aware Joint Neighborhood Optimization](#link128)
**Authors:** Haoben Huang, Shuxin Liu, Ou Wu, Di Gao

129. [Who Annotates in NLP? A Large-scale Assessment of Human Annotation Reporting between 2018 and 2025](#link129)
...
130. [SIRI: Self-Internalizing Reinforcement Learning with Intrinsic Skills for LLM Agent Training](#link130)
...
131. [Revisiting Parameter-Based Knowledge Editing in Large Language Models: Theoretical Limits and Empirical Evidence](#link131)
**Authors:** Wanying Ren, Xin Song, Futing Wang, Guoxiu He, Aixin Sun

132. [Learning When Not to Act: Mitigating Tool Abuse in Agentic Reinforcement Learning](#link132)
**Authors:** Liuji Chen, Dianxing Tang, Xing Shi, Dingshuo Chen, Qiang Liu, Shu Wu, Liang Wang

133. [On Effectiveness and Efficiency of Agentic Tool-calling and RL Training](#link133)
**Authors:** Tong Liu, Cheng Qian, Matej Cief, Yuan He, Daniele Dan, Nikolaos Aletras, Gabriella Kazai

134. [Towards Understanding Modality Interaction in Multimodal Language Models via Partial Information Decomposition](#link134)
**Authors:** Wanlong Fang, Tianle Zhang, Wen Tao, Alvin Chan

135. [Does Compression Preserve Uncertainty? A Unified Benchmark for Quantized and Sparse LLMs via Conformal Prediction](#link135)
**Authors:** Yujia Tong, Yuxi Wang, Yunyang Wan, Tian Zhang, Junhao Dong, Jingling Yuan

136. [ResMerge: Residual-based Spectral Merging of Large Language Models](#link136)
**Authors:** Yandu Sun, Zhiyan Hou, Haokai Ma, Yuheng Jia, Junfeng Fang, Haiyun Guo, Hongyan An, weizhen wang, Jinqiao Wang

137. [Early Diagnosis of Wasted Computation in Multi-Agent LLM Systems via Failure-Aware Observability](#link137)
**Authors:** Xianyou Li, Weiran Yan, Yichao Wu, Penghao Liang, Mengwei Yuan, Jianan Liu, Jing Yang

138. [TIGER: Traceable Inference with Graph-Based Evidence Routing for Mitigating Hallucinations in Multimodal Generation](#link138)
**Authors:** Kaixiang Zhao, Tianrun Yu, Shawn Huang, Porter Jenkins, Yushun Dong, Amanda Hughes

139. [Masking Stale Observations Helps Search Agents -- Until It Doesn't: A Regime Map and Its Mechanism](#link139)
**Authors:** Haoxiang Zhang, Qixin Xu, Zhuofeng Li, Lei Zhang, Pengcheng Jiang, Yu Zhang, Julian McAuley

140. [Geometric Erasure by Contrastive Velocity Matching in Rectified Flows](#link140)
**Authors:** Jonas Henry Grebe, Tobias Braun, Anna Rohrbach, Marcus Rohrbach

141. [Expected Value Alignment for Generative Reward Modeling in Formal Mathematics Verification](#link141)
**Authors:** Shihao Ji, Haotao Tan, Zihui Song, Mingyu Li

142. [Closed-Loop Neural Activation Control in Vision-Language-Action Models](#link142)
...
143. [FALAT: Tracing Failures in LLM Agent Trajectories via Dependency-Guided Search](#link143)
**Authors:** Md Nakhla Rafi, Md Ahasanuzzaman, Dong Jae Kim, Zhijie Wang, Tse-Hsun Chen

144. [On the Generalization Gap in Self-Evolving Language Model Reasoning](#link144)
**Authors:** Zhenting Qi, Susanna Maria Baby, Stefanie Anna Baby, Kan Yuan, Andrew Tomkins, Tu Vu, Da-Cheng Juan, Cyrus Rashtchian

145. [Mitigating Bias in Locally Constrained Decoding via Tractable Proposals](#link145)
**Authors:** Meihua Dang, Linxin Song, Honghua Zhang, Jieyu Zhao, Guy Van den Broeck, Stefano Ermon

146. [Robust Reasoning via Dynamic Token Selection for Distribution-Aligned Self-Distillation](#link146)
**Authors:** Ruiqi Zhang, Lingxiang Wang, Hainan Zhang Zhiming Zheng

147. [Exploiting weight-space symmetries for approximating curvature](#link147)
**Authors:** Artem Artemev, Rui Xia, Benjamin M. Boyd, Youjing Yu, Felix Dangel, Guillaume Hennequin, Alberto Bernacchia

148. [Unified Context Evolution for LLM Agents](#link148)
**Authors:** Zixuan Zhu, Yitong Hu, Yong Dai, Junfeng Fang, Chunyang Jiang, Senkang Hu, Yuzhi Zhao

149. [Why Are DMD Students Lazy? Understanding the Copying Behavior in Few-Step Distillation](#link149)
**Authors:** Shucheng Li, Iolo Jones, Alexander Tong, Michael M. Bronstein

150. [Consistent and Distinctive: LLM Benchmark Efficiency via Maximum Independent Set Prompt Selection on Similarity Graphs](#link150)
**Authors:** Denica Kjorvezir, Marko Djukanovi\'c, Ana Gjorgjevikj, Gjorgjina Cenikj, Tome Eftimov

151. [SkillSmith: Co-Evolving Skills and Tools for Self-Improving Agent Systems](#link151)
**Authors:** Yangbo Wei, Zhen Huang, Shaoqiang Lu, Junhong Qian, Qifan Wang, Chen Wu, Lei He

152. [ProactiveLLM: Learning Active Interaction for Streaming Large Language Models](#link152)
**Authors:** Junlong Tong, Yao Zhang, Anhao Zhao, Yingqi Fan, Yunpu Ma, Xiaoyu Shen

153. [Understanding LLM Behavior in Multi-Target Cross-Lingual Summarization](#link153)
**Authors:** Sangwon Ryu, Yihong Liu, Mingyang Wang, Yunsu Kim, Jungseul Ok, Gary Geunbae Lee, Hinrich Schuetze

154. [When Knowledge Is Not Free: Cost-Aware Evidence Selection in Retrieval-Augmented Generation](#link154)
**Authors:** Mingyan Wu, Han Yang, Omer Ben-Porat, Yftah Ziser

155. [Robust Asynchronous Planning via Auto-Formalization](#link155)
**Authors:** Jiayi Zhang, Jianing Yin, Ben Zhou, Li Zhang

156. [Multi-Agent Conformal Prediction with Personalized Statistical Validity](#link156)
**Authors:** Martin V. Vejling, Christophe A. N. Biscio, Adrien Mazoyer, Petar Popovski, Shashi Raj Pandey

157. [Prospect-Theory Behavior from Bellman Optimality in MDPs with Catastrophic States](#link157)
**Authors:** Yujiao Chen

158. [Memory-Efficient LLM Training with Dynamic Sparsity: From Stability to Practical Scaling](#link158)
...
159. [AGENTCL: Toward Rigorous Evaluation of Continual Learning in Language Agents](#link159)
**Authors:** Yiheng Shu, Bernal Jim\'enez Guti\'errez, Saisri Padmaja Jonnalagedda, Yuguang Yao, Huan Sun, Yu Su

160. [Grounded Decoding: Retrieval-Anchored Probability Fusion for Faithful RAG](#link160)
**Authors:** Ibne Farabi Shihab, Fariya Afrin, Sanjeda Akter, Anuj Sharma

161. [Rethinking Bregman Divergences in Kronecker-Factored Optimizers](#link161)
**Authors:** Bing Liu, Wenjie Zhou, Chengcheng Zhao

162. [lmfaoooo at SemEval-2026 Task 1: Humor Is an Audience. Preference Modeling for Constrained Humor Generation](#link162)
**Authors:** Alexey Tikhonov, Alexey Ivanov

163. [DFlare: Scaling Up Draft Capacity for Block Diffusion Speculative Decoding](#link163)
...
164. [On the Salience of Low-Probability Tokens for AI-Generated Text Detection: A Multiscale Uncertainty Perspective](#link164)
**Authors:** Yikai Guo, Bin Wang, Xilai Fan, Wenjun Ke, Haoran Luo

165. [ProbMoE: Differentiable Probabilistic Routing for Mixture-of-Experts](#link165)
**Authors:** Heng Zhao, Zilei Shao, Guy Van den Broeck, Zhe Zeng

166. [MomentKV: Closing the Directional Gap in KV Cache Eviction for Long-Context Inference](#link166)
**Authors:** Yu Li, Binxu Li, Tian Lan

167. [DAG-MoE: From Simple Mixture to Structural Aggregation in Mixture-of-Experts](#link167)
...
168. [TRON: Targeted Rule-Verifiable Online Environments for Visual Reasoning RL](#link168)
**Authors:** Tianze Yang, Yucheng Shi, Ruitong Sun, Jingyuan Huang, Ninghao Liu, Jin Sun

169. [Learning to Construct Practical Agentic Systems](#link169)
...
170. [Harness-1: Reinforcement Learning for Search Agents with State-Externalizing Harnesses](#link170)
**Authors:** Pengcheng Jiang, Zhiyi Shi, Kelly Hong, Xueqiang Xu, Jiashuo Sun, Jimeng Sun, Hammad Bashir, Jiawei Han

171. [CRAM: Centroid-Routing and Adaptive MoE for Multimodal Continual Instruction Tuning](#link171)
**Authors:** Jun-Tao Tang, Zhen-Hao Xie, Yu-Cheng Shi, Da-Wei Zhou

172. [Towards Lightweight Reliability: Using Soft Prompts for Hallucination Mitigation in Large Language Models](#link172)
**Authors:** S M Tahmid Siddiqui, Akib Jawad Ononto, Anoop Singhal, Latifur Khan

173. [Linguistics-Aware Non-Distortionary LLM Watermarking](#link173)
**Authors:** Shinwoo Park, Hyejin Park, Hyeseon An, Yo-Sub Han

174. [Do Gender Cues Affect LLM Value Trade-offs? Evidence from a Controlled Decision Benchmark](#link174)
**Authors:** Yangyang Liu, Dong Yu, Pengyuan Liu

175. [What Makes a Strong Model? A Unified Spectral Analysis of Knowledge Transfer over High-dimensional Linear Regression](#link175)
**Authors:** Wendao Wu, Fangqing Zhang, Haihan Zhang, Cong Fang

176. [Effects of Varying LLM Access on Essay Writing Behavior](#link176)
**Authors:** Julia Christenson, Karin de Langis, Shirley Anugrah Hayati, Dongyeop Kang

177. [Silent Failures in Federated Personalization of Foundation Models](#link177)
**Authors:** YongKyung Oh, Alex Bui

178. [Policy and World Modeling Co-Training for Language Agents](#link178)
...
179. [Forget Attention: Importance-Aware Attention Is All You Need](#link179)
**Authors:** Soohyeong Shin, Yeongwook Yang

180. [Adaptive Auto-Harness: Sustained Self-Improvement for Agentic System Deployment on Open-Ended Task Streams](#link180)
**Authors:** Zewen Liu, Zhan Shi, Yisi Sang, Bing He, Minhua Lin, Tianxin Wei, Dakuo Wang, Benoit Dumoulin, Wei Jin, Hanqing Lu

181. [Flow-Transformed Implicit Processes for Function-Space Variational Inference](#link181)
**Authors:** Luis A. Ortega, Andr\'es R. Masegosa, Thomas D. Nielsen

182. [Turning Back Without Forgetting: Selective Backward Refinement for Parameter-Efficient Continual Learning](#link182)
**Authors:** Anushka Tiwari, Kaiyi Ji

183. [When Softmax Fails at the Top: Extreme Value Corrections for InfoNCE](#link183)
**Authors:** Melihcan Erol, Suat Evren, Oktay Ozel, Alexander Morgan, Jongha Jon Ryu, Lizhong Zheng

184. [Token Predictors Are Not Planners: Building Physically Grounded Causal Reasoners](#link184)
**Authors:** Zheng Lu, Mingqi Gao, Qinlei Xie, Wanqi Zhong, Hanwen Cui, Heng Cao, Zirui Song, Yifan Yang, Chong Luo, Bei Liu, Yiming Li

185. [Characterization of Multi-Model Agentic AI Systems on General Tasks via Trace-Driven Simulation](#link185)
**Authors:** Donghwan Kim, Prakhar Singh, Younghoon Min, Jongryool Kim, Jongse Park, Kiwan Maeng

186. [Fast Generalization after Interpolation via Critically Damped Momentum Optimization](#link186)
**Authors:** Luca Muscarnera, Silas Ruhrberg Est\'evez, Yuanzhang Xiao, Mihaela Van der Schaar

187. [STARFISH: faST Accuracy Recovery in pruned networks From Internal State Healing](#link187)
**Authors:** Shir Maon, Odelia Melamed, Adi Shamir

188. [When Hard Negatives Hurt: Bridging the Generative-Discriminative Gap in Hard Negative Synthesis for Retrieval](#link188)
...
189. [Don't Read Everything: A Curvature-Conditioned Query for Linear Attention](#link189)
**Authors:** Dong Le, Thong Nguyen, Cong-Duy Nguyen, Anh Tuan Luu

190. [MindZero: Learning Online Mental Reasoning With Zero Annotations](#link190)
**Authors:** Shunchi Zhang, Jin Lu, Chuanyang Jin, Yichao Zhou, Zhining Zhang, Tianmin Shu

191. [HarnessForge: Joint Harness and Policy Evolution for Adaptive Agent Systems](#link191)
**Authors:** Mingju Chen, Can Lv, Guibin Zhang, Heng Chang, Shiji Zhou

192. [GPTQ-intrinsic LoRA: A Near-optimal Algorithm for Low-precision Quantization with Low-rank Adaptation](#link192)
**Authors:** Shihao Zhang, Rayan Saab

193. [The Case for Model Science: Verify, Explore, Steer, Refine](#link193)
**Authors:** Przemyslaw Biecek, Luca Longo, Jianlong Zhou, Thomas Fel, Andreas Holzinger, Wojciech Samek

194. [Soft-NBCE: Entropy-Weighted Chunk Fusion for Long-Context](#link194)
**Authors:** Shihao Ji, Mingyu Li, Zihui Song

195. [Efficient RAG with Intent-Aware Retrieval and Semantics-Preserving Chunking](#link195)
...
196. [RASER: Recoverability-Aware Selective Escalation Router for Multi-Hop Question Answering](#link196)
**Authors:** Yuyang Li, Zihe Yan, Tobias K\"afer

197. [Toward Robust In-Context Learning: Leveraging Out-of-distribution Proxies for Target Inaccessible Demonstration Retrieval](#link197)
**Authors:** Hao Xu, Rite Bo, Fausto Giunchiglia, Yingji Li, Rui Song

198. [Model-Native Computing Architecture: Envisioning Future System Architecture Through the Lens of Computer Architecture](#link198)
**Authors:** Hai Lin

199. [Parameter Alignment Mitigates Catastrophic Forgetting in Multilingual Expert Language Models](#link199)
**Authors:** Sanchit Ahuja, Terra Blevins

200. [SENSE: Semantic Embedding Navigation with Soft-gated Evaluation for Retrieval-based Speculative Decoding](#link200)
**Authors:** Shaowen Chen, Zhicheng Liao, Hongwei Wang

201. [Confidence-Adaptive SwiGLU for Mixture-of-Experts](#link201)
**Authors:** Shaohua Li, Xiuchao Sui, Xiaobing Sun, Yuhang Wu, Liangli Zhen, Yong Liu, Rick Siow Mong Goh

202. [CA-BED: Conversation-Aware Bayesian Experimental Design](#link202)
...
203. [When Parallelism Pays Off: Cohesion-Aware Task Partitioning for Multi-Agent Coding](#link203)
**Authors:** Xu Yang, Lunyiu Nie, Ethan Chandra, Stanislav Gannutin, Fangru Lin, Swarat Chaudhuri

204. [DREAM-S: Speculative Decoding with Searchable Drafting and Target-Aware Refinement for Multimodal Generation](#link204)
**Authors:** Zining Liu, Yunhai Hu, Tianhua Xia, Bo Bao, Eric Sather, Vithursan Thangarasa, Sai Qian Zhang

205. [Multilingual Idioms in Sentences and Conversations Across High-, Medium-, and Low-Resource Languages](#link205)
...
206. [SIRIUS-SQL: Anchoring Multi-Candidate Text-to-SQL in Execution Feedback](#link206)
**Authors:** Leo Luo, Haining Xie, Siqi Shen, Zhipeng Ma, Rui Ling, Hang Xu, Hefeng Jiang, Dingwei Chen, Yang Li, Peng Chen, Jie Jiang

207. [From Layers to Submodules: Rethinking Granularity in Replacement-Based LLM Compression](#link207)
**Authors:** Elia Cunegatti, Marcus Vukojevic, Erik Nielsen, Giovanni Iacca

208. [Generative AI and Digital Ecosystem Resilience: A Proactive Lifecycle-Based Survey](#link208)
**Authors:** Jonghyun Chung, Rishabh Chaddha, Sanket Badhe, Debanshu Das, Nathan Huang, Amanpreet Kaur

209. [Easier to Mislead Than to Correct: Harmful and Beneficial Revision in LLM Conformity](#link209)
**Authors:** Jiaming Qu, Lucheng fu, Yibo Hu

210. [Learning to Retrieve: Dual-Level Long-Term Memory for Text-to-SQL Agents](#link210)
**Authors:** Yibo Wang, Nikki Lijing Kuang, Philip S. Yu, Zhewei Yao, Yuxiong He

211. [CUPID in the Model Zoo: Online Matchmaking for Selecting Your Dream LLM](#link211)
**Authors:** Son Nguyen, Xinyuan Liu, Ransalu Senanayake

212. [FOAM: Frequency and Operator Error-Based Adaptive Damping Method for Reducing Staleness-Oriented Error for Shampoo](#link212)
**Authors:** Kyunghun Nam, Sumyeong Ahn

213. [When Meaning Travels: A Granular Lens on Hybrid-MoE's Role in Idiomatic Understanding for Language Models](#link213)
**Authors:** Sarmistha Das, Vaibhav Vishal, Shreyas Guha, Amaan Ali, Kitsuchart Pasupa, Sriparna Saha

214. [Saliency-Aware Model Merging](#link214)
**Authors:** Jungin Park, Jiyoung Lee, Kwanghoon Sohn

215. [BudgetDraft: Acceptance-Aware Multi-View Training for Sparse-KV Speculative Decoding](#link215)
**Authors:** Liang He, Jingbo Wen, Qishi Zhan, Yixiong Chen, Kangning Cui, Qizhen Lan, Xilu Wang

216. [Skill or Skip? Learning Selective Skill Invocation in Agentic Tasks via Dual-Granularity Preference Learning](#link216)
**Authors:** Chishui Chen, Jiaye Lin, Te Sun, Junxi Wang, Yi Yang, Cong Qin, Yangen Hu, Lu Pan, Ke Zeng

217. [Reasoning4Sciences: Bridging Reasoning Language Models to All Scientific Branches](#link217)
...
218. [MMG2Skill: Can Agents Distill In-the-Wild Guides into Self-Evolving Skills?](#link218)
...
219. [Connecting the Dots: Benchmarking Reflective Memory in Long-Horizon Dialogue](#link219)
**Authors:** Jingjie Lin, Bingbing Wang, Zihan Wang, Zhengda Jin, Weiming Qiao, Jing Li, Ruifeng Xu

220. [Hybrid Verified Decoding: Learning to Allocate Verification in Speculative Decoding](#link220)
...
221. [Finer Parameter Steps for Low-Rank PEFT: A Controlled Study with CP Tensor Adapters](#link221)
**Authors:** Xinjue Wang, Xiuheng Wang, Yejun Zhang, Sergiy A. Vorobyov, Esa Ollila, Zhi-Yong Wang

222. [BRo-JEPA: Learning Modular Arithmetic in Latent Space](#link222)
**Authors:** Divyansh Jha, Yuanfang Xie, Varan Mehra, Brennen Yu

223. [Balancing Learning Rates Across Layers: Exact Two-Step Dynamics and Optimal Scaling in Linear Neural Networks](#link223)
**Authors:** Tianyu Pang, Vignesh Kothapalli, Shenyang Deng, Haohui Wang, Dawei Zhou, Yaoqing Yang

224. [SkillAdaptor: Self-Adapting Skills for LLM Agents from Trajectories](#link224)
**Authors:** Zhuoyun Yu, Xin Xie, Wuguannan Yao, Chenxi Wang, Lei Liang, Xiang Qi, Shumin Deng

225. [SkillRevise: Improving LLM-Authored Agent Skills via Trace-Conditioned Skill Revision](#link225)
...
## Paper selection prompt
 ...
 7. Presents new methods or improvements for sparse autoencoders in neural network interpretability. Sparse autoencoders are unsupervised learning techniques that learn sparse representations of neural network activations to understand what features networks detect.
    - Relevant: papers that explicitly mention sparse autoencoders, sparse coding, or sparse feature extraction applied to understanding neural networks, language models, or other AI systems.
    - Not relevant: papers about general autoencoders without sparsity constraints, or sparse methods not applied to interpretability.
 8. Demonstrates new mechanistic interpretability techniques or discoveries about how neural networks work internally. Mechanistic interpretability seeks to understand the algorithms and circuits that neural networks learn.
    - Relevant: papers about circuit analysis, feature visualization, activation patching, causal interventions on neural networks, or reverse-engineering specific algorithms learned by models.
    - Not relevant: papers that only do black-box analysis or correlation studies without mechanistic understanding.
 9. Shows advances in machine unlearning techniques for removing specific knowledge or behaviors from trained models.
    - Relevant: papers on forgetting specific data, removing harmful capabilities, or selectively editing model knowledge while preserving other capabilities.
    - Not relevant: papers about general model editing or fine-tuning without specific unlearning focus.
 10. Presents methods for tamper resistance, robustness against adversarial modifications, or secure AI systems.
    - Relevant: papers on preventing model poisoning, backdoor attacks, or making AI systems resistant to tampering or manipulation.
    - Not relevant: papers only about general adversarial robustness without security/tamper resistance focus.
 11. Studies AI alignment techniques, value learning, or methods to ensure AI systems behave according to human values and intentions.
    - Relevant: papers on reward modeling, constitutional AI, value alignment, or techniques to make AI systems more aligned with human preferences.
    - Not relevant: papers focused only on performance improvement without alignment considerations.
 12. Advances in LLM reasoning capabilities, chain-of-thought reasoning, or understanding how language models perform complex reasoning tasks.
    - Relevant: papers on step-by-step reasoning, logical inference in LLMs, reasoning chain analysis, or methods to improve reasoning capabilities.
    - Not relevant: papers about reasoning in non-LLM contexts or that don't focus on reasoning mechanisms.
 13. Presents new methods for AI control, oversight, or monitoring of AI system behavior during deployment.
    - Relevant: papers on AI governance techniques, monitoring systems, control mechanisms, or methods to maintain oversight of deployed AI systems.
    - Not relevant: papers focused only on training-time controls without deployment considerations.
 14. Shows advances in chain-of-thought monitoring, reasoning transparency, or methods to understand AI decision-making processes.
    - Relevant: papers on monitoring reasoning chains, making AI reasoning more transparent, or techniques to track how models arrive at conclusions.
    - Not relevant: papers about general explainability without specific focus on reasoning processes.
 15. Studies ControlArena, Inspect framework, or similar evaluation platforms for AI safety and control.
    - Relevant: papers using or extending these evaluation frameworks, comparative studies using these platforms, or methodological improvements to these tools.
    - Not relevant: papers that mention these tools only in passing without substantial use or analysis.
 16. Advances in latent reasoning, implicit reasoning processes, or understanding hidden computational processes in neural networks.
    - Relevant: papers on uncovering implicit reasoning, analyzing hidden computational steps, or methods to make latent reasoning processes more explicit.
    - Not relevant: papers about explicit reasoning without focus on hidden or latent processes.
 17. Studies data poisoning attacks or defenses in machine learning systems.
    - Relevant: papers on poisoning training data to manipulate model behavior, detecting poisoned data, or defending against data poisoning attacks.
    - Not relevant: papers about general adversarial examples at inference time without training data manipulation.
 18. Advances in data-centric AI approaches that focus on improving data quality, curation, or data-driven methods for ML.
    - Relevant: papers on data quality assessment, data selection, data augmentation strategies, curriculum learning based on data properties, or systematic approaches to dataset creation and curation.
    - Not relevant: papers that simply use standard datasets without focusing on data-centric methodology.
 19. Studies security of LLMs and methods to protect language models from attacks or exploitation.
    - Relevant: papers on prompt injection defenses, jailbreak prevention, securing LLM deployments, protecting against extraction attacks, or hardening LLM systems against adversarial users.
    - Not relevant: papers about using LLMs for security applications, or general robustness without security focus.
